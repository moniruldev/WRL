...
{
    #region enums
    public enum ListViewAfterSortSelection
    {
        None = 0,
        Top = 1,
        TopSelect = 2,
    ...
    public class ListViewSortManager
    {
        ...
        /// <summary>
        /// After Sort Item Selection
        /// </summary>
        public ListViewAfterSortSelection ItemAfterSort
        {
            get { return m_ItemAfterSort; }
            set { m_ItemAfterSort = value; }
        }
		...
		{
			this.Sort(e.Column);
            switch (m_ItemAfterSort)
            {
                case ListViewAfterSortSelection.None:
                    break;
                case ListViewAfterSortSelection.Top:
                    if (this.m_list.Items.Count > 0)
                    {
                        this.m_list.Items[0].EnsureVisible();
                    }
                    break;
                case ListViewAfterSortSelection.TopSelect:
                    if (this.m_list.Items.Count > 0)
                    {
                        this.m_list.Items[0].Selected = true;
                        this.m_list.Items[0].EnsureVisible();
                    }
                    break;
                case ListViewAfterSortSelection.Bottom:
                    if (this.m_list.Items.Count > 0)
                    {
                        this.m_list.Items[this.m_list.Items.Count - 1].EnsureVisible();
                    }
                    break;
                case ListViewAfterSortSelection.BottomSelect:
                    if (this.m_list.Items.Count > 0)
                    {
                        this.m_list.Items[this.m_list.Items.Count - 1].Selected = true;
                        this.m_list.Items[this.m_list.Items.Count - 1].EnsureVisible();
                    }
                    break;
                case ListViewAfterSortSelection.EnsureVisibleSeleted:
                    if (this.m_list.SelectedItems.Count > 0)
                    {
                        this.m_list.SelectedItems[0].EnsureVisible();
                    }
                    break;
            }
		}
        ...
        private ListViewAfterSortSelection m_ItemAfterSort = ListViewAfterSortSelection.None;
