...
namespace PG.Report.ReportClass.InventoryRC
{
    ...
    public class rcMaterialStock
    {
        ...
        public string SND_ITEM_CODE { get; set; }
        ...
        public decimal COLISING_VALUE { get; set; }
        ...
        public decimal OP_REJECT_QTY { get; set; }
        ...
        public decimal OP_ISSUE_FOR_PRODUCTION { get; set; }
        ...
        public decimal BATT_CONVERT_FROM { get; set; }
        public decimal BATT_CONVERT_TO { get; set; }
        public int ITEM_ORDER { get; set; }
         public string BRAND_NAME { get; set; }
        public string BATERY_CAT_DESCR{ get; set; }
        public int BATERY_CAT_SL_NO{ get; set; }
        public int BRAND_SL_NO { get; set; }
         ...
         public decimal SCRAP_MIXTURE_QTY { set; get; }

         public DateTime? LAST_ITC_DATE { set; get; }

         public decimal ISSUE_TO_CASTING_REJ_GRID { set; get; }
         public decimal QC_PASS_QTY { set; get; }
         public decimal OP_QC_PASS_QTY { set; get; }
         public decimal QC_REJECT_QTY { set; get; }
         public decimal OP_QC_REJECT_QTY { set; get; }
         public decimal QC_RETURN_QTY { set; get; }
         public decimal OP_QC_RETURN_QTY { set; get; }
         public int STORE_ID { get; set; }
         public string STORE_NAME { get; set; }
         public decimal INDT_QTY { set; get; }
         public decimal PENDING_INDT_QTY { set; get; }
         public decimal PENDING_PURCHASE_QTY { set; get; }
         public decimal PENDING_MRR_QTY { set; get; }
         public decimal REQ_PENDING_QTY { set; get; }
         public decimal TOTAL_PR_PENDING_QTY { get; set; }
         public string STORAGE_LOCATION_NAME { get; set; }
         public decimal GRID_REJECT_QTY { get; set; }
         public decimal OP_GRID_REJECT_QTY { get; set; }
         public decimal CONV_LEAD_QTY { get; set; }
         ...
         #region  Rejection Item
        public decimal OP_GRID_REJ_QTY {get;set;}
        public decimal GRID_REJ_QTY { get; set; }
        public decimal OP_PROD_REJ_RCV_QTY{get;set;}
        public decimal PROD_REJ_RCV_QTY{get;set;}
        public decimal OP_PROD_REJ_ISS_QTY{get; set;}
        public decimal PROD_REJ_ISS_QTY{get;set;}
        public decimal OP_REJ_TRAN_RCV_QTY {get; set;}
        public decimal REJ_TRAN_RCV_QTY{get;set;}
        public decimal OP_REJ_TRAN_ISS_QTY{get;set;}
        public decimal REJ_TRAN_ISS_QTY{get;set;}
        public decimal OP_REJ_RCV_WITH_PROD_QTY{get;set;}
        public decimal REJ_RCV_WITH_PROD_QTY{get; set;}
        public decimal OP_REJ_ISS_WITH_PROD_QTY{get;set;}
        public decimal REJ_ISS_WITH_PROD_QTY { get; set; }
        public decimal OP_REJ_FROM_STORE_QTY{get;set;}
        public decimal REJ_FROM_STORE_QTY{get;set;}
        public decimal OP_REJ_ISS_FROM_STORE_QTY{get;set;}
        public decimal REJ_ISS_FROM_STORE_QTY{get;set;}
        public decimal OP_REJ_RCV_BY_STORE_QTY{get;set;}
        public decimal REJ_RCV_BY_STORE_QTY{get;set;}
        public decimal REJ_ISSUE_FROM_DEPT_QTY{get;set;}
        public decimal OP_REJ_ISSUE_FROM_DEPT_QTY { get; set; }
        public decimal TOTAL_PROD_REJ_RCV { get; set; }
        public decimal PROCESS_LOSS_QTY { get; set; }
        public decimal OP_PROCESS_LOSS_QTY { get; set; }
        public int DEPARTMENT_ID { get; set; }
        public decimal REJ_RCV_WEIGHT { get; set; }
        public decimal OP_REJ_RCV_WEIGHT { get; set; }
        public int RCV_WEIGHT_UOM_ID { get; set; }
        public decimal REJ_ISS_WEIGHT { get; set; }
        public decimal OP_REJ_ISS_WEIGHT { get; set; }
        public int ISS_WEIGHT_UOM_ID { get; set; }
        public decimal ISSUE_TO_BREAKING { get; set; }
         ...
         public string  GROUP_NAME { get; set; }
            public decimal OP_Balance { set; get; }
            public decimal OpeningRate { set; get; }
            public decimal Openning_Value { set; get; }
            public decimal  InwardQty { set; get; }
            public decimal  InwardRate { set; get; }
            public decimal  InwardValue { set; get; }
            public decimal  OutwardQty { set; get; }
            public decimal  OutwardRate { set; get; }
            public decimal  OutwardValue { set; get; }
            public decimal Closing_Balance { set; get; }
            public decimal ClosingRate { set; get; }
            public decimal ClosingValue { set; get; }
