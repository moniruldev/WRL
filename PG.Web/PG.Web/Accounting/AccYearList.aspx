<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master"  AutoEventWireup="true" CodeBehind="AccYearList.aspx.cs" Inherits="PG.Web.Accounting.AccYearList" %>
...
function tbopen(key, userid)
{
    ...
    var url = IForm.RootPath + "Accounting/AccYear.aspx?id=" + key;
      ...
      <table>
            ...
            <asp:Button ID="btnRefresh" runat="server"  CssClass="buttonRefresh" style="padding-left:22px;"
               ...
               <td>
                ...
                <input id="btnAddNew" type="button" runat="server" value="New Year" class="buttonNew" style="padding-left:22px;" />
    ...
    <div id="dvGridContainer" style="width:100%; height: auto; text-align:left;">
        <div id="dvGridHeader" style="width:100%;height:25px; font-size: smaller;" class="subHeader">
            ...
            <tr>
                ...
                <td width="255px" align="left">Year Name</td>
            </tr>
            </table>
        </div> 
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            DataKeyNames="AccYearID" onrowdatabound="GridView1_RowDataBound" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="AccYearName" HeaderText="Year Name" >
