...
{
    public partial class InstrumentReceiveList : BagePage
    {
        int CompanyID = 0;
        ...
        {
            int insModeID = Convert.ToInt32(InstrumentModeEnum.Receive);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    hLink = "~/Accounting/InstrumentReceive.aspx?id=" + strD;
                }
