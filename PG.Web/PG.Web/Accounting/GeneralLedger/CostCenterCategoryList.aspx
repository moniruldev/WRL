<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master"  AutoEventWireup="true" CodeBehind="CostCenterCategoryList.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.CostCenterCategoryList" %>
...
function tbopen(key, userid)
{
  ...
  var url = IForm.RootPath + "Accounting/GeneralLedger/CostCenterCategory.aspx?id=" + key;
    ...
    if (IForm.PageMode == Enums.PageMode.InTab)
    {
       ...
       tdata.id = 0;
       tdata.name = "CostCenterCat";
       //tdata.label = "User: " + userid;
       tdata.label = "CostCenter Category";
       tdata.type = 0;
       tdata.url = url;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvContentHeader" class="dvContentHeader">
       <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Cost Center Category List"></asp:Label>
    </div>
      ...
      <table>
            ...
            <asp:Button ID="btnRefresh" runat="server"  CssClass="buttonRefresh" style="padding-left:22px;"
               ...
               <td>
                ...
                <input id="btnAddNew" type="button" runat="server" value="New Category" class="buttonNew" style="padding-left:22px; width:130px;" />
    ...
    <div id="dvGridContainer" style="width:100%; height: auto; text-align:left;">
        <div id="dvGridHeader" style="width:100%;height:25px; font-size: smaller;" class="subHeader">
            ...
            <tr>
                ...
                <td width="222px" align="left">Name</td>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            DataKeyNames="AccRefCategoryID" onrowdatabound="GridView1_RowDataBound" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="AccRefCategoryCode" HeaderText="Code" ItemStyle-Width="100px" />
                <asp:BoundField DataField="AccRefCategoryName" HeaderText="Name" >
