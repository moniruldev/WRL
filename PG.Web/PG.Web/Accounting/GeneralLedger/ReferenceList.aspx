<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master"  AutoEventWireup="true" CodeBehind="ReferenceList.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.ReferenceList" %>
...
function tbopen(key, userid)
{
  ...
  var url = IForm.RootPath + "Accounting/GeneralLedger/Reference.aspx?id=" + key;
    ...
    if (IForm.PageMode == Enums.PageMode.InTab)
    {
       ...
       tdata.id = 0;
       tdata.name = "Reference";
       //tdata.label = "User: " + userid;
       tdata.label = "Reference";
       tdata.type = 0;
       tdata.url = url;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvContentHeader" class="dvContentHeader">
       <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Reference List"></asp:Label>
    </div>
      ...
      <table>
            ...
            <asp:Button ID="btnRefresh" runat="server"  CssClass="buttonRefresh" style="padding-left:22px;"
               ...
               <td>
                ...
                <input id="btnAddNew" type="button" runat="server" value="New Reference" class="buttonNew" style="padding-left:22px; width:130px;" />
