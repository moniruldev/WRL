<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master"  AutoEventWireup="true" CodeBehind="GLGroupList.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.GLGroupList" %>
...
function tbopen(key, userid)
{
  ...
  var url = IForm.RootPath + "Accounting/GeneralLedger/GLGroup.aspx?id=" + key;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvContentHeader" class="dvContentHeader">
       <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="GL Head List"></asp:Label>
    </div>
      ...
      <table>
               ...
               <td>
                ...
                <td>
                   <asp:DropDownList ID="ddlIsActive" runat="server" 
                         CssClass="dropDownList" width="90" AutoPostBack="True" 
            ...
            <asp:Button ID="btnRefresh" runat="server"  CssClass="buttonRefresh" style="padding-left:22px;"
               ...
               <td>
                ...
                <input id="btnAddNew" type="button" runat="server" value="New Item Group" class="buttonNew" style="padding-left:22px; width:120px;" />
    ...
    <div id="dvGridContainer" style="width:100%; height: auto; text-align:left;">
        <div id="dvGridHeader" style="width:100%;height:25px; font-size: smaller;" class="subHeader">
            ...
            <tr>
                ...
                <td width="102px" align="left">Short Name</td>
                <td width="202px" align="left">Name</td>
                <td width="202px" align="left">Parent</td>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            DataKeyNames="GLGroupID" onrowdatabound="GridView1_RowDataBound" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="GLGroupCode" HeaderText="Code" ItemStyle-Width="80px" />
                <asp:BoundField DataField="GLGroupNameShort" HeaderText="ShortName" ItemStyle-Width="100px" />
                <asp:BoundField DataField="GLGroupName" HeaderText="Name" >
                
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="200px" HorizontalAlign="Left" />
                </asp:BoundField> 
                <asp:BoundField DataField="GLGroupNameParentEffective" HeaderText="Under" ItemStyle-Width="200px" /> 
                <asp:BoundField DataField="IsActive" HeaderText="Active" ItemStyle-Width="30px" /> 
            </Columns>
