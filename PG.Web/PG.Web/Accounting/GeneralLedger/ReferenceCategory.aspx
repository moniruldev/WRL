<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ReferenceCategory.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.ReferenceCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Reference Category"></asp:Label>
    </div>
    <!--Message Div -->
