<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="GLTranCodeCategory.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.GLTranCodeCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="GL Tran. Code Category"></asp:Label>
    </div>
    <!--Message Div -->
                      ...
                      <div style="width:100%;height:20px;">
                         <table>
                            <tr>
                             ...
                             <td>
                                <span>GL Tran. Code Category</span> 
                             </td>
                            </tr>
                         </table>
              ...
              <table style="text-align:left;" border="0" cellspacing="4" cellpadding="2">
                 <tr>
                   ...
                   <td>
                       &nbsp;</td>
                   <td>
                       <asp:HiddenField ID="hdnAccRefCategoryID" runat="server" Value="0" />
                   </td>
                                      <td>
                   </td>
                   <td>
