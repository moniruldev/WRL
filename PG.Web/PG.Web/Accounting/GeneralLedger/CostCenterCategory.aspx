<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="CostCenterCategory.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.CostCenterCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div id="dvHeader" class="dvHeader" >
		<asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Cost Center Category"></asp:Label>
	</div>
	<!--Message Div -->
					  ...
					  <div style="width:100%;height:20px;">
						 <table>
							<tr>
							 ...
							 <td>
								<span>Cost Center Category</span> 
							 </td>
							</tr>
						 </table>
