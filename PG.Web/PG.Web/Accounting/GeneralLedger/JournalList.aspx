<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="JournalList.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.JournalList" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Journal List"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="Voucher No:"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtJournalNo" runat="server" CssClass="textBox notEnterToTab" Width="90"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlJournalType" runat="server" CssClass="dropDownList" OnSelectedIndexChanged="ddlJournalType_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>

                        <td>
                            <asp:Label ID="Label4" runat="server" Text="Posted"></asp:Label>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:Button ID="btnRefresh" runat="server" CssClass="buttonRefresh" Style="padding-left: 22px;"
                                Text="Load Data" OnClick="btnRefresh_Click" />
                        </td>
                        <td>
                            <input id="btnAddNew" type="button" runat="server" value="New Journal" class="buttonNew"
                                style="padding-left: 22px; width: 100px;" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                DataKeyNames="JournalID" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="JournalNo" HeaderText="No" ItemStyle-Width="80px" />
                                    <asp:BoundField DataField="JournalDate" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="80" />
                                    <asp:BoundField DataField="JournalTypeName" HeaderText="Type" ItemStyle-Width="100px" />
                                    <asp:BoundField DataField="JournalDesc" HeaderText="Description" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="JournalAmt" HeaderText="Description" ItemStyle-Width="100px"
                                        ItemStyle-HorizontalAlign="Right" DataFormatString="{0:#0.00}" />
                                    <asp:TemplateField HeaderText="Posted?">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsPosted" Text='<%# Eval("IsPosted").ToString() == "True" ? "POST": "UNPOST" %>'
