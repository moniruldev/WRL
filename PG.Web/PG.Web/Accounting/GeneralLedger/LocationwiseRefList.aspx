<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master"  AutoEventWireup="true" CodeBehind="LocationwiseRefList.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.LocationwiseRefList" %>
...
function tbopen(key, userid)
{
    ...
    var url = IForm.RootPath + "Accounting/GeneralLedger/LocationwiseRefBinding.aspx?id=" + key;
    ...
    if (IForm.PageMode == Enums.PageMode.InTab)
    {
       ...
       tdata.id = 0;
       tdata.name = "LocationwiseReference";
       //tdata.label = "User: " + userid;
       tdata.label = "Location wise Reference";
       tdata.type = 0;
       tdata.url = url;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvContentHeader" class="dvContentHeader">
       <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Location wise Reference List"></asp:Label>
    </div>
   ...
   <div id="dvControlsHead" style="height:auto;width:100%;">
      <table>
          <tr>
              ...
              <td>
                  <asp:DropDownList ID="ddlLocation" runat="server" CssClass="dropDownList" Width="130px"></asp:DropDownList>
              </td>
              <td>
            ...
            <asp:Button ID="btnRefresh" runat="server"  CssClass="buttonRefresh" style="padding-left:22px;"
               ...
               <td>
                ...
                <input id="btnAddNew" type="button" runat="server" value="New Bindings" class="buttonNew" style="padding-left:22px; width:130px;" />
    ...
    <div id="dvGridContainer" style="width:100%; height: auto; text-align:left;">
        <div id="dvGridHeader" style="width:100%;height:25px; font-size: smaller;" class="subHeader">
            ...
            <tr>
                ...
                <td width="102px" align="left">LocationID</td>
                <td width="102px" align="left">LocationName</td>
                <td width="102px" align="left">AccRefID</td>
                <td width="102px" align="left">CategoryName</td>
                <td width="102px" align="left">AccRefName</td>
                <td width="150px" align="left">AccRefTypeName</td>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            DataKeyNames="LocationAccRefID" onrowdatabound="GridView1_RowDataBound" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="LocationID" HeaderText="LocationID" ItemStyle-Width="100px" />
                <asp:BoundField DataField="LocationName" HeaderText="LocationName" >
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="220" HorizontalAlign="Left" />
                </asp:BoundField> 
                <asp:BoundField DataField="AccRefID" HeaderText="AccRefID" ItemStyle-Width="150px" />
                <asp:BoundField DataField="AccRefCategoryName" HeaderText="CategoryName" >
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="100px" HorizontalAlign="Left" />
                </asp:BoundField> 
                <asp:BoundField DataField="AccRefName" HeaderText="AccRefName" >
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="220px" HorizontalAlign="Left" />
                </asp:BoundField> 
                <asp:BoundField DataField="AccRefTypeName" HeaderText="AccRefTypeName" >
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="220px" HorizontalAlign="Left" />
                </asp:BoundField> 
