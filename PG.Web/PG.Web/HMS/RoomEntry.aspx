<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="RoomEntry.aspx.cs" Inherits="PG.Web.HMS.RoomEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
     <div class="container-fluid">
       <div class="card ">  <%-- "d-flex flex-column min-vh-100" this class for set footer on bottom--%>
         <div class="card-header p-0">
           <div class="d-flex align-items-center justify-content-between p-1">
             <h5 class="card-title">Room Entry</h5>
      ...
      <div class="card-body">
            <asp:HiddenField ID="hdnROOM_ID" runat="server" />
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Room No :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtRoomNo" placeholder="Room No" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Room Type :</label>
                    <div class="col-sm-8">
                     <asp:DropDownList runat="server" ID="ddlRoomType" CssClass="form-control form-control-sm"></asp:DropDownList>
                    </div>
                  </div>
                </div>
             ...
             <div class="row mb-0">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Floor :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtFloor" placeholder="Enter Floor" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
            ...
            <div class="row mb-0">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Room Status :</label>
                    <div class="col-sm-8">
                    <asp:DropDownList runat="server" ID="ddlRoomStatus" CssClass="form-control form-control-sm"></asp:DropDownList>
                    </div>
                  </div>
                </div>
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Responsible :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtResponsible" placeholder="Enter Responsible Person"></asp:TextBox> 
                    </div>
                  </div>
                </div>
