<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Resarvation_List.aspx.cs" Inherits="PG.Web.HMS.Resarvation_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "HMS/Resarvation_Entry.aspx?id=" + key;
    ...
    <div class="container-fluid">
      ...
      <div class="card-header p-0">
       <div class="d-flex align-items-center justify-content-between p-1">
         <h5 class="card-title">Resarvation List</h5>
        ...
        <div class="card-body">
          <div class="row mb-0">
              ...
              <div class="row mb-0">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Check In From :</label>
                    <div class="col-sm-8">
                        <table>
                            <tr>
                                <td>
                                     <asp:TextBox ID="txtCheckInFromDate" runat="server" CssClass="TextBoxnew textDate dateParse" ></asp:TextBox>
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Check In To :</label>
                    <div class="col-sm-8">
                        <table>
                            <tr>
                                <td>
                                     <asp:TextBox ID="txtCheckInToDate" runat="server" CssClass="TextBoxnew textDate dateParse" ></asp:TextBox>
            ...
            <div class="row">
             <div class="col-md-12">
                ...
                DataKeyNames="GUEST_ID" EnableModelValidation="True" ClientIDMode="AutoID" OnRowDataBound="GridView1_RowDataBound" AllowPaging="true" EmptyDataText="There is no record" PageSize="2" 
              ...
              <Columns>
                  ...
                  <asp:BoundField DataField="CHECK_IN" HeaderText="Check In Date" DataFormatString="{0:dd-MMM-yyyy}" />
                  <asp:BoundField DataField="CHECK_OUT" HeaderText="Check Out Date" DataFormatString="{0:dd-MMM-yyyy}" />
