<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="RoomList.aspx.cs" Inherits="PG.Web.HMS.RoomList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "HMS/RoomEntry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Room Type Entry";
                tdata.label = "Room Type Entry";
                tdata.type = 0;
                tdata.url = url;
          ...
          <div class="row mb-0">
                ...
                <div class="col-md-4">
                  <div class="form-group row mb-0">
                    ...
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtName" placeholder="Room Type" ></asp:TextBox> 
                    </div>
                  </div>
            ...
            <div class="row">
             <div class="col-md-12">
                ...
                DataKeyNames="ROOM_ID" EnableModelValidation="True" ClientIDMode="AutoID" OnRowDataBound="GridView1_RowDataBound" AllowPaging="true" EmptyDataText="There is no record" PageSize="2" 
              ...
              <Columns>
                  ...
                  <asp:BoundField DataField="ROOM_STATUS" HeaderText="Room Status" />
