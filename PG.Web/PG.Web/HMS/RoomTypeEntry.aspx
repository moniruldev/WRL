<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="RoomTypeEntry.aspx.cs" Inherits="PG.Web.HMS.RoomTypeEntry" %>
       ...
       <div class="card ">  <%-- "d-flex flex-column min-vh-100" this class for set footer on bottom--%>
         <div class="card-header p-0">
           <div class="d-flex align-items-center justify-content-between p-1">
             <h5 class="card-title">Room Type Entry</h5>
             <asp:LinkButton runat="server" ID="lnkList" class="btn btn-primary p-1"> <i class="fas fa-list"></i> Room Type List </asp:LinkButton>
         </div>

       </div>
        
      <div class="card-body">
            <asp:HiddenField ID="hdnROOM_TYPE_ID" runat="server" />
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Title :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtTitle" placeholder="Enter Room Title" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    ...
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtDescription" placeholder="Enter Room Description" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
             ...
             <div class="row mb-0">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Max Person :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtMaxPerson" placeholder="Enter Max Person" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
            ...
            <div class="row mb-0">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Normal Rate :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtNormalRate" placeholder="Enter Normal Rate" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Disc. Rate :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtDiscountedRate" placeholder="Enter Discounted Rate"></asp:TextBox> 
                    </div>
                  </div>
                </div>
             ...
             <div class="row mb-0">
                ...
                <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Order :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtOrder" placeholder="Enter Order" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Image :</label>
                    <div class="col-sm-8">
                 ...
                 <div class="col-md-2">
                  ...
                  <asp:LinkButton ID="btnUpload" runat="server" CssClass="btn btn-sm btn-primary" OnClick="btnUpload_Click" Visible="false" > <i class="fas fa-upload"></i> Upload</asp:LinkButton>
