<%@ Page Title="Report View" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ReportExport.aspx.cs" Inherits="PG.Web.Report.ReportExport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div id="dvPageContent" style="width:100%; height:100%;"> 
    <div id="dvReportViewer" style="height:100%; width:100%; background-color:White;">
    </div>
