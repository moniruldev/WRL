<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="DepartmentEntry.aspx.cs" Inherits="PG.Web.WREL.DepartmentEntry" %>
       ...
       <div class="card ">  <%-- "d-flex flex-column min-vh-100" this class for set footer on bottom--%>
         <div class="card-header p-0">
           <div class="d-flex align-items-center justify-content-between p-1">
             <h5 class="card-title">Department Entry</h5>
      ...
      <div class="card-body">
            ...
            <div class="row mb-0">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-5 col-form-label-sm">Department Name :</label>
                    <div class="col-sm-7">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtDepartmentName" placeholder="Department Name" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
             ...
             <div class="row mb-0">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-5 col-form-label-sm">Contact Person :</label>
                    <div class="col-sm-7">
           ...
           <div class="row mb-0">
             ...
             <div class="row mb-0">
                ...
                <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-5 col-form-label-sm">Status :</label>
                    <div class="col-sm-7">
