<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="BranchEntry.aspx.cs" Inherits="PG.Web.WREL.BranchEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var txtBranchHead = '<%=txtBranchHead.ClientID%>';
        ...
        function bindEmployeeList() {
            var cgColumns = [
                             { 'columnName': 'empid', 'width': '100', 'align': 'left', 'highlight': 4, 'label': 'Employee Id' }
                            , { 'columnName': 'empname', 'width': '200', 'align': 'left', 'highlight': 4, 'label': 'Name' }

            ];
            var serviceURL = EmployeeListServiceLink + "?isterm=1&includeempty=0&hasitem=1&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;

            serviceURL += "&ispaging=1";
            var groupIDElem = $('#' + txtBranchHead);

            $('#' + txtBranchHead).click(function (e) {
            ...
            $(groupIDElem).combogrid({
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.dealerid == '') {
                        ...
                        $('#' + hdnEmpId).val(ui.item.empid);
                        $('#' + txtBranchHead).val(ui.item.empname);
                    }
                    return false;
                },
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "WRL/BranchEntry.aspx?id=" + key;
       ...
       <div class="card ">  <%-- "d-flex flex-column min-vh-100" this class for set footer on bottom--%>
         <div class="card-header p-0">
           <div class="d-flex align-items-center justify-content-between p-1">
             <h5 class="card-title">Branch Entry</h5>
            ...
            <div class="row mb-0">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Branch Name :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtBranchName" placeholder="Branch Name" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
              ...
              <div class="row mb-0">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Branch Code :</label>
                    <div class="col-sm-8">
                     <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtBranchCode" placeholder="Branch Code" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
             ...
             <div class="row mb-0">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Branch Head :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtBranchHead" placeholder="Select" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
