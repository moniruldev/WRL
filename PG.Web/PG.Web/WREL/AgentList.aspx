<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="AgentList.aspx.cs" Inherits="PG.Web.WREL.AgentList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "WREL/AgentEntry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Agent Entry";
                tdata.label = "Agent Entry";
                tdata.type = 0;
                tdata.url = url;
          ...
          <div class="row mb-0">
            ...
            <div class="row">
             <div class="col-md-12">
                ...
                DataKeyNames="AGENT_ID" EnableModelValidation="True" ClientIDMode="AutoID" OnRowDataBound="GridView1_RowDataBound" AllowPaging="true" EmptyDataText="There is no record" PageSize="2" 
              ...
              <Columns>
                  ...
                  <ItemStyle Width="50px" />
                   ...
                   <asp:BoundField DataField="AGENT_COMPANY_NAME" HeaderText="Type Name" />
                  <asp:BoundField DataField="OWNER_NAME" HeaderText="Description" />
