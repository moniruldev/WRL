<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="CNAssignment.aspx.cs" Inherits="PG.Web.WREL.CNAssignment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
              ...
              <div class="row mb-0">
                ...
                <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-5 col-form-label-sm">Delivery Man :</label>
                    <div class="col-sm-7">
                  ...
                  <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-5 col-form-label-sm">Assign Date :</label>
                    <div class="col-sm-7">
                        <table>
                            <tr>
                                <td>
                                     <asp:TextBox ID="txtAssignDate" runat="server" CssClass="TextBoxnew textDate dateParse" Width="130px" ></asp:TextBox>
                  ...
                  <div class="form-group row mb-0">
                    ...
                    <div class="col-sm-7">
                        <table>
                            <tr>
                                <td>
                                     <asp:TextBox ID="txtAssignDate" runat="server" CssClass="TextBoxnew textDate dateParse" ></asp:TextBox>
    ...
    <div class="col-md-12">
        <div class="form-group row mb-0 align-items-center">
            <label for="txtCNNo" class="col-sm-1 col-form-label-sm">CN No :</label>
