<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="DeliveryManEntry.aspx.cs" Inherits="PG.Web.WREL.DeliveryManEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var txtAgent = '<%=txtAgent.ClientID%>';
        ...
        function bindTownList() {
            ...
            var groupIDElem = $('#' + txtAgent);

            $('#' + txtAgent).click(function (e) {
            ...
            $(groupIDElem).combogrid({
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.dealerid == '') {
                        ...
                        $('#' + txtAgent).val(ui.item.agentcompanyname);
                    }
                    return false;
                },
     ...
     <div class="container-fluid">
       <div class="card ">  <%-- "d-flex flex-column min-vh-100" this class for set footer on bottom--%>
         <div class="card-header p-0">
           <div class="d-flex align-items-center justify-content-between p-1">
             <h5 class="card-title">Delivery Man Entry</h5>
      ...
      <div class="card-body">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm required">Name :</label>
                    <div class="col-sm-9">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtName" placeholder="Enter Name" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
           ...
           <div class="row mb-0">
               ...
               <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Fathers Name:</label>
                    <div class="col-sm-9">
                    <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtFathersName" placeholder="Fathers Name" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
          ...
          <div class="row mb-0">
             ...
             <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Mothers Name :</label>
                    <div class="col-sm-9">
                       <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtMothersName" placeholder="Mothers Name" ></asp:TextBox> 
                    </div>
                  </div>
          ...
          <div class="row mb-0">
               ...
               <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm required">Mobile No:</label>
                    <div class="col-sm-9">
                     <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtMobileNo" placeholder="Mobile No" ></asp:TextBox>
                        <asp:RegularExpressionValidator 
                            ...
                            ErrorMessage="Enter a valid 11-digit Bangladeshi mobile number"
                            ValidationExpression="^01[3-9]\d{8}$"
                            ForeColor="Red"
                            Display="Dynamic">
                        </asp:RegularExpressionValidator>
                    </div>
             ...
             <div class="row mb-0">
                ...
                <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Agent :</label>
                    <div class="col-sm-9">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtAgent" placeholder="Select" ></asp:TextBox> 
