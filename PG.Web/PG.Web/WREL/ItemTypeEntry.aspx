<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ItemTypeEntry.aspx.cs" Inherits="PG.Web.WREL.ItemTypeEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        <%--   var txtCountry = '<%=txtCountry.ItemID%>';
        var hdnCountryId = '<%=hdnCountryId.ItemID%>';--%>
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "WREL/ItemTypeEntry.aspx?id=" + key;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
     <div class="container-fluid">
       <div class="card ">  <%-- "d-flex flex-column min-vh-100" this class for set footer on bottom--%>
         <div class="card-header p-0">
           <div class="d-flex align-items-center justify-content-between p-1">
             <h5 class="card-title">Item Type Entry</h5>
      ...
      <div class="card-body">
            <asp:HiddenField ID="hdnItemType_ID" runat="server" />
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Item Type Name :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtItemTypeName" placeholder="Item Type Name" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
