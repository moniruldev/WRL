<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="HubTypeList.aspx.cs" Inherits="PG.Web.WREL.HubTypeList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "WREL/HubTypeEntry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Hub Type Entry";
                tdata.label = "Hub Type Entry";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div class="container-fluid">
      ...
      <div class="card-header p-0">
       <div class="d-flex align-items-center justify-content-between p-1">
         <h5 class="card-title">Hub Type List</h5>
          ...
          <div class="row mb-0">
            ...
            <div class="row">
             <div class="col-md-12">
                ...
                DataKeyNames="HUB_TYPE_ID" EnableModelValidation="True" ClientIDMode="AutoID" OnRowDataBound="GridView1_RowDataBound" AllowPaging="true" EmptyDataText="There is no record" PageSize="2" 
              ...
              <Columns>
                  ...
                  <ItemStyle Width="50px" />
                   ...
                   <asp:BoundField DataField="HUB_TYPE_NAME" HeaderText="Type Name" />
