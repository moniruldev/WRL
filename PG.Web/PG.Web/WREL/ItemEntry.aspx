<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ItemEntry.aspx.cs" Inherits="PG.Web.WREL.ItemEntry" %>
       ...
       <div class="card ">  <%-- "d-flex flex-column min-vh-100" this class for set footer on bottom--%>
         <div class="card-header p-0">
           <div class="d-flex align-items-center justify-content-between p-1">
             <h5 class="card-title">Item Entry</h5>
            ...
            <div class="row mb-0">
             ...
             <div class="row mb-0">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Unit :</label>
                    <div class="col-sm-8">
                       <asp:DropDownList runat="server"  class="form-control form-control-sm"  ID="ddlUnitId" >
