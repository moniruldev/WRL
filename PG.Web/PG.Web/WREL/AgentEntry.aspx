<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="AgentEntry.aspx.cs" Inherits="PG.Web.WREL.AgentEntry" %>
     ...
     <div class="container-fluid">
       <div class="card ">  <%-- "d-flex flex-column min-vh-100" this class for set footer on bottom--%>
         <div class="card-header p-0">
           <div class="d-flex align-items-center justify-content-between p-1">
             <h5 class="card-title">Agent Entry</h5>
      ...
      <div class="card-body">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Company Name :</label>
                    <div class="col-sm-9">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtCompayName" placeholder="Company Name" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
           ...
           <div class="row mb-0">
               ...
               <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Owner Name:</label>
                    <div class="col-sm-9">
                     <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtOwner" placeholder="Owner Name" ></asp:TextBox>
                    </div>
                  </div>
                </div>
          ...
          <div class="row mb-0">
               ...
               <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Owner Mobile:</label>
                    <div class="col-sm-9">
                     <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtOwnercontact" placeholder="Owner Contact" ></asp:TextBox>
                    </div>
                  </div>
                </div>
          ...
          <div class="row mb-0">
               ...
               <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Contact Person:</label>
                    <div class="col-sm-9">
                     <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtContactPerson" placeholder="Contact Person" ></asp:TextBox>
                    </div>
                  </div>
                </div>
          ...
          <div class="row mb-0">
               ...
               <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Contact No:</label>
                    <div class="col-sm-9">
                     <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtContactNo" placeholder="Contact No" ></asp:TextBox>
                    </div>
                  </div>
                </div>
          ...
          <div class="row mb-0">
               ...
               <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Bank Name:</label>
                    <div class="col-sm-9">
                     <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtBankName" placeholder="Bank Name" ></asp:TextBox>
                    </div>
                  </div>
                </div>
          ...
          <div class="row mb-0">
               ...
               <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Bank Barnch:</label>
                    <div class="col-sm-9">
                     <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtBranch" placeholder="Branch Name" ></asp:TextBox>
                    </div>
                  </div>
                </div>
          ...
          <div class="row mb-0">
               ...
               <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Account No:</label>
                    <div class="col-sm-9">
                     <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtAccountNo" placeholder="Account No" ></asp:TextBox>
                    </div>
                  </div>
                </div>
