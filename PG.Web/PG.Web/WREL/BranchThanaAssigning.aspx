<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="BranchThanaAssigning.aspx.cs" Inherits="PG.Web.WREL.BranchThanaAssigning" %>
...
<%--    <link href="../css/toastr.css" rel="stylesheet" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        var BranchListServiceLink = '<%=this.BranchListServiceLink%>';
        ...
        function bindBranchList() {
            var cgColumns = [
                             { 'columnName': 'branchcode', 'width': '100', 'align': 'left', 'highlight': 4, 'label': 'Code' }
                            , { 'columnName': 'branchname', 'width': '150', 'align': 'left', 'highlight': 4, 'label': 'Name' }
                            , { 'columnName': 'branchheadname', 'width': '200', 'align': 'left', 'highlight': 4, 'label': 'Branch Head' }

            ];
            var serviceURL = BranchListServiceLink + "?isterm=1&includeempty=0&hasitem=1&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;

            serviceURL += "&ispaging=0";
            var groupIDElem = $('#' + txtBranchName);

            $('#' + txtBranchName).click(function (e) {
            ...
            $(groupIDElem).combogrid({
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.dealerid == '') {
                        ...
                        $('#' + hdnBranchId).val(ui.item.branchid);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
     <div class="container-fluid">
      ...
      <div class="card-body">
            <asp:HiddenField ID="hdnBRANCH_THANA_ID" runat="server" Value="0" />

              <div class="row mb-0">

               <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-4 col-form-label-sm">Branch :</label>
                    <div class="col-sm-8">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtBranchName" placeholder="Select" ></asp:TextBox> 
                           <asp:HiddenField runat="server" ID="hdnBranchId" Value="0" /> 
                    </div>
                  </div>
    ...
    DataKeyNames="BRANCH_THANA_ID" EnableModelValidation="True" ClientIDMode="AutoID"
     ...
     <asp:TemplateField HeaderText="SL" HeaderStyle-HorizontalAlign="Center">
        <ItemTemplate>
            <asp:Label ID="lblSerialNo" runat="server" Text=""></asp:Label>
              <asp:HiddenField runat="server" ID="hdnBRANCH_THANA_ID" Value='<%# Bind("BRANCH_THANA_ID") %>' />
        </ItemTemplate>
