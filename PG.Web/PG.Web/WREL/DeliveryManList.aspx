<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="DeliveryManList.aspx.cs" Inherits="PG.Web.WREL.DeliveryManList" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Delivery Man Entry";
                tdata.label = "Delivery Man Entry";
                tdata.type = 0;
                tdata.url = url;
          ...
          <div class="row mb-0">
            ...
            <div class="row">
             <div class="col-md-12">
                ...
                DataKeyNames="DELIVERY_MAN_ID" EnableModelValidation="True" ClientIDMode="AutoID" OnRowDataBound="GridView1_RowDataBound" AllowPaging="true" EmptyDataText="There is no record" PageSize="2" 
              ...
              <Columns>
                  ...
                  <ItemStyle Width="50px" />
                   ...
                   <asp:BoundField DataField="DELIVERY_MAN_NAME" HeaderText="Delivery Man Name" />
                  <asp:BoundField DataField="ADDRESS" HeaderText="Address" />
                  <asp:BoundField DataField="MOBILE_NO" HeaderText="Mobile No" />
                   <asp:BoundField DataField="AGENT_NAME" HeaderText="Agent Name" />
                 <asp:TemplateField HeaderText="Active Status">
                    <ItemTemplate>
                        <%# Eval("IS_ACTIVE").ToString() == "Y" ? "Active" : "Inactive" %>
                    </ItemTemplate>
                </asp:TemplateField>
