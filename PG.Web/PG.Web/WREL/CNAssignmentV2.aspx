<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="CNAssignmentV2.aspx.cs" Inherits="PG.Web.WREL.CNAssignmentV2" %>
      ...
      <div class="card-body">
            <asp:HiddenField ID="hdnCN_ASSIGN_ID" runat="server" Value="0" />
             ...
             <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-5 col-form-label-sm">Assignment Date :</label>
                    <div class="col-sm-7">
                        <table>
                            <tr>
                                <td>
