<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ChangeRequestListforApproval.aspx.cs" Inherits="PG.Web.WREL.ChangeRequestListforApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "WREL/ChangeRequestApproval.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Information Change Request";
                tdata.label = "Information Change Request";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div class="container-fluid">
      ...
      <div class="card-header p-0">
       <div class="d-flex align-items-center justify-content-between p-1">
         <h5 class="card-title">CN Information Change Request List</h5>
        ...
        <div class="d-flex align-items-center border-bottom pb-2 mb-2">
            ...
            <div class="d-flex align-items-center mr-3">
                <label for="txtToDate" class="mr-2 mb-0 small">CN Number:</label>
                <asp:TextBox ID="txtCnNumber" runat="server" CssClass="form-control form-control-sm" Style="width:130px;"></asp:TextBox>
            </div>
            <div class="d-flex align-items-center mr-3">
                <label for="txtToDate" class="mr-2 mb-0 small">Status:</label>
              <asp:DropDownList runat="server" ID="ddlStatus" CssClass="form-control form-control-sm" Style="width:130px;">
            ...
            <div class="row">
             <div class="col-md-12">
                ...
                DataKeyNames="REQUEST_ID" EnableModelValidation="True" ClientIDMode="AutoID" OnRowDataBound="GridView1_RowDataBound" AllowPaging="true" EmptyDataText="There is no record" PageSize="2" 
              ...
              <Columns>
                  ...
                  <asp:BoundField DataField="REQUEST_DATE" HeaderText="Request Date"  DataFormatString="{0:dd/MM/yyyy}" HtmlEncode="False" />
                     <asp:BoundField DataField="REQUEST_BY_NAME" HeaderText="Request By" />
                     <asp:BoundField DataField="CLIENT_NAME" HeaderText="Client Name" />
                  <asp:BoundField DataField="CURRENT_CONSIGNEE_NAME" HeaderText="Recipient Name" />
                  <asp:TemplateField HeaderText="Status">
                    <ItemTemplate>
                        <%# Eval("APPROVED_STATUS").ToString() == "Y" ? "Approved" : "Pending" %>
                    </ItemTemplate>
                </asp:TemplateField>
