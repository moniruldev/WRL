<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ItemTypeList.aspx.cs" Inherits="PG.Web.WREL.ItemTypeList" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Item Type Entry";
                tdata.label = "Item Type Entry";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div class="container-fluid">
      ...
      <div class="card-header p-0">
       <div class="d-flex align-items-center justify-content-between p-1">
         <h5 class="card-title">Item Type List</h5>
          ...
          <div class="row mb-0">
            ...
            <div class="row">
             <div class="col-md-12">
                ...
                DataKeyNames="ITEM_TYPE_ID" EnableModelValidation="True" ClientIDMode="AutoID" OnRowDataBound="GridView1_RowDataBound" AllowPaging="true" EmptyDataText="There is no record" PageSize="2" 
              ...
              <Columns>
                  ...
                  <asp:BoundField DataField="ITEM_TYPE_NAME" HeaderText="Item Type Name" />
