<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="RouteCreation.aspx.cs" Inherits="PG.Web.WREL.RouteCreation" %>
...
<%--    <link href="../css/toastr.css" rel="stylesheet" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        var hdnDestinationDistId = '<%=hdnDestinationDistId.ClientID%>';
            ...
            pageInstance.add_pageLoaded(function (sender, args) {
                ...
                for (i = 0; i < panels.length; i++) {
                    ...
                    if (panels[i].id == gridUpdatePanelIDDet) {
                        bindDistrictList(gridViewIDDet);
                        bindTownList(gridViewIDDet);
                    }
        ...
        function bindStartingDistrictList() {
            var cgColumns = [
                             { 'columnName': 'distname', 'width': '100', 'align': 'left', 'highlight': 4, 'label': 'District Name' }
        ...
        function bindDestinationDistList() {
            var cgColumns = [
                             { 'columnName': 'distname', 'width': '100', 'align': 'left', 'highlight': 4, 'label': 'District Name' }
            ...
            $(groupIDElem).combogrid({
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.dealerid == '') {
                        ...
                        $('#' + hdnDestinationDistId).val(ui.item.distid);
            ...
            $(groupIDElem).blur(function () {
                ...
                if (groupID == '') {
                    ...
                    $('#' + hdnDestinationDistId).val('0');
                }
            });
        }


        function bindDistrictList(gridViewID) {
            ...
            $(gridSelector).find('input[id$="txtDisttrict"]').each(function (index, elem) {

                var elemRow = $(elem).closest('tr.gridRow');

                var hdnItemIDElem = $(elemRow).find('input[id$="txtDisttrict"]');

                $(elem).closest('tr').find('input[id$="txtDisttrict"]').click(function (e) {
                    elmID = $(elem).attr('id');
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        var itemName = $(elemRowCur).find('input[id$="txtDisttrict"]').val();
        ...
        function ClearItemData(txtItemID) {
            ...
            $(detRow).find('input[id$="hdnDistId"]').val('0');
            $(detRow).find('input[id$="txtDisttrict"]').val('');
        }
      
        function SetItemData(txtItemCodeID, data) {
            $('#' + txtItemCodeID).val(data.cnnumber);
            var detRow = $('#' + txtItemCodeID).closest('tr.gridRow');
            $(detRow).find('input[id$="hdnDistId"]').val(data.distid);
            $(detRow).find('input[id$="txtDisttrict"]').val(data.distname);

        }


        function bindTownList(gridViewID) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <div class="card">
         <div class="card-header p-0">
           <div class="d-flex align-items-center justify-content-between p-1">
             <h5 class="card-title">Route Create</h5>
             <a class="btn btn-primary p-1"> <i class="fas fa-list"></i> Route List </a>
         </div>

       </div>
      <div class="card-body">
            <asp:HiddenField ID="hdnROUTE_ID" runat="server" Value="0" />
              ...
              <div class="row mb-0">
               ...
               <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-5 col-form-label-sm">Route Name :</label>
                    <div class="col-sm-7">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtRouteName" placeholder="Enter Route Name" ></asp:TextBox> 
                  ...
                  <div class="form-group row mb-0">
                    ...
                    <div class="col-sm-7">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtDestinationDist" placeholder="Select" ></asp:TextBox> 
                       <asp:HiddenField runat="server" ID="hdnDestinationDistId" Value="0" /> 
                    </div>
                  </div>
            ...
            <div class="row mb-0">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-5 col-form-label-sm">Is Active :</label>
                    <div class="col-sm-7">
                 ...
                 <div class="col-md-4">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-5 col-form-label-sm">Reamrks :</label>
                    <div class="col-sm-7">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtRemarks" placeholder="Enter Reamrks" ></asp:TextBox> 
    ...
    DataKeyNames="ROUTE_ID" EnableModelValidation="True" ClientIDMode="AutoID"
     ...
     <asp:TemplateField HeaderText="SL" HeaderStyle-HorizontalAlign="Center">
        <ItemTemplate>
            <asp:Label ID="lblSerialNo" runat="server" Text=""></asp:Label>
              <asp:HiddenField runat="server" ID="hdnRouteDtlId" Value='<%# Bind("ROUTE_DETAIL_ID") %>' />
        </ItemTemplate>
  ...
  <asp:TemplateField HeaderText="District">
    <ItemTemplate>
        <div class="d-flex align-items-center">
            <table>
                <tr>
                    <td class="p-0">
                        <asp:TextBox ID="txtDisttrict" runat="server"
                            CssClass="form-control form-control-sm"
                            Style="width: 200px;"
                            Text='<%# Bind("DIST_NAME") %>' ></asp:TextBox>

                        <asp:HiddenField ID="hdnDistId" runat="server" Value='<%# Bind("DIST_ID") %>' />
    ...
    <asp:TemplateField HeaderText="Upozilla">
    <ItemTemplate>
        <div class="d-flex align-items-center">
            <table>
                <tr>
