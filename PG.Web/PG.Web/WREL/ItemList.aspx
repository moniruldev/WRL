<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ItemList.aspx.cs" Inherits="PG.Web.WREL.ItemList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "WREL/ItemEntry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Item Entry";
                tdata.label = "Item Entry";
                tdata.type = 0;
                tdata.url = url;
          ...
          <div class="row mb-0">
            ...
            <div class="row">
             <div class="col-md-12">
                ...
                DataKeyNames="ITEM_ID" EnableModelValidation="True" ClientIDMode="AutoID" OnRowDataBound="GridView1_RowDataBound" AllowPaging="true" EmptyDataText="There is no record" PageSize="2" 
