<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="UserListWR.aspx.cs" Inherits="PG.Web.Admin.UserListWR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Admin/UserEntry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "User Entry";
                tdata.label = "User Entry";
                tdata.type = 0;
                tdata.url = url;
                    ...
                    <div class="row mb-0">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row mb-0">
                                <label for="name" class="col-sm-4 col-form-label-sm">Role :</label>
                                <div class="col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="true" CssClass="table table-sm table-striped table-bordered table-responsive-sm"
                                DataKeyNames="USERID" EnableModelValidation="True" ClientIDMode="AutoID" OnRowDataBound="GridView1_RowDataBound" AllowPaging="true" EmptyDataText="There is no record" PageSize="2"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="RoleName" HeaderText="Role" />
                                     <asp:TemplateField HeaderText="App">
                                        <ItemTemplate>
                                             <%# Eval("AppID").ToString() == "1" ? "Courier" : "Bank" %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
