<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="UserDepartmentPermission.aspx.cs" Inherits="PG.Web.Admin.UserDepartmentPermission" %>
 ...
 <div  id="dvPageContent" style="width:100%; height:100%;" >
   ...
   <div id="dvContentHeader" class="dvContentHeader">  
    ...
    <div id="dvHeader" class="dvHeader">
        <asp:Label ID="lblHeader" runat="server" Text="User Department Permission" 
       ...
       <div id="dvGridContainer" class="gridContainer"  
         ...
         <div id="dvGridHeader" style="width:100%;height:25px; font-size: smaller;" class="subHeader">
            ...
            <tr>
                ...
                <td width="152px" align="left">Department Name</td>
    ...
    <asp:GridView style="Z-INDEX: 100;" 
            id="GridView1" runat="server" DataKeyNames="DEPARTMENT_ID" 
