<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="RoleEntry.aspx.cs" Inherits="PG.Web.Admin.RoleEntry" %>
     ...
     <div class="container-fluid">
       <div class="card ">  
         <div class="card-header p-0">
           <div class="d-flex align-items-center justify-content-between p-1">
             <h5 class="card-title">Role Entry</h5>
      ...
      <div class="card-body">
                ...
                <div class="col-md-2">
                 ...
                 <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm required">Role Name :</label>
                    <div class="col-sm-9">
                      <asp:TextBox runat="server"  class="form-control form-control-sm"  ID="txtRoleName" placeholder="Enter Role Name" ></asp:TextBox> 
                    </div>
                  </div>
                </div>
          ...
          <div class="row mb-0">
               ...
               <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Is System:</label>
                    <div class="col-sm-9">
                     <asp:DropDownList ID="ddlIsSystem" runat="server" CssClass="form-control form-control-sm">
          ...
          <div class="row mb-0">
               ...
               <div class="col-md-6">
                  <div class="form-group row mb-0">
                    <label for="name" class="col-sm-3 col-form-label-sm">Is Admin:</label>
                    <div class="col-sm-9">
                     <asp:DropDownList ID="ddlIsAdmin" runat="server" CssClass="form-control form-control-sm">
                         <asp:ListItem Value="Y" Text="Yes" ></asp:ListItem>
                          <asp:ListItem Value="N" Text="No" Selected="True" ></asp:ListItem> 
                     </asp:DropDownList>
