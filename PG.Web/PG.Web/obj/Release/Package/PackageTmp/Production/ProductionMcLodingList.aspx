<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" ViewStateMode="Disabled" CodeBehind="ProductionMcLodingList.aspx.cs" Inherits="PG.Web.Production.ProductionMcLodingList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, type) {
            ...
            url = IForm.RootPath + "Production/ProductionMcLoadingEntry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Production : MC Battery Loading Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "Production : MC Battery Loading Entry ";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production MC Loading List"></asp:Label>
            </div>
            <!--Message Div -->
