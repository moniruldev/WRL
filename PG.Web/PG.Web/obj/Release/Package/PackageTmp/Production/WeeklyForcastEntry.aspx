<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"  CodeBehind="WeeklyForcastEntry.aspx.cs" Inherits="PG.Web.Production.WeeklyForcastEntry" %>
...
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
 <asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var txtTotalWK1_ITEM_QTY = '<%=this.txtTotalWK1_ITEM_QTY.ClientID%>';
        var txtTotalWK2_ITEM_QTY = '<%=this.txtTotalWK2_ITEM_QTY.ClientID%>';
        var txtTotalWK3_ITEM_QTY = '<%=this.txtTotalWK3_ITEM_QTY.ClientID%>';
        var txtTotalWK4_ITEM_QTY = '<%=this.txtTotalWK4_ITEM_QTY.ClientID%>';
        var txtTotalTOTAL_MONTH_QTY = '<%=this.txtTotalTOTAL_MONTH_QTY.ClientID%>';
        
     
        function sumGrandQtyTotol() {
            var wk1 = GetTotalSumAddedQty1();
                //$("#" + txtTotalWK1_ITEM_QTY).val();
            var wk2 = GetTotalSumAddedQty2();
                //$("#" + txtTotalWK2_ITEM_QTY).val();
            var wk3 = GetTotalSumAddedQty3(); //$("#" + txtTotalWK3_ITEM_QTY).val();
            var wk4 = GetTotalSumAddedQty4()  //$("#" + txtTotalWK4_ITEM_QTY).val();

           var wktotal = Number(wk1) + Number(wk2) + Number(wk3) + Number(wk4);

           $("#" + txtTotalTOTAL_MONTH_QTY).val(JSUtility.FormatCurrency(wktotal));
        }
        ...
        function sumGrandQty1() {
            var totAdded1 = GetTotalSumAddedQty1();
            $("#" + txtTotalWK1_ITEM_QTY).val(JSUtility.FormatCurrency(totAdded1));
        }
        function GetTotalSumAddedQty1() {
            ...
            //var totalAmount = 0;
            //var itemTotalWt = 0;
            $(document).find('.txt1').each(function (index, elem) {
        ...
        function sumGrandQty2() {
            var totAdded2 = GetTotalSumAddedQty2();
            $("#" + txtTotalWK2_ITEM_QTY).val(JSUtility.FormatCurrency(totAdded2));
        }
        function GetTotalSumAddedQty2() {
            debugger;
            var totAdd = 0;
            //var totalAmount = 0;
            //var itemTotalWt = 0;
            $(document).find('.txt2').each(function (index, elem) {
                var addQty = parseFloat(JSUtility.GetNumber($(elem).val()));
                if (!isNaN(addQty)) {
                    totAdd += addQty;
                }
        ...
        function sumGrandQty3() {
            var totAdded3 = GetTotalSumAddedQty3();
            $("#" + txtTotalWK3_ITEM_QTY).val(JSUtility.FormatCurrency(totAdded3));
        }
        function GetTotalSumAddedQty3() {
            debugger;
            var totAdd = 0;
            //var totalAmount = 0;
            //var itemTotalWt = 0;
            $(document).find('.txt3').each(function (index, elem) {
                var addQty = parseFloat(JSUtility.GetNumber($(elem).val()));
                if (!isNaN(addQty)) {
                    totAdd += addQty;
                }
        ...
        function sumGrandQty4() {
            var totAdded4 = GetTotalSumAddedQty4();
            $("#" + txtTotalWK4_ITEM_QTY).val(JSUtility.FormatCurrency(totAdded4));
        }
        function GetTotalSumAddedQty4() {
            debugger;
            var totAdd = 0;
            //var totalAmount = 0;
            //var itemTotalWt = 0;
            $(document).find('.txt4').each(function (index, elem) {
                var addQty = parseFloat(JSUtility.GetNumber($(elem).val()));
                if (!isNaN(addQty)) {
                    totAdd += addQty;
                }
        ...
        function TestOnTextChange(texbx) {
            ...
            var txtWK1_ITEM_QTY = $(detRow).find('input[id$="txtWK1_ITEM_QTY"]').val();
            var txtWK2_ITEM_QTY = $(detRow).find('input[id$="txtWK2_ITEM_QTY"]').val();
            var txtWK3_ITEM_QTY = $(detRow).find('input[id$="txtWK3_ITEM_QTY"]').val();
            var txtWK4_ITEM_QTY = $(detRow).find('input[id$="txtWK4_ITEM_QTY"]').val();
             
            var tpcqty = Number(txtWK1_ITEM_QTY) + Number(txtWK2_ITEM_QTY) + Number(txtWK3_ITEM_QTY) + Number(txtWK4_ITEM_QTY);
            $(detRow).find('input[id$="txtTOTAL_MONTH_QTY"]').val(tpcqty);
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="FG Weekly Forecast Entry"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td class="auto-style2" colspan="2">
                            <asp:TextBox ID="txtFC_NO" runat="server" Style="text-align: left;" CssClass="colourdisabletextBox" Width="150px" Enabled="False"></asp:TextBox>
                        </td>
                        <td align="right" class="auto-style2">
                            <asp:Label ID="Label6" runat="server" Text="Forecast Desc :"></asp:Label>
                        </td>
                        <td class="auto-style2" colspan="2">
                            <asp:TextBox ID="txtFC_DESC" runat="server" CssClass="textBox" Style="text-align: left;" Width="250px"></asp:TextBox>
                        </td>
             ...
             <div id="Div5" runat="server" class="" style="float: right;width: 100%; text-align: left; border-top : solid 1px #0b07f5;">
                ...
                <div id="dvGridHeader2" style="float:left; width: 1000px; height: 25px; font-size: smaller; padding-left:5px;" class="subHeader_Prod">
                                    <table style="height: 80%; color: #FFFFFF;  font-weight: bold; text-align: left;"
                                        ...
                                        <tr class="headerRow_Prod">
                                            ...
                                            <td width="61px" class="headerColCenter_prod">DEALER RATE
                                            </td>
                                            <td width="62px" class="headerColCenter_prod">1st Week 1--7
                                            </td>
                                             <td width="63px" class="headerColCenter_prod">2nd Week 8--14
                                            </td>
                                             <td width="65px" class="headerColCenter_prod">3rd Week 15--21
                                            </td>
                                             <td width="64px" class="headerColCenter_prod">4th Week 22-31
                                            </td>
                                             <td width="62px" class="headerColCenter_prod">Total Month
                                            </td>
               ...
               <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%; ">
                        <div id="groupDataDetails" style=" width: 90%; height: auto;">
                            ...
                            <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width : 100%">
                                  ...
                                  <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                            <asp:GridView ID="GRDDTLITEMLIST" runat="server" AutoGenerateColumns="False" ShowHeader="False" 
                                                ...
                                                EnableModelValidation="True" ClientIDMode="AutoID" OnRowCommand="GRDDTLITEMLIST_RowCommand" OnRowCreated="GRDDTLITEMLIST_RowCreated" OnRowDataBound="GRDDTLITEMLIST_RowDataBound" OnRowDeleting="GRDDTLITEMLIST_RowDeleting" Width="970px"  >
                                                                ...
                                                                <table border="0" cellpadding="1" cellspacing="1">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtDEALER_RATE" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect" Width="60px" BackColor="Khaki" align="right" Text='<%# Bind("DEALER_RATE") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtWK1_ITEM_QTY" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect txt1 txtQty" Width="60px" BackColor="Khaki" align="right" Text='<%# Bind("WK1_ITEM_QTY") %>' onchange="TestOnTextChange(this)"   onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtWK2_ITEM_QTY" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect txt2 txtQty" Width="60px" BackColor="Khaki" align="right" Text='<%# Bind("WK2_ITEM_QTY") %>' onchange="TestOnTextChange(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtWK3_ITEM_QTY" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect txt3 txtQty" Width="60px" BackColor="Khaki" align="right" Text='<%# Bind("WK3_ITEM_QTY") %>' onchange="TestOnTextChange(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtWK4_ITEM_QTY" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect txt4 txtQty" Width="60px" BackColor="Khaki" align="right" Text='<%# Bind("WK4_ITEM_QTY") %>' onchange="TestOnTextChange(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtTOTAL_MONTH_QTY" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect txttotal" Width="60px" BackColor="Khaki" align="right" Text='<%# Bind("TOTAL_MONTH_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                ...
                                <div id="divGridControls2" style="width: 1200px; height: 30px; border-top: solid 1px #C0C0C0; border-bottom : solid 1px #0b07f5; ">
                                    <table style="width: 66%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                        border="0">
                                        <tr>
                                            ...
                                            <td align="right" style="text-align: left">
                                              <asp:TextBox ID="txtTotalWK1_ITEM_QTY" runat="server" Width="60px" BackColor="Yellow" Text="0" CssClass="textBoxReadOnly"></asp:TextBox>
                                            </td>
                                             <td align="right">
                                                  <asp:TextBox ID="txtTotalWK2_ITEM_QTY" runat="server" Width="60px" Text="0" BackColor="Yellow" CssClass="textBoxReadOnly"></asp:TextBox>
                                             </td>
                                            <td align="right">
                                                <asp:TextBox ID="txtTotalWK3_ITEM_QTY" runat="server" Width="60px" Text="0" BackColor="Yellow" CssClass="textBoxReadOnly"></asp:TextBox></td>
                                            <td align="right">
                                                <asp:TextBox ID="txtTotalWK4_ITEM_QTY" runat="server" Width="60px" Text="0" BackColor="Yellow" CssClass="textBoxReadOnly"></asp:TextBox></td>
                                            <td align="right">
                                                <asp:TextBox ID="txtTotalTOTAL_MONTH_QTY" runat="server" Width="60px" Text="0" BackColor="Gold" CssClass="textBoxReadOnly"></asp:TextBox></td>
