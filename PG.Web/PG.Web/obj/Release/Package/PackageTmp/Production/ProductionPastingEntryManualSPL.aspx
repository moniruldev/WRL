<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionPastingEntryManualSPL.aspx.cs" Inherits="PG.Web.Production.ProductionPastingEntryManualSPL" %>
    ...
    <link href="../css/jquery.ui.combogrid.css" rel="stylesheet" type="text/css" />
     <script language="javascript" type="text/javascript">
         ...
         function bindClosingItemList(gridViewIDD) {
             ...
             serviceURL += "&ispaging=1&forProduction=Y&isFinished=N";
             ...
             $(gridSelector).find('input[id$="txtCLOSINGITEM_NAME"]').each(function (index, elem) {
                 ...
                 $(elem).combogrid({
                     ...
                     search: function (event, ui) {
                         ...
                         var deptid = e.options[e.selectedIndex].value;
                         <%-- //var vgroupid =--%>
                         var newServiceURL = serviceURL + "&deptid=" + DeptID;//+ "&stlmid=" + stlmid;//+ "&groupid=" + vgroupid+ "&deptid=" + deptid
                         newServiceURL = JSUtility.AddTimeToQueryString(newServiceURL);
                         $(this).combogrid("option", "url", newServiceURL);
                      ...
                      <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%" id="tblProductionMstEntry">
                          <tr>
                              ...
                              <td style="text-align: left">
                                  <asp:TextBox ID="txtPROD_NO" runat="server" CssClass="colourdisabletextBox"  Width="163px"></asp:TextBox>
                              </td>
                              <td style="text-align: right">
                        ...
                        <td>
                             <asp:TextBox ID="TextBox1" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="Pasting" Width="150px"></asp:TextBox>
                        </td>
                                                    ...
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="76" align="right" Text='<%# Bind("ITEM_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>
                                                                 ...
                                                                 <td>
                                                                    ...
                                                                    <asp:TextBox ID="txtITEM_STANDARD_WEIGHT_KG" runat="server" CssClass="txtstdweightQty textBox textAutoSelect" Width="65px" align="left" Text='<%# Bind("PASTE_PANEL_KG") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                 </td>
                                                                 <%--<td>
                                                                ...
                                                                <td>
                                                                 ...
                                                                 <td>
                                                                     <asp:TextBox ID="txtOPERATOR_NAME" runat="server" CssClass="textBox textAutoSelect" Width="116px" Text='<%#Bind("OPERATOR_NAME") %>'></asp:TextBox>
