<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionGridCastingEntry.aspx.cs" Inherits="PG.Web.Production.ProductionGridCastingEntry" %>
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtMACHINE_NAME" runat="server" CssClass="textBox textAutoSelect" Width="65px" Text='<%#Bind("MACHINE_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtITEM_PANEL_QTY" runat="server" CssClass="txtQty textBox textAutoSelect" Style="text-align: right;" Width="50px" BackColor="Khaki" Font-Bold="true" align="right" Text='<%# Bind("ITEM_PANEL_QTY") %>' onchange="TestOnTextChange(this)" onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtITEM_WEIGHT" runat="server" CssClass="txtWeightQty textBox textAutoSelect" Width="45px" align="left" Text='<%# Bind("ITEM_WEIGHT") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <td>
           ...
           <div id="groupBoxContainer1 boxShadow" style="height: auto; ">
                <div id="groupDataDetails1" style="width: 100%; height: auto;">
                    <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left; width: 100%">
                        <div id="dvGridHeaderClosing" style="float:left; width: 1100px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                        ...
                        <div id="dvGridClosing" style=" float:left; width: 1100px; height: 250px; overflow: auto;" class="dvGrid">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="grdClosingRowMaterial" runat="server" width="1100px" AutoGenerateColumns="False" ShowHeader="False"
