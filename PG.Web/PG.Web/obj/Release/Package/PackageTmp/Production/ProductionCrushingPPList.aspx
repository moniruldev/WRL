<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionCrushingPPList.aspx.cs" Inherits="PG.Web.Production.ProductionCrushingPPList" ViewStateMode="Disabled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            if (userid == "Y") {
                url = IForm.RootPath + "Production/ProductionCrushingPPEntryWithBOM.aspx?id=" + key;
            }
            if (userid == "N") {
                var url = IForm.RootPath + "Production/ProductionCrushingPPEntry_SPL.aspx?id=" + key;
            }
            //var url = IForm.RootPath + "Production/ProductionCrushingPPEntry_SPL.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Production Crushing PP Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "Production Crushing PP Entry";
                tdata.type = 0;
                tdata.url = url;
     ...
     <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production Crushing PP List"></asp:Label>
                </div>
                <!--Message Div -->
         ...
         <div id="dvContentMain" class="dvContentMain">
                            ...
                            <asp:TextBox ID="txtToDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px" ></asp:TextBox></td>
                                  ...
                                  <td>
                                      <asp:DropDownList ID="ddlAUTHO_STATUS" runat="server"  CssClass="dropDownList enableIsDirty">
                                                ...
                                                <asp:ListItem Value="U">Un-Authorized</asp:ListItem>
                                            </asp:DropDownList>
                                  </td>
                                  <td>
             ...
             <div id="dvControls" style="width: 100%;">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1000px">
                    <dx:aspxgridview ID="grdCastingList" runat="server" AutoGenerateColumns="False" Width="100%"  ClientInstanceName="grdPastingList" >
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Crushing NO" Name="lblPROD_NO" VisibleIndex="2"  Width="70px" FieldName="PROD_CMP_CRUS_NO">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Entry By" Name="lblEDIT_BY_ID" Width="80px" VisibleIndex="4" FieldName="CREATE_BY">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn Caption="Entry Date" FieldName="CREATE_DATE" Width="50px"   Name="lblENTRY_DATE" VisibleIndex="5">
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Shift Incharge" Name="lblSUPERVISOR_NAME" VisibleIndex="7" Width="100px" FieldName="FULL_NAME">
                                    </dx:GridViewDataTextColumn>
                                   
                                    <dx:GridViewDataTextColumn Caption="PROD_CRUSHING_ID" FieldName="PROD_CMP_CRUS_ID" Name="hdnPROD_ID" Visible="false" VisibleIndex="1">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn Caption="Crushing Date" FieldName="PROD_CMP_CRUS_DATE" Width="50px"   Name="lblPRODUCTION_DATE" VisibleIndex="3">
                                         <PropertiesDateEdit DisplayFormatString="dd-MMM-yyyy" ></PropertiesDateEdit>
                                    </dx:GridViewDataDateColumn>

                                    <dx:GridViewDataTextColumn Caption="With BOM" FieldName="WITH_BOM" Width="40px" Name="hdnWITH_BOM" Visible="true" VisibleIndex="9">
                                    </dx:GridViewDataTextColumn>
                                     
                                     <dx:GridViewDataTextColumn Caption="Status" FieldName="AUTHO_STATUS" Width="30px" Name="txtAUTH_STATUS" VisibleIndex="8">
                                      </dx:GridViewDataTextColumn>
                                </Columns>
