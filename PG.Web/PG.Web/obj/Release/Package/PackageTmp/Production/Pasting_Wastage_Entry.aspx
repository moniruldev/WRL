<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Pasting_Wastage_Entry.aspx.cs" Inherits="PG.Web.Production.Pasting_Wastage_Entry" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Pasting Wastage Entry"></asp:Label>
            </div>
            <!--Message Div -->
