<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionScrapList.aspx.cs" Inherits="PG.Web.Production.ProductionScrapList" ViewStateMode="Disabled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/ProductionScrapEntry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Production Scrap Entry";
                tdata.label = "Production Scrap Entry";
                tdata.type = 0;
                tdata.url = url;
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 800px">
                    <dx:ASPxGridView ID="grdStockTransferList" runat="server" AutoGenerateColumns="False" Width="98%" ClientInstanceName="grdPastingList">
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="SCRAP_ID" FieldName="SCRAP_ID" Name="hdnScrapId" Visible="false" VisibleIndex="1">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Scrap NO" Name="lblSCRAP_NO" VisibleIndex="2" Width="80px" FieldName="SCRAP_NO">
                            </dx:GridViewDataTextColumn>
                            ...
                            <dx:GridViewDataDateColumn Caption="Scrap Date" FieldName="SCRAP_DATE" Width="100px" Name="lblSCRAP_DATE" VisibleIndex="3">
