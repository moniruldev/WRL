<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionCrushingPPEntry_SPL.aspx.cs" Inherits="PG.Web.Production.ProductionCrushingPPEntry_SPL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
      ...
      <%--  var txtMachine = '<%= txtMachine.ClientID%>';
            ...
            pageInstance.add_pageLoaded(function (sender, args) {
                ...
                for (i = 0; i < panels.length; i++) {
                    if (panels[i].id == gridUpdatePanelIDDet) {
                        ...
                        bindCrushingItemList(gridViewIDDet);
        ...
        function bindCrushingItemList(gridViewID) {
            var cgColumns = [
                               { 'columnName': 'itemname', 'width': '200', 'align': 'left', 'highlight': 4, 'label': 'Name' }
                             , { 'columnName': 'uomname', 'width': '70', 'align': 'center', 'highlight': 4, 'label': 'Uom ' }
                             , { 'columnName': 'bomname', 'width': '150', 'align': 'center', 'highlight': 4, 'label': 'BOM Name' }
                ...
                $(elem).combogrid({
                    ...
                    select: function (event, ui) {
                        ...
                        if (ui.item.id == 0) {
                            ...
                            SetCrushingItemData(elemID, ui.item);
                        }
                        // setDetInstrument(hdnIsInstrumentElem, txtInstrumentElem, btnInstrumentElem);
                        return false;
                    }
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        if (prcNo == null) {
                            ...
                            SetCrushingItemData(elemID, grp);
                        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnStoragelocationID" runat="server" Value="14" />
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Crushing PP Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
 ...
 <div id="tabs" style="height: 100%; background : url(../image/bg_greendot.gif) !important;border:none;">
  <ul>
    <li><a href="#tabs-1">Finished Item Details</a></li>
    <li><a href="#tabs-2">Scrap Details </a></li>
                ...
                <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%" id="tblProductionMstEntry">
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtPROD_CMP_CRUSHING_NO" runat="server" CssClass="colourdisabletextBox" Enabled="false" Width="163px"></asp:TextBox>
                        </td>
                        ...
                        <td>
                            <asp:TextBox ID="txtPROD_CRUSHING_PP_DATE" runat="server" CssClass=" textBox textDate dateParse" Style="text-align: left;" Width="120px"  ></asp:TextBox>
                       ...
                       <%-- <td style="text-align: right">
                        ...
                        <td>
                             <asp:TextBox ID="TextBox1" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="Crushing PP" Width="150px" ReadOnly="true"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                       ...
                       <td style="text-align: right" class="auto-style1">
                        ...
                        <td style="text-align: left" colspan="" class="auto-style1">
                            <asp:TextBox ID="txtProdRemarks" runat="server" CssClass="textBox textAutoSelect" Width="200px"  TabIndex="5"  ></asp:TextBox>
     ...
     <div id="tabs-1">
            ...
            <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                 <div id="dvGridHeader2" style="float: left; width: 1070px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                    ...
                    <tr class="headerRow_Prod">
                        ...
                        <td width="135px" class="headerColCenter_prod">Reject Item
                        </td>
                        ...
                        <td width="135px" class="headerColCenter_prod">Crushing Item
                        </td>
                        <td width="15px" class="headerColCenter_prod"></td>
                        
                        
                        <td width="61px" class="headerColCenter_prod">Crush Item Qty
                        </td>
                        <td width="45px" class="headerColCenter_prod">Crush UOM
                        </td>
                        <td width="80px" class="headerColCenter_prod">Crush Type
                        </td>
                        <td width="116px" class="headerColCenter_prod">Operator
                        </td>
                       <td width="15px" class="headerColCenter_prod"></td>
                        <td width="160px" class="headerColCenter_prod">Remarks
                        </td>
                ...
                <div id="groupDataDetails" style="width: 90%; height: auto;">
                    ...
                    <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGrid" style="width: 1070px; height: 200px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="130px" Text='<%# Bind("REJECT_ITEM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnItemID" runat="server" Value='<%# Bind("REJECT_ITEM_ID") %>' />
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="57px" align="right" Style="text-align: right;" Text='<%# Bind("REJECT_ITEM_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <%--onchange="TestOnTextChange(this)"--%>
                                                                    <td>

                                                                        <asp:TextBox ID="txtUOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="40px" Text='<%# Bind("REJECT_UOM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnUomID" runat="server" Value='<%# Bind("REJECT_UOM_ID") %>' />
                                                                    </td>
                                                                   
                                                                     <td>
                                                                        <asp:TextBox ID="txtCrushingItemName" runat="server" CssClass="textBox textAutoSelect" Width="130px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnCrusingItemID" runat="server" Value='<%# Bind("ITEM_ID") %>' />
                                                                    </td>
                                                                    <td>
                                                                        <input id="btnCrushingItemName" type="button" value="" runat="server" class="buttonDropdown"
                                                                            tabindex="-1" />
                                                                    </td>
                                                                    

                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtCrushingItemQty" runat="server" CssClass="textBox textAutoSelect" Width="60px" align="right" Style="text-align: right;" Text='<%# Bind("ITEM_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <%--onchange="TestOnTextChange(this)"--%>
                                                                    <td>

                                                                        <asp:TextBox ID="txtCrushingUOMName" runat="server" CssClass="textBox textAutoSelect" Width="45px" Text='<%# Bind("UOM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnCrushingUOMID" runat="server" Value='<%# Bind("UOM_ID") %>' />
                                                                    </td>
                                                                   

                                                                     <td>
                                                                                        <asp:HiddenField ID="hdnCrushingType" runat="server" Value='<%# Bind("MIXED_CRUSHING_TYPE_ID") %>' />
                                                                                        <asp:DropDownList ID="ddlCrushingType" runat="server" CssClass="dropDownList" Width="78px"  >
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtOPERATOR_NAME" runat="server" CssClass="textBox textAutoSelect" Width="115px" Text='<%#Bind("OPERATOR_NAME") %>'></asp:TextBox>
                        ...
                        <div id="divGridControls2" style="width: 70%; height: 30px; border-top: solid 1px #C0C0C0; border-bottom: solid 1px #0b07f5;">
                            <table style="width: 70%; height: 90%; text-align: center;" cellspacing="1" cellpadding="1"
                                border="0">
                                <tr>
                            ...
                            <table style="width: 70%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 90px" align="left">
                                       <asp:Button ID="btnNewRowScrap" runat="server"  Text="" CssClass="buttonNewRow" OnClientClick="ShowProgress()" OnClick="btnNewRowScrap_Click" Enabled="true" />
                                    </td>
                                    <td style="width: 20px;">
