<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionAssemblySFGEntry.aspx.cs" Inherits="PG.Web.Production.ProductionAssemblySFGEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var GetLink_AssemblyMachineListInfo = '<%= this.GetLink_AssemblyMachineListInfo%>';
        ...
        var grdModalOperator = '<%=grdModalOperator.ClientID%>';
        ...
        var hdnStoragelocationID = '<%=hdnStoragelocationID.ClientID%>';
       ...
       <%-- var txtFinishedItemOP = '<%=txtFinishedItemOP.ClientID%>';
        var btnFinishedItemOP = '<%=btnFinishedItemOP.ClientID%>';

        var hdnFinishedItemOPID = '<%=hdnFinishedItemOPID.ClientID%>';--%>

        var txtMachineOP = '<%=txtMachineOP.ClientID%>';

        var btnMachineOP = '<%=btnMachineOP.ClientID%>';
        var hdnMachineOPID = '<%=hdnMachineOPID.ClientID%>';

        var txtOperator = '<%=txtOperator.ClientID%>';
        var btnOperator = '<%=btnOperator.ClientID%>';

        var hdnOperatorID = '<%=hdnOperatorID.ClientID%>';
      ...
      <%--  var txtMachine = '<%= txtMachine.ClientID%>';
        ...
        $(document).ready(function () {
            ...
            //bindMShiftOperatorMFGITEMList();
            bindMShiftOperatorList();
            bindAssemblyMachineList();
            bindItemGroupList(gridViewIDDet);
            bindItemList(gridViewIDDet);
        ...
        function bindMShiftOperatorList() {
            ...
            var groupIDElem = $('#' + txtOperator);
            $('#' + btnOperator).click(function (e) {
            ...
            $(groupIDElem).combogrid({
                ...
                search: function (event, ui) {
                    ...
                    var name = $('#' + txtOperator).val();
                    var newServiceURL = serviceURL + "&deptid=136&stlmid=17&name=" + name;
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.dealerid == '') {
                        ...
                        $('#' + hdnOperatorID).val(ui.item.empid);
                        $('#' + txtOperator).val(ui.item.fullname);
            ...
            $(groupIDElem).blur(function () {
                ...
                var eCode = $('#' + txtOperator).val();
                serviceURL += "&ispaging=0&isOperator=1&deptid=136&stlmid=17";
        ...
        function bindMShiftOperatorMLineList() {
            ...
            $(groupIDElem).combogrid({
                ...
                search: function (event, ui) {
                    ...
                    var newServiceURL = serviceURL + "&deptid=136&stlid=17&machinename=" + name;
            ...
            $(groupIDElem).blur(function () {
                ...
                serviceURL += "&ispaging=0&deptid=136&stlid=17";
        ...
        function bindMShiftOperatorMFGITEMList() {
            ...
            var groupIDElem = $('#' + txtFinishedItemOP);

            $('#' + btnFinishedItemOP).click(function (e) {
                $(groupIDElem).combogrid("dropdownClick");
            });
            ...
            $(groupIDElem).combogrid({
                ...
                search: function (event, ui) {
                    ...
                    var name = $('#' + txtFinishedItemOP).val();
                    var newServiceURL = serviceURL + "&deptid=136&stlmid=17&machinename=" + name;
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.machineid == '') {
                        ...
                        $('#' + hdnFinishedItemOPID).val(ui.item.itemid);
                        $('#' + txtFinishedItemOP).val(ui.item.itemname);
            ...
            $(groupIDElem).blur(function () {
                ...
                var eCode = $('#' + txtFinishedItemOP).val();
                serviceURL += "&ispaging=0&deptid=136&stlmid=17";

                var prcNo = "A";

                if (prcNo == null) {
                    $('#' + hdnFinishedItemOPID).val('0');
                    $('#' + txtFinishedItemOP).val('');
                }
                else {
                    $('#' + hdnFinishedItemOPID).val(ui.item.itemid);
                    $('#' + txtFinishedItemOP).val(ui.item.itemname);
        ...
        function bindAssemblyMachineList() {
            ...
            var serviceURL = GetLink_AssemblyMachineListInfo + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            serviceURL += "&ispaging=0";
            var groupIDElem = $('#' + txtMachineOP);

            $('#' + btnMachineOP).click(function (e) {
                $(groupIDElem).combogrid("dropdownClick");
            });
            ...
            $(groupIDElem).combogrid({
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.machineid == '') {
                        ...
                        $('#' + hdnMachineOPID).val(ui.item.machineid);
                        $('#' + txtMachineOP).val(ui.item.machinename);
            ...
            $(groupIDElem).blur(function () {
                ...
                var eCode = $('#' + txtMachineOP).val();
                serviceURL += "&ispaging=0&deptid=136&stlid=17";

                var prcNo = "A";

                if (prcNo == null) {
                    $('#' + hdnMachineOPID).val('0');
                    $('#' + txtMachineOP).val('');
                }
                else {
                    $('#' + hdnMachineOPID).val(ui.item.machineid);
        ...
        function bindUsedItemList(gridViewIDD) {
            ...
            serviceURL += "&ispaging=1&isFinished=N&for_production=Y";
            ...
            $(gridSelector).find('input[id$="txtUSED_ITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&isFinished=N&for_production=Y" + "&deptid=" + DeptID + "&stlmid=" + stlmid;
                        var prcNo = GetItemNo(eCode, serviceURL);
                        if (prcNo == null) {
                            ClearUsedItemData(elemID);
                        }
        ...
        function ClearUsedItemData(txtCLOSINGITEM_NAME) {
            ...
            $('#' + hdnCLOSING_ITEM_GROUP_ID).val('0');
        ...
        function SetUsedItemData(txtCLOSINGITEM_NAME, data) {
            ...
            // $('#' + hdnFinishItemNameForRm).val($(detRow).find('input[id$="txtITEM_NAME"]').val());
            $('#' + hdnCLOSING_ITEM_GROUP_ID).val(data.itemgroupid);
            //alert(data.itemgroupid)
        ...
        function bindClosingItemList(gridViewIDD) {
            ...
            serviceURL += "&ispaging=1&isFinished=N&forproduction=Y";
            var gridSelector = "#" + gridViewIDD;
            $(gridSelector).find('input[id$="txtCLOSINGITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&isFinished=N&forproduction=Y" + "&deptid=" + DeptID + "&stlmid=" + stlmid;
        ...
        function SetClosingItemData(txtCLOSINGITEM_NAME, data) {
            ...
            $(detRow).find('input[id$="hdnIsBatch"]').val(data.is_batch);
            $("[id*=btnChangeItem]").click();
        }
        ...
        function TestOnTextChange(texbx) {
            var detRow = $(texbx).closest('tr.gridRow');
            //var pcqty = $(detRow).find('input[id$="hdnPANEL_PC"]').val();
            var MachineID = $(detRow).find('input[id$="hndMACHINE_ID"]').val();
            var panelqty = $(detRow).find('input[id$="txtItem_qty"]').val();
            var tpcqty = panelqty;
            $(detRow).find('input[id$="txtItem_qty"]').val(tpcqty);
            var standardweight = $(detRow).find('input[id$="hdnITEM_STANDARD_WEIGHT_KG"]').val();
            ...
            $('#' + hndMACHINE_ID_CLOSING).val(MachineID);
        ...
        function ValidateBatchStock() {
            ...
            if (sumUsed.toFixed(4) > totalqty.toFixed(4)) {
                alert("Used Quantity Can not be greater than Total Quantity");
                return false;
        ...
        function CalculateTotalQty() {
            ...
            var grid = document.getElementById("<%= GRDDTLITEMLIST.ClientID%>");
            var txtTotQty = document.getElementById("<%= txtTotQty.ClientID%>");

            txtTotQty.value = '0';
            var sumUsed = 0;
            for (var i = 0; i < grid.rows.length; i++) {
                sumUsed += parseFloat($("input[id*=txtItem_qty]")[i].value);
                txtTotQty.value = sumUsed;
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        var e = document.getElementById("<%=ddlDEPT_ID.ClientID%>");
                         ...
                         var stlid = $('#' + hdnStoragelocationID).val();
                         var newServiceURL = serviceURL + "&deptid=" + dept_id + "&machinename=" + machinename + "&stlid=" + stlid ;
                         newServiceURL = JSUtility.AddTimeToQueryString(newServiceURL);
                         $(this).combogrid("option", "url", newServiceURL);
                 ...
                 $(elem).blur(function () {
                     ...
                     if (eCode == '') {
                         ...
                         var dept_id = e.options[e.selectedIndex].value;
                         var serviceURL = MachineListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                         serviceURL += "&ispaging=0&stlid=17&deptid=" + dept_id;
       ...
       <%-- function bindMachineMstList() {
        ...
        function bindOperatorList(gridViewID) {
             ...
             var cgColumns = [{ 'columnName': 'empid', 'width': '100', 'align': 'left', 'highlight': 4, 'label': 'Emp ID' }
                              , { 'columnName': 'fullname', 'width': '200', 'align': 'left', 'highlight': 4, 'label': 'Emp Name' }
                              , { 'columnName': 'designationName', 'width': '100', 'align': 'left', 'highlight': 4, 'label': ' Designation' }
             ...
             var gridSelector = "#" + gridViewID;
             //var gridSelector = document.getElementById("<%= grdModalOperator.ClientID%>");
             //alert(gridSelector);
             $(gridSelector).find('input[id$="txtOPERATOR_NAME"]').each(function (index, elem) {
                 ...
                 $(elem).combogrid({
                     ...
                     search: function (event, ui) {
                         ...
                         //" + dept_id + "
                         var newServiceURL = serviceURL + "&name=" + name + "&deptid=" + dept_id + "&stlmid=" + stlmid;
                         newServiceURL = JSUtility.AddTimeToQueryString(newServiceURL);
                         $(this).combogrid("option", "url", newServiceURL);
                 ...
                 $(elem).blur(function () {
                     ...
                     if (eCode == '') {
                         ...
                         var stlmid = $('#' + hdnStoragelocationID).val();
                         var serviceURL = SupporvisorListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                         serviceURL += "&ispaging=0&isOperator=1" + "&deptid=" + dept_id + "&stlmid=" + stlmid;
        ...
        //End
         ...
         function clearTextBox() {
             document.getElementByID('<%=txtOperator.ClientID%>').value = "";
         }
        </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnStoragelocationID" runat="server" Value="17" />
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Assembly (SFG) Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
 ...
 <div id="dvContentMain" class="dvContentMain" style="height: 100%; width: 98%;" align="left">
            
 <div id="tabs" style="height: 95%; background : url(../image/bg_greendot.gif) !important;font-size:12px;">
  <ul>
    <li><a href="#tabs-1">Finished Item Details</a></li>
    <li><a href="#tabs-2">Used RM </a></li>
 ...
 <div id="dvControlsHead" style="height: auto; width: 100%;" align="left">
                <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%;font-size:12px; margin:5px;" id="tblProductionMstEntry">
                    <tr>
                        <td style="text-align: right">
                            <asp:Label ID="lblPROD_CODE" runat="server" Text="Prod. NO : " Width="120px"></asp:Label>
                        </td>
                        <td style="text-align: left">
                            <asp:TextBox ID="txtPROD_NO" runat="server" CssClass="colourdisabletextBox" Enabled="false" Width="200px"></asp:TextBox>
                        </td>
                         <%--<td style="text-align: right">
                        ...
                        <td style="text-align: left">
                         ...
                         <td style="text-align: right">
                            ...
                            <asp:Label ID="lblPRODUCTION_DATE" runat="server" Text="Production Date :" Width="150px"></asp:Label>
                        </td>
                        <td>
                        ...
                        <td style="text-align: right">
                            ...
                            <asp:Label ID="lblProcessCode" runat="server" Text="Batch NO :" Width="150px"></asp:Label>
                        </td>
                        <td style="text-align: left">
                            <asp:TextBox ID="txtREF_NO_MANUAL" runat="server" style="display:none" CssClass="textBox" Width="163px" TabIndex="1"></asp:TextBox>
                            <asp:TextBox ID="txtPROD_BATCH_NO" runat="server" CssClass="textBox textAutoSelect textNumberOnly" Width="150px"   Style="text-transform:uppercase;" OnTextChanged="txtPROD_BATCH_NO_TextChanged" AutoPostBack="true" TabIndex="2" MaxLength="5"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                       ...
                       <td style="text-align: right" class="auto-style1">
                        ...
                        <td style="text-align: left" colspan="" class="auto-style1">
                            <asp:TextBox ID="txtProdRemarks" runat="server" CssClass="textBox textAutoSelect" Width="250px"  TabIndex="5"  ></asp:TextBox>
                            
                        </td>
                          <td align="right">
                             <asp:Label ID="Label1" runat="server" Text="Storage Loc:"></asp:Label>
                        </td>
                        <td>
                             <asp:TextBox ID="txtStorageLocation" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="Assembly SFG" Width="200px" ReadOnly="true"></asp:TextBox>
                        </td>
 ...
 <div id="tabs-1">
            ...
            <div id="groupBoxContainer boxShadow" style="height:auto; width: 100%;">
                 <div id="dvGridHeader2" style="float: left; width: 1200px; height: 35px; font-size: smaller;" class="subHeader_Prod">
                <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                    ...
                    <tr class="headerRow_Prod">
                        <td width="30px" class="headerColCenter_prod">SL#
                         ...
                         <td width="93px" class="headerColCenter_prod">Machine Name
                        </td>
                        <td width="220px" class="headerColCenter_prod">Battery Type
                        </td>
                        ...
                        <%--<td width="60px" class="headerColCenter_prod">Operator
                        </td>--%>
                      ...
                      <td width="70px" class="headerColCenter">  Bar Type
                        ...
                        <td width="100px" class="headerColCenter_prod">Remarks
                         ...
                         <td width="100px" class="headerColCenter_prod">BatchNo
                        </td>
                ...
                <div id="groupDataDetails" style="width: 100%; height: auto;">
                    ...
                    <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGrid" style="width: 1200px; height: 200px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtMACHINE_NAME" runat="server" CssClass="textBox textAutoSelect" Width="75px" style="text-align:left; font-size : 11px;" Text='<%#Bind("MACHINE_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="220px" Text='<%# Bind("ITEM_NAME") %>' Style="font-size:11px; font-weight:bold;color:black;"></asp:TextBox>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="txtPcQty textBox textAutoSelect" Width="62px" align="right" Style="text-align: right;" Text='<%# Bind("ITEM_QTY") %>' onblur="TestOnTextChange(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <%--onchange="TestOnTextChange(this)"--%>
                                                                    <td>

                                                                        <asp:TextBox ID="txtUOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="46px" Text='<%# Bind("UOM_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtWEIGHT_UOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="45px" Text='<%# Bind("WEIGHT_UOM_NAME") %>' Style=""></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                          <asp:LinkButton ID="lnkOperator"  CommandName="AddOperator"  CssClass="buttoncommon"  CommandArgument='<%# Bind("CLOSING_ITEM_ID") %>' runat="server" CausesValidation="false" Width="60px" Height="17" style="display:none;" >Operator</asp:LinkButton>  
                                                                ...
                                                                <%--    <td>
                                                                 ...
                                                                 <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtBatchNoDtl" runat="server" CssClass="textBox textAutoSelect" Width="100px" Text='<%# Bind("PROD_BATCH_NO_DTL") %>' Style=""></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
          ...
          <div id="myModalOperator" class="modal fade" >  
            <div class="modal-dialog" style="max-width:600px; align-content:space-around;"> <%-- --%>
                <div class="modal-content" style="max-width:600px;">  
                    <div class="modal-header" style="max-width:600px;">  
                        ...
                        <h4 class="modal-title">Operator Details</h4>  
                    </div> 
                    <div class="col-md-12">
                   <%--     <asp:Label ID="Label2" runat="server" Text="Item Name : " Visible="true" ></asp:Label>
                        <asp:Label ID="Label3" runat="server" Visible="true"  Font-Bold="true" ></asp:Label>--%>
                    </div> 
                    <div class="modal-body" style="overflow-y:scroll; overflow-x:scroll; max-height:300px; max-width:600px; margin-top: 10px; margin-bottom: 10px;"> <%-- --%>
                        <asp:Label ID="Label4" runat="server" ClientIDMode="Static" Visible="false"></asp:Label>  
                    
                        <asp:HiddenField ID="hdnRefMachineId" runat="server" />
                         <asp:HiddenField ID="hdnMachineId" runat="server" />
                        <asp:HiddenField ID="hdnItemID_OP" runat="server" />
                  <%--  <table>

                        <tr>
                            <td style="text-align: right">
                            <asp:Label ID="lblMShiftOperator" runat="server" Text="Operator : "></asp:Label>
                        </td>
                        <td style="text-align: left; width:200px;" >
                            <asp:TextBox ID="txtMOPERATOR_NAME" runat="server" CssClass="textBox textAutoSelect" Width="150px"></asp:TextBox>
                            <input id="btnMOPERATOR" type="button" value="" runat="server" class="buttonDropdown" style="width: 15px"/>
                            
                             <asp:HiddenField ID="hdnMOPERATOR_ID" runat="server" />
                        </td>
                        </tr>
                    </table>--%>
          
             <asp:GridView ID="grdModalOperator" runat="server" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="Black"
            RowStyle-BackColor="White" AlternatingRowStyle-BackColor="" AlternatingRowStyle-ForeColor="#000"
            BorderStyle="None" BorderWidth="5px" CellPadding="10"  GridLines="Vertical" CssClass="gridView" OnRowDataBound="grdModalOperator_RowDataBound"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Machine">
                    <ItemTemplate>
                        ...
                        <asp:Label ID="txtMachineName" runat="server" CssClass="" Text='<%# Bind("MACHINE_NAME") %>' Width="150px" ReadOnly="true"></asp:Label>
                        <asp:HiddenField ID="hdnMachineId" runat="server" Value='<%# Bind("MACHINE_ID") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                  ...
                  <div>
                      <table>
                        <tbody>
                          <tr>
                    <td>
                        <asp:DropDownList runat="server" ID="ddlOperator" CssClass="" Width="250px"></asp:DropDownList>
                       <%-- <asp:TextBox ID="txtOPERATOR_NAME" runat="server" CssClass="textBox textAutoSelect" Width="100px" Text='<%#Bind("OPERATOR_NAME") %>'></asp:TextBox>--%>
                        <asp:HiddenField ID="hdnOPERATOR_ID" runat="server" Value='<%# Bind("EMP_ID") %>' />
                  ...
                  <input id="btnOPERATOR" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
                    ...
                    <div class="modal-footer"> 
                        <table>
                            <tr>
                        <td>
                         <asp:Button ID="btnOperatorAdd" runat="server" Text="Add" CssClass="buttonSave" OnClientClick=""   OnClick="btnOperatorAdd_Click" Visible="true" />
                         <button type="button"  Class="buttonClose"  data-dismiss="modal">Close</button> 
                            <asp:Button runat="server" ID="Button2" OnClick="btnCalculateBatchStock_Click" Style="display:none;" /> 
                             </td>
                                </tr>
                          </table> 
                    </div>  
   ...
   <%-- <script src="../javascript/jquery.ui.combogrid.js" type="text/javascript"></script>
    ...
    <link href="../css/jquery.ui.combogrid.css" rel="stylesheet" type="text/css" />
              ...
              <script language="javascript" type="text/javascript">
                  ...
                  var txtMOPERATOR_NAME = '<%=txtMOPERATOR_NAME.ClientID%>';

                  var btnMOPERATOR = '<%=btnMOPERATOR.ClientID%>';
                  var hdnMOPERATOR_ID = '<%=hdnMOPERATOR_ID.ClientID%>';
                        ...
                        <div id="divGridControls2" style="width: 100%; height: 30px; border-top: solid 1px #C0C0C0; border-bottom: solid 1px #0b07f5;">
                            <table style="width: 70%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <asp:Label ID="lblTotQty" runat="server" Text="Total Qnty:" Font-Bold="True"></asp:Label>
                                      </td>
                                      <td align="left">
                                       <asp:TextBox ID="txtTotQty" runat="server" CssClass="textBox" Style="text-align: right;" Width="100" TabIndex="-1" Font-Bold="True" Enabled="false"></asp:TextBox>
                                     </td>
                                    <td align="right">&nbsp;</td>
                        ...
                        <div id="dvGridHeaderClosing" style="float:left; width: 1200px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style=" height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="190px" class="headerColCenter_prod">Finished Item
                                    </td>
                                    <td width="15px" class="headerColCenter_prod"></td>
                                    <td width="220px" class="headerColCenter_prod"> RM Item
                                    </td>
                                    <td width="15px" class="headerColCenter_prod"></td>

                                    <td width="65px" class="headerColCenter_prod">UOM
                                    </td>
                                    <td width="50px" class="headerColCenter_prod">Batch
                                    </td>
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtFINISH_ITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="190px" Text='<%# Bind("FINISH_ITEM_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="220px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnCLOSING_ITEM_ID" runat="server" Value='<%# Bind("CLOSING_ITEM_ID") %>' />
                                                                         <asp:HiddenField ID="hdnCLOSING_ITEM_GROUP_ID" runat="server" Value='<%# Bind("CLOSING_ITEM_GROUP_ID") %>' />
                                                                         <asp:HiddenField ID="hdnCosLeadId" runat="server" Value='<%# Bind("COS_LEAD_ID") %>' />
                                                                         <asp:HiddenField ID="hdnCosLeadQty" runat="server" Value='<%# Bind("COS_LEAD_QTY") %>' />
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtCLOSING_UOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="66px" Text='<%# Bind("CLOSING_UOM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnCLOSING_UOM_ID" runat="server" Value='<%# Bind("CLOSING_UOM_ID") %>' />
                                                                    </td>
                                                                     <td> 
                                                                    <%--<i class="glyphicon glyphicon-expand" style="padding-right:4px;color:blue;font-size:12px"></i>--%>
                                                                    <asp:LinkButton ID="lnkBatchDtl"  CommandName="itemdtl"  CssClass="buttoncommon"  CommandArgument='<%# Bind("CLOSING_ITEM_ID") %>' runat="server" CausesValidation="false" Width="52px" Height="17" >Batch</asp:LinkButton>  
                                                                    <asp:HiddenField ID="hdnIsBatch" runat="server" Value='<%# Bind("IS_BATCH") %>' />
                                                                  </td>
                 
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" CssClass="textBox textAutoSelect"  Width="80px" style="text-align:right;" Text='<%# Eval("SYSTEM_OPENING_STOCK", "{0:#,##0.00}") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtCLOSING_QTY" runat="server" CssClass="textBox textAutoSelect" Width="74" style="text-align:right;" Text='<%# Eval("CLOSING_QTY", "{0:#,##0.00}") %>' onchange="calcIssueStock(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                   ...
                                                                   <%-- <td align="right">
                                                                    ...
                                                                    <%--  <td>
                                                                        ...
                                                                        <td align="right">
                                                                        <asp:TextBox ID="txtSTD_USED_QTY" runat="server" CssClass="textBox textAutoSelect" Width="76"  align="right" style="text-align:right;" Text='<%# Eval( "STD_USED_QTY", "{0:#,##0.00}") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtPOSITIVE_DEV" runat="server" CssClass="txtgQty textBox textAutoSelect"   Width="64px" style="text-align:right;" BackColor="Yellow"  Text='<%# Eval( "POSITIVE_DEV", "{0:#,##0.00}") %>'  onBlur=" calcCloseingDevStock(this)" onchange="TestOnTextChangegqty(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                    </td>
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtNEGATIVE_DEV" runat="server" CssClass="txtgQty textBox textAutoSelect"   Width="62" style="text-align:right;" BackColor="Yellow"  Text='<%# Eval("NEGATIVE_DEV", "{0:#,##0.00}") %>' onBlur=" calcCloseingDevStock(this)" onchange="TestOnTextChangegqty(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox> 
                                                                    </td>
                                                                    <td align="right">
                    ...
                    <div class="modal-body" style="overflow-y:scroll; overflow-x:scroll; max-height:300px; max-width:600px; margin-top: 10px; margin-bottom: 10px;"> <%-- --%>
                        ...
                        <asp:HiddenField ID="hdnBatchItemId" runat="server" />
                         ...
                         <asp:HiddenField ID="hdnEditMode" runat="server" />
                          <asp:HiddenField ID="hdnBatchFinishedItemId" runat="server" />
                ...
                <asp:TemplateField HeaderText="Used Qty">
                    ...
                    <div class="modal-footer"> 
                        ...
                        <td>
                         ...
                         <button type="button"  Class="buttonClose"  data-dismiss="modal">Close</button> 
                            <asp:Button runat="server" ID="btnCalculateBatchStock" OnClick="btnCalculateBatchStock_Click" Style="display:none;" /> 
                             </td>
                                </tr>
                          </table> 
                    </div>  
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="btnNewRowClosing" EventName="Click" />
                                     <asp:AsyncPostBackTrigger ControlID="btnRefreshClosingGrid" EventName="Click" />
                                       <asp:AsyncPostBackTrigger ControlID="btnChangeItem" EventName="Click" />
                                     <%--<asp:AsyncPostBackTrigger ControlID="btnCalculateBatchStock" EventName="Click" />--%>
                                </Triggers>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 90px" align="left">
                                        <asp:Button ID="btnNewRowClosing" runat="server" CssClass="buttonNewRow" Text="" OnClientClick="ShowClosingProgress()" OnClick="btnNewRowClosing_Click" />
                                          <asp:Button ID="btnChangeItem" runat="server" OnClick="btnChangeItem_Click" Style="display:none" />
                                    </td>
                                    <td style="width: 20px;">
 ...
 <div id="tabs-3">
          ...
          <div id="Div2" runat="server" class="" style="float:left; width: 100%; text-align: left;  border-top: solid 1px #0b07f5;">
                        <span style="font-weight: bold; font-size: 15; color: #ff3b00;">Operator Details: </span>
                    </div>
         <div id="groupBoxContainer3 boxShadow" style="height: auto; ">
             <div id="groupDataDetails3" style="width: 100%; height: auto;">
                 <div id="Div4" runat="server" class="" style="width: auto; height: auto; text-align: left; width: 100%">
             <table>
                 <tr>
                     <td>
                         <asp:Label ID="lblLineOP" runat="server" Text="Line" Font-Bold="true" ></asp:Label>
                     </td>
                     <td>
                     ...
                     <%-- <td>
                         <asp:Label ID="lblFinishedItemOP" runat="server" Text="Finished Type" Font-Bold="true" ></asp:Label>
                     </td>
                     <td>
                         <asp:TextBox ID="txtFinishedItemOP" runat="server" CssClass="textBox"></asp:TextBox>
                         
                     </td>
                     <td>
                          <input id="btnFinishedItemOP" type="button" value="" runat="server" class="buttonDropdown" style="width: 15px" tabindex="-1" />
                         <asp:HiddenField ID="hdnFinishedItemOPID" runat="server" />
                     </td>--%>

                     <td>
                         <asp:Label ID="lblMachinOP" runat="server" Text="Machine" Font-Bold="true" ></asp:Label>
                     </td>
                     <td>
                         <asp:TextBox ID="txtMachineOP" runat="server" CssClass="textBox"></asp:TextBox>
                         
                     </td>
                     <td>
                          <input id="btnMachineOP" type="button" value="" runat="server" class="buttonDropdown" style="width: 15px" tabindex="-1" />
                         <asp:HiddenField ID="hdnMachineOPID" runat="server" />
                     </td>
                      <td>
                         <asp:Label ID="lblOperator" runat="server" Text="Operator" Font-Bold="true" ></asp:Label>
                     </td>
                     <td>
                     ...
                     <td>
                          <input id="btnOperator" type="button" value="" runat="server" class="buttonDropdown" style="width: 15px" tabindex="-1" /> &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                         <asp:HiddenField ID="hdnOperatorID" runat="server" />
                     </td>
                    <%-- OnClientClick="return Clear();"--%>
                     <td>
                          <asp:Button ID="btnaddOperator" runat="server" CssClass="buttoncommon" Text="Add"  OnClick="btnaddOperator_Click"   />
         ...
         <script type="text/javascript">
             function Clear() {
                 document.getElementById("<%=txtOperator.ClientID %>").value = "";
                 document.getElementById("<%=hdnOperatorID.ClientID %>").value = "";
           return true;
       }
   </script>

         <div id="groupBoxContainer4 boxShadow" style="height: auto; width: 90%;">
                            <div id="groupDataDetails4" style="float: left;width: 90%; height: auto;">
                                <div id="Div8" runat="server" class="" style="float:left; width: 90%; text-align: left;  border-top: solid 1px #0b07f5;">
                                    <span style="font-weight: bold; font-size: 15; color: #ff3b00;">Details: </span>
                                </div>

                                <div id="Div9" runat="server" class="" style=" float:left; width: auto; height: auto; text-align: left; width: 100%">
                                    <div id="dvGridHeaderClosingSummary1" style="width: 900px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                        <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                            class="defFont" cellspacing="1" cellpadding="1">
                                            <tr class="headerRow_Prod">
                                                <td width="40px" class="headerColCenter_prod">SL#
                                                ...
                                                <td width="150px" class="headerColCenter_prod">Line
                                                </td>
                                    

                                               <%-- <td width="300px" class="headerColCenter_prod">Item
                                                </td>--%>
                                               
                                                <td width="250px" class="headerColCenter_prod">Machine
                                                </td>
                                               <td width="300px" class="headerColCenter_prod">Operator
                                                </td>
                                                 <td width="16px" class="headerColCenter_prod">Delete
                                    </td>
                                    ...
                                    <div id="dvGridClosingSummary1" style="width: auto; height: 150px; overflow: auto;" class="dvGrid">
                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:GridView ID="GridViewOperator" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                    CellPadding="1" CellSpacing="1" ForeColor="#333333" GridLines="Both" DataKeyNames="PROD_OP_ID"
                                                    EnableModelValidation="True" ClientIDMode="AutoID" OnRowCommand="GridViewOperator_RowCommand" OnRowDataBound="GridViewOperator_RowDataBound" OnRowDeleting="GridViewOperator_RowDeleting"   >
                                                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="SL#">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:Label ID="lblOperator_SI" runat="server" Text= <%# Container.DataItemIndex + 1 %>    Style="text-align: center;" Width="40px">
                                                                </asp:Label>
                                                                    ...
                                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtMachineLine" runat="server" CssClass="textBox textAutoSelect" Width="150px" Text='<%# Bind("REF_MACHINE_NAME") %>'></asp:TextBox>
                                                                                    <asp:HiddenField ID="hdnMachineLine_ID" runat="server" Value='<%# Bind("REF_MACHINE_ID") %>' />
                                                                                     <asp:HiddenField ID="hdnPROD_OP_ID" runat="server" Value='<%# Bind("PROD_OP_ID") %>' />
                                                                               ...
                                                                               <%-- <td>
                                                                                    ...
                                                                                    <asp:TextBox ID="txtFinishedItemType" runat="server" CssClass="textBox textAutoSelect" Width="300px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                    <asp:HiddenField ID="hdnFinishedItem_ID" runat="server" Value='<%# Bind("ITEM_ID") %>' />
                                                                                </td>--%>
                                                                               
                                                                                <td>
                                                                                    <asp:TextBox ID="txtOperatorMachine" runat="server" CssClass="textBox textAutoSelect" Width="250px"  align="right" style="text-align:right;" Text ='<%# Bind("MACHINE_NAME") %>'></asp:TextBox>
                                                                                    <asp:HiddenField ID="hdnOperatorMachineID" runat="server" Value='<%# Bind("MACHINE_ID") %>' />
                                                                                </td>
                                                                                <td>
                                                                                    <asp:TextBox ID="txtOperatorName" runat="server" CssClass="textBox textAutoSelect" Width="300px"  align="right" style="text-align:right;" Text ='<%# Bind("OPERATOR_NAME") %>'></asp:TextBox>
                                                                                    <asp:HiddenField ID="hdnOperatorEMPID" runat="server" Value='<%# Bind("EMP_ID") %>' />
                                                                                </td>
                                                        ...
                                                        <asp:TemplateField HeaderText="Delete" ShowHeader="false" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnDeleteRow" CssClass="buttonDeleteIcon" Height="16px" Width="18px"
                                                                    CommandName="delete" runat="server">
                                                                </asp:LinkButton>
                         ...
                         <div id="divGridControlsClosing1">
                            <table style="width: 70%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                border="0">
                                <tr>
                                    <td style="width: 2px"></td>
                                    ...
                                    <td style="width: 20px;">
                                        <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanel4"
                                            DisplayAfter="300">
                                            <ProgressTemplate>
                                                <asp:Image ID="imgProgressClosing1" runat="server" ImageUrl="~/image/loader.gif" />
                                            </ProgressTemplate>
                                        </asp:UpdateProgress>
                                    </td>
                                </tr>
