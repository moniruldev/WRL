<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionSmallPartsList.aspx.cs" ViewStateMode="Disabled" Inherits="PG.Web.Production.ProductionSmallPartsList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            //var url = IForm.RootPath + "Production/ProductionSmallPartsEntry.aspx?id=" + key;
            var url = IForm.RootPath + "Production/ProductionSmallPartsEntryWithBOM_SPL.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Production Small Parts Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "Production Small Parts Entry";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production Small Parts List"></asp:Label>
                </div>
                <!--Message Div -->
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1000px; height : auto;">
                        ...
                        <div id="dvGrid" style="width: 100%; height: auto; overflow: auto;">
                            <dx:ASPxGridView ID="grdAssemblyList" runat="server" AutoGenerateColumns="False" Width="98%"  ClientInstanceName="grdAssemblyList" >
                                <Columns>
                                      <dx:GridViewDataTextColumn Caption="Action" UnboundType="String"  Width="45px" VisibleIndex="0">
                                        <DataItemTemplate>
                                            <dx:ASPxHyperLink ID="hyperLink"  runat="server" OnInit="hyperLink_Init">
                                            </dx:ASPxHyperLink>
                                        </DataItemTemplate>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Production NO" Name="lblPROD_NO" VisibleIndex="3"  Width="100px" FieldName="PROD_NO">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Entry By" Name="lblEDIT_BY_ID" Width="100px" VisibleIndex="4" FieldName="ENTRY_BY">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn Caption="Entry Date" FieldName="ENTRY_DATE" Width="60px"   Name="lblENTRY_DATE" VisibleIndex="5">
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Shift" Name="lblSHIFT_NAME" VisibleIndex="6" Width="45px" FieldName="SHIFT_NAME">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Supervisor" Name="lblSUPERVISOR_NAME" VisibleIndex="2" Width="120px" FieldName="FULL_NAME">
                                    </dx:GridViewDataTextColumn>
                                   
                                    <dx:GridViewDataTextColumn Caption="PROD_ID" FieldName="PROD_ID" Name="hdnPROD_ID" Visible="false" VisibleIndex="1">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn Caption="Production Date" FieldName="PRODUCTION_DATE" Width="80px"   Name="lblPRODUCTION_DATE" VisibleIndex="3">
                                         <PropertiesDateEdit DisplayFormatString="dd-MMM-yyyy" ></PropertiesDateEdit>
                                    </dx:GridViewDataDateColumn>
                                   
                                      <dx:GridViewDataTextColumn Caption="Batch" FieldName="PROD_BATCH_NO" Width="50px" Name="txtPROD_BATCH_NO" VisibleIndex="1">
                                      </dx:GridViewDataTextColumn>
