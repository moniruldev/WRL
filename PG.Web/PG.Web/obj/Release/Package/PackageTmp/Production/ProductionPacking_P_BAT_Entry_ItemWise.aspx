<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionPacking_P_BAT_Entry_ItemWise.aspx.cs" Inherits="PG.Web.Production.ProductionPacking_P_BAT_Entry_ItemWise" %>
        ...
        <asp:HiddenField ID="hdnFinishItemNameForRm" runat="server" />
          <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Replace Battery Packing Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
                       ...
                       <%-- <td style="border-right: solid 2px #C0C0C0;">
                        ...
                        <td>
                                <div id="Div4" runat="server" class="" style="width: auto; height: auto; text-align: left;padding-left : 5px;border: solid 1px #2e4be5;">
                                                    ...
                                                    <div id="dvGridPack" style="width: 1160px;  height: 150px; overflow: auto;" class="dvGrid">
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    ...
                                                                                                    <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="52px" align="right" Text='<%# Bind("ITEM_QTY") %>' onchange="TestOnTextChange(this)" onBlur=" validationPackingQty(this)"   onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                                </td>
                                                                                                 <td>
                                                                                                    <asp:TextBox ID="txtUOM_NAME" runat="server" CssClass="textBox textAutoSelect"  Width="45px" Text='<%# Bind("UOM_NAME") %>'></asp:TextBox>
                                                                                                    <asp:HiddenField ID="hdnUomID" runat="server" Value='<%# Bind("UOM_ID") %>' />
               ...
               <%-- End Finished item Details --%>                                 
                 ...
                 <div id="Div2" runat="server" style="width: 100%; ">
                    ...
                    <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                        ...
                        <div id="dvGridClosing" style="width: 1250px; height: 150px; overflow: auto;" class="dvGrid">
