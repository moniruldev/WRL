<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" ViewStateMode="Disabled" CodeBehind="ProductionFormationLoadingList.aspx.cs" Inherits="PG.Web.Production.ProductionFormationLoadingList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, type) {
            ...
            if (type == "U") {
                url = IForm.RootPath + "Production/ProductionFormationEntryUnLoading.aspx?id=" + key;
            } else {
                url = IForm.RootPath + "Production/ProductionFormationEntryLoading.aspx?id=" + key;
            }
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Production : Formation ";
                //tdata.label = "User: " + userid;
                tdata.label = "Production : Formation ";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production Formation Loading List"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table style="width: 800px">
                    <tr>
                        ...
                        <td align="right" class="auto-style2">
                            <asp:Label ID="Label1" runat="server" Text="Loaded/Unloaded :" Width="130px"></asp:Label>
                        </td>
                        <td class="auto-style2" colspan="2">
                            <asp:DropDownList ID="ddlLoadUnloading" CssClass="dropDownList" Width="90px" runat="server" EnableViewState="true">
                               <%-- <asp:ListItem Value="">--All--</asp:ListItem>--%>
                                <asp:ListItem Value="U" >Unloaded</asp:ListItem>
                                <asp:ListItem Value="L" Selected="True">Loaded</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    ...
                    <div id="dvGrid" style="width: 100%; height: auto; overflow: auto;">
                        <dx:ASPxGridView ID="grdPastingList" runat="server" EnableRowsCache="false" EnableViewState="false" AutoGenerateColumns="False" Width="98%" ClientInstanceName="grdPastingList" ViewStateMode="Disabled">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Circuit" FieldName="MACHINE_NAME" Width="100px" Name="txtMachineName" VisibleIndex="7">
                                </dx:GridViewDataTextColumn>
                               
                                <dx:GridViewDataTextColumn Caption=" Batch NO" FieldName="PROD_BATCH_NO" Width="80px" Name="txtPROD_BATCH_NO" VisibleIndex="9">
                                </dx:GridViewDataTextColumn>
