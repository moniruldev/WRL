<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ASM_RejPlateToStore.aspx.cs" Inherits="PG.Web.Production.ASM_RejPlateToStore" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function bindItemList(gridViewID) {
            ...
            // serviceURL += "&ispaging=1&isFinished=Y&deptid=7&rejectType=Plate";
            var serviceURL = ItemListServiceLinkd + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            serviceURL += "&ispaging=1&isFinished=Y&rejectType=" + rejectType;
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var rejectType = $('#' + ddlREJECT_ITEM_TYPE).val();
                        var serviceURL = ItemListServiceLinkd + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&rejectType=" + rejectType;
                        //&batchno=" + vbatchNo
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Reject Plate Declaration(Transfer To Store)"></asp:Label>
            </div>
            <!--Message Div -->
