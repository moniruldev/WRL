<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionSolarBatteryEntryPackingWithBom.aspx.cs" Inherits="PG.Web.Production.ProductionSolarBatteryEntryPackingWithBom" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
            ...
            pageInstance.add_pageLoaded(function (sender, args) {
                ...
                for (i = 0; i < panels.length; i++) {
                    if (panels[i].id == gridUpdatePanelIDDet) {
                        ...
                        bindPackItemList(gridViewIDDet)
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = BOMNameListServiceLink + "?isterm=1&deptid=54&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1";
        ...
        function ClearItemData(txtItemID) {
            ...
            $(detRow).find('input[id$="txtPacked_qty"]').val('0');
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            var itemqty = $(detRow).find('input[id$="txtPacked_qty"]').val();
            //var tpcqty = pcqty * panelqty;
            //$(detRow).find('input[id$="txtPacked_qty"]').val(tpcqty);


            var standardweight = $(detRow).find('input[id$="hdnITEM_STANDARD_WEIGHT_KG"]').val();
            var tweight = itemqty * standardweight;
        ...
        function SetPanelUOMData(txtPANEL_UOM_ID, data) {
            ...
            $(detRow).find('input[id$="txtPacked_qty"]').val(pcqty);
            var standardweight = $(detRow).find('input[id$="hdnITEM_STANDARD_WEIGHT_KG"]').val();
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Packing Entry (Charge)" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
 ...
 <div id="tabs" style="height: 95%; background : url(../image/bg_greendot.gif) !important;">
  <ul>
    ...
    <li><a href="#tabs-2">Used RM </a></li>
      <li><a href="#tabs-3">RM Summary </a></li>
                ...
                <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                    ...
                    <tr class="headerRow_Prod">
                        ...
                        <td width="15px" class="headerColCenter_prod"></td>
                         ...
                         <td width="120px" class="headerColCenter_prod">Unpack Qty
                                            </td> 
                        <td width="81px" class="headerColCenter_prod">Packing Qty
                        </td>
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="248px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td>
                                                                      <asp:TextBox ID="txtAvailablePackingQty" runat="server" CssClass="textBox textAutoSelect" Width="115px" align="right" Style="text-align : right;" Text='<%# Bind("AVAILABLE_PACKING_QUANTITY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                     </td>    

                                                                     <td>
                                                                                <asp:TextBox ID="txtPacked_qty" runat="server" CssClass="textBox textAutoSelect" Width="81px" BackColor="Khaki" align="right" Style="text-align : right;" Text='<%# Bind("PACKING_QUANTITY") %>' onblur="AddAutoRM(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                        ...
                        <div id="dvGridHeaderClosing" style="float:left; width: 1300px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style=" height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="75px" style="display : none;" class="headerColCenter_prod">Reuse Qty
                                    </td>
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtFINISH_ITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="170px" Text='<%# Bind("FINISH_ITEM_NAME") %>'></asp:TextBox>
                    ...
                    <div id="groupBoxContainer2 boxShadow" style="height: auto; width: 100%;">
                            <div id="groupDataDetails2" style="float: left;width: 90%; height: auto;">
                                ...
                                <div id="Div7" runat="server" class="" style=" float:left; width: auto; height: auto; text-align: left; width: 100%">
                                        ...
                                        <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                            ...
                                            <tr class="headerRow_Prod">
                                               ...
                                               <%-- <td width="125px" class="headerColCenter_prod">Op Stock
                                                ...
                                                <td width="80px" style="display:none;" class="headerColCenter_prod">Reuse Qty
                                                </td>
                                    ...
                                    <div id="dvGridClosingSummary" style="width: auto; height: 250px; overflow: auto;" class="dvGrid">
