<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionFormationEntryUnLoading.aspx.cs" Inherits="PG.Web.Production.ProductionFormationEntryUnLoading" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <asp:HiddenField ID="hdnUnloadPROD_ID" runat="server" />
        <asp:HiddenField ID="hdnLoad_PROD_ID" runat="server" />
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Formation Unloading" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
        ...
        <div id="dvContentMain" class="dvContentMain" align="left">
                ...
                <div style="float: left">
                    <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 100%;" id="tblProductionMstEntry">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPROD_BATCH_NO" runat="server"  CssClass="textBox" Width="163px"></asp:TextBox>
                            ...
                            <td>
                                <asp:Label ID="Label2" runat="server" Text="Ref Prod No :"></asp:Label>
                                <asp:TextBox ID="txtBATCH_ID" runat="server" CssClass="textBox" Style="text-align: left; display: none" Width="150px"></asp:TextBox>
                            </td>
                            <td>
                                <asp:TextBox ID="txtRefProNo" runat="server" CssClass="textBox" Style="text-align: left;" Width="150px" ReadOnly="true"></asp:TextBox>
                            </td>
                      ...
                      <tr>
                                ...
                                <td style="text-align: right">
                                    <asp:Label ID="Label3" runat="server" Text="Batch Start Time : "></asp:Label>
                                </td>
                                <td style="text-align: left">
                                ...
                                <td style="text-align: right">
                                    <asp:Label ID="Label4" runat="server" Text="Cycle Time : "></asp:Label>
                                </td>
                                <td style="text-align: left">
                            ...
                            <tr>
                                <td style="text-align: right" class="auto-style1">
                                    <asp:Label ID="Label5" runat="server" Text="Batch Sl No : "></asp:Label>
                                </td>
            ...
            <div id="dvControls" style="height: auto; width: 100%;">
                ...
                <div id="groupDataDetails" style="width: 90%; height: auto;">
                    ...
                    <div id="groupDataHeaderCredit" runat="server" class="" style="float: right; width: 100%; text-align: left;">
                            ...
                            <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="52px" class="headerColCenter_prod">Panel Qty
                                     ...
                                     <td width="100px" class="headerColCenter_prod">Is Formed
                                    </td>
                                    <td width="100px" class="headerColCenter_prod">Pasted Batch
                                    </td>
                                    ...
                                    <asp:GridView ID="GRDDTLITEMLIST" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                        ...
                                        <Columns>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <td>
                                                                      ...
                                                                      <td>
                                                                        ...
                                                                        <asp:CheckBox ID="cbIsUnformed" Width="100px"  runat="server" Enabled="false" />
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtPASTING_BATCH" runat="server" CssClass="textBox textAutoSelect" Width="100px" align="right" Text='<%# Bind("PASTING_BATCH") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtFORMED_QTY" runat="server" CssClass="textBox textAutoSelect" Width="55px" align="right" Text='<%# Bind("FORMED_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>

                                                                    <td>
                                                                        <asp:TextBox ID="txtUNFORMED_QTY" runat="server" CssClass="textBox textAutoSelect" Width="55px" align="right" Text='<%# Bind("UNFORMED_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtREJECT_QTY" runat="server" CssClass="textBox textAutoSelect" Width="55px" align="right" Text='<%# Bind("REJECT_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                            ...
                                            <asp:TemplateField HeaderText="Delete" ShowHeader="false">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnDeleteRow" CssClass="buttonDeleteIcon" Height="16px" Width="18px" Visible="false"
                            ...
                            <table style="width: 90%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 90px" align="left">
                                        <asp:Button ID="btnNewRow" runat="server" CssClass="buttonNewRow" Visible="false" Text="" OnClientClick="ShowProgress()" OnClick="btnNewRow_Click" />
                                    </td>
                                    <td style="width: 20px;">
                        ...
                        <div id="divGridControlsClosing" style="width: 90%; height: 30px; border-top: solid 1px #C0C0C0;">
                            <table style="width: 90%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 90px" align="left">
                                        <asp:Button ID="btnNewRowClosing" runat="server" CssClass="buttonNewRow" Visible="false" Text="" OnClientClick="ShowClosingProgress()" OnClick="btnNewRowClosing_Click" />
                                    </td>
                                    <td style="width: 20px;">
        ...
        <div id="dvContentFooter" class="dvContentFooter">
            <table>
                <tr>
                    <td></td>
                    <td>
                        <asp:Button ID="btnAddNew" runat="server" Visible="false" Text="New" CssClass="buttonNew" OnClick="btnAddNew_Click" />
