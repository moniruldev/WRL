<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionFormationUnFormEntry.aspx.cs" Inherits="PG.Web.Production.ProductionFormationUnFormEntry" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Formation Unform Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
  ...
  <ul>
   ...
   <%-- <li><a href="#tabs-3">Dross Details </a></li>--%>
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;" align="left">
               <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 95%; font-size:12px;" id="tblProductionMstEntry">
                    <tr>
                ...
                <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                    ...
                    <tr class="headerRow_Prod">
                        ...
                        <td width="150px"  Style="display: none;"  class="headerColCenter_prod">Used Item
                          ...
                          <td width="100px" class="headerColCenter_prod" style="display:none;" >BatchNo
                        </td>
