<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionSulphationEntryWithBOM_SPL.aspx.cs" Inherits="PG.Web.Production.ProductionSulphationEntryWithBOM_SPL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnStoragelocationID" runat="server" Value="8" />
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Sulphation Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
               ...
               <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%;font-size:12px;margin:5px;" id="tblProductionMstEntry">
                    ...
                    <tr>
                       ...
                       <td style="text-align: right" class="auto-style1">
                        ...
                        <td>
                             <asp:TextBox ID="txtStorageLocation" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="Sulphation" Width="200px" ReadOnly="true"></asp:TextBox>
                        </td>
                ...
                <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                    ...
                    <tr class="headerRow_Prod">
                      ...
                      <td width="70px" class="headerColCenter">  Bar Type
                        ...
                        <td width="60px" class="headerColCenter_prod">SLNO
                        </td>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtManualSLNO" runat="server" CssClass="textBox textAutoSelect" Width="60px" Text='<%# Bind("MANUAL_SLNO") %>' Style=""></asp:TextBox>
                                                                    </td>
