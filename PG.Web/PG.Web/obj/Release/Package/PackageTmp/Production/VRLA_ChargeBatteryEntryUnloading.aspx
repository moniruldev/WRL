<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="VRLA_ChargeBatteryEntryUnloading.aspx.cs" Inherits="PG.Web.Production.VRLA_ChargeBatteryEntryUnloading" %>
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        var newServiceURL = serviceURL + "&deptid=142" + "&is_solar_Unload=Y" + "&specId=" + specId;                       
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                       ...
                       <%--  var e = document.getElementById("<%=ddlDEPT_ID.ClientID%>");
                        ...
                        var newServiceURL = serviceURL + "&deptid=142"+"&is_solar_Packing=Y";;
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="VRLA Charging UnLoading Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
