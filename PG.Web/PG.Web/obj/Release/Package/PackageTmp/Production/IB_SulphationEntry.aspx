<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="IB_SulphationEntry.aspx.cs" Inherits="PG.Web.Production.IB_SulphationEntry" %>
         ...
         <asp:HiddenField ID="hdnCompanyID" runat="server" Value="0" />
          <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="IB Sulphation Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px" ></asp:Label>
            </div>
                 ...
                 <div id="dvControlsHead" style="height: auto; width: 100%;" align="left">
                       <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 70%" id="tblProductionMstEntry">
                          ...
                          <tr>
                              ...
                              <td><asp:TextBox ID="txtBATCH_STARTTIME" runat="server" CssClass="textBox textDate   dateParse" Style="text-align: left;" Width="75px" TabIndex="4" MaxLength="11"></asp:TextBox>
                              ...
                              <td><asp:TextBox ID="txtBATCH_ENDTIME" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px" TabIndex="6" MaxLength="11"></asp:TextBox>
               ...
               <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%; ">
                        <div id="groupDataDetails" style=" width: 90%; height: auto;">
                            ...
                            <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width : 100%">
                                ...
                                <div id="dvGrid" style="  width: 950px; height: 150px; overflow: auto;" class="dvGrid">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                             ...
                                                                             <td>
                                                                                 <asp:TextBox ID="txtFILLING_BATCH" runat="server" CssClass="textBox textAutoSelect" Width="48px" Text='<%#Bind("FILLING_BATCH") %>'></asp:TextBox>
                                                                            </td>
                                                                            <td>
