<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionDMWRegenConEntry_SPL.aspx.cs" Inherits="PG.Web.Production.ProductionDMWRegenConEntry_SPL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
      ...
      <%--  var txtMachine = '<%= txtMachine.ClientID%>';
        ...
        <%--var txtPRODUCTION_DATE = '<%=txtPROD_DMW_REGENARATION_DATE.ClientID%>';--%>
        ...
        function bindItemList(gridViewID) {
            ...
            serviceURL += "&ispaging=1&for_production=N";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdn_PROD_DMW_REGEN_ID" runat="server" />
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="DM Water Regenaration Consumption Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
...
<%--  <ul>
    ...
    <li><a href="#tabs-2">Used RM </a></li>
                ...
                <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%" id="tblProductionMstEntry">
                    <tr>
                        <td style="text-align: right">
                            <asp:Label ID="lblPROD_CODE" runat="server" Text="Regenaration NO : "></asp:Label>
                        </td>
                        <td style="text-align: left">
                            <asp:TextBox ID="txtPROD_DMW_REGENARATION_NO" runat="server" CssClass="colourdisabletextBox" Enabled="false" Width="163px"></asp:TextBox>
                        </td>
                    
                         <td style="text-align: right">
                            <%--<asp:Label ID="lblREJECTED_QTY" runat="server"   Text="Rejected Qty :"></asp:Label>--%>
                            <asp:Label ID="lblPRODUCTION_DATE" runat="server" Text="Regenaration Date :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtPROD_DMW_REGENARATION_DATE" runat="server" CssClass=" textBox textDate dateParse" Style="text-align: left;" Width="120px"  ></asp:TextBox>
            ...
            <div id="Div5" runat="server" class="" style="float: right; width: 100%; text-align: left; border-top: solid 1px #0b07f5;">
                <span style="font-weight: bold; font-size: 15px; color: #ff3b00;">Consumption Items Details: </span>
            </div>
            <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                 <div id="dvGridHeader2" style="float: left; width: 1024px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                    ...
                    <tr class="headerRow_Prod">
                        ...
                        <td width="135px" class="headerColCenter_prod">Item Name
                        </td>
                ...
                <div id="groupDataDetails" style="width: 90%; height: auto;">
                    ...
                    <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGrid" style="width: 1024px; height: 200px; overflow: auto;" class="dvGrid">
                                    ...
                                    <asp:GridView ID="GRDDTLITEMLIST" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="SL#">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSLNo" runat="server" Text='<%# Bind("DMW_REGEN_DET_SLNO") %>' Style="text-align: center;"
                                                        Width="30px">
                                                    </asp:Label>
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:HiddenField ID="hdnPROD_DMW_REGEN_DTL_ID" runat="server" Value='<%# Bind("PROD_DMW_REGEN_DTL_ID") %>' />
                                                                    </td>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="57px" align="right" Style="text-align: right;" Text='<%# Bind("CONSUMPTION_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="100px" Text='<%# Bind("DMW_REGEN_DET_REMARKS") %>' Style=""></asp:TextBox>
                                                                    </td>
                                                                    <%--<td>
