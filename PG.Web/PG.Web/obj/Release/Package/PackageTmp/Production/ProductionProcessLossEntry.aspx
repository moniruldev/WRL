<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionProcessLossEntry.aspx.cs" Inherits="PG.Web.Production.ProductionProcessLossEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <%--    var txtTotQty = '<%=txtTotQty.ClientID%>';
        ...
        function ClearClosingItemData(txtItemName) {
            //$('#' + txtGLAccCodeID).val('');
        ...
        function SetClosingItemData(txtItemName, data) {
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Process Loss Entry"></asp:Label>
            </div>
            <!--Message Div -->
            <div id="dvMsg" runat="server" class="dvMessage" style="">
                            <asp:HiddenField ID="hdnLOSS_ID" runat="server" />
                   ...
                   <tr style="height:5px;">
                     ...
                     <tr>
                        ...
                        <td align="right" class="auto-style2">
                            <asp:Label ID="lblLossNo" runat="server" Text="Process Loss No :" style=""></asp:Label>
                        </td>
                        <td class="auto-style2">
                            <asp:TextBox ID="txtLossNo" runat="server" Style="text-align: left;" CssClass="textBox" ForeColor="Red" Width="190px"  Enabled="False"></asp:TextBox>
                        </td>
                        <td style="width:100px"></td>
                        <td align="right">
                              <asp:Label ID="lblLossDate" runat="server" Text="Date :" style=""></asp:Label>
                        </td>
                        <td>
                              <asp:TextBox ID="txtLossDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                        </td>
                    </tr>
                     <tr style="height:5px;">
                       <td></td>
                             ...
                             <%--   <td width="15px" class="headerColLeft">
                              ...
                              <%--  <td width="180px" class="headerColCenter_prod">Item
                                ...
                                <td width="15px" class="headerColLeft"></td>--%>
                                 ...
                                 <td width="80px" class="headerColCenter_prod">Quantity
                                </td>
                                                ...
                                                <div>
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <asp:HiddenField ID="hdnLossMstId" runat="server" Value='<%# Bind("LOSS_MST_ID") %>' />
                                                                 ...
                                                                 <%--  <td>
                                                                    ...
                                                                    <td>
                                                                     <asp:TextBox ID="txtItemName" runat="server" CssClass="textBox textAutoSelect" Width="200px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                  ...
                                                                  <td>
                                                                    <asp:TextBox ID="txtItemQty" runat="server" style="text-align: right;font-size:14px;color:black;" CssClass="textBox textAutoSelect txtQty"  Width="80px" align="right" Text='<%# Bind("ITEM_QTY") %>'  onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                 </td>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtLossDetRemarks" runat="server" CssClass="textBox textAutoSelect" Width="150px" Text='<%# Bind("REMARKS") %>' Style=""></asp:TextBox>
                                                                </td>
