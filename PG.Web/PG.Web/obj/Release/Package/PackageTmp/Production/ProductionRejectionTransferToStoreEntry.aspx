<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionRejectionTransferToStoreEntry.aspx.cs" Inherits="PG.Web.Production.ProductionRejectionTransferToStoreEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Clear() {
            ...
            document.getElementById("<%=txtClosingQty.ClientID %>").value = "0";
            document.getElementById("<%=txtTransferQty.ClientID %>").value = "0";
            return true;
        }
            ...
            $(gridSelector).find('input[id$="txtUSED_ITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        var newServiceURL = serviceURL + "&deptid=" + DeptID + "&stlmid=" + stlmid;//+ "&groupid=" + vgroupid
            ...
            pageInstance.add_pageLoaded(function (sender, args) {
                ...
                for (i = 0; i < panels.length; i++) {
                    ...
                    if (panels[i].id == gridUpdatePanelIDDet) {
                        //bindScrapItemList(gridViewIDDet);
        ...
        function bindItemList() {
            ...
            itemServiceURL += "&ispaging=1&for_production=Y";
            ...
            $(itemIDElem).combogrid({
                ...
                search: function (event, ui) {
                    ...
                    var DeptID = $('[id*=ddlDEPT_ID] option:selected').val();
                    var newServiceURL = itemServiceURL + "&deptid=" + DeptID + "&stlmid=1";
                    $(this).combogrid("option", "url", newServiceURL);
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.itemid == '') {
                        ...
                        $('#' + txtUomName).val(ui.item.uomname);
                        $("[id*=btnLoadStlm]").click();
        ...
        function bindScrapItemList(gridViewIDD) {
            ...
            var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            serviceURL += "&ispaging=1&for_production=Y"; //&isFinished=Y
            var gridSelector = "#" + gridViewIDD;
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var stlmid = $('[id*=ddlStorageLocation] option:selected').val();
                        var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&for_production=Y" + "&deptid=" + DeptID + "&stlmid=" + stlmid; //&isFinished=Y
                        var prcNo = GetItemNo(eCode, serviceURL);
                        if (prcNo == null) {
                            ClearScrapItemData(elemID);
                        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hdnRejIssueId" runat="server" />
    <asp:Button ID="btngrdSum" runat="server" OnClick="btngrdSum_Click" />

    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Rejection Transfer Entry"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
                ...
                <table>
                    <tr>
                        ...
                        <td align="right" class="auto-style2">
                            <asp:Label ID="lblTransferNo" runat="server" Text="Transfer No :" Style=""></asp:Label>
                        </td>
                        <td class="auto-style2">
                            <asp:TextBox ID="txtTransferNo" runat="server" Style="text-align: left; font-weight: 700;" CssClass="textBox" Enabled="False" ForeColor="Red"></asp:TextBox>
                        </td >
                        <td></td>
                        <td align="right">  
                            <asp:Label ID="lblTransferDate" runat="server" Text="Transfer Date : "></asp:Label> </td>
                        <td>
                         <asp:TextBox ID="txtTransferDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                    ...
                    <tr>
                        <td style="text-align: right">
                            <asp:Label ID="lblDEPT_ID" runat="server" Text="From Department : "></asp:Label>
                        </td>
                        ...
                        <td style="text-align: left">
                            ...
                            <asp:DropDownList ID="ddlToDept" runat="server" CssClass="dropDownList required" Width="190px"  Enabled="false"></asp:DropDownList>
                        </td>
                   
                         <td style="text-align: right">
                            <asp:Label ID="lblClosingQty" runat="server" Text="Closing Qty :"></asp:Label>
                        </td>
                        <td>
                          <asp:TextBox runat="server" ID="txtClosingQty" CssClass="textBox"></asp:TextBox>
                        </td>
                        <td></td>
                        <td>
                            <asp:TextBox runat="server" ID="txtUomName" Width="50px"></asp:TextBox>
                            <asp:HiddenField runat="server" ID="hdnUomId" />
                        </td>
                     ...
                     <tr>
                       ...
                       <td>
                         <asp:TextBox ID="txtItemName" runat="server" CssClass="textBox required" Enabled="true" Width="220px"></asp:TextBox> 
                       ...
                       <td style="text-align: right">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlStorageLocation" runat="server" CssClass="dropDownList" Width="190px" OnSelectedIndexChanged="ddlStorageLocation_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                        </td>
                         <td style="text-align: right">
                            <asp:Label ID="lblTransferQty" runat="server" Text="Transfer Qty :"></asp:Label>
                        </td>
                        <td>
                          <asp:TextBox runat="server" ID="txtTransferQty" CssClass="textBox" onChange="AddNewRow(this)" ></asp:TextBox>
                        </td>
                         <td></td>
                         <td>
                             <asp:Button ID="btnNewRow2" runat="server" CssClass="buttonNew" Text="Add" OnClientClick="ShowProgress()" OnClick="btnNewRow2_Click" />
                              <asp:Button ID="btnLoadStlm" runat="server"  Text=""  OnClick="btnLoadStlm_Click" Style="display:none;" />
                         </td>
                         <td>
            ...
            <div id="dvControls" style="width: 100%; height:auto;" >
                <div id="Div3" runat="server" class="" style="width: 100%; text-align: left;">
                    <span style="font-weight: bold; font-size: 15px; color: #ff3b00;">Item Details: </span>
                </div>
                ...
                <div id="Div1" runat="server" class="" style="width: auto; height:auto; text-align: left">
                        ...
                        <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                            ...
                            <tr class="headerRow_Prod">
                                ...
                                <td width="78px" class="headerColCenter_prod">Qty
                                 ...
                                 <td width="78px" class="headerColCenter_prod">Closing Qty
                                </td>
                                 <td width="100px" class="headerColCenter_prod">Storage Loc.
                                </td>
                    ...
                    <div id="dvGridClosing" style="width: 1000px; height: 200px; overflow: auto;" class="dvGrid">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:GridView ID="grdTransferList" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="SL#">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSLNO" runat="server" Text='<%# Bind("REJ_ISSUE_DET_SLNO") %>' Style="text-align: center;"
                                                    Width="60px">
                                                </asp:Label>
                                                    ...
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                <td></td>
                                                                <td>
                                                                    <asp:HiddenField ID="hdnREJ_ISSUE_DET_ID" runat="server" Value='<%# Bind("REJ_ISSUE_DET_ID") %>' />
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="335px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                ...
                                                                <td style="text-align: right;">
                                                                    <asp:TextBox ID="txtITEM_QTY" runat="server" CssClass="txtQty textBox textAutoSelect" Width="75px" align="right" Style="text-align: right;" Text='<%# Bind("ISSUE_QNTY") %>' onchange="calcIssueStock(this)"></asp:TextBox>
                                                                </td>

                                                                  <td style="text-align: right;">
                                                                    <asp:TextBox ID="txtClosingQty" runat="server" CssClass="textBox textAutoSelect" Width="75px" align="right" Style="text-align: right;" Text='<%# Bind("CLOSING_QTY") %>' ></asp:TextBox>
                                                                </td>

                                                                 <td>
                                                                    <asp:TextBox ID="txtStlmName" runat="server" CssClass="textBox textAutoSelect" Width="100px" align="left" Style="text-align: left;" Text='<%# Bind("STLM_NAME") %>' ></asp:TextBox>
                                                                     <asp:HiddenField runat="server" ID="hdnStlmId" Value='<%# Bind("STLM_ID") %>' />
                                                                </td>

                                                                <td>
                                                                    <asp:TextBox ID="txtREMARKS" runat="server" CssClass="textBox textAutoSelect" Width="150px" Text='<%# Bind("REJ_ISSUE_NOTE") %>' Style=""></asp:TextBox>
                                                                </td>
                              ...
                              <Triggers>
                                ...
                                <%--<asp:AsyncPostBackTrigger ControlID="btnLoadStlm" EventName="Click" />--%>
