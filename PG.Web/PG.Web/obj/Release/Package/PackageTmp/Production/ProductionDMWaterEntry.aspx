<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionDMWaterEntry.aspx.cs" Inherits="PG.Web.Production.ProductionDMWaterEntry" %>
     ...
     <script language="javascript" type="text/javascript">
         ...
         function bindSupporvisorList() {
             ...
             var cgColumns = [{ 'columnName': 'empid', 'width': '80', 'align': 'left', 'highlight': 4, 'label': 'Emp ID' }
                              ...
                              , { 'columnName': 'designationName', 'width': '180', 'align': 'left', 'highlight': 4, 'label': ' Designation Name' }
             ...
             $(groupIDElem).combogrid({
                 ...
                 search: function (event, ui) {
                     ...
                     var dept_id = e.options[e.selectedIndex].value;
                     //+ dept_id
                     var newServiceURL = serviceURL + "&deptid=123";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         ...
         <asp:HiddenField ID="hdnSECTION" runat="server" Value="0" />
          ...
          <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text=" DM Water Production Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px" ></asp:Label>
            </div>
 ...
 <div id="tabs" style="height: 95%; background : url(../image/bg_greendot.gif) !important;">
  <ul>
    <li><a href="#tabs-1">DM Water Details</a></li>
    <li><a href="#tabs-2">Used RM </a></li>
                 ...
                 <div id="dvControlsHead" style="height: auto; width: 100%;" align="left">
                     <fieldset style="border:1px solid;">
                      ...
                      <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 87%; height: 98px;" id="tblProductionMstEntry">
                          <tr>
                              <td style="text-align: right" class="auto-style6">
                                  <asp:Label ID="lblPROD_CODE" runat="server" Text="Prod. NO : "></asp:Label>
                              </td>
                              <td style="text-align: left" class="auto-style5">
                                  <asp:TextBox ID="txtPROD_NO" runat="server" CssClass="colourdisabletextBox" Enabled="false" Width="192px" Height="21px"></asp:TextBox>
                              </td>
                          ...
                          <tr>
                              ...
                              <td style="text-align: left">
                                  <asp:DropDownList ID="ddlSHIFT_ID" runat="server" CssClass="dropDownList" Width="155px" AutoPostBack="True" TabIndex="2" OnSelectedIndexChanged="ddlSHIFT_ID_SelectedIndexChanged"></asp:DropDownList>
                          ...
                          <tr>
                              <td style="text-align: right" class="auto-style6">Batch Start Time : </td>
                              <td class="auto-style5"><asp:TextBox ID="txtBATCH_STARTTIME" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px" TabIndex="3"></asp:TextBox>
                              ...
                              <td style="text-align: right" class="auto-style7">Batch End Time : </td>
                              <td class="auto-style3"><asp:TextBox ID="txtBATCH_ENDTIME" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px" TabIndex="5"></asp:TextBox>
                ...
                <div id="dvGridHeader2" style="float:left; width: 831px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                    <table style="height: 80%; color: #FFFFFF;  font-weight: bold; text-align: left;"
                                        ...
                                        <tr class="headerRow_Prod">
                                            ...
                                            <td width="120px" class="headerColCenter_prod"> Plant Name
                                            </td>
               ...
               <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%; ">
                        <div id="groupDataDetails" style=" width: 90%; height: auto;">
                            ...
                            <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width : 100%">
                                ...
                                <div id="dvGrid" style="width: 1100px; height: 240px; overflow: auto;" class="dvGrid">
                                                                ...
                                                                <table border="0" cellpadding="1" cellspacing="1">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtItem_qty" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect" Width="60px" BackColor="Khaki" align="right" Text='<%# Bind("ITEM_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
     ...
     <div id="tabs-2">
                            ...
                            <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left;width : 100%">
                                        <div id="dvGridHeaderClosing" style="float:left; width: 878px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                            <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                                class="defFont" cellspacing="1" cellpadding="1">
                                                <tr class="headerRow_Prod">
                                                    <td width="40px" class="headerColCenter_prod">SL#
                                                    </td>
                                                    <td width="230px" class="headerColCenter_prod">RM Item
                                                    </td>
                                                    <td width="15px" class="headerColCenter_prod"></td>
                                                    <td width="70px" class="headerColCenter_prod">UOM
                                                    </td>
                                                     <td width="125px" class="headerColCenter_prod">   Stock Qty
                                                    </td>
                                                    ...
                                                    <td width="80px" class="headerColCenter_prod"> Neg Dev
                                                     ...
                                                     <td width="80px" class="headerColCenter_prod"> Used RM Qty
                                                    </td>
                                ...
                                <div id="dvGridClosingContainer2" runat="server" style="height: auto; text-align: left; width : 100%" >
                                        <div id="dvGridClosing" style="float:left; width: 1100px; height: 240px; overflow: auto;" class="dvGrid">
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="230px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                     ...
                                                                                     <td>
                                                                                        <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect" Width="120px" align="right" Text='<%# Bind("SYSTEM_OPENING_STOCK") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    </td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtCLOSING_QTY" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect"   Width="80" align="right" Text='<%# Bind("CLOSING_QTY") %>' onchange="calcIssueStock(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                         <%-- </td>
                                                                                    ...
                                                                                    <td>
                                                                                      ...
                                                                                      <td>
                                                                                        <asp:TextBox ID="txtISSUE_STOCK" runat="server" style="text-align: right;"  CssClass="textBox textAutoSelect" Width="75px" BackColor="Khaki"  align="right" Text='<%# Bind("ISSUE_STOCK") %>' onchange="calcCloseingStock(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                        ...
                                        <div id="divGridControlsClosing" style=" float:left; width: 100%; height: 30px; border-top: solid 1px #C0C0C0; border-bottom : solid 1px #0b07f5;">
                                            <table style="width: 70%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                                border="0">
                                                <tr>
                                                    <td style="width: 2px"></td>
