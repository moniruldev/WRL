<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Grid_Dross_EntryList.aspx.cs" Inherits="PG.Web.Production.Grid_Dross_EntryList" ViewStateMode="Disabled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/Grid_Dross_Entry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Dross Entry";
                tdata.label = "Dross Entry";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Dross List"></asp:Label>
            </div>
            <!--Message Div -->
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 800px">
                    <dx:ASPxGridView ID="grdStockTransferList" runat="server" AutoGenerateColumns="False" Width="98%" ClientInstanceName="grdPastingList">
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="DROSS_MST_ID" FieldName="DROSS_MST_ID" Name="hdnDROSS_MST_ID" Visible="false" VisibleIndex="1">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Dross NO" Name="lblDROSS_NO" VisibleIndex="2" Width="80px" FieldName="DROSS_NO">
                            </dx:GridViewDataTextColumn>
