<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionScrapEntry.aspx.cs" Inherits="PG.Web.Production.ProductionScrapEntry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hdnScrap_MST_ID" runat="server" />
    <asp:Button ID="btngrdSum" runat="server" OnClick="btngrdSum_Click" />

    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Scrap Entry"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
                ...
                <table>
                    <tr>
                        ...
                        <td align="right" class="auto-style2">
                            <asp:Label ID="lblRejectionNo" runat="server" Text="Scrap No :" Style=""></asp:Label>
                        </td>
                        <td class="auto-style2">
                            <asp:TextBox ID="txtScrap_NO" runat="server" Style="text-align: left; font-weight: 700;" CssClass="textBox" Enabled="False" ForeColor="Red"></asp:TextBox>
                        </td >
                        <td align="right">  <asp:Label ID="Label1" runat="server" Text="Scrap Date : "></asp:Label> </td>
                        <td>
                                   <asp:TextBox ID="txtScrapDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                    ...
                    <tr>
                     <%--   <td align="right" class="auto-style2">
                            <asp:Label ID="lblTRANSFER_REASON" runat="server" Text="Remarks :"></asp:Label>
                        </td>
                        <td class="auto-style2" colspan="">
                            <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox" Style="text-align: left;" Width="200px"></asp:TextBox>
                        </td>--%>
            ...
            <div id="dvControls" style="width: 100%; height:auto;" >
                <div id="Div3" runat="server" class="" style="width: 100%; text-align: left;">
                    <span style="font-weight: bold; font-size: 15px; color: #ff3b00;">Scrap Item Details: </span>
                </div>
                                                    ...
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                <td></td>
                                                                <td>
                                                                    <asp:HiddenField ID="hdnScrap_DTL_ID" runat="server" Value='<%# Bind("SCRAP_DTL_ID") %>' />
                                                                </td>
                                                                <td>
