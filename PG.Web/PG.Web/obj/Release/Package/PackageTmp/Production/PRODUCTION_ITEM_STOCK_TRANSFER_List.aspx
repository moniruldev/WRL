<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="PRODUCTION_ITEM_STOCK_TRANSFER_List.aspx.cs" Inherits="PG.Web.Production.PRODUCTION_ITEM_STOCK_TRANSFER_List" ViewStateMode="Disabled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/PRODUCTION_ITEM_STOCK_TRANSFER.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Item Stock Transfer";
                //tdata.label = "User: " + userid;
                tdata.label = "Item Stock Transfer";
                tdata.type = 0;
                tdata.url = url;
     ...
     <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item Stock Transfer List"></asp:Label>
                </div>
                <!--Message Div -->
         ...
         <div id="dvContentMain" class="dvContentMain">
                <div id="dvControlsHead" style="height: auto; width: 100%;">
                     <table style="width : 700px">
                        ...
                        <%--<td align="right" class="auto-style2">
                            <asp:Label ID="Label8" runat="server" Text="Transfer Date :" Width="100px"></asp:Label>
                        </td>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1000px">
                    <dx:aspxgridview ID="grdStockTransferList" runat="server" AutoGenerateColumns="False" Width="98%"  ClientInstanceName="grdPastingList" >
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="STOCK_TRANSFER_ID" FieldName="STOCK_TRANSFER_ID" Name="hdnSTOCK_TRANSFER_ID" Visible="false" VisibleIndex="1">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Transfer NO" Name="lblSTOCK_TRANSFER_NO" VisibleIndex="2"  Width="150px" FieldName="STOCK_TRANSFER_NO">
                                    </dx:GridViewDataTextColumn>
                                   ...
                                   <%-- <dx:GridViewDataTextColumn Caption="Shift Name" Name="lblSHIFT_NAME" VisibleIndex="6" Width="100px" FieldName="SHIFT_NAME">
                                    ...
                                    <dx:GridViewDataDateColumn Caption="Transfer Date" FieldName="STOCK_TRANSFER_DATE" Width="100px"   Name="lblSTOCK_TRANSFER_DATE" VisibleIndex="3">
