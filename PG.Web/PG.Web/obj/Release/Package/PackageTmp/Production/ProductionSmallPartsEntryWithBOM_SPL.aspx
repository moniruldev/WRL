<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionSmallPartsEntryWithBOM_SPL.aspx.cs" Inherits="PG.Web.Production.ProductionSmallPartsEntryWithBOM_SPL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ValidateBatchStock() {
            ...
            if (sumUsed.toFixed(2) > totalqty.toFixed(2)) {
        ...
        function CalculateBatchStock(txtbox) {
            ...
            for (var i = 0; i < grid.rows.length - 1; i++) {
                ...
                if (chkSelect[i].checked) {
                    ...
                    if (parseFloat(txtSysOpening[i].value) == parseFloat(txtTotIssueQty[i].value)) {
                        $("input[id*=txtusedQty]")[i].value = parseFloat(txtTotIssueQty[i].value);
                        sumUsed += parseFloat($("input[id*=txtusedQty]")[i].value);
                        //pending = parseFloat(txtTotIssueQty[i].value) - parseFloat($("input[id*=txtusedQty]")[i].value);
                    }
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        //var DeptID = $('[id*=ddlDEPT_ID] option:selected').val();
                        //var stlmid = $('#' + hdnStoragelocationID).val();
                        var newServiceURL = serviceURL + "&stlmid=" + stlmid;//&deptid=" + DeptID + "
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&deptid=136&codecomptype=" + Enums.DataCompareType.StartsWith;

                        var deptid = $('[id*=ddlDEPT_ID] option:selected').val();

                        serviceURL += "&ispaging=1" + "&stlmid=" + stlmid;//&deptid=136+ DeptID + 
        ...
        function bindUsedItemInDrossSection(gridViewID) {
            ...
            var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            serviceURL += "&ispaging=1&isFinished=N&deptid=136&for_production=Y&groupid=5";
            ...
            $(gridSelector).find('input[id$="txtUsedItemName"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&groupid=5";
        ...
        function GetItemNo(eCode, serviceURL) {
            ...
            var newServiceURL = serviceURL + "&deptid=136&selectedId=" + eCode; //groupid=5&
            var dummyVar = $.ajax({
                type: "GET",
                cache: false,
                async: false,
        ...
        function GetItemNoused(eCode, serviceURL) {
            var prcNo = null;
            var isError = false;
            var isComplete = false;
            //ajax call

            var newServiceURL = serviceURL + "&deptid=136&groupid=5&selectedId=" + eCode; //
            var dummyVar = $.ajax({
                type: "GET",
                cache: false,
                async: false,
        ...
        function bindDrossItemList(gridViewIDD) {
            ...
            serviceURL += "&ispaging=1&deptid=136&isFinished=Y&for_production=Y&groupid=47";
            ...
            $(gridSelector).find('input[id$="txtUSED_ITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var prcNo = GetItemNoused(eCode, serviceURL);
                        if (prcNo == null) {
                            ClearUsedItemData(elemID);
                        }
                        else {
            ...
            $(gridSelector).find('input[id$="txtCLOSINGITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        var newServiceURL = serviceURL + "&deptid=" + DeptID + "&stlmid=" + stlmid + "&groupid=5";
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
                        newServiceURL = JSUtility.AddTimeToQueryString(newServiceURL);
                        $(this).combogrid("option", "url", newServiceURL);
                    },
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&isFinished=N&for_production=Y" + "&deptid=" + DeptID + "&stlmid=" + stlmid + "&groupid=5";
        ...
        function bindMachineList(gridViewID) {
         ...
         function bindSupporvisorList() {
             ...
             function bindEntryByList() {
                 ...
                 var cgColumns = [{ 'columnName': 'empid', 'width': '80', 'align': 'left', 'highlight': 4, 'label': 'Emp ID' }
                                  , { 'columnName': 'fullname', 'width': '200', 'align': 'left', 'highlight': 4, 'label': 'Emp Name' }
                                  , { 'columnName': 'designationName', 'width': '100', 'align': 'left', 'highlight': 4, 'label': ' Designation Name' }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnStoragelocationID" runat="server" Value="16" />
               ...
               <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%;font-size:12px; margin:5px;" id="tblProductionMstEntry">
                    ...
                    <tr>
                       ...
                       <td style="text-align: right" class="auto-style1">
                        ...
                        <td>
                             <asp:TextBox ID="txtStorageLocation" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="Small Parts" Width="200px" ReadOnly="true"></asp:TextBox>
                        </td>
 ...
 <div id="tabs-2">
                        ...
                        <div id="dvGridHeaderClosing" style="float:left; width: 1200px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style=" height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="50px" class="headerColCenter_prod" style="display:none;">Batch
                                    </td>
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                   ...
                                                                   <td> 
                                                                    <asp:LinkButton ID="lnkBatchDtl"  CommandName="itemdtl"  CssClass="buttoncommon"  CommandArgument='<%# Bind("CLOSING_ITEM_ID") %>' runat="server" CausesValidation="false" Width="52px" Height="17" Visible="false" >Batch</asp:LinkButton>  
                                                                  </td>
                                                                    <td align="right">
     ...
     <div id="tabs-3">
                    ...
                    <div id="Div2" runat="server" class="" style="float:left; width: 100%; text-align: left;  border-top: solid 1px #0b07f5;">
                        ...
                        <asp:Label runat="server" ID="lblDrossNo"></asp:Label>
                    </div>
                        ...
                        <div id="divGridControlsDross">
                            <table style="width: 70%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 90px" align="left">
                                       <asp:Button ID="btnNewRowDross" runat="server"  Text="" CssClass="buttonNewRow" OnClientClick="ShowClosingProgress()" OnClick="btnNewRowDross_Click" Enabled="true" />
                                    </td>
                                    <td style="width: 20px;">
