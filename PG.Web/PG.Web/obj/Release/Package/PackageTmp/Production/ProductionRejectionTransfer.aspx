<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionRejectionTransfer.aspx.cs" Inherits="PG.Web.Production.ProductionRejectionTransfer" %>
            ...
            $(gridSelector).find('input[id$="txtRejectItemName"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var stlmid = $('[id*=ddlStorageLocation] option:selected').val();
                        var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&isFinished=Y&forproduction=Y" + "&deptid=" + DeptID + "&stlmid=" + stlmid + "&groupid=62";
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Reject Transfer"></asp:Label>
            </div>
            <!--Message Div -->
            <div id="dvMsg" runat="server" class="dvMessage" style="">
                            <asp:HiddenField ID="hdnProd_Rejection_ID" runat="server" />
                             <asp:HiddenField runat="server" ID="hdnTRANSFER_ID" />
        ...
        <div id="dvContentMain" class="dvContentMain">
                   ...
                   <tr style="height:5px;">
                     ...
                     <tr>
                        ...
                        <td class="auto-style2">
                            <asp:TextBox ID="txtTransferNo" runat="server" Style="text-align: left;" CssClass="textBox" ForeColor="Red" Width="190px"  Enabled="False"></asp:TextBox>
                        </td>
                        <td style="width:100px"></td>
                        <td align="right">
                              <asp:Label ID="lblTransferDate" runat="server" Text="Date :" style=""></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                              ...
                              <td style="text-align: left">
                                  ...
                                  <asp:DropDownList ID="ddlDEPT_ID" runat="server" CssClass="dropDownList required" Width="190px" Enabled="false" ></asp:DropDownList>
                              </td>
                         <td style="width:100px"></td>
                         <td align="right">
                             <asp:Label ID="ddlToStlm" runat="server" Text="To Storage Loc:" style=""></asp:Label>
                        </td>
                        <td>
                             <asp:DropDownList ID="ddlToStorageLocation" runat="server" CssClass="dropDownList"></asp:DropDownList>
                        </td>
                    ...
                    <tr>
                         <td style="width:100px"></td>
                         <td align="right">
                             <asp:Label ID="lblFromStorageLocation" runat="server" Text="From Storage Loc:" style=""></asp:Label>
                        </td>
                        <td>
                             <asp:DropDownList ID="ddlFromStorageLocation" runat="server" CssClass="dropDownList" Enabled="false"></asp:DropDownList>
                        </td>
                          <td style="width:100px"></td>
                        <td align="right" class="auto-style2">
            ...
            <div id="dvControls" style="width: 100%; height: 400px;">
                <div id="Div3" runat="server" class="" style="width: 100%; text-align: left;border-top: solid 1px #0b07f5;">
                    <span style="font-weight: bold;font-size : 15px;color :#ff3b00;">Transfer Details: </span>
                </div>
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="SL#">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSLNO" runat="server" Text='<%# Bind("TRANSFER_DET_SLNO") %>' Style="text-align: center;"
                                                    Width="65px">
                                                </asp:Label>
                                                ...
                                                <div>
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <asp:HiddenField ID="hdnTRANSFER_ID" runat="server" Value='<%# Bind("TRANSFER_ID") %>' />
                                                                     <asp:HiddenField ID="hdnTransferDetId" runat="server" Value='<%# Bind("TRANSFER_DTL_ID") %>' />
                                                                     <asp:HiddenField ID="hdnRejectionDetId" runat="server" Value='<%# Bind("REJECTION_DTL_ID") %>' />
                                                                </td>
                                                          
                                                                   <td>
                                                                        <asp:TextBox ID="txtFINISH_ITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="180px" Text='<%# Bind("FROM_REJ_ITEM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnFINISHED_ITEM_ID" runat="server" Value='<%# Bind("FROM_REJ_ITEM_ID") %>' />
                                                                    </td>
                                                                    <td>
                                                                        <input id="btnFinishItem" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
                                                                    </td>
                                                                    <td>
                                                                     <asp:TextBox ID="txtRejectItemName" runat="server" CssClass="textBox textAutoSelect" Width="200px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                      <asp:HiddenField ID="hdnRejectItemId" runat="server" Value='<%# Bind("ITEM_ID") %>' />
                                                                    </td>
                                                                    <td>
                                                                  ...
                                                                  <td>
                                                                    <asp:TextBox ID="txtTransfer_QTY" runat="server" style="text-align: right;font-size:14px;color:black;" CssClass="textBox textAutoSelect txtQty"  Width="80px" align="right" Text='<%# Bind("TRANSFER_QTY") %>'  onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                 </td>
                                                              ...
                                                              <%--    <td> 
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtTRANSFER_DET_REMARKS" runat="server" CssClass="textBox textAutoSelect" Width="150px" Text='<%# Bind("TRANSFER_DET_REMARKS") %>' Style=""></asp:TextBox>
                                                                </td>
