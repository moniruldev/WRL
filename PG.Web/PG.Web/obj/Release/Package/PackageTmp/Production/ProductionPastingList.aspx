<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionPastingList.aspx.cs" ViewStateMode="Disabled" Inherits="PG.Web.Production.ProductionPastingList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/ProductionPastingEntryWithBOM_SPL.aspx?id=" + key;
            
            //var url = IForm.RootPath + "Production/ProductionPastingEntry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Production Pasting Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "Production Pasting Entry";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production Pasting List"></asp:Label>
                </div>
                <!--Message Div -->
             ...
             <div id="dvControls" style="width: 100%; height : 600px;">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1000px; height : auto;">
                        ...
                        <div id="dvGrid" style="width: 100%; height: auto; overflow: auto;">
                            <dx:ASPxGridView ID="grdPastingList" runat="server" AutoGenerateColumns="False" Width="98%"  ClientInstanceName="grdPastingList" >
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Production NO" Name="lblPROD_NO" VisibleIndex="3"  Width="110px" FieldName="PROD_NO">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Entry By" Name="lblEDIT_BY_ID" Width="100px" VisibleIndex="4" FieldName="ENTRY_BY">
                                    </dx:GridViewDataTextColumn>
                                     <dx:GridViewDataDateColumn Caption="Entry Date" FieldName="ENTRY_DATE" Width="80px"   Name="lblENTRY_DATE" VisibleIndex="5">
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Shift" Name="lblSHIFT_NAME" VisibleIndex="6" Width="50px" FieldName="SHIFT_NAME">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Shift Incharge" Name="lblSUPERVISOR_NAME" VisibleIndex="2" Width="100px" FieldName="FULL_NAME">
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataDateColumn Caption="Production Date" FieldName="PRODUCTION_DATE" Width="100px"   Name="lblPRODUCTION_DATE" VisibleIndex="3">
                                      ...
                                      <dx:GridViewDataTextColumn Caption="Batch" FieldName="PROD_BATCH_NO" Width="70px" Name="txtPROD_BATCH_NO" VisibleIndex="1">
                                      </dx:GridViewDataTextColumn>
                                   <dx:GridViewDataTextColumn Caption="Status" FieldName="AUTH_STATUS" Width="70px" Name="txtAUTH_STATUS" VisibleIndex="8">
                                      </dx:GridViewDataTextColumn>
                                </Columns>
