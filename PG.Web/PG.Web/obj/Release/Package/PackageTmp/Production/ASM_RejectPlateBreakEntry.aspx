<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ASM_RejectPlateBreakEntry.aspx.cs" Inherits="PG.Web.Production.ASM_RejectPlateBreakEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function bindBatchList(gridViewID) {
            ...
            var DEPT_ID = $('#' + ddlDEPT_ID).val();
           // var proddate = $('#' + txtProductionDate).val();+ "&proddate=" + proddate
            ...
            $(gridSelector).find('input[id$="txtBatchNo"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        var elemRowCur = $(elem).closest('tr.gridRow');
                        var DEPT_ID = $('#' + ddlDEPT_ID).val();
                        var proddate = $(elemRowCur).find('input[id$="txtProductionDate"]').val(); // $('#' + txtProductionDate).val();
                        var serviceURL = ProductionDateWiseBatch_List + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Reject Plate Breaking Entry"></asp:Label>
            </div>
            <!--Message Div -->
            <div id="dvMsg" runat="server" class="dvMessage" style="">
                            <asp:HiddenField ID="hdnREJECT_PLATE_BREAKING_MST_ID" runat="server" />
                             <asp:HiddenField ID="hdnDeptID" runat="server" Value ="0" />
                             <asp:HiddenField ID="hdnUOM_ID" runat="server" Value="2"></asp:HiddenField>
                
                 <asp:HiddenField ID="hdnLoggedInUser" runat="server"></asp:HiddenField>
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    ...
                    <tr>--%>
                        ...
                        <td align="right" class="auto-style2">
                            <asp:Label ID="lblRejectionNo" runat="server" Text="Breaking NO :" style="font-weight: 700"></asp:Label>
                        </td>
                        <td class="auto-style2">
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="lblProductionDate" runat="server" Text="Production Date :" style="font-weight: 700; display:none;"></asp:Label>
                             ...
                             <asp:Label ID="Label2" runat="server" Text="UOM :" style="font-weight: 700;"></asp:Label>
                              
                        </td>
                        <td >
                              
                            <asp:TextBox ID="txtProductionDate" runat="server" CssClass="textBox" Style="text-align: left;display:none;" Width="100px"></asp:TextBox>
                            <asp:TextBox ID="txtREJECT_ITEM_UOM_NAME"  runat="server" CssClass="textBox" Style="text-align: left;" Width="100px" Text="Kg" ></asp:TextBox>
                        </td>
                       <%-- <td>
                    ...
                    <tr>
                         <td style="text-align: right;">
                                  <asp:Label ID="lblRejectionItem"  runat="server" Text="Rejection Type : "></asp:Label>
                              </td>
                              <td style="text-align: left;">
                                 <%--<asp:TextBox ID="txtRejectionItem" runat="server" CssClass="textBox" Style="text-align: left;" ></asp:TextBox>--%>
                                  ...
                                  <asp:DropDownList ID="ddlREJECT_ITEM_TYPE" runat="server"  CssClass="dropDownList required" Width="190px" >
                                     <%-- <asp:ListItem Selected="True" Value="Grid">Reject Grid</asp:ListItem>--%>
                                      <asp:ListItem Value="5400">Reject Plate</asp:ListItem>
                                  </asp:DropDownList>
                              </td>
                         <td style="text-align: right">
                             <asp:Label ID="Label1" runat="server" Text="Openning Qty :" style="font-weight: 700;display:none;"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtOPENNING_QTY"  runat="server" CssClass="textBox" Style="text-align: left; display:none;" Width="100px" ></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td align="right" class="auto-style2">
                        ...
                        <td class="auto-style2" colspan="4">
                            <asp:TextBox ID="txtRejectionReason" runat="server" CssClass="textBox" Style="text-align: left;" Width="410px" ></asp:TextBox>
                        </td>
            ...
            <div id="dvControls" style="width: 100%; height: 400px;">
                ...
                <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                    <div id="dvGridHeaderClosing" style="width: 1170px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                        <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                            ...
                            <%--    <td width="15px" class="headerColLeft"></td>--%>
                                 <td width="68px" class="headerColCenter_prod">UOM
                                </td>
                                 <%--  <td width="70px" class="headerColCenter_prod">Std. Pc Wt. (Kg)
                                </td>
                               <td width="80px" class="headerColCenter_prod">Production Qty
                                </td>
                                <td width="80px" class="headerColCenter_prod">Reject Qty
                                </td> 
                               <td width="76px" class="headerColCenter_prod">Good Qty
                                </td>--%>
                    ...
                    <div id="dvGridClosing" style="width: 1170px; height: 200px; overflow: auto;" class="dvGrid">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="SL#">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSLNO" runat="server" Text= <%# Container.DisplayIndex+1 %> Style="text-align: center;"
                                                    Width="60px">
                                                </asp:Label>
                                                    ...
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:HiddenField ID="hdnREJECT_PLATE_BREAKING_DTL_ID" runat="server" Value='<%# Bind("REJECT_PLATE_BREAKING_DTL_ID") %>' />
                                                                </td>
                                                                    <%--   <td style="white-space:nowrap; display:none;" >
                                                                     <asp:TextBox ID="txtREJECTION_DATE" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="115px"   Text='<%# Bind("REJECTION_DATE" ,"{0:dd-MMM-yyyy}") %>'></asp:TextBox>
                                                                </td>
                                                         <td>
                                                                    <asp:TextBox ID="txtBatchNo" runat="server" CssClass="textBox textAutoSelect" Width="100px" align="right" Text='<%# Bind("BATCH_NO") %>'></asp:TextBox>
                                                                ...
                                                                <td>
                                                                    <input id="btnITEM_NAME" type="button" value="" runat="server" style="display:none;" class="buttonDropdown" tabindex="-1" />
                                                                </td>
                                                                  <td>
                                                              ...
                                                              <td>
                                                                    <asp:TextBox ID="txtPRODUCTION_QTY" runat="server" CssClass="textBox textAutoSelect " style="text-align: right;"   Width="80px" align="right" Text='<%# Bind("PRODUCTION_QTY") %>'   onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                </td> 

                                                                 <td>
                                                                    <asp:TextBox ID="txtRejection_QTY" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect txtQty" BackColor="Khaki"   Width="78px" align="right" Text='<%# Bind("REJECTION_QTY") %>' onchange="calcWeight(this)" onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>

                                                                
                                                               <td>
                                                                    <asp:TextBox ID="txtGOOD_QTY" runat="server" CssClass="textBox textAutoSelect " style="text-align: right;"  Width="75px" align="right" Text='<%# Bind("GOOD_QTY") %>'  onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>--%>
                                                                <td>
                                                                    <asp:TextBox ID="txtQTY" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect txtWt"   Width="75px" align="right" Text='<%# Eval("QTY", "{0:#,##0.00}") %>'    onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtREMARKS_DTL" runat="server" CssClass="textBox textAutoSelect" Width="150px" Text='<%# Bind("REMARKS_DTL") %>' Style=""></asp:TextBox>
                                                                </td>
                                            ...
                                            <table style="width: auto; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 70px" align="left">
                                                        <asp:Button ID="btnNewRow2" runat="server" CssClass="buttonNewRow" style="display:none;" Text="" OnClientClick="ShowProgress()" OnClick="btnNewRow2_Click" />
                                                    </td>
                                                    <td style="width: 20px;">
