<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionConnectingBarEntry.aspx.cs" Inherits="PG.Web.Production.ProductionConnectingBarEntry" %>
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1" + "&deptid=" + DeptID + "&stlmid=" + stlmid + "&groupid=5";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnStoragelocationID" runat="server" Value="26" />
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Connection Bar Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
                ...
                <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%" id="tblProductionMstEntry">
                    ...
                    <tr>
                       ...
                       <td style="text-align: right" class="auto-style1">
                        ...
                        <td>
                             <asp:TextBox ID="TextBox1" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="Connection Bar" Width="200px" ReadOnly="true"></asp:TextBox>
                        </td>
 ...
 <div id="tabs-1">
            ...
            <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                 <div id="dvGridHeader2" style="float: left; width: 1000px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                ...
                <div id="groupDataDetails" style="width: 90%; height: auto;">
                    ...
                    <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGrid" style="width: 1000px; height: 200px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="57px" align="right" Style="text-align: right;" Text='<%# Bind("ITEM_QTY") %>' onblur="TestOnTextChange(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox> <%--onblur="TestOnTextChange(this)"--%>
                                                                    </td>
 ...
 <div id="tabs-2">
           ...
           <div id="groupBoxContainer1 boxShadow" style="height: auto; ">
                <div id="groupDataDetails1" style="width: 90%; height: auto;">
                    <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left; width: 90%">
                        <div id="dvGridHeaderClosing" style="float:left; width: 1150px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                        ...
                        <div id="dvGridClosing" style=" float:left; width: 1150px; height: 200px; overflow: auto;" class="dvGrid">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="grdClosingRowMaterial" runat="server" width="1000px" AutoGenerateColumns="False" ShowHeader="False"
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtISSUE_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="72"  align="right" style="text-align:right;"  Text='<%# Eval("ISSUE_STOCK", "{0:#,##0.000}") %>' onchange="calcCloseingStock(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <td>
     ...
     <div id="tabs-3">
           ...
           <div id="groupBoxDross" style="height: auto; ">
                <div id="groupDataDrossDetails" style="width: 90%; height: auto;">
                    <div id="Div4" runat="server" class="" style="width: auto; height: auto; text-align: left; width: 100%">
                         <div id="dvGridHeaderDross" style="float:left; width: 900px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style=" height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                class="defFont" cellspacing="1" cellpadding="1">
                                <tr class="headerRow_Prod">
                                    <td width="40px" class="headerColCenter_prod">SL#
                        ...
                        <div id="dvGridDross" style=" float:left; width: 900px; height: 200px; overflow: auto;" class="dvGrid">
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="grdDross" runat="server" width="900px" AutoGenerateColumns="False" ShowHeader="False"
                                        CellPadding="1" CellSpacing="1" ForeColor="#333333" GridLines="Both" DataKeyNames="ITEM_ID"
                                                    ...
                                                    <div>
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <asp:HiddenField ID="hdnDROSS_MST_ID" runat="server" Value='<%# Bind("DROSS_AN_MST_ID") %>' />
                                                                         <asp:HiddenField ID="hdnDrossDtlId" runat="server" Value='<%# Bind("PUR_DROSS_DTL_ID") %>' />
                                                                    </td>
                                                                    <td>
                                                                        <asp:HiddenField ID="hdnPROD_MST_ID" runat="server" Value='<%# Bind("PROD_MST_ID") %>' />
                                                                       <%-- <asp:HiddenField ID="hdnISMANUAL" runat="server" Value='<%# Bind("ISMANUAL") %>' />--%>
