<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionFormationListSPL.aspx.cs" Inherits="PG.Web.Production.ProductionFormationListSPL" ViewStateMode="Disabled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/ProductionFormationFormEntry.aspx?id=" + key;

            if (userid == "F") {
                url = IForm.RootPath + "Production/ProductionFormationFormEntry.aspx?id=" + key;
            }
            if (userid == "U") {
                url = IForm.RootPath + "Production/ProductionFormationUnFormEntry.aspx?id=" + key;
            }
            if (userid == "R") {
                url = IForm.RootPath + "Production/ProductionFormationReFormEntry.aspx?id=" + key;
            }
            if (userid == "UN") {
                url = IForm.RootPath + "Production/ProductionReFormFromUnformEntry.aspx?id=" + key;
            }
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Formation Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "Formation Entry";
                tdata.type = 0;
                tdata.url = url;
     ...
     <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="DFS Production List"></asp:Label>
                </div>
                <!--Message Div -->
         ...
         <div id="dvContentMain" class="dvContentMain">
             ...
             <asp:HiddenField ID="hdnFormationStatus" runat="server" Value ="" />
                <div id="dvControlsHead" style="height: auto; width: 100%;">
                     <table style="width : 900px">
                        ...
                        <td>
                            <asp:TextBox ID="txtToDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px" ></asp:TextBox></td>
                                  <td align="right">
                                        <asp:Label ID="lblAutho" runat="server" Text="Auth. Status :"></asp:Label>
                                  </td>
                                  <td>
                    ...
                    <tr>
                        <td align="right">
                            ...
                            <asp:DropDownList ID="ddlDEPT_ID" runat="server" CssClass="dropDownList required" Width="200px" ViewStateMode="Enabled" Enabled="False"></asp:DropDownList>

                            </td>
                        
                          <td align="right">
                              <asp:Label ID="lblFormationStatus" runat="server" Text="Form Status :"></asp:Label>
                           </td>
                            <td>
                             <asp:DropDownList ID="ddlFormationStatus" runat="server"  CssClass="dropDownList enableIsDirty">
                              <asp:ListItem Selected="True" Value="">-All-</asp:ListItem>
                              <asp:ListItem Value="F">Formed</asp:ListItem>
                              <asp:ListItem Value="U">Un-Formed</asp:ListItem>
                              <asp:ListItem Value="R">Re-Formed</asp:ListItem>
                              <asp:ListItem Value="UN">Re-Formed (From Unform)</asp:ListItem>
                              </asp:DropDownList>
                             </td>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1000px">
                    <dx:aspxgridview ID="grdCastingList" runat="server" AutoGenerateColumns="False" Width="98%"  ClientInstanceName="grdPastingList" >
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Production NO" Name="lblPROD_NO" VisibleIndex="2"  Width="70px" FieldName="PROD_NO">
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Shift Incharge" Visible="true" Name="lblSUPERVISOR_NAME" VisibleIndex="7" Width="100px" FieldName="FULL_NAME">
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataDateColumn Caption="Pro. Date" FieldName="PRODUCTION_DATE" Width="50px"   Name="lblPRODUCTION_DATE" VisibleIndex="3">
                                      ...
                                      <dx:GridViewDataTextColumn Caption="Batch" FieldName="PROD_BATCH_NO" Width="30px" Name="txtPROD_BATCH_NO" VisibleIndex="8" Visible="false">
                                      </dx:GridViewDataTextColumn>
                                     <dx:GridViewDataTextColumn Caption="Form Status" FieldName="FORMATION_STATUS" Width="50px" Name="txtFormationStatus" VisibleIndex="8" Visible="true">
                                      </dx:GridViewDataTextColumn>
                                     <dx:GridViewDataTextColumn Caption="Status" FieldName="AUTH_STATUS" Width="50px" Name="txtAUTH_STATUS" VisibleIndex="8">
                                      </dx:GridViewDataTextColumn>
                                </Columns>
