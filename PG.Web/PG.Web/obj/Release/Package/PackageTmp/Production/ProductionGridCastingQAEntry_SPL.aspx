<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionGridCastingQAEntry_SPL.aspx.cs" Inherits="PG.Web.Production.ProductionGridCastingQAEntry_SPL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnPROD_QA_ID" runat="server" />
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Grid Casting QA Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
                ...
                <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%" id="tblProductionMstEntry">
                    <tr>
                        ...
                        <td style="text-align: left">
                         ...
                         <td style="text-align: right">
                            <asp:Label ID="lblQANo" runat="server" Text="QA. NO : "></asp:Label>
                        </td>
                        <td style="text-align: left">
                            <asp:TextBox ID="txtQANo" runat="server" CssClass="colourdisabletextBox" Enabled="false" Width="200px"></asp:TextBox>
                        </td>
                         <td style="text-align: right">
                    ...
                    <tr>
                       ...
                       <td style="text-align: right" class="auto-style1">
                            ...
                            <%--<asp:Label ID="lblEntryBy" runat="server" Text="Entry By : " Visible="false"></asp:Label>--%>
                        </td>
                        <td style="text-align: left" class="auto-style1">
                           ...
                           <%-- <asp:TextBox ID="txtEntryBy" runat="server" CssClass="textBox textAutoSelect" Width="150px"  TabIndex="1" Visible="false"  ></asp:TextBox>
                            <input id="btnEntryBy" type="button" value="" runat="server" class="buttonDropdown" style="width: 15px" tabindex="-1" visible="false" />--%>
                        </td>
                         <td style="text-align: right" class="auto-style1">
                        ...
                        <td style="text-align: left" class="auto-style1">
                         ...
                         <td style="text-align: right" class="auto-style1">
                            <asp:Label ID="lblStorageLoc" runat="server" Text="Storage Loc : "></asp:Label>
                        </td>
                        <td style="text-align: left">
                            <asp:Label ID="lblStorageLoctxt" runat="server" CssClass="textBox" Width="150px" Style="text-align: left;background-color:gray; color : white;font-size:small; font-weight: 700;"  TabIndex="6" Text="GridCast"  ></asp:Label>
 ...
 <div id="tabs-1">
            ...
            <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                 <div id="dvGridHeader2" style="float: left; width: 1200px; height: 100%; font-size: smaller;" class="subHeader_Prod">
                <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                    ...
                    <tr class="headerRow_Prod">
                        <td width="52px" class="headerColCenter">
                          <asp:CheckBox ID="chkAll" runat="server" Text="Select All" OnCheckedChanged="chkAll_CheckedChanged" AutoPostBack="true" Font-Size="8px" Checked="true" />
                        </td>
                      ...
                      <%--  <td width="116px" class="headerColCenter_prod">Operator
                         ...
                         <td width="110px" class="headerColCenter"> BOM
                                            </td>
                      ...
                      <td width="70px" class="headerColCenter">  Bar Type
                        ...
                        <td width="100px" class="headerColCenter_prod">Remarks
                         ...
                         <td width="80px" class="headerColCenter_prod">QA
                        </td>
                ...
                <div id="groupDataDetails" style="width: 90%; height: auto;">
                    ...
                    <div id="dvGridContainer2" class=" " runat="server" style="height: auto;  text-align: left; width: 100%">
                        ...
                        <div id="dvGrid" style="width: 1200px; height: 250px; overflow: auto;"  class="dvGrid">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="txtPcQty textBox textAutoSelect" Width="61px" align="right" Style="text-align: right;" Text='<%# Bind("ITEM_QTY") %>' onchange="TestOnTextChange(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtITEM_WEIGHT" runat="server" CssClass="txtWeightQty textBox textAutoSelect" Width="49px" align="left" Text='<%# Eval("ITEM_WEIGHT", "{0:#,##0.00}") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtWEIGHT_UOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="50px" Text='<%# Bind("WEIGHT_UOM_NAME") %>' Style=""></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td>
                                                                                <asp:TextBox ID="txtBOM_Name" runat="server" CssClass="textBox textAutoSelect" Width="105px" Text='<%#Bind("BOM_NAME") %>'></asp:TextBox>
                                                                 ...
                                                                 <td>
                                                                    ...
                                                                    <%--<td>
                                                                        <asp:LinkButton ID="lnkdetailcom"  CommandName="qa"  CssClass="buttonAttach"  CommandArgument='<%# Bind("PROD_ID") %>' runat="server" CausesValidation="false" ><i class="glyphicon glyphicon-plus-sign" style="padding-right:4px;color:blue;font-size:12px"></i>QA Entry</asp:LinkButton>  
                              <asp:HiddenField ID="hdnPROD_ID" runat="server" Value='<%# Bind("PROD_ID") %>' />
                                                                    </td>--%>
                        ...
                        <ItemTemplate>  
                            ...
                            <asp:LinkButton ID="lnkdetailcom"  CommandName="qa"  CssClass="buttoncommon"  CommandArgument='<%# Bind("PROD_DTL_ID") %>' runat="server" CausesValidation="false" Width="76px" Height="17" >QA Entry</asp:LinkButton>  
                              <asp:HiddenField ID="hdnPROD_DTL_ID_QA" runat="server" Value='<%# Bind("PROD_DTL_ID") %>' />
                        </ItemTemplate>  
            ...
            <div class="modal-dialog" style="max-width:900px; height: 100px; align-content:space-around;">  
                <div class="modal-content">  
                    <div class="modal-header" style="background-color:lightgreen;" >  

                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>  
                        <h4 class="modal-title">QA Entry detail page</h4>  
                    </div>  
                    <div class="modal-body" style="overflow-y: scroll; max-height: 85%; margin-top: 10px; margin-bottom: 10px;">  
                        ...
                        <asp:Label ID="lblFGItemName" runat="server" BackColor="YellowGreen" Font-Bold="true" ></asp:Label>&nbsp;&nbsp;
                         <asp:Label ID="lblProdBatchDtl" runat="server" BackColor="YellowGreen" Font-Bold="true" ></asp:Label>&nbsp;&nbsp;
                        <asp:Label ID="lblPendingQty" runat="server" Text="Pending Qty:" Font-Bold="true" ></asp:Label>
                        <asp:Label ID="lblPendingQtytxt" runat="server" BackColor="YellowGreen" Font-Bold="true" ></asp:Label>
                         <asp:Label ID="lblProdDtlID" runat="server" Visible="false" ></asp:Label>
                        <asp:HiddenField ID="hdnQATEMPEntryID" runat="server" />
                        <asp:HiddenField ID="hdnQAFinishedItemID" runat="server" />
                        ...
                        <table > 
                            ...
                            <tr>
                                 ...
                                 <td align="right">
                                    <asp:Label ID="lblItemProdQty" runat="server" Text="Production Qty :" Font-Bold="true"  ></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtProdQty" runat="server" CssClass="textBox" Height="30px" Width="100px" Font-Bold="true" BackColor="Yellow" Enabled="false" ></asp:TextBox>
                                    &nbsp;
                                </td>

                                 <td align="right">
                                    <asp:Label ID="lblQAPassQty" runat="server" Text="QA Pass Qty :" Font-Bold="true"  ></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtQAPassQty" runat="server" CssClass="textBox" Height="30px" Width="100px" Visible="true" ></asp:TextBox>
                                    &nbsp;
                                </td>
                             <td align="right">
                                    <asp:Label ID="lblRejectQty" runat="server" Text="Reject Qty :" Font-Bold="true"  ></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtRejectQty" runat="server" CssClass="textBox"  Height="30px" Width="100px"  Enabled="true"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtWeight" runat="server" CssClass="textBox"  Height="30px" Width="100px"  Enabled="true"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqUserName" ControlToValidate="txtWeight" ValidationGroup="ForgotwordFrame" runat="server" ErrorMessage="Enter Weight 1!"></asp:RequiredFieldValidator>  
                                    &nbsp;
                                </td>

                                 <td align="right">
                                    <asp:Label ID="lblWeight2" runat="server" Text="Weight 2 :" Font-Bold="true"  ></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtWeight2" runat="server" CssClass="textBox"  Height="30px" Width="100px"  Enabled="true"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtWeight2" ValidationGroup="ForgotwordFrame" runat="server" ErrorMessage="Enter Weight 2!"></asp:RequiredFieldValidator>  
                                    &nbsp;
                                </td>
                                   <td align="right">
                                    <asp:Label ID="lblthikness" runat="server" Text="Thikness :" Font-Bold="true"  ></asp:Label>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtThikness" runat="server" CssClass="textBox"  Height="30px" Width="100px"  Enabled="true"></asp:TextBox>
                                    &nbsp;
                                </td>
                            ...
                            <tr style="height:10px;">
                               ...
                               <tr>
                                    <td align="right">
                                    <asp:Label ID="lblFrameCrack" runat="server" Text="Frame Crack :" Font-Bold="true"  ></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlFrameCrack" runat="server" CssClass="dropDownList" Height="28px" Width="100px">
                                 ...
                                 <td align="right">
                                    <asp:Label ID="lblCavity" runat="server" Text="Cavity :" Font-Bold="true"  ></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlCavity" runat="server" CssClass="dropDownList" Height="28px" Width="100px">
                                        <asp:ListItem  Text="Yes" Value="Yes"></asp:ListItem>
                                        <asp:ListItem Selected="True" Text="No" Value="No"></asp:ListItem>
                                    </asp:DropDownList>
                                    &nbsp;
                                    ...
                                    <td align="right">
                                    <asp:Label ID="lblWindowMissing" runat="server" Text="Window Missing :" Font-Bold="true"  ></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlWindowMissing" runat="server" CssClass="dropDownList" Height="28px" Width="100px">
                                        <asp:ListItem  Text="Yes" Value="Yes"></asp:ListItem>
                                        <asp:ListItem Selected="True" Text="No" Value="No"></asp:ListItem>
                                    </asp:DropDownList>
                                     &nbsp;
                            ...
                            <tr style="height:10px;">
                              ...
                              <tr style="height:10px;">
                                   <td align="right">
                                    <asp:Label ID="lblFeather" runat="server" Text="Feather :" Font-Bold="true"  ></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlFeather" runat="server" CssClass="dropDownList" Height="30px" Width="100px">
                                        <asp:ListItem  Text="Yes" Value="Yes"></asp:ListItem>
                                        <asp:ListItem Selected="True" Text="No" Value="No"></asp:ListItem>
                                    </asp:DropDownList>
                                ...
                                <td colspan="5">
                                     <asp:TextBox ID="txtQARemarks" runat="server" CssClass="textBox"  Height="30px" Width="300px" TextMode="MultiLine"  Enabled="true"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtQARemarks" ValidationGroup="ForgotwordFrame" runat="server" ErrorMessage="Enter Remarks!"></asp:RequiredFieldValidator> 
                                </td>
                            </tr>
                    ...
                    <div class="modal-footer"> 
                        <table>
                            <tr>
                        <td>
                        <asp:Button ID="btnQASave" runat="server" Text="Add" CssClass="buttonSave" OnClick="btnQASave_Click" Visible="true"  ValidationGroup="ForgotwordFrame"  />
                            <%--<asp:Button ID="btnQAClose" runat="server" Text="Close" CssClass="buttonClose" OnClick="btnQAClose_Click" Visible="true"   />--%>
                       <%-- class="btn btn-default"--%>
                            <%-- <button id="btnSave" type="button"  Class="buttonSave" OnClick="btnSave_Click" >Save</button>data-dismiss  --%>
           ...
           <div id="groupBoxContainer1 boxShadow" style="height: auto; ">
                <div id="groupDataDetails1" style="width: 100%; height: auto;">
                    <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGridClosing" style=" float:left; width: 1200px; height: 150px; overflow: auto;" class="dvGrid">
                    ...
                    <div id="groupBoxContainer2 boxShadow" style="height: auto; width: 100%;">
                            <div id="groupDataDetails2" style="float: left;width: 90%; height: auto;">
                                ...
                                <div id="Div7" runat="server" class="" style=" float:left; width: auto; height: auto; text-align: left; width: 100%">
                                    ...
                                    <div id="dvGridClosingSummary" style="width: auto; height: 80px; overflow: auto;" class="dvGrid">
        ...
        <div id="dvContentFooter" class="dvContentFooter">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnAuthorize" runat="server" Text="Transfer to Casting" Width="120px" CssClass="buttoncommon" OnClientClick="if ( ! UserAuthorizeConfirmation()) return false;" OnClick="btnAuthorize_Click" Visible="false" />
                         <asp:Button ID="btnQCTransfer" runat="server" Text="Transfer to Dept." CssClass="buttoncommon" OnClick="btnQCTransfer_Click" Visible="false" />
                    </td>
                    <td>
