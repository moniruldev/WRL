<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionDFSList.aspx.cs" Inherits="PG.Web.Production.ProductionDFSList" ViewStateMode="Disabled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/ProductionDFSEntryWithBOM_SPL.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "DFS Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "DFS Entry";
                tdata.type = 0;
                tdata.url = url;
