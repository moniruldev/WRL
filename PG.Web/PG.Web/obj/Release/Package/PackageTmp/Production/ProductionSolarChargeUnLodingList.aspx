<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" ViewStateMode="Disabled" CodeBehind="ProductionSolarChargeUnLodingList.aspx.cs" Inherits="PG.Web.Production.ProductionSolarChargeUnLodingList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, type) {
            ...
            url = IForm.RootPath + "Production/ProductionSolarBatteryEntryUnloading.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Production : Charging Unloading Entry ";
                tdata.label = "Production : Charging Unloading Entry ";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production Solar Charging UnLoading List"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table style="width: 800px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnAddNew" runat="server" CssClass="buttonNew" Text="New UnLoading" Height="26px" />
                        </td>
                        <td></td>
