<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ASM_RejPlateToStore_List.aspx.cs" ViewStateMode="Disabled"  Inherits="PG.Web.Production.ASM_RejPlateToStore_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/ASM_RejPlateToStore.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Reject Plate Declaration(Transfer To Store)";
                //tdata.label = "User: " + userid;
                tdata.label = "Reject Plate Declaration(Transfer To Store)";
                tdata.type = 0;
                tdata.url = url;
