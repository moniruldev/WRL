<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionAssamblyEntry.aspx.cs" Inherits="PG.Web.Production.ProductionAssamblyEntry" %>
                    ...
                    <tr >
                        ...
                        <td style="border-right: solid 2px #C0C0C0;">
                                <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left; float : left; padding-right : 5px; border: solid 1px #2e4be5;">
                                                    ...
                                                    <div id="dvGridHeader2" style=" width:550px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                                        <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                                            ...
                                                            <tr class="headerRow_Prod">
                                                                ...
                                                                <td width="80px" class="headerColCenter_prod"> Line NO</td>
                                                    ...
                                                    <div id="dvGrid" style="width: 575px; height: 150px; overflow: auto;" class="dvGrid">
                                                                                    ...
                                                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="127px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                                ...
                                                                                                <td>
                                                                                                    <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="138px" Text='<%# Bind("REMARKS") %>' Style=""></asp:TextBox>
                                                                                                </td>
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="123px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td>
                                                                        <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="127px" align="right" Text='<%# Bind("SYSTEM_OPENING_STOCK") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                     <td>
