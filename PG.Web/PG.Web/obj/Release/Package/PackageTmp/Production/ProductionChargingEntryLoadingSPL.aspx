<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionChargingEntryLoadingSPL.aspx.cs" Inherits="PG.Web.Production.ProductionChargingEntryLoadingSPL" %>
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                       ...
                       <%--  var e = document.getElementById("<%=ddlDEPT_ID.ClientID%>");
                        ...
                        var newServiceURL = serviceURL + "&deptid=54" + "&is_solar_Loading=Y" + "&specId=" + specId + "&groupid=60";  //
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&isFinished=N&deptid=54&for_production=Y&groupid=60";
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Charging Battery Loading Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
                        ...
                        <div id="dvGridHeader2" style="float: left; width: 800px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="230px" class="headerColCenter_prod">Item
                                    </td>
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="55px" align="right" Text='<%# Bind("ITEM_QTY") %>' onChange="CalculateTotalQty(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:HiddenField ID="hdnSpecificationType" runat="server" Value='<%# Bind("ITEM_SPECIFICATION_ID") %>' />
                                                                        <asp:DropDownList ID="ddlSpecificationType" runat="server" CssClass="dropDownList" Width="135px" AutoPostBack="true" OnSelectedIndexChanged="ddlSpecificationType_SelectedIndexChanged" Visible="false" >
                                                                        </asp:DropDownList>
                                                                    </td>
                            ...
                            <table style="width: 89%; height: 70%; text-align: center;" cellspacing="1" cellpadding="1"
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                      ...
                                      <td align="left">
                                       <asp:Label ID="txtTotQty" runat="server" CssClass="textBox" Style="text-align: right;" Width="100" TabIndex="-1" Font-Bold="True" Enabled="true"></asp:Label>
                                     </td>
                                    <td align="right">&nbsp;</td>
