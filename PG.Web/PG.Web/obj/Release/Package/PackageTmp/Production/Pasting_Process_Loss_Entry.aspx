<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Pasting_Process_Loss_Entry.aspx.cs" Inherits="PG.Web.Production.Pasting_Process_Loss_Entry" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function bindItemList(gridViewID) {
            var cgColumns = [
                             ...
                             , { 'columnName': 'closing_qty', 'width': '150', 'align': 'left', 'highlight': 4, 'label': 'Closing Qty' }
            ...
            serviceURL += "&ispaging=1&isdeptstock=Y&isFinished=N&isMixture=Y&deptid=" + DEPT_ID;
        ...
        function ClearItemData(txtItemID) {
            ...
            $(detRow).find('input[id$="txtCLOSING_QTY"]').val('0');
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            $(detRow).find('input[id$="txtCLOSING_QTY"]').val(data.closing_qty);
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Pasting Process Loss Entry"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
                ...
                <table>
                    <tr>
                        ...
                        <td align="right" class="auto-style2">
                            <asp:Label ID="lblWASTAGENo" runat="server" Text="LOSS NO :" style="font-weight: 700"></asp:Label>
                        </td>
                        <td class="auto-style2">
                            <asp:TextBox ID="txtLOSS_NO" runat="server" Style="text-align: left; font-weight: 700;" CssClass="textBox" ForeColor="Red"  Enabled="False"></asp:TextBox>
                        </td>
                        <td align="right">
                              <asp:Label ID="lblWASTAGE_DATE" runat="server" Text="Date :" style="font-weight: 700"></asp:Label>
                        </td>
                        <td>
                              <asp:TextBox ID="txtLOSS_DATE" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                              ...
                              <td style="text-align: left">
                                  ...
                                  <asp:DropDownList ID="ddlDEPT_ID" runat="server" CssClass="dropDownList required enableIsDirty" Width="190px" ></asp:DropDownList>
                              </td>
            ...
            <div id="dvControls" style="width: 100%; height: 400px;">
                ...
                <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                    <div id="dvGridHeaderClosing" style="width: 780px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                        <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                            ...
                            <tr class="headerRow_Prod">
                                <td width="60px" class="headerColCenter_prod">SL#
                                </td>
                                                    ...
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:HiddenField ID="hdnLOSS_DTL_ID" runat="server" Value='<%# Bind("WASTAGE_DTL_ID") %>' />
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtCLOSING_QTY" runat="server" CssClass="textBox textAutoSelect " style="text-align: right;"   Width="75px" align="right" Text='<%# Bind("CLOSING_QTY") %>'   onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>
