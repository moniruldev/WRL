<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionAssemblyFGList.aspx.cs" ViewStateMode="Disabled" Inherits="PG.Web.Production.ProductionAssemblyFGList" %>
        ...
        function tbopen(key, userid) {
          ...
          <%--  var IS_PACKING = document.getElementById("<%=chkIS_PACKING.ClientID%>");
            ...
            if (IS_PACKING.checked)
                ...
                url = IForm.RootPath + "Production/ProductionAssemblyFGEntry.aspx?id=" + key;
