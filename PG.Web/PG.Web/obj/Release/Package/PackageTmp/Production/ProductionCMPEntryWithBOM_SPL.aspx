<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionCMPEntryWithBOM_SPL.aspx.cs" Inherits="PG.Web.Production.ProductionCMPEntryWithBOM_SPL" %>
...
<%--        var gridDrossUpdatePanelIDDet = '<%=UpdatePanel4.ClientID%>';
            ...
            $(gridSelector).find('input[id$="txtCLOSINGITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        var newServiceURL = serviceURL + "&deptid=" + DeptID + "&stlmid=" + stlmid; //+ "&stlmid=" + stlmid+ "&groupid=7"
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
                        newServiceURL = JSUtility.AddTimeToQueryString(newServiceURL);
                        $(this).combogrid("option", "url", newServiceURL);
                    },
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&isFinished=N&for_production=Y" + "&deptid=" + DeptID + "&stlmid=" + stlmid;// + "&groupid=7"; //+ "&stlmid=" + stlmid
        ...
        function ClearClosingItemData(txtCLOSINGITEM_NAME) {
            ...
            $(detRow).find('input[id$="hdnClosingItemGroupId"]').val('0');
        ...
        function SetClosingItemData(txtCLOSINGITEM_NAME, data) {
            ...
            $(detRow).find('input[id$="hdnClosingItemGroupId"]').val(data.itemgroupid);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnStoragelocationID" runat="server" Value="13" />
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production CMP Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
               ...
               <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%;font-size:12px;margin:5px;" id="tblProductionMstEntry">
                    ...
                    <tr>
                       ...
                       <td style="text-align: right" class="auto-style1">
                        ...
                        <td>
                             <asp:TextBox ID="txtStorageLocation" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="CMP" Width="200px" ReadOnly="true"></asp:TextBox>
                        </td>
 ...
 <div id="tabs-1">
            ...
            <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                 <div id="dvGridHeader2" style="float: left; width: 1250px; height: 30px; font-size: smaller;" class="subHeader_Prod">
                <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                    ...
                    <tr class="headerRow_Prod">
                        ...
                        <td width="260px" class="headerColCenter_prod">FG Item
                        </td>
                ...
                <div id="groupDataDetails" style="width: 100%; height: auto;">
                    ...
                    <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGrid" style="width: 1250px; height: 200px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="260px" Text='<%# Bind("ITEM_NAME") %>' Style="font-size:10px; font-weight:bold;color:black;"></asp:TextBox>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="txtPcQty textBox textAutoSelect" Width="60px" align="right" Style="text-align: right;" Text='<%# Bind("ITEM_QTY") %>' onblur="TestOnTextChange(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                        ...
                        <div id="dvGridHeaderClosing" style="float:left; width: 1200px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style=" height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="85px" class="headerColCenter_prod">Op Stock
                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:HiddenField ID="hdnCLOSING_ITEM_ID" runat="server" Value='<%# Bind("CLOSING_ITEM_ID") %>' />
                                                                          <asp:HiddenField ID="hdnClosingItemGroupId" runat="server" Value='<%# Bind("CLOSING_ITEM_GROUP_ID") %>' />
                                                                    </td>
                                                                    <td>
                                                                   ...
                                                                   <td> 
                                                                    <asp:LinkButton ID="lnkBatchDtl"  CommandName="itemdtl"  CssClass="buttoncommon"  CommandArgument='<%# Bind("CLOSING_ITEM_ID") %>' runat="server" CausesValidation="false" Width="52px" Height="17" Visible="true" >Batch</asp:LinkButton>  
                                                                       <asp:HiddenField ID="hdnIsBatch" runat="server" Value='<%# Bind("IS_BATCH") %>' />
                                                                  </td>
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" CssClass="textBox textAutoSelect"  Width="85px" style="text-align:right;" Text='<%# Eval("SYSTEM_OPENING_STOCK", "{0:#,##0.00}") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
