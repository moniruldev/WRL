<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Solar_Battery_ConversionList.aspx.cs" Inherits="PG.Web.Production.Solar_Battery_ConversionList" ViewStateMode="Disabled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/Solar_Battery_Conversion.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Battery Conversion ";
                //tdata.label = "User: " + userid;
                tdata.label = "Battery Conversion";
                tdata.type = 0;
                tdata.url = url;
     ...
     <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Battery Conversion List"></asp:Label>
                </div>
                <!--Message Div -->
                ...
                <div id="dvControlsHead" style="height: auto; width: 100%;">
                    ...
                    <tr>
                        <td align="right">
                            ...
                            <td colspan="4">
                                <%--<asp:Button ID="btnUpload" CssClass="buttonSearch" runat="server" OnClick="btnUpload_Click" Text="Show Data" /> Enabled="False"--%>
                                  <asp:HiddenField ID="hdnCompanyID" runat="server" Value ="0" />
                            <asp:DropDownList ID="ddlDEPT_ID" runat="server" CssClass="dropDownList required" Width="250px"   ViewStateMode="Enabled" ></asp:DropDownList>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1000px">
                    <dx:aspxgridview ID="grdCastingList" runat="server" AutoGenerateColumns="False" Width="98%"  ClientInstanceName="grdPastingList" >
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Convert NO" Name="lblPROD_NO" VisibleIndex="2"  Width="70px" FieldName="CONVERT_NO">
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Supervisor" Name="lblSUPERVISOR_NAME" VisibleIndex="7" Width="100px" FieldName="FULL_NAME">
                                    </dx:GridViewDataTextColumn>--%>
                                   
                                    <dx:GridViewDataTextColumn Caption="CONVERT_ID" FieldName="CONVERT_ID" Name="hdnPROD_ID" Visible="false" VisibleIndex="1">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn Caption="Convert Date" FieldName="CONVERT_DATE" Width="50px"   Name="lblPRODUCTION_DATE" VisibleIndex="3">
                                         <PropertiesDateEdit DisplayFormatString="dd-MMM-yyyy" ></PropertiesDateEdit>
                                    </dx:GridViewDataDateColumn>
                                   
                                   <%--   <dx:GridViewDataTextColumn Caption="Batch" FieldName="PROD_BATCH_NO" Width="30px" Name="txtPROD_BATCH_NO" VisibleIndex="8">
                                      </dx:GridViewDataTextColumn>--%>
