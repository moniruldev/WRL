<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionRejectionListForApprovalDeptH.aspx.cs" ViewStateMode="Disabled"  Inherits="PG.Web.Production.ProductionRejectionListForApprovalDeptH" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/ProductionRejectionApprovalDeptH.aspx?id=" + key +"&rejectiontype=" + userid;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "FG Reject Declaration";
                //tdata.label = "User: " + userid;
                tdata.label = "FG Reject Declaration";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="FG Reject Declaration List"></asp:Label>
                </div>
                <!--Message Div -->
                ...
                <div id="dvControlsHead" style="height: auto; width: 100%;">
                     <table style="width : 650px">
                        ...
                        <td>
                          ...
                          <tr>
                             <td class="auto-style1" align="right">
                             <asp:Label ID="lblAuthorized" runat="server" Text="Is Authorized : " Width="100px" Visible="false"></asp:Label>
                        </td>
                        <td class="auto-style1">
                            <asp:DropDownList ID="ddlAuthorized" runat="server" CssClass="dropDownList required" Width="150px" ViewStateMode="Enabled" Visible="false">
                              ...
                              <td></td>
                         <td class="auto-style1" align="right">
                             <asp:Label ID="Label1" runat="server" Text="Is Approved : " Width="100px" Visible="false"></asp:Label>
                        </td>
                        <td class="auto-style1">
                            <asp:DropDownList ID="ddlIsApproved" runat="server" CssClass="dropDownList required" Width="150px" ViewStateMode="Enabled" Visible="false">
                        ...
                        <div id="dvGrid" style="width: 100%; height: auto; overflow: auto;">
                            <dx:ASPxGridView ID="grdRejectionList" runat="server" AutoGenerateColumns="False" Width="98%"  ClientInstanceName="grdPastingList" >
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Rejection Reason" Name="lblRejectionReason" VisibleIndex="5" Width="100px" FieldName="REJECTION_REASON">
                                    </dx:GridViewDataTextColumn>
                                    
                                   
                                    <dx:GridViewDataTextColumn Caption="PROD_REJECTION_ID" FieldName="PROD_REJECTION_ID" Name="hdnRejection_ID" Visible="false" VisibleIndex="1">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn Caption="Rejection Date" FieldName="PROD_REJECTION_DATE" Width="100px"   Name="lblRejection_DATE" VisibleIndex="3">
                                     ...
                                     <dx:GridViewDataTextColumn Caption="Rejection Type" FieldName="REJECTION_TYPE" Width="70px" Name="txtREJECTION_TYPE" VisibleIndex="5">
                                      </dx:GridViewDataTextColumn>
