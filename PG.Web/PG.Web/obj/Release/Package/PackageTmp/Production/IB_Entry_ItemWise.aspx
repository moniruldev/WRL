<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="IB_Entry_ItemWise.aspx.cs" Inherits="PG.Web.Production.IB_Entry_ItemWise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
            ...
            pageInstance.add_pageLoaded(function (sender, args) {
                ...
                for (i = 0; i < panels.length; i++) {                    
                    ...
                    if (panels[i].id == updatePanelClosing) {                      
                        ...
                        bindFinishInRawMaterialSection(gvClosingID);
                    }
                }
            });
        ...
        function bindFinishInRawMaterialSection(gridViewID) {
            ...
            var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            serviceURL += "&ispaging=1&isFinished=Y&deptid=18&for_production=Y";
        ...
        function CuttingItemQtyChange(texbx) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div id="tabs" style="height: 95%; background : url(../image/bg_greendot.gif) !important;">
  <ul>
    <li><a href="#tabs-1">Cutting Details</a></li>
     <li><a href="#tabs-2">Filling Details</a></li>
     <li><a href="#tabs-3">Sulphation Details</a></li>
    <li><a href="#tabs-4">Used RM Details</a></li>
     <li><a href="#tabs-5">Used RM Summary </a></li>
  </ul>
      ...
      <%-- Start Finished item Details --%>
        <div id="tabs-1">
            ...
            <div id="Div10" runat="server" class="" style="float: left; width: 100%; text-align: left; border-top: solid 1px #0b07f5;">
                <span style="font-weight: bold; font-size: 15px; color: #ff3b00;">Cutting Details: </span>
            </div>
             <div id="Div9" runat="server" class="" style="width: auto; height: 200px; text-align: left">
            ...
            <div id="groupBoxContainer boxShadow2" style="height: auto; width: 100%;">
                <div id="groupDataDetails2" style="width: 100%; height: auto;">
                    ...
                    <div id="Div11" class=" " runat="server" style="height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGrid2" style="width: 1100px; height: 250px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="100px" style="text-align: right;" BackColor="Khaki" align="right" Text='<%# Bind("ITEM_QTY") %>' onchange="CuttingItemQtyChange(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <td>
           ...
           <div id="tabs-2">
            ...
            <div id="Div14" runat="server" class="" style="float:left; width: auto; height: auto; text-align: left">
            <div id="dvGridHeader3" style="width: 850px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                    class="defFont" cellspacing="1" cellpadding="1">
                    <tr class="headerRow_Prod">
                        <td width="30px" class="headerColCenter_prod">SL#
                        ...
                        <td width="105px" class="headerColCenter_prod">UOM
                         ...
                         <td width="135px" class="headerColCenter"> BOM
                                            </td>
                        <td width="200px" class="headerColCenter_prod">Remarks
                        </td>
                        <td width="16px" class="headerColCenter_prod">Delete
            ...
            <div id="groupBoxContainer boxShadow1" style="height: auto; width: 100%;">
                <div id="groupDataDetails1" style="width: 90%; height: auto;">
                    ...
                    <div id="Div7" class=" " runat="server" style="height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGrid1" style="width: 1100px; height: 275px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="100px" BackColor="Khaki" align="right" Text='<%# Bind("ITEM_QTY") %>' onchange="FillingRMAdd(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <%-- <td>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtBOM_Name" runat="server" CssClass="textBox textAutoSelect" Width="132px" Text='<%#Bind("BOM_NAME") %>'></asp:TextBox>
           ...
           <div id="tabs-3">
            ...
            <div id="Div15" runat="server" class="" style="width: auto; height: auto; text-align: left">
            ...
            <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGrid" style="width: 950px; height: 275px; overflow: auto;" class="dvGrid">
...
<%-- Start Closing Details --%>
                    <div id="Div3" runat="server" class="" style="float:left;width: 100%; text-align: left;">
                        <span style="font-weight: bold; font-size: 15px; color: #ff3b00;">Closing Raw Materials Details of Filling: </span>
                    </div>

                    <div id="Div1" runat="server" class="" style="float:left;width: auto; height: auto; text-align: left; width: 100%">
                        <div id="dvGridHeaderClosing" style="width: 1200px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style="height: 85%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                class="defFont" cellspacing="1" cellpadding="1">
                                <tr class="headerRow_Prod">
                                    <td width="50px" class="headerColCenter_prod">SL#
                                    </td>
                                    <td width="100px" class="headerColCenter_prod">Finished Item
                                    </td>
                                    <td width="15px" class="headerColCenter_prod"></td>
                        ...
                        <div id="dvGridClosing" style="width: 1200px; height: 275px; overflow: auto;" class="dvGrid">
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="gvClosingID" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="SL#">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCLOSING_SI" runat="server" Text= <%# Container.DataItemIndex + 1 %>  Style="text-align: center;" Width="48px">
                                                    </asp:Label>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td>
                                                                        <asp:TextBox ID="txtFINISH_ITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="100px" Text='<%# Bind("FINISH_ITEM_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="140px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtCLOSING_UOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="47px" Text='<%# Bind("CLOSING_UOM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnCLOSING_UOM_ID" runat="server" Value='<%# Bind("CLOSING_UOM_ID") %>' />
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="122px" align="right" Text='<%# Bind("SYSTEM_OPENING_STOCK") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtCLOSING_QTY" runat="server" CssClass="textBox textAutoSelect" Width="66px" align="right" Text='<%# Bind("CLOSING_QTY") %>' onchange="calcIssueStock(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                  ...
                                                                  <td>
                                                                                        <asp:TextBox ID="txtPOSITIVE_DEV" runat="server" CssClass=" txtgQty textBox textAutoSelect"  BackColor="Yellow"   Width="59" align="right" Text='<%# Bind("POSITIVE_DEV") %>' onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtNEGATIVE_DEV" runat="server" CssClass=" txtgQty textBox textAutoSelect"  BackColor="Yellow"   Width="58" align="right" Text='<%# Bind("NEGATIVE_DEV") %>' onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtISSUE_STOCK" runat="server" CssClass="textBox textAutoSelect" BackColor="Khaki" Width="46px" align="right" Text='<%# Bind("ISSUE_STOCK") %>' onchange="calcCloseingStock(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtCLOSING_REMARKS" runat="server" CssClass="textBox textAutoSelect" Width="220px" Text='<%# Bind("CLOSING_REMARKS") %>' Style=""></asp:TextBox>
                                                                    </td>
            ...
            <div id="tabs-5">
                    ...
                    <div id="groupBoxContainer2 boxShadow" style="height: auto; width: 100%;">
                            <div id="groupDataDetails2" style="float: left;width: 90%; height: auto;">
                                <div id="Div4" runat="server" class="" style="float:left; width: 100%; text-align: left;  border-top: solid 1px #0b07f5;">
                                    <span style="font-weight: bold; font-size: 15; color: #ff3b00;">Used Raw Materials Summary of Filling: </span>
                                </div>

                                <div id="Div13" runat="server" class="" style=" float:left; width: auto; height: auto; text-align: left; width: 100%">
                                    <div id="dvGridHeaderClosingSummary" style="width: 600px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                        <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                            class="defFont" cellspacing="1" cellpadding="1">
                                            <tr class="headerRow_Prod">
                                                <td width="50px" class="headerColCenter_prod">SL#
                                                ...
                                                <td width="350px" class="headerColCenter_prod">RM Item
                                                </td>
                                    ...
                                    <div id="dvGridClosingSummary" style="width: auto; height: 275px; overflow: auto;" class="dvGrid">
                                                                    ...
                                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="348px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                                    <asp:HiddenField ID="hdnCLOSING_ITEM_ID" runat="server" Value='<%# Bind("CLOSING_ITEM_ID") %>' />
                                                                                </td>
