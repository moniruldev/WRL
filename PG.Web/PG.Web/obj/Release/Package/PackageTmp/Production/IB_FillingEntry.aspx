<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="IB_FillingEntry.aspx.cs" Inherits="PG.Web.Production.IB_FillingEntry" %>
         ...
         <asp:HiddenField ID="hdnCompanyID" runat="server" Value="0" />
          <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="IB Filling Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px" ></asp:Label>
            </div>
           ...
           <div id="dvContentMain" class="dvContentMain" align="left">
                 <div id="dvControlsHead" style="height: auto; width: 100%;" align="left">
                      <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 70%" id="tblProductionMstEntry">
                          ...
                          <tr>
                              ...
                              <td><asp:TextBox ID="txtBATCH_STARTTIME" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="75px" TabIndex="3" MaxLength="11"></asp:TextBox>
                              ...
                              <td><asp:TextBox ID="txtBATCH_ENDTIME" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px" TabIndex="5" MaxLength="11"></asp:TextBox>
               ...
               <div id="dvGridSeparator" runat="server" style="height : 10px; float: left;width: 100%;">
                ...
                <div id="dvGridHeader2" style="float:left; width: 700px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                    <table style="height: 80%; color: #FFFFFF;  font-weight: bold; text-align: left;"
                                        ...
                                        <td width="80px" class="headerColCenter_prod"> Machine Name
                                          ...
                                          <%--  <td width="49px" class="headerColCenter_prod">Item Weight
                                            ...
                                            </td> <td width="70px" class="headerColCenter">  Bar Type
                                            </td>
                                                                ...
                                                                <table border="0" cellpadding="1" cellspacing="1">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="100px" BackColor="Khaki"  align="right" Text='<%# Bind("ITEM_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                   ...
                                                                                   <%-- <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtCLOSING_REMARKS" runat="server" CssClass="textBox textAutoSelect" Width="104px" Text='<%# Bind("CLOSING_REMARKS") %>' Style=""></asp:TextBox>
                                                                                    </td>
