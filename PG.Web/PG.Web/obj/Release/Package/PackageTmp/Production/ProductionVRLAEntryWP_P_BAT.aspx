<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionVRLAEntryWP_P_BAT.aspx.cs" Inherits="PG.Web.Production.ProductionVRLAEntryWP_P_BAT" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function TestOnTextChangegqty(texbx) {
            ...
            var rejqty = $(detRow).find('input[id$="REJECTED_QTY"]').val();

            var recovqty = $(detRow).find('input[id$="txtRecovery_QTY"]').val();
            var usedqty = $(detRow).find('input[id$="txtISSUE_STOCK"]').val();
            totalusedqty = Number(rejqty) + Number(recovqty) + Number(usedqty);
            //alert(totalusedqty);
            $(detRow).find('input[id$="txtTotalQty"]').val(totalusedqty);
        ...
        function bindItemList(gridViewID) {
         ...
         function bindClosingItemList(gridViewIDD) {
             ...
             serviceURL += "&ispaging=1&isFinished=N&deptid=140";
             ...
             $(gridSelector).find('input[id$="txtCLOSINGITEM_NAME"]').each(function (index, elem) {
                 ...
                 $(elem).combogrid({
                     ...
                     search: function (event, ui) {
                         ...
                         var deptid = e.options[e.selectedIndex].value;
                        <%-- //var vgroupid =--%>
                         var newServiceURL = serviceURL + "&isprm=" + 'Y';//+ "&deptid=" + deptid + "&groupid=" + vgroupid
                         //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
                         newServiceURL = JSUtility.AddTimeToQueryString(newServiceURL);
                         $(this).combogrid("option", "url", newServiceURL);
                     },
         ...
         function ClearClosingItemData(txtCLOSINGITEM_NAME) {
             ...
             $(detRow).find('input[id$="txtOPRejectQty"]').val('');
             $(detRow).find('input[id$="txtOPRecoveryQty"]').val('');
         }
         function SetClosingItemData(txtCLOSINGITEM_NAME, data) {
             ...
             $(detRow).find('input[id$="txtOPRejectQty"]').val(data.rej_cls_qty);
             $(detRow).find('input[id$="txtOPRecoveryQty"]').val(data.rec_cls_qty);
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production VRLA (P Battery) Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
                ...
                <div id="groupDataDetails" style="width: 100%; height: auto;">
                        ...
                        <tr>
                            ...
                            <td style="border-right: solid 2px #C0C0C0;">
                                <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left; float: left; padding-right: 5px; border: solid 1px #2e4be5;">
                                    ...
                                    <div id="dvGridHeader2" style="width: 1150px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                        <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                            ...
                                            <tr class="headerRow_Prod">
                                                ...
                                                <td width="15px" class="headerColCenter_prod"></td>
                                                <td width="120px" class="headerColCenter_prod">Bat Type
                                                </td>
                                    ...
                                    <div id="dvGrid" style="width: 1150px; height: 150px; overflow: auto;" class="dvGrid">
                    ...
                    <div id="Div2" runat="server" style="width: 100%;">
                        ...
                        <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                            ...
                            <div id="dvGridHeaderClosing" style="width: 1165px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                    class="defFont" cellspacing="1" cellpadding="1">
                                    <tr class="headerRow_Prod">
                                        ...
                                        <td width="80px" class="headerColCenter_prod">OP Stock Good
                                        </td>
                                        <td width="80px" class="headerColCenter_prod">OP Reject Qty
                                        </td>
                                        <%--<td width="145px" class="headerColCenter">Manual Opening Stock
                                    </td>--%>

                                        <td width="80px" class="headerColCenter_prod">OP Recovery Qty
                                        </td>
                                    ...
                                    <td width="80px" class="headerColCenter_prod"> Neg Dev
                                        ...
                                        <td width="80px" class="headerColCenter_prod">Total Qty
                                        </td>
                            ...
                            <div id="dvGridClosing" style="width: 1160px; height: 150px; overflow: auto;" class="dvGrid">
                                                            ...
                                                            <table border="0" cellpadding="1" cellspacing="1">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="76px" align="right" Text='<%# Bind("SYSTEM_OPENING_STOCK") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtOPRejectQty" runat="server" CssClass="textBox textAutoSelect" Width="75px" align="right" onchange="calcIssueStock(this)" Text='<%# Bind("ASM_OP_REJECT_QTY") %>'></asp:TextBox>
                                                                        </td>
                                                                        <%-- <td>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtOPRecoveryQty" runat="server" CssClass="textBox textAutoSelect" Width="80px" align="right" Text='<%# Bind("ASM_OP_RECOVERY_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtREJECTED_QTY" runat="server" CssClass=" txtQty textBox textAutoSelect" Width="80px" align="right" Text='<%# Bind("REJECTED_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtRecovery_QTY" runat="server" CssClass=" txtQty textBox textAutoSelect" Width="76px" align="right" Text='<%# Bind("RECOVERY_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                        </td>
                                                                        <%--<td>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtISSUE_STOCK" runat="server" CssClass=" txtQty textBox textAutoSelect" Width="78px" align="right" Text='<%# Bind("ISSUE_STOCK") %>' onchange="calcCloseingStock(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                        </td>

                                                                        <td>
                                                                            <asp:TextBox ID="txtTotalQty" runat="server" CssClass="textBox textAutoSelect" Width="78px" align="right" Text='<%# Bind("TOTAL_QTY") %>' onchange="calcCloseingStock(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                        </td>
