<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionPlasticEntry_withBOM.aspx.cs" Inherits="PG.Web.Production.ProductionPlasticEntry_withBOM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:HiddenField ID="hdnFinishItemNameForRm" runat="server" />
          <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="PPL Production Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
  ...
  <ul>
    ...
    <li><a href="#tabs-2">Used RM </a></li>
       <li><a href="#tabs-3">Summary Used RM </a></li>
   <%-- <li><a href="#tabs-3">Replace and Sample Battery</a></li>--%>
                      ...
                      <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%" id="tblProductionMstEntry">
                          <tr>
                              ...
                              <td style="text-align: left">
                                  <asp:TextBox ID="txtPROD_NO" runat="server" CssClass="colourdisabletextBox" Enabled="false" Width="174px"></asp:TextBox>
                              </td>
                              <td style="text-align: right">
                              ...
                              <td style="text-align: left">
                                 ...
                                 <asp:TextBox ID="txtSHIFT_INCHARGE" runat="server" CssClass="textBox textAutoSelect" Width="150px" ></asp:TextBox>
                          ...
                          <tr>
                              ...
                              <td style="text-align: left">
                                  <asp:TextBox ID="txtREF_NO_MANUAL" runat="server" CssClass="textBox" Width="170px"></asp:TextBox>
                              </td>
                              <td style="text-align: right">
                                  <asp:Label ID="lblFORECUSTID" runat="server" Text="Forecast Month : "></asp:Label>
                              </td>
                              <td>
                              ...
                              <td style="text-align: left">
                                  <asp:TextBox ID="txtSUPERVISOR_NAME" runat="server" CssClass="textBox textAutoSelect" Width="150px" ></asp:TextBox>
                          ...
                          <tr>
                              ...
                              <td><asp:TextBox ID="txtBATCH_STARTTIME" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="82px"></asp:TextBox>
                          ...
                          <tr>
                              ...
                              <td>
                                  <asp:TextBox ID="txtPROD_BATCH_NO" runat="server" CssClass="textBox textNumberOnly" Width="170px"></asp:TextBox>
                                   <span style="color:red">*</span>
                    ...
                    <tr >
                        ...
                        <td style="border-right: solid 2px #C0C0C0;">
                                <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left; float : left; padding-right : 5px; border: solid 1px #2e4be5;">
                                                    ...
                                                    <span style="font-weight: bold;font-size : 15px; color :#ff3b00;">Plastic Items Details: </span>
                                                </div>
                                                    <div id="dvGridHeader2" style=" width:1100px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                                        <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                                            ...
                                                            <tr class="headerRow_Prod">
                                                                ...
                                                                <td width="150px" class="headerColCenter_prod"> Machine NO</td>
                                                                ...
                                                                <td width="50px" class="headerColCenter_prod">UOM
                                                                   ...
                                                                   <td width="150px" class="headerColCenter"> BOM
                                                                </td>
                                                                <td width="250px" class="headerColCenter_prod">Remarks
                                                                </td>
                                                    ...
                                                    <div id="dvGrid" style="width: 1150px; height: 350px; overflow: auto;" class="dvGrid">
                                                                                ...
                                                                                <div>
                                                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                  <td>
                                                                                                     <asp:TextBox ID="txtMACHINE_NAME" runat="server" CssClass="textBox textAutoSelect" Width="142px" Text='<%#Bind("MACHINE_NAME") %>'></asp:TextBox>
                                                                                                ...
                                                                                                <td>
                                                                                                    <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="340px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                                ...
                                                                                                <td>
                                                                                                    <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="52px" BackColor="Khaki" Style="text-align:right;" align="right" Text='<%# Bind("ITEM_QTY") %>' onchange="TestOnTextChange(this)"   onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                                </td>
                                                                                                 <td>
                                                                                                 ...
                                                                                                 <td>
                                                                                <asp:TextBox ID="txtBOM_Name" runat="server" CssClass="textBox textAutoSelect" Width="144px" Text='<%#Bind("BOM_NAME") %>'></asp:TextBox>
                                                                                 <asp:HiddenField ID="hdnITEM_BOM_ID" runat="server" Value='<%# Bind("BOM_ID") %>' />
                                                                            </td>
                                                                                                <td>
                                                                                                    <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="245px" Text='<%# Bind("REMARKS") %>' Style=""></asp:TextBox>
                                                                                                </td>
              ...
              <%-- End Finished item Details --%>
                ...
                <div id="tabs-2">
                 ...
                 <div id="Div2" runat="server" style="width: 100%; ">
                    <div id="Div3" runat="server" class="" style="float:left;width: 100%; text-align: left;">
                    ...
                    <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                        ...
                        <div id="dvGridHeaderClosing" style="float:left;width: 1300px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                class="defFont" cellspacing="1" cellpadding="1">
                                <tr class="headerRow_Prod">
                                    <td width="40px" class="headerColCenter_prod">SL#
                                    </td>
                                     <td width="140px" class="headerColCenter_prod">Finished Item
                                    </td>
                                    <td width="15px" class="headerColCenter_prod"></td>
                        ...
                        <div id="dvGridClosing" style="width: 1300px; height: 350px; overflow: auto;" class="dvGrid">
                            ...
                            <ContentTemplate>
                                    <asp:GridView ID="grdClosingRowMaterial" runat="server" AutoGenerateColumns="False" ShowHeader="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="SL#">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCLOSING_SI" runat="server" Text= <%# Container.DataItemIndex + 1 %>   Style="text-align: center;"
                                                        Width="35px">
                                                    </asp:Label>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td>
                                                                        <asp:TextBox ID="txtFINISH_ITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="140px" Text='<%# Bind("FINISH_ITEM_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="180px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td>
                                                                        <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" CssClass="textBox textAutoSelect"  Style="text-align:right;" Width="110px" align="right" Text='<%# Bind("SYSTEM_OPENING_STOCK") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                     <td>
                                                                        <asp:TextBox ID="txtCLOSING_QTY" runat="server" CssClass="textBox textAutoSelect"  Style="text-align:right;"  Width="76px" align="right" onchange="calcIssueStock(this)" Text='<%# Bind("CLOSING_QTY") %>'  ></asp:TextBox>
                                                                    </td>
                                                                    <%-- <td>
                                                                    ...
                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtREJECTED_QTY" runat="server" CssClass="textBox textAutoSelect"   Width="78px" align="right" Text='<%# Bind("REJECTED_QTY") %>' onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>--%>
                                                                     <td align="right">
                                                                        <asp:TextBox ID="txtSTD_USED_QTY" runat="server" CssClass="textBox textAutoSelect" Width="72"  align="right" style="text-align:right;" Text='<%# Bind( "STD_USED_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtPOSITIVE_DEV" runat="server" CssClass=" txtgQty textBox textAutoSelect"  Style="text-align:right;" BackColor="Yellow"  Width="76" align="right" Text='<%# Bind("POSITIVE_DEV") %>'  onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtNEGATIVE_DEV" runat="server" CssClass=" txtgQty textBox textAutoSelect"  Style="text-align:right;" BackColor="Yellow" Width="76" align="right" Text='<%# Bind("NEGATIVE_DEV") %>' onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                     <td>
                                                                        <asp:TextBox ID="txtISSUE_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="80px" BackColor="Khaki" Style="text-align:right;" align="right" Text='<%# Bind("ISSUE_STOCK") %>' onchange="calcCloseingStock(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtCLOSING_REMARKS" runat="server" CssClass="textBox textAutoSelect" Width="105px" Text='<%# Bind("CLOSING_REMARKS") %>' Style=""></asp:TextBox>
                                                                    </td>
                        ...
                        <div id="divGridControlsClosing" style="width: 80%; height: 50px; border-top: solid 1px #C0C0C0;">
               ...
               <div id="tabs-3">
                    ...
                    <div id="groupBoxContainer2 boxShadow" style="height: auto; width: 80%;">
                            <div id="groupDataDetails2" style="float: left;width: 80%; height: auto;">
                                ...
                                <div id="Div7" runat="server" class="" style=" float:left; width: auto; height: auto; text-align: left; width: 80%">
                                    ...
                                    <div id="dvGridClosingSummary" style="width: auto; height: 420px; overflow: auto;" class="dvGrid">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                               ...
                                                                               <%-- <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtISSUE_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="75px" BackColor="Yellow" align="right" style="text-align:right;" Text ='<%# Bind("ISSUE_STOCK") %>' onchange="calcCloseingStock(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                </td>
                                                                                <%--<td>
    ...
    <script src="../javascript/jquery.attributeobserver.js" type="text/javascript"></script>
     ...
     <script language="javascript" type="text/javascript">
         ...
         var txtBATCH_STARTTIMEs = '<%= txtBATCH_STARTTIMEs.ClientID%>';
         var txtBATCH_ENDTIMEs = '<%= txtBATCH_ENDTIMEs.ClientID%>';
        ...
        <%-- var gridUpdatePackIDDet = '<%=UpdatePanel3.ClientID%>';
         ...
         var ddlSHIFT_ID = '<%=ddlSHIFT_ID.ClientID%>';
         ...
         function TestOnTextChange(texbx) {
             ...
             var bomname = $(detRow).find('input[id$="txtBOM_Name"]').val();
             if (bomname == "") {
                 $(detRow).find('input[id$="txtItem_qty"]').val('0');
                 alert('BOM is not listed!');
             }
             else {
                 var itemqty = $(detRow).find('input[id$="txtItem_qty"]').val();
                 $('#' + hdnFinishedQty).val(itemqty);
                 if (itemqty > 0)
         ...
         $("#" + ddlSHIFT_ID).change(function () {
             var selectedValue = this.value;

             $.ajax({
                 url: 'ProductionPlasticEntry_withBOM.aspx/GetShiftStartTimeEndTime',
                 type: 'POST',
                 data: '{ shiftSelectedValue:"' + selectedValue + '"}',
                 ...
                 success: function (data) {
                     if (data != '') {
                         ...
                         $('#' + txtBATCH_STARTTIMEs).val(array[0]);
                         $('#' + txtBATCH_ENDTIMEs).val(array[1]);
                     }
                 },
                 error: function () {
         ...
         function UserSaveConfirmation() {
             ...
             var supervisor = $('#' + txtSUPERVISOR_NAME).val();
             if (supervisor == "") {
             ...
             var gridViewRowCount = $("#" + gridViewIDDet + " tr").length;
         ...
         function bindItemList(gridViewID) {
             var cgColumns = [
                            ...
                            //  , { 'columnName': 'itemcode', 'width': '80', 'align': 'left', 'highlight': 4, 'label': 'Code' }
                             ...
                             //  , { 'columnName': 'item_type', 'width': '100', 'align': 'left', 'highlight': 4, 'label': 'Item Type' }
                              ...
                              , { 'columnName': 'bomname', 'width': '120', 'align': 'left', 'highlight': 4, 'label': 'BOM' }
             ...
             //serviceURL += "&companyid=" + companyid;&deptid=1351&classid=3
             serviceURL += "&ispaging=&isFinished=Y";
         ...
         function bindFinishInRawMaterialSection(gridViewID) {
             ...
             var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
             serviceURL += "&ispaging=1&isFinished=Y&deptid=-1&snd_transfer=Y";
         ...
         function bindClosingItemList(gridViewIDD) {
             ...
             serviceURL += "&ispaging=1&isFinished=N&deptid="+ deptid;
         ...
         function calcCloseingStock(txtbox) {
             ...
             var detRow = $(txtbox).closest('tr.gridRow');
             //alert($(detRow).find('input[id$="hdnCLOSING_ITEM_ID"]').val());
             //if ($(detRow).find('input[id$="hdnCLOSING_ITEM_ID"]').val() == '0');
             //{
         ...
         function bindMachineList(gridViewID) {
             var cgColumns = [
                              ...
                              , { 'columnName': 'machinedescription', 'width': '100', 'align': 'left', 'highlight': 4, 'label': 'Line Description' }
