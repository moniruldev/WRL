<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionRecoveryPasteEntry.aspx.cs" Inherits="PG.Web.Production.ProductionRecoveryPasteEntry" %>
...
<%--        var ProductionNoListServiceLink = '<%=this.ProductionNoListServiceLink%>';
        ...
        function bindScrapItemList(gridViewIDD) {
            ...
            var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            serviceURL += "&ispaging=1&isFinished=Y&forProduction=Y&itemid=3696";
            var gridSelector = "#" + gridViewIDD;
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&isFinished=Y&forProduction=Y&itemid=3696" + "&deptid=" + DeptID + "&stlmid=" + stlmid;
                        var prcNo = GetItemNo(eCode, serviceURL);
                        if (prcNo == null) {
                            ClearScrapItemData(elemID);
                        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hdnRecoveryId" runat="server" />
    <asp:Button ID="btngrdSum" runat="server" OnClick="btngrdSum_Click" />

    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Recovery Paste Entry"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
                ...
                <table>
                    <tr>
                        ...
                        <td align="right" class="auto-style2">
                            <asp:Label ID="lblRecoveryNo" runat="server" Text="Recovery No :" Style=""></asp:Label>
                        </td>
                        <td class="auto-style2">
                            <asp:TextBox ID="txtRecoveryNo" runat="server" Style="text-align: left; font-weight: 700;" CssClass="textBox" Enabled="False" ForeColor="Red"></asp:TextBox>
                        </td >
                        <td align="right">  <asp:Label ID="Label1" runat="server" Text="Recovery Date : "></asp:Label> </td>
                        <td>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td style="text-align: left">
                            ...
                            <asp:DropDownList ID="ddlShiftId" runat="server" CssClass="dropDownList required" Width="190px"  Enabled="true"></asp:DropDownList>
                        </td>
                        ...
                        <td>
                            <asp:TextBox runat="server" CssClass="textBox" ID="txtBatchNo" Width="150px"></asp:TextBox>
                        </td>
            ...
            <div id="dvControls" style="width: 100%; height:auto;" >
                ...
                <div id="Div1" runat="server" class="" style="width: auto; height:auto; text-align: left">
                    <div id="dvGridHeaderClosing" style="width: 900px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                        <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                            ...
                            <tr class="headerRow_Prod">
                                ...
                                <td width="253px" class="headerColCenter_prod">Item
                                </td>
                    ...
                    <div id="dvGridClosing" style="width: 900px; height: 200px; overflow: auto;" class="dvGrid">
                                                    ...
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                <td></td>
                                                                <td>
                                                                    <asp:HiddenField ID="hdnRecoveryDtlId" runat="server" Value='<%# Bind("RECOVERY_DTL_ID") %>' />
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="235px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
