<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionRejectionTransferToStoreList.aspx.cs" Inherits="PG.Web.Production.ProductionRejectionTransferToStoreList" ViewStateMode="Disabled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/ProductionRejectionTransferToStoreEntry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Production Rejection Transfer Entry";
                tdata.label = "Production Rejection Transfer Entry";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production Scrap List"></asp:Label>
            </div>
            <!--Message Div -->
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 800px">
                    <dx:ASPxGridView ID="grdStockTransferList" runat="server" AutoGenerateColumns="False" Width="98%" ClientInstanceName="grdPastingList">
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="REJ_ISSUE_ID" FieldName="REJ_ISSUE_ID" Name="hdnScrapId" Visible="false" VisibleIndex="1">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Issue NO" Name="lblREJ_ISSUE_NO" VisibleIndex="2" Width="120px" FieldName="REJ_ISSUE_NO">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Entry By" Name="lblCREATE_BY" Width="120px" VisibleIndex="4" FieldName="CREATE_BY_NAME">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn Caption="Dept ID" Name="lblDEPT_ID" VisibleIndex="5" Visible="false" FieldName="DEPARTMENT_ID">
                            </dx:GridViewDataTextColumn>

                            <dx:GridViewDataDateColumn Caption="Issue Date" FieldName="REJ_ISSUE_DATE" Width="100px" Name="lblREJ_ISSUE_DATE" VisibleIndex="3">
