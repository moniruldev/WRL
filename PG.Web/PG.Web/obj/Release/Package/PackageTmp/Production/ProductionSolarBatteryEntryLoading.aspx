<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionSolarBatteryEntryLoading.aspx.cs" Inherits="PG.Web.Production.ProductionSolarBatteryEntryLoading" %>
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                       ...
                       <%--  var e = document.getElementById("<%=ddlDEPT_ID.ClientID%>");
                        ...
                        var newServiceURL = serviceURL + "&deptid=54" + "&is_solar_Loading=Y" + "&specId=" + specId;
