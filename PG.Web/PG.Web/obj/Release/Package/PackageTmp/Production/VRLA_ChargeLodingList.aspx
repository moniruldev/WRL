<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" ViewStateMode="Disabled" CodeBehind="VRLA_ChargeLodingList.aspx.cs" Inherits="PG.Web.Production.VRLA_ChargeLodingList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, type) {
            ...
            url = IForm.RootPath + "Production/VRLABatteryEntryLoading.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "VRLA Charging Loading Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "VRLA Charging Loading Entry ";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="VRLA Charging Loading List"></asp:Label>
            </div>
            <!--Message Div -->
