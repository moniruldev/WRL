<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionGridCastingEntry_withBOM_V1.aspx.cs" Inherits="PG.Web.Production.ProductionGridCastingEntry_withBOM_V1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div id="tabs" style="height: 95%; background : url(../image/bg_greendot.gif) !important;">
  <ul>
    <li><a href="#tabs_1">Finished Item Details</a></li>
    <li><a href="#tabs_2">Used RM</a></li>
    <li><a href="#tabs_3">Dross Details</a></li>
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtITEM_PANEL_QTY" runat="server" CssClass="txtQty textBox textAutoSelect" Style="text-align: right;" Width="50px" BackColor="Khaki" Font-Bold="true" align="right" Text='<%# Bind("ITEM_PANEL_QTY") %>' onchange="TestOnTextChange(this)" onBlur="AddAutoRM(this)" onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
 ...
 <div id="tabs_2">
                        ...
                        <div id="divGridControlsClosing">
                            <table style="width: 70%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 90px" align="left">
                                        <asp:Button ID="btnNewRowClosing" runat="server"  Text="" CssClass="buttonNewRow" OnClientClick="ShowClosingProgress()" OnClick="btnNewRowClosing_Click" />
                                    </td>
                                    <td style="width: 20px;">
           ...
           <div id="groupBoxDross" style="height: auto; ">
                <div id="groupDataDrossDetails" style="width: 100%; height: auto;">
                    <div id="Div4" runat="server" class="" style="width: auto; height: auto; text-align: left; width: 100%">
                        <div id="dvGridHeaderDross" style="float:left; width: 1400px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style=" height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                class="defFont" cellspacing="1" cellpadding="1">
                                <tr class="headerRow_Prod">
                                    <td width="40px" class="headerColCenter_prod">SL#
                        ...
                        <div id="dvGridDross" style=" float:left; width: 1400px; height: 250px; overflow: auto;" class="dvGrid">
                                    ...
                                    <asp:GridView ID="grdDross" runat="server" width="1200px" AutoGenerateColumns="False" ShowHeader="False"
                                        CellPadding="1" CellSpacing="1" ForeColor="#333333" GridLines="Both" DataKeyNames="CLOSING_ITEM_ID"
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtFinishedItemName" runat="server" CssClass="textBox textAutoSelect" Width="180px" Text='<%# Bind("FINISH_ITEM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnFinishedItemId" runat="server" Value='<%# Bind("FINISHED_ITEM_ID") %>' />
                                                                    </td>
                                                                    <td>
                                                                        <input id="btnFinishedItem" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtDrossItemName" runat="server" CssClass="textBox textAutoSelect" Width="198px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnDrossItemId" runat="server" Value='<%# Bind("CLOSING_ITEM_ID") %>' />
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtDrossItemUOM" runat="server" CssClass="textBox textAutoSelect" Width="62px" Text='<%# Bind("CLOSING_UOM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnDossItemUOMId" runat="server" Value='<%# Bind("CLOSING_UOM_ID") %>' />
                                                                    </td>
                              

                                                               
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtDrossQty" runat="server" CssClass="textBox textAutoSelect" Width="72"  align="right" style="text-align:right;"  Text='<%# Eval("ISSUE_STOCK", "{0:#,##0.000}") %>' onchange="calcCloseingStock(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtDrossRemarks" runat="server" CssClass="textBox textAutoSelect" Width="110px" Text='<%# Bind("CLOSING_REMARKS") %>' Style=""></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                        ...
                        <div id="divGridControlsDross">
                            <table style="width: 70%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 90px" align="left">
                                        <asp:Button ID="btnNewRowDross" runat="server"  Text="" CssClass="buttonNewRow" OnClientClick="ShowClosingProgress()" OnClick="btnNewRowDross_Click" />
                                    </td>
                                    <td style="width: 20px;">
    ...
    <%-- <Triggers>
  <asp:AsyncPostBackTrigger ControlID="txtPRODUCTION_DATE" EventName="TextChanged" />
</Triggers>--%>
                        <%--<Triggers>
                             <asp:AsyncPostBackTrigger ControlID="btnNewRow" EventName="Click" />
                                    <asp:AsyncPostBackTrigger ControlID="btnNewRowClosing" EventName="Click" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        var btnNewRowClosing = '<%=btnNewRowClosing.ClientID%>';
        ...
        $(document).ready(function () {
            ...
            if (pageInstance != null) {
                pageInstance.add_endRequest(function (sender, e) {
            ...
            $('#' + txtPRODUCTION_DATE).datepicker("option", "onSelect", function (dateText) {
                $('#' + txtBATCH_STARTTIME).val(dateText);
                $('#' + txtBATCH_ENDTIME).val(dateText);
            });
