<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionSolarBatteryEntryUnloading.aspx.cs" Inherits="PG.Web.Production.ProductionSolarBatteryEntryUnloading" %>
...
.tabcontent {
    ...
    <script language="javascript" type="text/javascript">
        ...
        var gridViewPackingIDDet = '<%=gvPacking.ClientID%>';
        var gridViewClosingIDDet = '<%=grdClosingRowMaterial.ClientID%>';


        var gridUpdatePanelChargedID = '<%=UpdatePanelCharged.ClientID%>';
        var gridUpdatePanelPackingID = '<%=UpdatePanelPacking.ClientID%>';
        var gridUpdatePanelClosingID = '<%=UpdatePanelClosing.ClientID%>';

        var updateProgressChargedID = '<%=UpdateProgressCharged.ClientID%>';
        var updateProgressPackingID = '<%=UpdateProgressPacking.ClientID%>';
        var updateProgressClosingID = '<%=UpdateProgressClosing.ClientID%>';    
        ...
        function ShowChargedProgress() {
            $('#' + updateProgressChargedID).show();
        }
        function ShowPackingProgress() {
            $('#' + updateProgressPackingID).show();
        }
        
        function ShowClosingProgress() {
            $('#' + updateProgressClosingID).show();
        }
        ...
        $(document).ready(function () {
            ...
            pageInstance.add_pageLoaded(function (sender, args) {
                ...
                for (i = 0; i < panels.length; i++) {
                    ...
                    if (panels[i].id == gridUpdatePanelChargedID) {
                        bindItemList(gridViewIDDet);                                            
                    }

                    if (panels[i].id == gridUpdatePanelPackingID) {

                        bindPackItemList(gridViewPackingIDDet);
                    }

                    if (panels[i].id == gridUpdatePanelClosingID) {
            ...
            bindItemList(gridViewIDDet);
            bindPackingItemList(gridViewPackingIDDet);
            bindClosingItemList(gridViewClosingIDDet);
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        var newServiceURL = serviceURL + "&deptid=54" + "&is_solar_Unload=Y" + "&specId=" + specId;                       
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&isFinished=Y&deptid=54&for_production=Y";
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                       ...
                       <%--  var e = document.getElementById("<%=ddlDEPT_ID.ClientID%>");
                        ...
                        var newServiceURL = serviceURL + "&deptid=54"+"&is_solar_Packing=Y";;
                    ...
                    select: function (event, ui) {
                        ...
                        if (ui.item.id == 0) {
                            ...
                            SetPackingItemData(elemID, ui.item);
                        }
                        // setDetInstrument(hdnIsInstrumentElem, txtInstrumentElem, btnInstrumentElem);
                        return false;
                    }
        ...
        function ClearPackingItemData(txtItemID) {
            //$('#' + txtGLAccCodeID).val('');
            var detRow = $('#' + txtItemID).closest('tr.gridRow');
            $(detRow).find('input[id$="hdnItemId"]').val('0');
            $(detRow).find('input[id$="txtITEM_NAME"]').val('');
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            $(detRow).find('input[id$="txtItem_qty"]').val(data.available_charging_qty);            
        }

        function SetPackingItemData(txtItemCodeID, data) {
            $('#' + txtItemCodeID).val(data.itemid);
            var detRow = $('#' + txtItemCodeID).closest('tr.gridRow');
            $(detRow).find('input[id$="hdnItemID"]').val(data.itemid);
            $(detRow).find('input[id$="txtITEM_NAME"]').val(data.itemname);
            ...
            $(detRow).find('input[id$="txtBOM_Name"]').val(data.bomname);
            $(detRow).find('input[id$="hdnITEM_BOM_ID"]').val(data.bomid);
            $(detRow).find('input[id$="txtAvailablePackingQty"]').val(data.available_packing_qty);         
        }
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Charging Battery UnLoading Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
        ...
        <div id="dvContentMain" class="dvContentMain" align="left">
            ...
            <div id="tabs" style="height: 95%; background: url(../image/bg_greendot.gif) !important;">
                <ul>
                    <li><a href="#tabs-1">Unloading</a></li>
                    <li style="display:none"><a href="#tabs-2">Packing</a></li>
                     <li style="display:none"><a href="#tabs-3">Used RM </a></li>
                    ...
                    <div id="dvControls" style="height: auto; width: 100%;">
                        ...
                        <div id="groupDataDetails" style="width: 60%; height: auto;">
                            ...
                            <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                <div id="dvGridHeader2" style="float: left; width: 900px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                    <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                        ...
                                        <tr class="headerRow_Prod">
                                            ...
                                            <td width="155px" class="headerColCenter_prod">Item Type
                                            </td>     

                                            <td width="100px" class="headerColCenter_prod">Closing Qty
                                            </td>
                                            <td width="100px" class="headerColCenter_prod">Charged
                                            </td>
                                            <td width="100px" class="headerColCenter_prod">Reject
                                            </td>      
                                ...
                                <div id="dvGrid" style="width:1000px; height: 250px; overflow: auto;" class="dvGrid">
                                    <asp:UpdatePanel ID="UpdatePanelCharged" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                                                ...
                                                                <table border="0" cellpadding="1" cellspacing="1">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="167px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <asp:DropDownList ID="ddlSpecificationType" runat="server" CssClass="dropDownList" Width="150px" AutoPostBack="true" OnSelectedIndexChanged="ddlSpecificationType_SelectedIndexChanged" > 
                                                                                </asp:DropDownList>
                                                                            </td>

                                                                            <td>
                                                                                <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="97px" align="right" Text='<%# Bind("AVAILABLE_CHARGING_QUANTITY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtChargedQty" runat="server" CssClass="textBox textAutoSelect" Width="95px" align="right" Text='<%# Bind("CHARGED_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtRejectQty" runat="server" CssClass="textBox textAutoSelect" Width="92px" align="right" Text='<%# Bind("REJECT_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                    ...
                                    <table style="width: 89%; height: 70%; text-align: center;" cellspacing="1" cellpadding="1"
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 80px" align="left">
                                                <asp:Button ID="btnNewRow" runat="server" CssClass="buttonNewRow" Text="" OnClientClick="ShowChargedProgress()" OnClick="btnNewRow_Click" />
                                            </td>
                                            <td style="width: 20px;">
                                                <asp:UpdateProgress ID="UpdateProgressCharged" runat="server" AssociatedUpdatePanelID="UpdatePanelCharged"
                                                    DisplayAfter="300">
                                                    <ProgressTemplate>
                ...
                <div id="tabs-2" style="display:none">
                    <div id="dvControlspack" style="height: auto; width: 100%;">

                        <div id="groupDataDetailspack" style="width: 60%; height: auto;">
                            <div id="Div1" runat="server" style="width: 100%;">
                            </div>
                            <div id="Div2" runat="server" class="" style="float: right; width: 100%; text-align: left; border-top: solid 1px #0b07f5;">
                                <span style="font-weight: bold; font-size: 15px; color: #ff3b00;">Packing Items Details: </span>
                            </div>
                            <div id="Div3" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                <div id="dvGridHeaderpack" style="float: left; width: 700px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                    <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                        class="defFont" cellspacing="1" cellpadding="1">
                                        <tr class="headerRow_Prod">
                                            <td width="30px" class="headerColCenter_prod">SL#
                                            ...
                                            <td width="15px" class="headerColLeft"></td>
                                           <td width="120px" class="headerColCenter_prod">Available Packing Qty
                                            </td>     
                                            <td width="100px" class="headerColCenter_prod">Packing Qty
                                            </td>                                          
                                           <%-- <td width="99px" class="headerColCenter_prod">Item Type
                                            </td>--%>
                                            <td width="50px" class="headerColCenter_prod">UOM
                                            </td>
                                            <td width="140px" class="headerColCenter_prod">Remarks
                                ...
                                <div id="dvGridpack" style="width: 700px; height: 250px; overflow: auto;" class="dvGrid">
                                    <asp:UpdatePanel ID="UpdatePanelPacking" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:GridView ID="gvPacking" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                CellPadding="1" CellSpacing="1" ForeColor="#333333" GridLines="Both" DataKeyNames="ITEM_ID"
                                                EnableModelValidation="True" ClientIDMode="AutoID" OnRowCommand="gvPacking_RowCommand" OnRowCreated="gvPacking_RowCreated" OnRowDataBound="gvPacking_RowDataBound" OnRowDeleting="gvPacking_RowDeleting">
                                                <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                                                <Columns>
                                                                ...
                                                                <table border="0" cellpadding="1" cellspacing="1">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="174px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                <asp:HiddenField ID="hdnItemID" runat="server" Value='<%# Bind("ITEM_ID") %>' />
                                                                            </td>
                                                                            <td>
                                                                                <input id="btnITEM_NAME" type="button" value="" runat="server" class="buttonDropdown"
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtAvailablePackingQty" runat="server" CssClass="textBox textAutoSelect" Width="120px" align="right" Text='<%# Bind("AVAILABLE_PACKING_QUANTITY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>                                                                       

                                                                            <td>
                                                                                <asp:TextBox ID="txtPacked_qty" runat="server" CssClass="textBox textAutoSelect" Width="100px" align="right" Text='<%# Bind("PACKING_QUANTITY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                        ...
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="btnPackingNewRow" EventName="Click" />
                                        </Triggers>
                                    </asp:UpdatePanel>


                                </div>
                                <div id="divGridControlspack" style="width: 95%; height: 30px; border-top: solid 1px #C0C0C0; border-bottom: solid 1px #0b07f5;">
                                    <table style="width: 89%; height: 70%; text-align: center;" cellspacing="1" cellpadding="1"
                                        border="0">
                                        <tr>
                                            <td style="width: 20px"></td>
                                            ...
                                            <td align="right">&nbsp;</td>
                                            <td style="width: 80px" align="left">
                                                <asp:Button ID="btnPackingNewRow" runat="server" CssClass="buttonNewRow" Text="" OnClientClick="ShowPackingProgress()" OnClick="btnPackingNewRow_Click" />
                                            </td>
                                            <td style="width: 20px;">
                                                <asp:UpdateProgress ID="UpdateProgressPacking" runat="server" AssociatedUpdatePanelID="UpdatePanelPacking"
                                                    DisplayAfter="300">
                                                    <ProgressTemplate>
                                                        <asp:Image ID="imgProgresspack" runat="server" ImageUrl="~/image/loader.gif" Height="16px" />
                                                    </ProgressTemplate>
                                                </asp:UpdateProgress>
                                            </td>
                                        </tr>
                 ...
                 <div id="tabs-3" style="display:none">
                     <div id="Div4" runat="server" style="width: 100%;">
                        <div id="Div5" runat="server" class="" style="width: 100%; text-align: left;">
                            <span style="font-weight: bold; font-size: 15px; color: #ff3b00;">Used Raw Materials Details: </span>
                        </div>
                        <div id="Div6" runat="server" class="" style="width: auto; height: auto; text-align: left">

                            <div id="dvGridHeaderClosing" style="width: 800px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                    class="defFont" cellspacing="1" cellpadding="1">
                                    <tr class="headerRow_Prod">
                                        <td width="65px" class="headerColCenter_prod">SL#
                                        </td>
                                        <td width="170px" class="headerColCenter_prod">Item
                                        </td>
                                        <td width="15px" class="headerColCenter_prod"></td>
                                        <td width="70px" class="headerColCenter_prod">UOM
                                        </td>
                                        <td width="70px" class="headerColCenter_prod">OP Stock
                                        </td>
                            ...
                            <div id="dvGridClosing" style="width:800px; height:250px; overflow: auto;" class="dvGrid">
                                                            ...
                                                            <table border="0" cellpadding="1" cellspacing="1">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="170px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                        ...
                                                                        <td>
                                                                            <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="70px" align="right" Text='<%# Bind("SYSTEM_OPENING_STOCK") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:TextBox ID="txtCLOSING_QTY" runat="server" CssClass="textBox textAutoSelect" Width="75px" align="right" onchange="calcIssueStock(this)" Text='<%# Bind("CLOSING_QTY") %>'></asp:TextBox>
                                                                        </td>
                                                                      
                                                                        <td>
                                                                            <asp:TextBox ID="txtISSUE_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="72" align="right" Text='<%# Bind("ISSUE_STOCK") %>' onchange="calcCloseingStock(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                        </td>
