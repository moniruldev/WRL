<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionDmWaterList.aspx.cs" Inherits="PG.Web.Production.ProductionDmWaterList" ViewStateMode="Disabled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/ProductionDmWaterEntry_SPL.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Production DM Water Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "Production DM Water Entry";
                tdata.type = 0;
                tdata.url = url;
