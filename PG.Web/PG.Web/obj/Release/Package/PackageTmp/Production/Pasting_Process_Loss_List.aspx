<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Pasting_Process_Loss_List.aspx.cs" Inherits="PG.Web.Production.Pasting_Process_Loss_List" ViewStateMode="Disabled" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/Pasting_Process_Loss_Entry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Pasting Process Loss Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "Pasting  Process Loss Entry";
                tdata.type = 0;
                tdata.url = url;
     ...
     <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Pasting Process Loss List"></asp:Label>
                </div>
                <!--Message Div -->
         ...
         <div id="dvContentMain" class="dvContentMain">
                <div id="dvControlsHead" style="height: auto; width: 100%;">
                     <table style="width : 600px">
                        ...
                        <td>
                             <asp:Label ID="lblDEPT_ID" runat="server" Text="Department : " Width="100px" style="text-align: right"></asp:Label>
                        </td>
                        <td>
                        ...
                        <td class="auto-style2" colspan="2">
                           <asp:Button ID="btnAddNew" runat="server" CssClass="buttonNew" Text="New Process Loss" Height="26px" Width="150px" />
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1000px">
                    <dx:aspxgridview ID="grdStockTransferList" runat="server" AutoGenerateColumns="False" Width="98%"  ClientInstanceName="grdPastingList" >
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="WASTAGE_ID" FieldName="WASTAGE_ID" Name="hdnWASTAGE_ID" Visible="false" VisibleIndex="1">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Wastage NO" Name="lblWASTAGE_NO" VisibleIndex="2"  Width="150px" FieldName="WASTAGE_NO">
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataDateColumn Caption="  Date" FieldName="WASTAGE_DATE" Width="100px"   Name="lblWASTAGE_DATE" VisibleIndex="3">
