<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="SolarElectrolyteEntry.aspx.cs" Inherits="PG.Web.Production.SolarElectrolyteEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var hdnBOMID = '<%=hdnBOMID.ClientID%>';
        ...
        function bindItemList(gridViewID) {
            ...
            serviceURL += "&ispaging=1&isFinished=Y&deptid=54&for_production=Y&groupid=49";
        ...
        function bindUsedItemList(gridViewIDD) {
            ...
            serviceURL += "&ispaging=1&deptid=54&isFinished=N&for_production=Y";
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            //if ($(detRow).find('input[id$="hdnITEM_BOM_ID"]').val() > 0)
            //{
        ...
        function TestOnTextChange(texbx) {
            ...
            var useditemname = $(detRow).find('input[id$="hdnITEM_BOM_ID"]').val();
            $('#' + hdnFinishItemIdForRm).val($(detRow).find('input[id$="hdnItemID"]').val());
            $('#' + hdnFinishItemNameForRm).val($(detRow).find('input[id$="txtITEM_NAME"]').val());
            $('#' + hdnBOMID).val($(detRow).find('input[id$="hdnITEM_BOM_ID"]').val());
            if (useditemname != "")
            {
                //  alert(useditemname);
                $("[id*=btnAddAutoUsedItem]").click();
        ...
        function bindMachineList(gridViewID) {
         ...
         function AddAutoRM(texbx) {
             ...
             $('#' + hdnFinishItemNameForRm).val($(detRow).find('input[id$="txtITEM_NAME"]').val());
             $('#' + hdnBOMID).val($(detRow).find('input[id$="hdnITEM_BOM_ID"]').val());
             $('#' + hdnFinishedQty).val($(detRow).find('input[id$="txtItem_qty"]').val());
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnIS_ELECTROLYTE" Value="Y" runat="server" />
        <asp:Button ID="btnAddAutoUsedItem" runat="server"   OnClick="btnAddAutoUsedItem_Click" />
         <asp:Button ID="btnRefreshClosingGrid" runat="server"  OnClick="btnRefreshClosingGrid_Click" />
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Electrolyte Production Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
 ...
 <div id="tabs-1">
            ...
            <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                 <div id="dvGridHeader2" style="float: left; width: 1180px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                    ...
                    <tr class="headerRow_Prod">
                       ...
                       <%-- <td width="30px" class="headerColCenter_prod">STD Weight
                        ...
                        <td width="10px" class="headerColCenter_prod"></td>
                           --%>
                        <td width="160px" class="headerColCenter_prod">Operator
                        </td>
                        <td width="15px" class="headerColCenter_prod"></td>
                         <%--
                        ...
                        <td width="70px" class="headerColCenter">  Bar Type
                            ...
                            --%>
                                               <td width="150px" class="headerColCenter"> BOM Name
                                            </td>
                ...
                <div id="groupDataDetails" style="width: 90%; height: auto;">
                    ...
                    <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGrid" style="width: 1180px; height: 330px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="230px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="txtPcQty textBox textAutoSelect" Width="57px" align="right" Style="text-align: right;" Text='<%# Bind("ITEM_QTY") %>'   onBlur="AddAutoRM(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <input id="btnOPERATOR" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtBOM_Name" runat="server" CssClass="textBox textAutoSelect" Width="150px" Text='<%#Bind("BOM_NAME") %>'></asp:TextBox>
           ...
           <div id="groupBoxContainer1 boxShadow" style="height: auto; ">
                <div id="groupDataDetails1" style="width: 100%; height: auto;">
                    <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left; width: 100%">
                        <div id="dvGridHeaderClosing" style="float:left; width: 850px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style=" height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                ...
                                <tr class="headerRow_Prod">
                                  ...
                                  <%--  <td width="200px" class="headerColCenter_prod">Finished Item
                                    ...
                                    <td width="15px" class="headerColCenter_prod"></td>--%>
                                    <td width="235px" class="headerColCenter_prod"> RM Item
                                    </td>
                                    <td width="15px" class="headerColCenter_prod"></td>
                        ...
                        <div id="dvGridClosing" style=" float:left; width: 800px; height: 300px; overflow: auto;" class="dvGrid">
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <%--   <td>
                                                                     ...
                                                                     <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtNEGATIVE_DEV" runat="server" CssClass="textBox textAutoSelect"   Width="70" align="right" Text='<%# Bind("NEGATIVE_DEV") %>' onkeypress="return isNumberKey(event,this);" ></asp:TextBox> onchange="calcCloseingUsedqtyStock(this)" 
                                                                                    </td>--%>
                                                                    <td>
                                                                        <asp:TextBox ID="txtISSUE_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="72" BackColor="Khaki"  align="right" style="text-align:right;"  Text='<%# Bind("ISSUE_STOCK") %>' onchange="calcCloseingStock(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                    ...
                    <%--        <div id="groupBoxContainer2 boxShadow" style="height: auto; width: 100%;">
                            <div id="groupDataDetails2" style="float: left;width: 90%; height: auto;">
                                ...
                                <div id="Div7" runat="server" class="" style=" float:left; width: auto; height: auto; text-align: left; width: 100%">
                                    <div id="dvGridHeaderClosingSummary" style="width: 435px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                        <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                            class="defFont" cellspacing="1" cellpadding="1">
                                            <tr class="headerRow_Prod">
                                                ...
                                                <td width="150px" class="headerColCenter_prod">RM Item
                                                </td>
                                                                    ...
                                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                                        <tbody>
                                                                           ...
                                                                           <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="150px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                                    <asp:HiddenField ID="hdnCLOSING_ITEM_ID" runat="server" Value='<%# Bind("CLOSING_ITEM_ID") %>' />
                                                                                </td>
                                                                               <td>
                                                                                    <input id="btnCLOSINGITEM_NAME" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
