<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Supervisor_OperatorEntry.aspx.cs" Inherits="PG.Web.Production.Supervisor_OperatorEntry" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Supervisor/Operator Entry"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Supervisor/Operator Entry</span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                ...
                                <table cellpadding="2" cellspacing="4">
                                    <tr>
                                        <td></td>
                                        <td>
                                            <asp:HiddenField ID="hdnSupervisorMstId" runat="server" Value="0" />
                                     ...
                                     <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtEmpId" runat="server" CssClass="TextBoxnew" Width="200px" MaxLength="50"></asp:TextBox>
                                        </td>
                                        <td align="right"></td>
                                        <td align="left"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:TextBox ID="txtName" runat="server" CssClass="TextBoxnew" Width="200px"></asp:TextBox>
                                        </td>
                                      ...
                                      <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:TextBox ID="txtDesignation" runat="server" CssClass="TextBoxnew" Width="200px"></asp:TextBox>
                                        </td>
                                        <td style="" align="right">&nbsp;</td>
                                        <td style="" align="left">&nbsp;</td>
                                    </tr>
                                     ...
                                     <tr>
                                        ...
                                        <td style="" align="right">
                                            ...
                                            <asp:Label ID="lblIsOperator" runat="server" Text="Is Operator:" Visible="true"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlIsOperator" runat="server"
                                                CssClass="TextBoxnew" Width="90" Visible="true">
