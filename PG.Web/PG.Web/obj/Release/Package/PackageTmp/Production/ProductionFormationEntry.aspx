<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionFormationEntry.aspx.cs" Inherits="PG.Web.Production.ProductionFormationEntry" %>
    ...
    <link href="../css/jquery.ui.combogrid.css" rel="stylesheet" type="text/css" />
     <script language="javascript" type="text/javascript">
         ...
         function bindItemList(gridViewID) {
             ...
             serviceURL += "&ispaging=1&isFinished=Y";
             ...
             $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                 ...
                 $(elem).combogrid({
                     ...
                     search: function (event, ui) {
                       ...
                       <%--  var e = document.getElementById("<%=ddlDEPT_ID.ClientID%>");
                         ...
                         var newServiceURL = serviceURL + "&groupid=" + vgroupid + "&deptid=7" ;
                 ...
                 $(elem).blur(function () {
                     ...
                     if (eCode == '') {
                         ...
                         var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                         serviceURL += "&ispaging=1&isFinished=Y&deptid=7&for_production=Y";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
           ...
           <div id="dvContentMain" class="dvContentMain" align="left">
                 <div id="dvControlsHead" style="height: auto; width: 100%;" align="left">
                      <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%" id="tblProductionMstEntry">
                          ...
                          <tr>
                              ...
                              <td style="text-align: right">
                                  <asp:Label ID="lblREJECTED_QTY" runat="server"  Text="Rejected Qty :" Visible="false"></asp:Label>
                              </td>
                              <td>
                                  <asp:TextBox ID="txtREJECTED_QTY" runat="server" CssClass="textBox textNumberOnly" Visible="false" Width="150px" onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                              </td>
                              <td></td>
                              <td>
            ...
            <div id="groupDataDetails" style="width: 90%; height: auto;">
                ...
                <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                    <div id="dvGridHeader2" style="float:left; width: 1370px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                        <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                            ...
                            <tr class="headerRow_Prod">
                                ...
                                <td width="80px" class="headerColCenter_prod"> Rectifier NO</td>
                                <td width="55px" class="headerColCenter_prod">Start Time
                                </td>
                                ...
                                <td width="52px" class="headerColCenter_prod">Panel Qty
                                 ...
                                 <td width="62px" class="headerColCenter_prod">Panel UOM
                                  ...
                                  <td width="55px" class="headerColCenter_prod">Item (Pcs) Qty
                                </td>
                                <td width="50px" class="headerColCenter_prod">UOM
                                </td>

                                <td width="90px" class="headerColCenter_prod">Off Date
                                </td>
                                <td width="55px" class="headerColCenter_prod">Off Time
                                </td>

                                 <td width="55px" class="headerColCenter_prod">Formed Qty
                                </td>
                                 <td width="55px" class="headerColCenter_prod">Unformed Qty
                                </td>
                                <td width="55px" class="headerColCenter_prod">Reject Qty
                                </td>
                                
                              <%--  <td width="76px" class="headerColCenter">Item Weight
                                </td>
                                <td width="75px" class="headerColCenter">Weight UOM
                                </td>--%>

                                <td width="50px" class="headerColCenter_prod">Amp.
                                </td>
                                 <td width="50px" class="headerColCenter_prod">Cycle Time
                                </td>
                                 <td width="50px" class="headerColCenter_prod">SP. GR
                                </td>
                                <td width="52px" class="headerColCenter_prod">Tempr.
                                </td>
                                <td width="48px" class="headerColCenter_prod">Casting Batch
                                </td>
                                 <td width="49px" class="headerColCenter_prod">Pasting Batch
                                </td>
                                <%--
                                <td width="116px" class="headerColCenter"> Operator
                                </td>
 ...
 <%--
                    ...
                    <div id="dvGrid" style="width: 1380px; height: 150px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                 ...
                                                                 <td>
                                                                   <asp:TextBox  ID="txt_FORMATION_STARTTIME"  runat="server" CssClass="textBox" Width="50px" Text='<%# Bind("FORMATION_STARTTIME") %>' >  </asp:TextBox>
                                                                 <cc1:MaskedEditExtender id="MaskedEditExtender3" runat="server" acceptampm="true"  mask="99:99" masktype="Time"   messagevalidatortip="true"  targetcontrolid="txt_FORMATION_STARTTIME" autocompletevalue="00:00AM"></cc1:MaskedEditExtender>
                                                                 </td>
                                                                ...
                                                                <td style="white-space:nowrap">
                                                                    <asp:TextBox ID="txtFORMATION_OFFDATE" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="70px"  Text='<%# Bind("FORMATION_OFFDATE" ,"{0:dd-MMM-yyyy}") %>' ></asp:TextBox>
                                                                </td>
                                                                <td>
                                                               <cc1:MaskedEditExtender id="MaskedEditExtender4" runat="server" acceptampm="true"  mask="99:99" masktype="Time"   messagevalidatortip="true"  targetcontrolid="txtFORMATION_OFFTIME" autocompletevalue="00:00AM"></cc1:MaskedEditExtender>
                                                                    <asp:TextBox  ID="txtFORMATION_OFFTIME"  runat="server" CssClass="textBox" Width="50px" Text='<%# Bind("FORMATION_OFFTIME") %>'>  </asp:TextBox>
                                                                </td>
                                                                 <td>
                                                                    <asp:TextBox ID="txtFORMED_QTY" runat="server" CssClass="textBox textAutoSelect" Width="52px" align="right" Text='<%# Bind("FORMED_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>

                                                                 <td>
                                                                    <asp:TextBox ID="txtUNFORMED_QTY" runat="server" CssClass="textBox textAutoSelect" Width="52px" align="right" Text='<%# Bind("UNFORMED_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>
                                                                  <td>
                                                                    <asp:TextBox ID="txtREJECT_QTY" runat="server" CssClass="textBox textAutoSelect" Width="52px" align="right" Text='<%# Bind("REJECT_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtAMPERE" runat="server" CssClass="textBox textAutoSelect" Width="46px" align="right" Text='<%# Bind("AMPERE") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>
                                                                 <td>
                                                                    <asp:TextBox ID="txtCYCLETIME" runat="server" CssClass="textBox textAutoSelect" Width="46px" align="right" Text='<%# Bind("CYCLETIME") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>

                                                                 <td>
                                                                    <asp:TextBox ID="txtSULFURIC_GRAVITY" runat="server" CssClass="textBox textAutoSelect" Width="46px" align="right" Text='<%# Bind("SULFURIC_GRAVITY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>

                                                                <td>
                                                                    <asp:TextBox ID="txtTEMPARATURE" runat="server" CssClass="textBox textAutoSelect" Width="48px" align="right" Text='<%# Bind("TEMPARATURE") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>
                                                               <td>
                                                                    <asp:TextBox ID="txtGRID_BATCH" runat="server" CssClass="textBox textAutoSelect" Width="46px" align="right" Text='<%# Bind("GRID_BATCH") %>' ></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtPASTING_BATCH" runat="server" CssClass="textBox textAutoSelect" Width="46px" align="right" Text='<%# Bind("PASTING_BATCH") %>' ></asp:TextBox>
                                                                </td>
                                                                 <%-- 
                                                                 <td>
                                                                    <asp:TextBox ID="txtITEM_WEIGHT" runat="server" CssClass="textBox textAutoSelect" Width="72" align="left" Text='<%# Bind("ITEM_WEIGHT") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>
                                                                 <td>
                        ...
                        <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                            ...
                            <tr class="headerRow_Prod">
                                ...
                                <td width="80px" class="headerColCenter_prod">Closing Qty
                                 ...
                                 <%--<td width="145px" class="headerColCenter">Manual Opening Stock </td>--%>
                                                    ...
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="120px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                ...
                                                                <td>
                                                                 ...
                                                                 <td>
                                                                    <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="130px" align="right" Text='<%# Bind("SYSTEM_OPENING_STOCK") %>'    onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>

                                                                 <td>
                                                                    <asp:TextBox ID="txtCLOSING_QTY" runat="server" CssClass="textBox textAutoSelect"   Width="75px" align="right" Text='<%# Bind("CLOSING_QTY") %>'  onchange="calcIssueStock(this)"></asp:TextBox>
                                                                </td>
                                                                 <td>
                                                                    <asp:TextBox ID="txtWASTAGE_QTY" runat="server" CssClass="textBox textAutoSelect"   Width="73px" align="right" Text='<%# Bind("WASTAGE_QTY") %>' onkeypress="return isNumberKey(event,this);"  ></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtREJECTED_QTY" runat="server" CssClass="textBox textAutoSelect"   Width="75px" align="right" Text='<%# Bind("REJECTED_QTY") %>' onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtNEGATIVE_DEV" runat="server" CssClass="textBox textAutoSelect"   Width="73px" align="right" Text='<%# Bind("NEGATIVE_DEV") %>' onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                </td>
