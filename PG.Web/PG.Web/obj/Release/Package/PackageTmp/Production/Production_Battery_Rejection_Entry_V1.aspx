<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Production_Battery_Rejection_Entry_V1.aspx.cs" Inherits="PG.Web.Production.Production_Battery_Rejection_Entry_V1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function bindRejectItemList(gridViewID) {
            var cgColumns = [
                               { 'columnName': 'itemname', 'width': '200', 'align': 'left', 'highlight': 4, 'label': 'Name' }
            ...
            //var serviceURL = GLAccountServiceLink + "?isterm=1&includeempty=1&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            //serviceURL += "&companyid=" + companyid;&deptid=" + ddlDEPT_ID&isFinished=Y&batterytypeid=1
            serviceURL += "&ispaging=1&groupid=1140";
            //serviceURL += "&locationid=" + locationid;
            // serviceURL += "&empstatus=" + "A";
            //serviceURL += "&acctypefilter=" + Enums.GLAccountTypeFilter.AllAccount;
            // serviceURL += "&namecomptype=" + Enums.DataCompareType.Contains;
        ...
        function SetRejectItemData(txtItemCodeID, data) {
            $('#' + txtItemCodeID).val(data.itemid);
        ...
        function ClearRejectItemData(txtItemID) {
            //$('#' + txtGLAccCodeID).val('');
            var detRow = $('#' + txtItemID).closest('tr.gridRow');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvContentMain" runat="server" align="left" > 
        ...
        <div id="dvControlsHead" style="height: auto; width: 800px;" align="left" > 
            <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 800px" id="lblRejectionEntry" >
                <tr>
    ...
    <div id="dvGridControl" style="height:auto">
            <div id="dvGrid"  style="border:1px solid blue; width:900px" >

                <div id="dvGridHeader" style="width:900px;">
                    <table width="800px">
                      <tr class="headerRow_Prod" >
                          <td style="width:25px; " align="center">SL#</td>
                           <td style="width:108px; " align="center">Reject Name</td>
                          <td style="width : 10px;"></td>
                          <td style="width:135px; " align="center">Item Name</td>
                          <td style="width : 10px;"></td>
                           <td style="width:40px; " align="center">Battery Wight</td> 
                          <td style="width:50px; " align="center">Reject Qty</td>
                          <td style="width:100px; " align="center">Remarks</td>
                          <td style="width:18px; " align="center">Delete</td>
                      </tr>
                  </table> 
                </div>
                <div id="dvGridMain" class="dvGrid"  style="width:800px; height:300px; overflow: auto;">
                            ...
                            <asp:GridView ID="grdRejectionDeclare" runat="server" AutoGenerateColumns="false" ShowHeader="false" CellPadding="1" 
                                ...
                                <Columns>
                                    <asp:TemplateField ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSlNo" runat="server" Text='<%# Bind("SLNO")%>' style="text-align:center; width:40px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <div>
                                                <table>
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <asp:TextBox ID="txtRejectItemName" runat="server" CssClass="textBox textAutoSelect" Width="162px" Text='<%# Bind("REJECT_ITEM_NAME") %>'></asp:TextBox>
                                                                <asp:HiddenField ID="hdnRejectItemID" runat="server" Value='<%# Bind("REJECT_ITEM_ID") %>' />
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtItemName" runat="server" CssClass="textBox textAutoSelect" Width="198px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                            ...
                                                            <td>
                                                             ...
                                                             <td>
                                                                <asp:TextBox ID="txtITEM_WEIGHT" runat="server" CssClass="textBox textAutoSelect txtQty txtQtybw" style="text-align : right;" Width="60px" align="right" Text='<%# Bind("ITEM_WEIGHT") %>' onchange="Calc(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                            </td>
                                                            <td style="text-align :right;">
                                                                <asp:TextBox ID="txtRejectionQty" runat="server" CssClass="textBox textAutoSelect" style="text-align : right;"  Width="70px" Text='<%# Bind("REJECT_QTY") %>' onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                            </td>
                                                           
                                                             <td >
                                                               <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect"  Width="152px" Text='<%# Bind("REMARKS") %>'></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
