<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Prod_ASM_Recovery_List.aspx.cs" ViewStateMode="Disabled"  Inherits="PG.Web.Production.Prod_ASM_Recovery_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/Production_Asm_Plate_Recovery_Declare.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Plate Recovery Declaration";
                //tdata.label = "User: " + userid;
                tdata.label = "Plate Recovery Declaration";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Assembly Plate Recovery Declaration List"></asp:Label>
                </div>
                <!--Message Div -->
                        ...
                        <div id="dvGrid" style="width: 100%; height: auto; overflow: auto;">
                            <dx:ASPxGridView ID="grdRejectionList" runat="server" AutoGenerateColumns="False" Width="98%"  ClientInstanceName="grdPastingList" >
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Rejection No" Name="lblRejection_NO" Width="80px" VisibleIndex="2" FieldName="PROD_ASM_REC_NO">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Dept. ID" Name="lblDEPT_ID" VisibleIndex="4" Visible="false" FieldName="DEPT_ID">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Rejection Reason" Name="lblRejectionReason" VisibleIndex="5" Width="100px" FieldName="RECOVERY_ASM_REASON">
                                    </dx:GridViewDataTextColumn>
                                    
                                   
                                    <dx:GridViewDataTextColumn Caption="PROD_REJECTION_ID" FieldName="PROD_ASM_REC_ID" Name="hdnRejection_ID" Visible="false" VisibleIndex="1">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn Caption="Rejection Date" FieldName="PROD_ASM_REC_DATE" Width="100px"   Name="lblRejection_DATE" VisibleIndex="3">
