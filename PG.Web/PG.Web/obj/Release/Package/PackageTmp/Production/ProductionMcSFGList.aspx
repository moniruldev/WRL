<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionMcSFGList.aspx.cs" ViewStateMode="Disabled" Inherits="PG.Web.Production.ProductionMcSFGList" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
          ...
          <%--  var IS_PACKING = document.getElementById("<%=chkIS_PACKING.ClientID%>");
            ...
            url = IForm.RootPath + "Production/ProductionMcSFGEntry.aspx?id=" + key;
            if (IForm.PageMode == Enums.PageMode.InTab) {
             ...
             <%--   var IS_PACKINGs = document.getElementById("<%=chkIS_PACKING.ClientID%>");
                ...
                {
                    tdata.name = "Production MC  Entry";
                    tdata.label = "Production MC Entry";
                }
