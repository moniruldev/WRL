<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionPastingEntry_ItemWise.aspx.cs" Inherits="PG.Web.Production.ProductionPastingEntry_ItemWise" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../css/jquery.ui.combogrid.css" rel="stylesheet" type="text/css" />
     <script language="javascript" type="text/javascript">
         ...
         var hdnItemQntypcs = '<%=hdnItemQntypcs.ClientID%>';
         ...
         //$(document).on('change', '#txtPRODUCTION_DATE', function () {
         //    var s = $('#' + txtPRODUCTION_DATE).val();
         //    alert(s);
         //    $("#" + txtBATCH_STARTTIME).val(s);
         //    $("#" + txtBATCH_ENDTIME).val(s);
         //});
         ...
         function TestOnTextChangegqty(texbx) {
             ...
             var CLOSING_QTY = Number(SYSTEM_OPENING_STOCK) - Number(ISSUE_QTY);
             //alert(CLOSING_QTY);
             ...
             //$(detRow).find('input[id$="txtISSUE_STOCK"]').val(tweight);
         ...
         function ClosingCalRM(texbx) {
           
             calcCloseingStock(this);
         }
         ...
         $(document).ready(function () {
             ...
             //$("#" + txtPRODUCTION_DATE).change(SetDate);
         ...
         function SetItemData(txtItemCodeID, data) {
             ...
             $(detRow).find('input[id$="txtITEM_STANDARD_WEIGHT_KG"]').val(data.paste_panel_kg / data.panelpc);
             $(detRow).find('input[id$="hdnITEM_STANDARD_WEIGHT_KG"]').val(data.paste_panel_kg / data.panelpc);
            ...
            // $(detRow).find('input[id$="hdnUomID"]').val(data.isprime);
             ...
             //$('#' + hdnItemQntypcs).val(tpcqty);

             //alert(hdnItemQntypcs);
...
<asp:HiddenField ID="hdnItemQntypcs" runat="server" Value="0" />
  ...
  <ul>
   ...
   <div id="tabs-1">
                ...
                <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                    <div id="dvGridHeader2" style="float:left; width:1250px;   font-size: smaller;" class="subHeader_Prod">
                        <table style="height: 100%;  color: #FFFFFF; font-weight: bold; text-align: left;"
                            ...
                            <tr class="headerRow_Prod">
                                ...
                                <td width="15px" class="headerColCenter_prod">
                                </td>
                              ...
                              <%--   <td width="10px" class="headerColCenter_prod">
                                ...
                                <%--<td width="70px" class="headerColCenter"> Used Bar(Pcs)
                                 ...
                                 <td width="100px" class="headerColCenter">ITEM BOM
                                            </td>
                    ...
                    <div id="dvGrid" style="width: 1250px; height: 300px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                  ...
                                                                  <td>
                                                                     <asp:TextBox ID="txtMACHINE_NAME" runat="server" CssClass="textBox textAutoSelect" Width="74px" Text='<%#Bind("MACHINE_NAME") %>'></asp:TextBox>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="142px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtITEM_PANEL_QTY" runat="server" CssClass="txtQty textBox textAutoSelect" Width="50px"  BackColor="Khaki" Font-Bold="true" align="left" Text='<%# Bind("ITEM_PANEL_QTY") %>' onchange="TestOnTextChange(this)" onBlur="AddAutoRM(this)" onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>

                                                                 <td>
                                                                    <asp:TextBox ID="txtPANEL_UOM_ID" runat="server" CssClass="textBox textAutoSelect" Width="57px" Text='<%#Bind("PANEL_UOM_NAME") %>'></asp:TextBox>
                                                               ...
                                                               <%-- <td>
                                                                    <input id="btnPANEL_UOM_ID" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" style="display:none" />
                                                                </td>--%>

                                                                <td>
                                                                    <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="75" align="right" Text='<%# Bind("ITEM_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>

                                                                 <td>

                                                                    <asp:TextBox ID="txtUOM_NAME" runat="server" CssClass="textBox textAutoSelect"  Width="48px" Text='<%# Bind("UOM_NAME") %>'></asp:TextBox>
                                                                 ...
                                                                 <td>
                                                                    ...
                                                                    <asp:TextBox ID="txtITEM_STANDARD_WEIGHT_KG" runat="server" CssClass="txtstdweightQty textBox textAutoSelect" Width="63px" align="left" Text='<%# Bind("PASTE_PANEL_KG") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                 </td>
                                                                 <td>
                                                                    <asp:TextBox ID="txtITEM_WEIGHT" runat="server" CssClass="txtWeightQty textBox textAutoSelect" Width="71" align="left" Text='<%# Bind("ITEM_WEIGHT") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>
                                                                 <td>
                                                                    <asp:TextBox ID="txtWEIGHT_UOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="71" Text='<%# Bind("WEIGHT_UOM_NAME") %>' Style=""   ></asp:TextBox>
                                                                    <asp:HiddenField ID="hndWEIGHT_UOM_ID" runat="server" Value='<%# Bind("WEIGHT_UOM_ID") %>' />
                                                                </td>
                                                               
                                                                
                                                                 <td>
                                                                     <asp:TextBox ID="txtOPERATOR_NAME" runat="server" CssClass="textBox textAutoSelect" Width="106px" Text='<%#Bind("OPERATOR_NAME") %>'></asp:TextBox>
                                                            ...
                                                            <%--    
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtGRID_BATCH"  CssClass="textBox" runat="server"  style="text-transform: uppercase"  Text='<%# Bind("GRID_BATCH") %>'  Width="55px"></asp:TextBox>
                                                                </td>
                                                               <td>
                                                                                <asp:TextBox ID="txtBOM_Name" runat="server" CssClass="textBox textAutoSelect" Width="98px" Text='<%#Bind("BOM_NAME") %>'></asp:TextBox>
                                                               ...
                                                               <%-- <td>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="135px" Text='<%# Bind("REMARKS") %>' Style=""></asp:TextBox>
                                                                </td>
...
<%-- Start Closing Details --%>
                ...
                <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                    <div id="dvGridHeaderClosing" style="width: 1270px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                        <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                            class="defFont" cellspacing="1" cellpadding="1">
                            <tr class="headerRow_Prod">
                                                    <td width="50px" class="headerColCenter_prod">SL#
                                                    </td>
                                                    <td width="150px" class="headerColCenter_prod">Finished Item
                                                        </td>
                                <td width="15px" class="headerColCenter_prod"></td>
                                ...
                                <td width="75px" class="headerColCenter_prod">Std Used Qty
                                    ...
                                    <td width="70px" class="headerColCenter_prod"> Pos Dev
                                    </td>
                                    <td width="70px" class="headerColCenter_prod"> Neg Dev
                                    </td>
                    ...
                    <div id="dvGridClosing" style=" width: 1270px; height: 100px; overflow: auto;" class="dvGrid">
                      <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                                <asp:GridView ID="grdClosingRowMaterial" runat="server" Width="1270px" AutoGenerateColumns="False" ShowHeader="False" 
                                                    ...
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                 ...
                                                                 <td>
                                                                        <asp:TextBox ID="txtFINISH_ITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="148px" Text='<%# Bind("FINISH_ITEM_NAME") %>'></asp:TextBox>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="248px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                ...
                                                                <td>
                                                                 ...
                                                                 <td>
                                                                    <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="113px" align="right" Text='<%# Bind("SYSTEM_OPENING_STOCK") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>
                                                                <td>
                                                                  ...
                                                                  <td>
                                                                        <asp:TextBox ID="txtSTD_USED_QTY" runat="server" CssClass="txtgQty textBox textAutoSelect" Width="72"  align="right" style="text-align:right;"  Text='<%# Bind("STD_USED_QTY") %>' onchange="TestOnTextChangegqty(this)"   onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtPOSITIVE_DEV" runat="server" CssClass="txtgQty textBox textAutoSelect"   Width="64px" align="right" BackColor="Yellow"  Text='<%# Bind("POSITIVE_DEV") %>' onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtNEGATIVE_DEV" runat="server" CssClass="txtgQty textBox textAutoSelect"   Width="67" align="right" BackColor="Yellow"  Text='<%# Bind("NEGATIVE_DEV") %>' onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)"  onkeypress="return isNumberKey(event,this);" ></asp:TextBox> 
                                                                    </td>
                                                             <%--  onchange="calcCloseingStock(this)"--%>
                                                                 <td>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtCLOSING_REMARKS" runat="server" CssClass="textBox textAutoSelect" Width="114px" Text='<%# Bind("CLOSING_REMARKS") %>' Style=""></asp:TextBox>
                                                                </td>
