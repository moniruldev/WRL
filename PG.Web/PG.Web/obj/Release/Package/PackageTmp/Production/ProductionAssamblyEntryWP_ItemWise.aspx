<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionAssamblyEntryWP_ItemWise.aspx.cs" Inherits="PG.Web.Production.ProductionAssamblyEntryWP_ItemWise" %>
               ...
               <div id="tabs-3">
                    ...
                    <div id="groupBoxContainer2 boxShadow" style="height: auto; width: 90%;">
                            <div id="groupDataDetails2" style="float: left;width: 90%; height: auto;">
                                ...
                                <div id="Div7" runat="server" class="" style=" float:left; width: auto; height: auto; text-align: left; width: 90%">
                                    <div id="dvGridHeaderClosingSummary" style="width: 735px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                               ...
                                                                               <%-- <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtCLOSING_QTY" runat="server" CssClass="textBox textAutoSelect" Width="70" Style="text-align:right;" align="right" Text='<%# Bind("CLOSING_QTY") %>' onchange="calcIssueStock(this)" onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                </td>
