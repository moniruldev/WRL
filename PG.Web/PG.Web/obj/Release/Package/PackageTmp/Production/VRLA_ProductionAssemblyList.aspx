<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="VRLA_ProductionAssemblyList.aspx.cs" ViewStateMode="Disabled" Inherits="PG.Web.Production.VRLA_ProductionAssemblyList" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            if (IS_PACKING.checked)
                url = IForm.RootPath + "Production/VRLA_ProductionPackingEntry.aspx?id=" + key;
            //else if (IS_P_BATTERY.checked)
            //    url = IForm.RootPath + "Production/VRLA_ProductionAssamblyEntryWP_P_BAT.aspx?id=" + key;
                else
                //url = IForm.RootPath + "Production/VRLA_ProductionAssamblyEntryWP.aspx?id=" + key;
            url = IForm.RootPath + "Production/VRLA_Assembly_Entry_BOMWise.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                {
                    tdata.name = "VRLA Packing Entry";
                    tdata.label = "VRLA Packing Entry";
                }
                else
                {
                    tdata.name = "VRLA Assembly  Entry";
                    tdata.label = "VRLA Assembly Entry";
                }
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="VRLA Assembly & Packing List"></asp:Label>
                </div>
                <!--Message Div -->
         ...
         <div id="dvContentMain" class="dvContentMain">
                <div id="dvControlsHead" style="height: auto; width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                             <asp:CheckBox ID="chkIS_PBattery" CssClass="checkbox" runat ="server" Text="P_Battery" Checked="false" />  
                        </td>
                        <td> 
                            <asp:CheckBox ID="chkIS_PACKING" CssClass="checkbox" runat ="server" Text="Packing" Checked="false" />
                        </td>
