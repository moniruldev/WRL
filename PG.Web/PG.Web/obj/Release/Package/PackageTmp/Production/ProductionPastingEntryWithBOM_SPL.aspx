<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionPastingEntryWithBOM_SPL.aspx.cs" Inherits="PG.Web.Production.ProductionPastingEntryWithBOM_SPL" %>
...
<%--        var gridDrossUpdatePanelIDDet = '<%=UpdatePanel4.ClientID%>';
        ...
        var hdnFinishedItemIdForLug = '<%=hdnFinishedItemIdForLug.ClientID%>';
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            $('#' + hdnFinishedItemIdForLug).val($(detRow).find('input[id$="hdnItemID"]').val());
            $("[id*=btnAddFalseLug]").click();
        ...
        function bindOperatorList(gridViewID) {
         ...
         function TestOnTextChangegqty(texbx) {
             ...
             stusedqty = parseFloat(stusedqty.replaceAll(',', ''));
             var posqty = $(detRow).find('input[id$="txtPOSITIVE_DEV"]').val();
             posqty = parseFloat(posqty.replaceAll(',', ''));
             var negqty = $(detRow).find('input[id$="txtNEGATIVE_DEV"]').val();
             negqty = parseFloat(negqty.replaceAll(',', ''));
             totalusedqty = parseFloat(stusedqty) + parseFloat(posqty) - parseFloat(negqty);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnFinishItemIdForRm" runat="server" />
         <asp:HiddenField ID="hdnFinishedItemIdForLug" runat="server" />
        ...
        <asp:HiddenField ID="hdnStoragelocationID" runat="server" Value="3" />
               ...
               <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%;font-size:12px;margin:5px;" id="tblProductionMstEntry">
                    ...
                    <tr>
                       ...
                       <td style="text-align: right" class="auto-style1">
                        ...
                        <td>
                             <asp:TextBox ID="txtStorageLocation" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="Pasting" Width="200px" ReadOnly="true"></asp:TextBox>
                        </td>
 ...
 <div id="tabs-1">
            ...
            <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                 <div id="dvGridHeader2" style="float: left; width: 1200px; height: 30px; font-size: smaller;" class="subHeader_Prod">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="220px" Text='<%# Bind("ITEM_NAME") %>' Style="font-size:10px; font-weight:bold;color:black;"></asp:TextBox>
                                ...
                                <Triggers>
                                    <asp:AsyncPostBackTrigger ControlID="btnNewRow" EventName="Click" />
                                     <asp:AsyncPostBackTrigger ControlID="btnAddFalseLug" EventName="Click" />
                                </Triggers>
                            </asp:UpdatePanel>
                        </div>
                            ...
                            <table style="width: 70%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 90px" align="left">
                                        ...
                                        <asp:Button ID="btnAddFalseLug" runat="server" OnClick="btnAddFalseLug_Click" Style="display:none;" />
