<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionAssemblyList.aspx.cs" ViewStateMode="Disabled" Inherits="PG.Web.Production.ProductionAssemblyList" %>
        ...
        function tbopen(key, userid) {
          ...
          <%--  var IS_PACKING = document.getElementById("<%=chkIS_PACKING.ClientID%>");
            ...
            if (IS_PACKING.checked)
                ...
                url = IForm.RootPath + "Production/ProductionAssemblySFGEntry.aspx?id=" + key;
            if (IForm.PageMode == Enums.PageMode.InTab) {
             ...
             <%--   var IS_PACKINGs = document.getElementById("<%=chkIS_PACKING.ClientID%>");
                ...
                {
                    tdata.name = "Production Assembly  Entry";
                    tdata.label = "Production Assembly Entry";
                }
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production Assembly List"></asp:Label>
                </div>
                <!--Message Div -->
         ...
         <div id="dvContentMain" class="dvContentMain">
                <div id="dvControlsHead" style="height: auto; width: 100%;">
                    ...
                    <tr>
                        ...
                        <td> 
                            <asp:CheckBox ID="chkIS_PACKING" CssClass="checkbox" runat ="server" Text="Packing" Checked="false" Visible="false" />
                        </td>
                        ...
                        <div id="dvGrid" style="width: 100%; height: auto; overflow: auto;">
                            <dx:ASPxGridView ID="grdAssemblyList" runat="server" AutoGenerateColumns="False" Width="98%"  ClientInstanceName="grdAssemblyList" >
                                <Columns>
                                    ...
                                    <dx:GridViewDataDateColumn Caption="Entry Date" FieldName="ENTRY_DATE" Width="100px"   Name="lblEntry_Date" VisibleIndex="5">
