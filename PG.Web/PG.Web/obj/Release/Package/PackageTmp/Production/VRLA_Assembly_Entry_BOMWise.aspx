<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="VRLA_Assembly_Entry_BOMWise.aspx.cs" Inherits="PG.Web.Production.VRLA_Assembly_Entry_BOMWise" %>
                    ...
                    <tr >
                        ...
                        <td style="border-right: solid 2px #C0C0C0;">
                                <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left; float : left; padding-right : 5px; border: solid 1px #2e4be5;">
                                                    ...
                                                    <span style="font-weight: bold;font-size : 15px; color :#ff3b00;">VRLA Assembly Items Details: </span>
                                                </div>
     ...
     <script language="javascript" type="text/javascript">
        ...
        <%-- var gridUpdatePackIDDet = '<%=UpdatePanel3.ClientID%>';
         ...
         $("#"+ddlSHIFT_ID).change(function () {
             ...
             $.ajax({
                 url: 'VRLA_Assembly_Entry_BOMWise.aspx/GetShiftStartTimeEndTime',
                 type: 'POST',
             ...
             $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                 ...
                 $(elem).combogrid({
                     ...
                     search: function (event, ui) {
                         ...
                         var newServiceURL = serviceURL + "&snd_transfer=Y&deptid=" + deptid;
