<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionReFormFromUnformEntry.aspx.cs" Inherits="PG.Web.Production.ProductionReFormFromUnformEntry" %>
...
<%--        var gridDrossUpdatePanelIDDet = '<%=UpdatePanel4.ClientID%>';
        ...
        function bindClosingItemList(gridViewIDD) {
            ...
            serviceURL += "&ispaging=1&isFinished=Y&forProduction=Y&groupid=65"; 
            var gridSelector = "#" + gridViewIDD;
            $(gridSelector).find('input[id$="txtCLOSINGITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&isFinished=Y&for_production=Y"  + "&deptid=" + DeptID + "&stlmid=" + stlmid;
        ...
        function ClearClosingItemData(txtCLOSINGITEM_NAME) {
            ...
            $(detRow).find('input[id$="txtISSUE_STOCK"]').val('');
        ...
        function SetClosingItemData(txtCLOSINGITEM_NAME, data) {
            ...
            $(detRow).find('input[id$="hdnItemGroupId"]').val(data.itemgroupid);
        ...
        function bindMachineList(gridViewID) {
         ...
         function SetMachineData(txtMACHINE_NAME, data) {
             ...
             $('#' + hndMACHINE_ID_CLOSING).val(data.machineid);
         ...
         function bindSupporvisorList() {
             ...
             var cgColumns = [{ 'columnName': 'empid', 'width': '80', 'align': 'left', 'highlight': 4, 'label': 'Emp ID' }
                              ...
                              , { 'columnName': 'designationName', 'width': '120', 'align': 'left', 'highlight': 4, 'label': ' Designation' }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnStoragelocationID" runat="server" Value="9" />
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Formation Form Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
  ...
  <ul>
   ...
   <%-- <li><a href="#tabs-3">Dross Details </a></li>--%>
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;" align="left">
               <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 95%; font-size:12px; margin:5px;" id="tblProductionMstEntry">
                    <tr>
                        ...
                        <td style="text-align: right">
                            ...
                            <asp:Label ID="lblProcessCode" runat="server" Text="Batch NO :" Width="150px" style="display:none"></asp:Label>
                        ...
                        <td style="text-align: left">
                            ...
                            <asp:TextBox ID="txtPROD_BATCH_NO" runat="server" CssClass="textBox textAutoSelect textNumberOnly" Width="150px" TabIndex="2" style="display:none;"></asp:TextBox>
                            <asp:TextBox ID="txtStorageLocation" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="Formation" Width="200px" ReadOnly="true"></asp:TextBox>
                        </td>
 ...
 <div id="tabs-1">
            ...
            <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                 <div id="dvGridHeader2" style="float: left; width: 1100px; height: 30px; font-size: smaller;" class="subHeader_Prod">
                ...
                <div id="groupDataDetails" style="width: 90%; height: auto;">
                    ...
                    <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGrid" style="width: 1100px; height: 200px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="135px" Text='<%# Bind("ITEM_NAME") %>' Font-Size="10px"></asp:TextBox>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="txtPcQty textBox textAutoSelect" Width="60px" align="right" Style="text-align: right;" Text='<%# Bind("ITEM_QTY") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                        ...
                        <div id="dvGridHeaderClosing" style="float:left; width: 1200px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style=" height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="75px" class="headerColCenter_prod" style="display:none;">Closing Qty
                                    </td>
                                   <%-- <td width="75px" class="headerColCenter_prod">Reuse Qty
                                    </td>--%>
                                     <td width="75px" class="headerColCenter_prod" style="display:none;">Std Used Qty
                                    </td>
                                    <%--     <td width="80px" class="headerColCenter_prod"> Wastage Qty
                                                    </td>
                                                     <td width="80px" class="headerColCenter_prod"> Rejected Qty
                                                    </td>--%>
                                    <td width="62px" class="headerColCenter_prod"  style="display:none;"> Pos Dev
                                    </td>
                                    <td width="62px" class="headerColCenter_prod"  style="display:none;"> Neg Dev
                                    </td>
                                    <td width="72px" class="headerColCenter_prod">Used Qty
                                    </td>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:HiddenField ID="hdnISMANUAL" runat="server" Value='<%# Bind("ISMANUAL") %>' />
                                                                         <asp:HiddenField ID="hdnMachineIDgridcloding" runat="server" Value='<%# Bind("MACHINE_ID") %>' />
                                                                          <asp:HiddenField ID="hdnItemGroupId" runat="server" Value='<%# Bind("CLOSING_ITEM_GROUP_ID") %>' />
                                                                    </td>
                                                                   ...
                                                                   <td> 
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" CssClass="textBox textAutoSelect"  Width="115px" style="text-align:right;" Text='<%# Eval("SYSTEM_OPENING_STOCK", "{0:#,##0.00}") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtCLOSING_QTY" runat="server" CssClass="textBox textAutoSelect" Width="75" style="text-align:right;" Text='<%# Eval("CLOSING_QTY", "{0:#,##0.00}") %>' onchange="calcIssueStock(this)" onkeypress="return isNumberKey(event,this);" Visible="false"></asp:TextBox>
                                                                    </td>
                                                                   ...
                                                                   <%-- <td align="right">
                                                                    ...
                                                                    <%--  <td>
                                                                        ...
                                                                        <td align="right">
                                                                        <asp:TextBox ID="txtSTD_USED_QTY" runat="server" CssClass="textBox textAutoSelect" Width="75"  align="right" style="text-align:right;" Text='<%# Eval( "STD_USED_QTY", "{0:#,##0.00}") %>'  onkeypress="return isNumberKey(event,this);" Visible="false"></asp:TextBox>
                                                                    </td>
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtPOSITIVE_DEV" runat="server" CssClass="txtgQty textBox textAutoSelect"   Width="62px" style="text-align:right;" BackColor="Yellow"  Text='<%# Eval( "POSITIVE_DEV", "{0:#,##0.00}") %>'  onBlur=" calcCloseingDevStock(this)" onchange="TestOnTextChangegqty(this)" onkeypress="return isNumberKey(event,this);" Visible="false" ></asp:TextBox>
                                                                    </td>
                                                                    <td align="right">
                                                                        <asp:TextBox ID="txtNEGATIVE_DEV" runat="server" CssClass="txtgQty textBox textAutoSelect"   Width="60" style="text-align:right;" BackColor="Yellow"  Text='<%# Eval("NEGATIVE_DEV", "{0:#,##0.00}") %>' onBlur=" calcCloseingDevStock(this)" onchange="TestOnTextChangegqty(this)" onkeypress="return isNumberKey(event,this);" Visible="false" ></asp:TextBox> 
                                                                    </td>
                                                                    <td align="right">
                ...
                <div class="modal-content" style="max-width:600px;">  
                    ...
                    <div class="modal-body" style="overflow-y:scroll; overflow-x:scroll; max-height:300px; max-width:600px; margin-top: 10px; margin-bottom: 10px;"> <%-- --%>
                        ...
                        <asp:HiddenField ID="hdnBatchItemId" runat="server" />
                         ...
                         <asp:HiddenField ID="hdnBatchItemGroupId" runat="server" />
