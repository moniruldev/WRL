<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionFGRejectionList.aspx.cs" ViewStateMode="Disabled"  Inherits="PG.Web.Production.ProductionFGRejectionList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/PRODUCTION_FG_REJECTION_DECLARE_SPL.aspx?id=" + key;
