<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" ViewStateMode="Disabled" CodeBehind="ProductionFormationUnLoadingList.aspx.cs" Inherits="PG.Web.Production.ProductionFormationUnLoadingList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, type) {
            ...
            url = IForm.RootPath + "Production/ProductionFormationEntryUnLoading.aspx?U_PROD_ID=" + key;
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table style="width: 600px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnAddNew" runat="server" CssClass="buttonNew" Visible="false" Text="New Loading" Height="26px" />
                        </td>
                        <%--  <td></td>
                    ...
                    <div id="dvGrid" style="width: 100%; height: auto; overflow: auto;">
                        <dx:ASPxGridView ID="grdPastingList" runat="server" EnableRowsCache="false" EnableViewState="false" AutoGenerateColumns="False" Width="98%" ClientInstanceName="grdPastingList" ViewStateMode="Disabled">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Pro. Batch NO" FieldName="PROD_BATCH_NO" Width="100px" Name="txtPROD_BATCH_NO" VisibleIndex="8">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Circuit" FieldName="MACHINE_NAME" Width="100px" Name="txtMachineName" VisibleIndex="8">
                                </dx:GridViewDataTextColumn>
