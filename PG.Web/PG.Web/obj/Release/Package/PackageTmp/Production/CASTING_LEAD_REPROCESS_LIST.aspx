<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="CASTING_LEAD_REPROCESS_LIST.aspx.cs" ViewStateMode="Disabled" Inherits="PG.Web.Production.CASTING_LEAD_REPROCESS_LIST" %>
    ...
    <script language="javascript" type="text/javascript">
       ...
       <%-- var chkIS_PACKING = '<%=chkIS_PACKING.ClientID%>';--%>
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/Production_Pure_Lead_Entry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Production Pure Lead Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "Production Pure Lead Entry";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production Pure Lead List"></asp:Label>
                </div>
                <!--Message Div -->
