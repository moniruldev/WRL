<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="PRODUCTION_ITEM_STOCK_TRANSFER.aspx.cs" Inherits="PG.Web.Production.PRODUCTION_ITEM_STOCK_TRANSFER" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item Stock Transfermation Entry (Oxide & Pasting)"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
                ...
                <table>
                    ...
                    <tr>--%>
                        ...
                        <td align="left" style="text-align: right">
                               <asp:Label ID="lblStockTransferDate" runat="server" Text="Date:" style="font-weight: 700"></asp:Label>
                        </td>
                        <td>
                              <asp:TextBox ID="txtSTOCK_TRANSFER_DATE" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>  
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right">
                              ...
                              <td style="text-align: left">
                                  ...
                                  <asp:DropDownList ID="ddlDEPT_ID" runat="server" CssClass="dropDownList required" Width="250px" OnSelectedIndexChanged="ddlDEPT_ID_SelectedIndexChanged" AutoPostBack="true" ></asp:DropDownList>
                              </td>
                        <td style="text-align: right">
                         ...
                         <td style="text-align: right">
                              ...
                              <td style="text-align: left">
                                <%--   <asp:TextBox ID="txtRejectionItem" runat="server" CssClass="textBox" Style="text-align: left;" ></asp:TextBox>
                                  ...
                                  <asp:DropDownList ID="ddlITEM_NAME" runat="server" CssClass="dropDownList required" OnSelectedIndexChanged="ddlITEM_NAME_SelectedIndexChanged" AutoPostBack="true" Width="250px" ></asp:DropDownList>
                              </td>
                         <td style="text-align: right">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:CheckBox ID="chkMIXTOMIX" Text="Mixture To Mixture"  runat="server" />
                        </td>
            ...
            <div id="dvControls" style="width: 100%; height: 400px;">
                ...
                <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                    <div id="dvGridHeaderClosing" style="width: 850px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                      ...
                      <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                                <asp:GridView ID="grdTransferList" runat="server" AutoGenerateColumns="False" ShowHeader="False" 
                                    CellPadding="1" CellSpacing="1" ForeColor="#333333" GridLines="Both" DataKeyNames="STOCK_TRANSFER_ITEM_ID" 
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="SL#">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSLNO" runat="server" Text='<%# Bind("STOCK_TRANSFER_SLNO") %>' Style="text-align: center;"
                                                    Width="60px">
                                                </asp:Label>
                                                    ...
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:HiddenField ID="hdnSTOCK_TRANSFER_DTL_ID" runat="server" Value='<%# Bind("STOCK_TRANSFER_DTL_ID") %>' />
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtSTOCK_TRANSFER_ITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="235px" Text='<%# Bind("STOCK_TRANSFER_ITEM_NAME") %>'></asp:TextBox>
                                                                    <asp:HiddenField ID="hdnSTOCK_TRANSFER_ITEM_ID" runat="server" Value='<%# Bind("STOCK_TRANSFER_ITEM_ID") %>' />
                                                                </td>
                                                                <td>
                                                                 ...
                                                                 <td style="text-align:right;">
                                                                    <asp:TextBox ID="txtTRANSFER_QTY" runat="server" CssClass="txtQty textBox textAutoSelect"   Width="75px" align="right" style="text-align:right;" Text='<%# Bind("TRANSFER_QTY") %>'  onchange="calcIssueStock(this)"></asp:TextBox>
                                                                </td>
