<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionAssamblyP_BAT_EntryWP_ItemWise.aspx.cs" Inherits="PG.Web.Production.ProductionAssamblyP_BAT_EntryWP_ItemWise" %>
        ...
        <asp:HiddenField ID="hdnFinishItemNameForRm" runat="server" />
          <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Assembly Replace Battery Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
                    ...
                    <tr >
                        ...
                        <td style="border-right: solid 2px #C0C0C0;">
                                <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left; float : left; padding-right : 5px; border: solid 1px #2e4be5;">
                                                    ...
                                                    <div id="dvGrid" style="width: 1150px; height: 200px; overflow: auto;" class="dvGrid">
                                                                                    ...
                                                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="52px" align="right" Text='<%# Bind("ITEM_QTY") %>' onchange="TestOnTextChange(this)"   onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                                </td>
                                                                                                 <td>
              ...
              <%-- End Finished item Details --%>
                ...
                <div id="tabs-2">
                 ...
                 <div id="Div2" runat="server" style="width: 100%; ">
                    ...
                    <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                        ...
                        <div id="dvGridClosing" style="width: 1300px; height: 150px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="148px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtCLOSING_UOM_NAME" runat="server" CssClass="textBox textAutoSelect"  Width="64px" Text='<%# Bind("CLOSING_UOM_NAME") %>'></asp:TextBox>
                                                                     ...
                                                                     <td>
                                                                        <asp:TextBox ID="txtCLOSING_QTY" runat="server" CssClass="textBox textAutoSelect"   Width="76px" align="right" onchange="calcIssueStock(this)" Text='<%# Bind("CLOSING_QTY") %>'  ></asp:TextBox>
                                                                    </td>
                                                                    <%-- <td>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td align="right">
                                                                        <asp:TextBox ID="txtSTD_USED_QTY" runat="server" CssClass="textBox textAutoSelect" Width="72"  align="right" style="text-align:right;" Text='<%# Eval( "STD_USED_QTY", "{0:#,##0.00}") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtPOSITIVE_DEV" runat="server" CssClass=" txtgQty textBox textAutoSelect"   Width="76" align="right" Text='<%# Bind("POSITIVE_DEV") %>'  onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
               ...
               <%-- <div id="tabs-3">
                    ...
                    <tr >
                        ...
                        <td style="border-right: solid 2px #C0C0C0;">
                                <div id="Div4" runat="server" class="" style="width: auto; height: auto; text-align: left; float : left; padding-right : 5px; border: solid 1px #2e4be5;">
                                                    <div id="Div5" runat="server" class="" style="width: 100%; text-align: left;">
                                                    <span style="font-weight: bold;font-size : 15px; color :#ff3b00;">Replace and Sample Items Details: </span>
                                                </div>
                                                    <div id="dvGridHeader3" style=" width:1100px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                                        <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                                            class="defFont" cellspacing="1" cellpadding="1">
                                                            <tr class="headerRow_Prod">
                                                                <td width="30px" class="headerColCenter_prod">SL#
                                                    ...
                                                    <div id="dvGridRPL" style="width: 1150px; height: 200px; overflow: auto;" class="dvGrid">
                                                      <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                                <asp:GridView ID="GridListRPL" runat="server" AutoGenerateColumns="False" ShowHeader="False" 
                                                                    CellPadding="1" CellSpacing="1" ForeColor="#333333" GridLines="Both" DataKeyNames="ITEM_ID" 
                                                                    EnableModelValidation="True" ClientIDMode="AutoID" OnRowCommand="GridListRPL_RowCommand" OnRowCreated="GridListRPL_RowCreated" OnRowDataBound="GridListRPL_RowDataBound" OnRowDeleting="GridListRPL_RowDeleting"  >
                                                                    <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                                                                    <Columns>
                                                         ...
                                                         <Triggers>
                                                                <asp:AsyncPostBackTrigger ControlID="btnNewRowRPL" EventName="Click" />
                                                            </Triggers>
                                                    </asp:UpdatePanel>


                                                    </div>
                                                    <div id="divGridControls3" style="width: auto; height: 30px; border-top: solid 1px #C0C0C0;">
                                                        <table style="width: 100%; height: 30px; text-align: center;" cellspacing="1" cellpadding="1"
                                                            border="0">
                                                            <tr>
                                                                <td style="width: 2px"></td>
                                                                ...
                                                                <td align="right">&nbsp;
                                                                 ...
                                                                 <td style="width: 90px" align="left">
                                                                    <asp:Button ID="btnNewRowRPL" runat="server" CssClass="buttonNewRow" Text="" OnClientClick="ShowProgress()" OnClick="btnNewRowRPL_Click" />
                                                                </td>
                                                                <td style="width: 20px;">
