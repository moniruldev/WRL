<%@ Page Title="" Language="C#" ViewStateMode="Disabled" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Dept_Prod_Item_Mapping.aspx.cs" Inherits="PG.Web.Report.INV.Dept_Prod_Item_Mapping" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Department Production Item Binding"></asp:Label>
            </div>
            <!--Message Div -->
