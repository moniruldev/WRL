<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" ViewStateMode="Disabled" CodeBehind="VRLA_ChargeUnLodingList.aspx.cs" Inherits="PG.Web.Production.VRLA_ChargeUnLodingList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, type) {
            ...
            url = IForm.RootPath + "Production/VRLA_ChargeBatteryEntryUnloading.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = " VRLA Charging Unloading Entry ";
                tdata.label = " VRLA Charging Unloading Entry ";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="VRLA Charging UnLoading List"></asp:Label>
            </div>
            <!--Message Div -->
