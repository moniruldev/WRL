<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionPackingEntry_ItemWise.aspx.cs" Inherits="PG.Web.Production.ProductionPackingEntry_ItemWise" %>
 ...
 <script src="../javascript/jquery.ui.combogrid.js" type="text/javascript"></script>
    ...
    <link href="../css/jquery.ui.combogrid.css" rel="stylesheet" type="text/css" />
     <script language="javascript" type="text/javascript">
        ...
        <%--  var gridUpdatePanelIDDet = '<%=UpdatePanel3.ClientID%>';
         var gridViewIDDet = '<%=grdPackingList.ClientID%>';
         ...
         $(document).ready(function () {
             ...
             pageInstance.add_pageLoaded(function (sender, args) {
                 ...
                 for (i = 0; i < panels.length; i++) {
                     ...
                     //    bindItemList(gridViewPackIDDet);
             ...
             $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                 ...
                 $(elem).combogrid({
                     ...
                     search: function (event, ui) {
                         ...
                         var newServiceURL = serviceURL + "&snd_transfer=Y&deptid=136&batchno=" + vbatchno;
                       //  alert(newServiceURL);
                         //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
                         newServiceURL = JSUtility.AddTimeToQueryString(newServiceURL);
                         $(this).combogrid("option", "url", newServiceURL);
        ...
        <asp:HiddenField ID="hdnFinishItemNameForRm" runat="server" />
          <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Packing Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
                       ...
                       <%-- <td style="border-right: solid 2px #C0C0C0;">
                        ...
                        <td>
                                <div id="Div4" runat="server" class="" style="width: auto; height: auto; text-align: left;padding-left : 5px;border: solid 1px #2e4be5;">
                                                    ...
                                                    <div id="dvGridHeaderPack" style="width: 1160px;   height: 25px; font-size: smaller;" class="subHeader_Prod">
                                                        <table style="height: auto; color: #FFFFFF; font-weight: bold; text-align: left;"
                                                            class="defFont" cellspacing="1" cellpadding="1">
                                                            <tr class="headerRow_Prod">
                                                                <td width="30px" class="headerColCenter_prod">SL#
                                                                </td>
                                                                <td width="100px" class="headerColCenter_prod"> Batch NO</td>
                                                                <td width="350px" class="headerColCenter_prod">Item
                                                                </td>
                                                                 <td width="15px" class="headerColCenter_prod"></td>
                                                                  <td width="55px" class="headerColCenter_prod">Item Qty
                                                                ...
                                                                <td width="350px" class="headerColCenter_prod">Remarks
                                                                </td>
                                                                <td width="16px" class="headerColCenter_prod">Delete
                                                                </td>
                                                    ...
                                                    <div id="dvGridPack" style="width: 1160px;  height: 300px; overflow: auto;" class="dvGrid">
                                                                                ...
                                                                                <div>
                                                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                  <td>
                                                                                                     <asp:TextBox ID="txtPACK_FINISHED_BATCH" runat="server" CssClass="textBox textAutoSelect" Width="98px" Text='<%#Bind("PACK_FINISHED_BATCH") %>'></asp:TextBox>
                                                                                                      <asp:HiddenField ID="hdnPROD_DTL_ID" runat="server" Value='<%# Bind("PROD_DTL_ID") %>' />
                                                                                                </td>
                                                                                                ...
                                                                                                <td>
                                                                                                    <%--onchange="validationPackingQty(this)"--%> 
                                                                                                    <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="52px" BackColor="Khaki" align="right" Text='<%# Bind("ITEM_QTY") %>' onchange="TestOnTextChange(this)" onBlur=" validationPackingQty(this)"   onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                                </td>
                                                                                                 <td>
                                                                                                    <asp:TextBox ID="txtUOM_NAME" runat="server" CssClass="textBox textAutoSelect"  Width="45px" Text='<%# Bind("UOM_NAME") %>'></asp:TextBox>
                                                                                                    <asp:HiddenField ID="hdnUomID" runat="server" Value='<%# Bind("UOM_ID") %>' />
                                                                                                 ...
                                                                                                 <td>
                                                                                <asp:TextBox ID="txtBOM_Name" runat="server" CssClass="textBox textAutoSelect" Width="146px" Text='<%#Bind("BOM_NAME") %>'></asp:TextBox>
                                                                                 <asp:HiddenField ID="hdnITEM_BOM_ID" runat="server" Value='<%# Bind("BOM_ID") %>' />
                                                                            </td>
                                                                                                <td>
                                                                                                    <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="350px" Text='<%# Bind("REMARKS") %>' Style=""></asp:TextBox>
                                                                                                </td>
               ...
               <%-- End Finished item Details --%>                                 
                 ...
                 <div id="Div2" runat="server" style="width: 100%; ">
                    ...
                    <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                        ...
                        <div id="dvGridHeaderClosing" style="float:left;width: 1230px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                class="defFont" cellspacing="1" cellpadding="1">
                                <tr class="headerRow_Prod">
                        ...
                        <div id="dvGridClosing" style="width: 1250px; height: 350px; overflow: auto;" class="dvGrid">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                     ...
                                                                     <td align="right">
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtPOSITIVE_DEV" runat="server" CssClass=" txtgQty textBox textAutoSelect" BackColor="Yellow"  Width="76" align="right" Text='<%# Bind("POSITIVE_DEV") %>'  onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtNEGATIVE_DEV" runat="server" CssClass=" txtgQty textBox textAutoSelect" BackColor="Yellow"  Width="76" align="right" Text='<%# Bind("NEGATIVE_DEV") %>' onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                     <td>
                                                                        <asp:TextBox ID="txtISSUE_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="72" align="right" BackColor="Khaki" Text='<%# Bind("ISSUE_STOCK") %>' onchange="calcCloseingStock(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                    ...
                    <div id="groupBoxContainer2 boxShadow" style="height: auto; width: 100%;">
                            <div id="groupDataDetails2" style="float: left;width: 90%; height: auto;">
                                ...
                                <div id="Div7" runat="server" class="" style=" float:left; width: auto; height: auto; text-align: left; width: 100%">
                                    <div id="dvGridHeaderClosingSummary" style="width: 635px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                        <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                                            ...
                                            <tr class="headerRow_Prod">
                                                ...
                                                <td width="330px" class="headerColCenter_prod">RM Item
                                                </td>
                                    ...
                                    <div id="dvGridClosingSummary" style="width: auto; height: 320px; overflow: auto;" class="dvGrid">
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                                    ...
                                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtCLOSINGITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="330px" Text='<%# Bind("CLOSINGITEM_NAME") %>'></asp:TextBox>
                                                                                    <asp:HiddenField ID="hdnCLOSING_ITEM_ID" runat="server" Value='<%# Bind("CLOSING_ITEM_ID") %>' />
                                                                                </td>
                                                                               <%-- <td>
                                                                                    <input id="btnCLOSINGITEM_NAME" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
