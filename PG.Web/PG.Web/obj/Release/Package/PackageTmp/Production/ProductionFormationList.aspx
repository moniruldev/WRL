<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" ViewStateMode="Disabled" CodeBehind="ProductionFormationList.aspx.cs" Inherits="PG.Web.Production.ProductionFormationList" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production Formation List"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <div id="dvControls" style="width: 100%; height: auto; overflow: auto;">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1200px;">
                    ...
                    <div id="dvGrid" style="width: 100%; height: auto; overflow: auto;">
                        <dx:ASPxGridView ID="grdPastingList" runat="server" EnableRowsCache="false" EnableViewState="false" AutoGenerateColumns="False" Width="98%" ClientInstanceName="grdPastingList" ViewStateMode="Disabled">
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Supervisor" Name="lblSUPERVISOR_NAME" VisibleIndex="7" Width="150px" FieldName="FULL_NAME">
                                </dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataTextColumn Caption="Auth Status" FieldName="AUTH_STATUS" Width="70px" Name="txtAUTH_STATUS" VisibleIndex="4">
                                </dx:GridViewDataTextColumn>
