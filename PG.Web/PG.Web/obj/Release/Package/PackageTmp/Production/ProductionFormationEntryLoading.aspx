<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionFormationEntryLoading.aspx.cs" Inherits="PG.Web.Production.ProductionFormationEntryLoading" %>
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                       ...
                       <%--  var e = document.getElementById("<%=ddlDEPT_ID.ClientID%>");
                        ...
                        var newServiceURL = serviceURL + "&deptid=11";
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                        serviceURL += "&ispaging=1&isFinished=Y&deptid=11&for_production=Y";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        8<asp:HiddenField ID="hdnLoggedInUser" runat="server" />
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Formation Loading Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtPASTING_BATCH" runat="server" CssClass="textBox textAutoSelect" Width="100px" align="right" Text='<%# Bind("PASTING_BATCH") %>'></asp:TextBox>
                                                                    </td>
