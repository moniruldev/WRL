<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="RM_REJECTION_DECLARE.aspx.cs" Inherits="PG.Web.Production.RM_REJECTION_DECLARE" %>
       ...
       <%-- var txtTotWt = '<%=txtTotWt.ClientID%>';--%>
        ...
        function bindItemList(gridViewID) {
           ...
           // var rejectType = $('#' + ddlREJECT_ITEM_TYPE).val();
            ...
            serviceURL += "&ispaging=1&isFinished=N&deptid=" + DEPT_ID + "&rejectType=RM" ;
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        //var vbatchNo = $(elemRowCur).find('input[id$="hdnBatchNo"]').val();&batchno=" + vbatchNo
                        var serviceURL = ItemListServiceLinkd + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
        ...
        function ClearItemData(txtItemID) {
            ...
            $(detRow).find('input[id$="txtTO_REJ_ITEM_NAME"]').val('');
            $(detRow).find('input[id$="hdnTO_REJ_ITEM_ID"]').val('0');
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            $(detRow).find('input[id$="txtTO_REJ_ITEM_NAME"]').val(data.torejitemname);
            $(detRow).find('input[id$="hdnTO_REJ_ITEM_ID"]').val(data.torejitemid);
        }
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="RM Reject Entry"></asp:Label>
            </div>
            <!--Message Div -->
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="display:none;">
                            <asp:TextBox ID="txtProductionDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;display:none;" Width="100px"></asp:TextBox>
                        </td>
                       <%-- <td>
         ...
         <%--           <tr>
                         <td style="text-align: right;">
                              ...
                              <td style="text-align: left;">
                                  <asp:DropDownList ID="ddlREJECT_ITEM_TYPE" runat="server"  CssClass="dropDownList required" Width="190px" >
                                      ...
                                      <asp:ListItem Value="Plate">Reject Plate</asp:ListItem>
                                  </asp:DropDownList>
                              </td>
                         <td style="text-align: right">
            ...
            <div id="dvControls" style="width: 100%; height: 400px;">
                ...
                <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                    <div id="dvGridHeaderClosing" style="width: 1100px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                        <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: left;"
                            ...
                            <tr class="headerRow_Prod">
                             ...
                             <%--   <td width="15px" class="headerColLeft">
                                ...
                                <td width="200px" class="headerColCenter_prod"> Rej Item
                                </td>
                                <td width="15px" class="headerColLeft"></td>

                                 <td width="68px" class="headerColCenter_prod">UOM
                                </td>
                                  <td width="200px" class="headerColCenter_prod"> Rej. Store Item
                                </td>
                    ...
                    <div id="dvGridClosing" style="width: 1100px; height: 250px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                             ...
                                                             <td>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="200px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                ...
                                                                <td>
                                                                 ...
                                                                 <td>
                                                                    <asp:TextBox ID="txtTO_REJ_ITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="200px" Text='<%# Bind("TO_REJ_ITEM_NAME") %>'></asp:TextBox>
                                                                    <asp:HiddenField ID="hdnTO_REJ_ITEM_ID" runat="server" Value='<%# Bind("TO_REJ_ITEM_ID") %>' />
                                                                </td>
                                                                <%--
                                                                 <td>
                                                               ...
                                                               <%-- <td>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtREJECTION_WEIGHT" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect txtWt"   Width="75px" align="right" Text='<%# Eval("REJECTION_WEIGHT", "{0:#,##0.00}") %>'    onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>--%>
                                                                <td>
