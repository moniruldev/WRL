<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionOxideList.aspx.cs" ViewStateMode="Disabled" Inherits="PG.Web.Production.ProductionOxideList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            //var url = IForm.RootPath + "Production/ProductionOxideEntry_WithBOM_NEW.aspx?id=" + key + "&section=" + SECTION;
            
            var url = IForm.RootPath + "Production/ProductionOxideEntry.aspx?id=" + key + "&section=" + SECTION;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Production Oxide Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "Production Oxide Entry";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production Oxide List"></asp:Label>
                </div>
                <!--Message Div -->
                        ...
                        <div id="dvGrid" style="width: 100%; height: auto; overflow: auto;">
                            <dx:ASPxGridView ID="grdAssemblyList" runat="server" AutoGenerateColumns="False" Width="98%"  ClientInstanceName="grdAssemblyList" >
                                <Columns>
                                    ...
                                    <dx:GridViewDataDateColumn Caption="Prod. Date" FieldName="PRODUCTION_DATE" Width="100px"   Name="lblPRODUCTION_DATE" VisibleIndex="3">
                                         <PropertiesDateEdit DisplayFormatString="dd-MMM-yyyy" ></PropertiesDateEdit>
                                    </dx:GridViewDataDateColumn>
                                   
                                      <dx:GridViewDataTextColumn Caption="Batch NO" FieldName="PROD_BATCH_NO" Width="50px" Name="txtPROD_BATCH_NO" VisibleIndex="8">
                                      </dx:GridViewDataTextColumn>
