<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionGridEntry_withBOM_SPL_v2.aspx.cs" Inherits="PG.Web.Production.ProductionGridEntry_withBOM_SPL_v2" %>
    ...
    <script language="javascript" type="text/javascript">
       ...
       <%-- var txtSUPERVISOR_NAME = '<%= txtSUPERVISOR_NAME.ClientID%>';
        ...
        function bindItemList(gridViewID) {
            ...
            var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.ContentForm;
            serviceURL += "&ispaging=1&isFinished=Y&deptid=135&for_production=Y&stlid=2";
        ...
        function ClearItemData(txtItemID) {
            ...
            $(detRow).find('input[id$="txtITEM_CODE"]').val('');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnUsedUOMID" runat="server" />
         <asp:HiddenField ID="hdnDeptID" runat="server" Value="135" />
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Grid Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;" align="left">
                <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%" id="tblProductionMstEntry">
                    ...
                    <tr>
                        ...
                        <td>
                             <asp:TextBox ID="TextBox1" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="GridCast" Width="150px"></asp:TextBox>
                        </td>
                            ...
                            <table style="width: 70%; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 90px" align="left">
                                        <asp:Button ID="btnNewRow" runat="server" CssClass="buttonNewRow" Text="" Visible="false" OnClientClick="ShowProgress()" OnClick="btnNewRow_Click" />
