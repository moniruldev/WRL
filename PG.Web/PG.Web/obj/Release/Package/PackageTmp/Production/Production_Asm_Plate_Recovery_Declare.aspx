<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Production_Asm_Plate_Recovery_Declare.aspx.cs" Inherits="PG.Web.Production.Production_Asm_Plate_Recovery_Declare" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function calcWeight(texbx) {
            ...
            var txtRejectStock_QTY = $(detRow).find('input[id$="txtRejectStock_QTY"]').val();
            var txtRecovery_QTY = $(detRow).find('input[id$="txtRecovery_QTY"]').val();
          


            //if (Number( txtRecovery_QTY )> Number( txtRejectStock_QTY))
            //{
            //    $(detRow).find('input[id$="txtRecovery_QTY"]').val('0');
            //    alert('Please Enter Correct Recovery Qty!!');
            //}
        ...
        function bindItemList(gridViewID) {
            ...
            var serviceURL = ItemListServiceLinkd + "?isterm=1&includeempty=0&iscodename=1&ispaging=1&isFinished=Y&codecomptype=" + Enums.DataCompareType.StartsWith;
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).blur(function () {
                    ...
                    if (eCode == '') {
                        ...
                        serviceURL += "&ispaging=1&&deptid=" + DEPT_ID;
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            $(detRow).find('input[id$="txtRejectStock_QTY"]').val(data.closing_qty);
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Assembly Plate Recovery Declaration"></asp:Label>
            </div>
            <!--Message Div -->
            <div id="dvMsg" runat="server" class="dvMessage" style="">
                            <asp:HiddenField ID="hdnProd_Recovery_ID" runat="server" />
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    ...
                    <tr>--%>
                        ...
                        <td align="right" class="auto-style2">
                            <asp:Label ID="lblRecoveryNo" runat="server" Text="Recovery NO :" style="font-weight: 700"></asp:Label>
                        </td>
                        <td class="auto-style2">
                            <asp:TextBox ID="txtRecoveryNo" runat="server" Style="text-align: left; font-weight: 700;" CssClass="textBox" ForeColor="Red"  Enabled="False"></asp:TextBox>
                        </td>
                        <td align="right">
                              <asp:Label ID="lblRecoveryDate" runat="server" Text="Recovery Date :" style="font-weight: 700"></asp:Label>
                        </td>
                        <td>
                              <asp:TextBox ID="txtRecoveryDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="lblProductionDate" runat="server" Text="Production Date :" style="font-weight: 700" Visible="false"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtProductionDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px" Visible="false"></asp:TextBox>
                        </td>
                       <%-- <td>
                    ...
                    <tr>
                         <td style="text-align: right;">
                                  <asp:Label ID="lblRejectionItem" style="display:none;" runat="server" Text="Rejection ITEM : "></asp:Label>
                              </td>
                              <td style="text-align: left;">
                    ...
                    <tr>
                        <td align="right" class="auto-style2">
                            <asp:Label ID="lblRejectionReason" runat="server" Text="Recovery Reason :" Font-Bold="true"></asp:Label>
                        </td>
                        <td class="auto-style2" colspan="4">
                            <asp:TextBox ID="txtRecoveryReason" runat="server" CssClass="textBox" Style="text-align: left;" Width="500px" ></asp:TextBox>
                        </td>
            ...
            <div id="dvControls" style="width: 100%; height: 400px;">
                ...
                <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                    <div id="dvGridHeaderClosing" style="width: 650px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                            ...
                            <tr class="headerRow_Prod">
                               ...
                               <%-- <td width="135px" class="headerColCenter_prod">
                                ...
                                <td width="15px" class="headerColLeft"></td>
                                 ...
                                 <%--<td width="70px" class="headerColCenter_prod">Std. Panel Wt. (Kg)
                                </td>--%>
                               <%--  <td width="80px" class="headerColCenter_prod">Production Qty
                                </td>--%>
                                <td width="80px" class="headerColCenter_prod">Rject Stock Qty
                                </td>
                                <td width="80px" class="headerColCenter_prod">Recovery Qty
                                </td>
                    ...
                    <div id="dvGridClosing" style="width: 750px; height: 250px; overflow: auto;" class="dvGrid">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="SL#">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSLNO" runat="server" Text='<%# Bind("PROD_REC_DET_SLNO") %>' Style="text-align: center;"
                                                    Width="62px">
                                                </asp:Label>
                                                    ...
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:HiddenField ID="hdnPROD_RECOVERY_ID" runat="server" Value='<%# Bind("PROD_ASM_REC_ID") %>' />
                                                                </td>
                                                               <%-- <td>
                                                                    <asp:TextBox ID="txtBatchNo" runat="server" CssClass="textBox textAutoSelect" Width="128px" align="right" Text='<%# Bind("BATCH_NO") %>'></asp:TextBox>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="134px" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                               ...
                                                               <%-- <td>
                                                                    ...
                                                                    <asp:TextBox ID="txtITEM_STANDARD_WEIGHT_KG" runat="server" CssClass="textBox textAutoSelect"  Width="65px" Text='<%# Bind("ITEM_STANDARD_WEIGHT_KG") %>'></asp:TextBox>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtRejectStock_QTY" runat="server" CssClass="textBox textAutoSelect " style="text-align: right;"  Width="78px" align="right" Text='<%# Bind("REJECT_STOCK_QTY") %>'  onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>

                                                                 <td>
                                                                    <asp:TextBox ID="txtRecovery_QTY" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect" BackColor="Khaki"   Width="75px" align="right" Text='<%# Bind("RECOVERY_QTY") %>' onchange="calcWeight(this)" onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>

                                                              
                                                               <%-- <td>
                                                                    <asp:TextBox ID="txtREJECTION_WEIGHT" runat="server" style="text-align: right;" CssClass="textBox textAutoSelect txtWt"   Width="77px" align="right" Text='<%# Bind("REJECTION_WEIGHT") %>'  onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                </td>--%>
                                                                <td>
                                                                    <asp:TextBox ID="txtRECOVERY_DET_REMARKS" runat="server" CssClass="textBox textAutoSelect" Width="150px" Text='<%# Bind("RECOVERY_DET_REMARKS") %>' Style=""></asp:TextBox>
                                                                </td>
