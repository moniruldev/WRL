<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionQAPass_List.aspx.cs" Inherits="PG.Web.Production.ProductionQAPass_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/ProductionQA_Pass_View.aspx?QAPassMasterId=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "QA Pass Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "QA Pass Entry";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="QA Pass List"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblQANo" runat="server" Text="QA Pass No:"></asp:Label>
                        </td>
                        <td>
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="152px" align="left">QA No
                                    </td>
                                    <td width="80px" align="left">QA Date
                                    </td>
                                    
                                      <%--<td width="80px" align="left">Transfer?
                                    </td>--%>
                                     <td width="100px" align="left">Status
                                    </td>
                        ...
                        <div id="dvGrid" style="width:auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                DataKeyNames="PROD_QA_ID" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PROD_QA_NO" HeaderText="QA No" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="PROD_QA_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="100" />
                                   
                                     <%--<asp:BoundField DataField="QC_PASS_STATUS" HeaderText="Is Transfer" ItemStyle-Width="80px" />--%>
                                     <asp:BoundField DataField="STATUS_NAME" HeaderText="STATUS_NAME" ItemStyle-Width="100px" />
                                    <asp:BoundField DataField="PROD_QA_REMARKS" HeaderText="Remarks" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="FULLNAME" HeaderText="Create By" ItemStyle-Width="200px" />


                                      <asp:TemplateField HeaderText="Authorize?">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsPosted" Text='<%# Eval("IS_TRANSFER").ToString() == "N" ? "No": "Yes" %>'
