<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionGridCastingQAPendingList.aspx.cs" Inherits="PG.Web.Production.ProductionGridCastingQAPendingList" ViewStateMode="Disabled" %>
    ...
    <script language="javascript" type="text/javascript">
       ...
       <%-- var btnGridPageGoTo = '<%=btnGridPageGoTo.ClientID %>';
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/ProductionGridCastingQAEntry_SPL.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Grid Casting QA Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "Grid Casting QA Entry";
                tdata.type = 0;
                tdata.url = url;
     ...
     <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Production Grid Casting QA Pending List"></asp:Label>
                </div>
                <!--Message Div -->
         ...
         <div id="dvContentMain" class="dvContentMain">
                <div id="dvControlsHead" style="height: auto; width: 100%;">
                     <table style="width : 700px">
                        ...
                        <td>
                            <asp:TextBox ID="txtToDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px" ></asp:TextBox></td>
                                  ...
                                  <td>
                                      <asp:DropDownList ID="ddlAUTHO_STATUS" runat="server"  CssClass="dropDownList enableIsDirty" Enabled="false">
                                                <asp:ListItem  Value="">-All-</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="Y">Authorized</asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td>
                             <%--<asp:Button ID="btnAddNew" runat="server" CssClass="buttonNew" Text="New Loading" Height="26px" Visible="false" OnClick="btnAddNew_Click" />--%>
                        </td>
                    </tr>
                         </table>
                    </div>
