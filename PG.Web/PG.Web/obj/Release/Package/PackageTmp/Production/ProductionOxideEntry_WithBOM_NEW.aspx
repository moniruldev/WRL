<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionOxideEntry_WithBOM_NEW.aspx.cs" Inherits="PG.Web.Production.ProductionOxideEntry_WithBOM_NEW" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <link href="../css/jquery.ui.combogrid.css" rel="stylesheet" type="text/css" />
     <script language="javascript" type="text/javascript">
         ...
         var hdnSECTION = '<%=hdnSECTION.ClientID%>';
         ...
         function bindItemList(gridViewID) {
             ...
             serviceURL += "&ispaging=1&isFinished=Y&deptid=" + ddlDEPT_ID;
         ...
         function bindClosingItemList(gridViewIDD) {
             ...
             //var deptId = 0;
             //var isdeptstock = "Y";
             //if ($(ddlDEPT_ID).val() != "" && $(ddlDEPT_ID).val() != "0")
             //{
             //    deptId = $(ddlDEPT_ID).val();
             //}
             ...
             //serviceURL += "&companyid=" + companyid;
             var ddlDEPT_ID = $('#' + hdnSECTION).val();
             serviceURL += "&ispaging=1&deptid=" + ddlDEPT_ID;
         ...
         function bindSupporvisorList() {
             ...
             $(groupIDElem).combogrid({
                 ...
                 search: function (event, ui) {
                     ...
                     var dept_id = e.options[e.selectedIndex].value;
                     //+ dept_id
                     var newServiceURL = serviceURL + "&deptid=2" ;
...
//+ dept_id
         ...
         function bindFinishInRawMaterialSection(gridViewID) {
             ...
             var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
             serviceURL += "&ispaging=1&isFinished=Y&deptid=" + ddlDEPT_ID +"&for_production=Y";
...
<asp:HiddenField ID="hdnFinishItemIdForRm" runat="server" />
         <asp:HiddenField ID="hdnSECTION" runat="server" Value="0" />
...
<asp:HiddenField ID="hdnFinishItemNameForRm" runat="server" />
  ...
  <ul>
                 ...
                 <div id="dvControlsHead" style="height: auto; width: 100%;" align="left">
                      <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%" id="tblProductionMstEntry">
                          ...
                          <tr>
                              ...
                              <td style="text-align: left">
                                  <asp:DropDownList ID="ddlSHIFT_ID" runat="server" CssClass="dropDownList" Width="155px" AutoPostBack="True" ></asp:DropDownList>
   ...
   <div id="tabs-1">
                ...
                <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                    <div id="dvGridHeader2" style="float:left; width:850px;   font-size: smaller;" class="subHeader_Prod">
                           ...
                           <tr class="headerRow_Prod">
                               ...
                               <td width="15px" class="headerColCenter_prod"></td>
                                          ...
                                          <%--  <td width="49px" class="headerColCenter_prod">Item Weight
                                            ...
                                            <td width="15px" class="headerColCenter_prod"></td> 
                                           <%-- <td width="50px" class="headerColCenter_prod"> Used Bar(Pcs)
                                            </td>--%>
                    ...
                    <div id="dvGrid" style="width: 850px; height: 300px; overflow: auto;" class="dvGrid">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                              ...
                                                                              <td>
                                                                                 <asp:TextBox ID="txtMACHINE_NAME" runat="server" CssClass="textBox textAutoSelect" Width="108px" Text='<%#Bind("MACHINE_NAME") %>'></asp:TextBox>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="55px" BackColor="Khaki" align="right" Text='<%# Bind("ITEM_QTY") %>' onchange="TestOnTextChange(this)"   onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                             ...
                                                                             <td>
                                                                                 <asp:TextBox ID="txtOPERATOR_NAME" runat="server" CssClass="textBox textAutoSelect" Width="102px" Text='<%#Bind("OPERATOR_NAME") %>'></asp:TextBox>
 ...
 <%--
                                                                           ...
                                                                           <td>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtBOM_Name" runat="server" CssClass="textBox textAutoSelect" Width="133px" Text='<%#Bind("BOM_NAME") %>'></asp:TextBox>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="130px" Text='<%# Bind("REMARKS") %>' Style=""></asp:TextBox>
                                                                            </td>
  ...
  <asp:TemplateField Visible="false">
                    ...
                    <div id="divGridControls2" style="width: 80%; height: 30px; border-top: solid 1px #C0C0C0; border-bottom : solid 1px #0b07f5;">
...
<%-- Start Closing Details --%>
                ...
                <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                    <div id="dvGridHeaderClosing" style="width: 1270px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                        <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                            ...
                            <tr class="headerRow_Prod">
                                  ...
                                  <td width="122px" class="headerColCenter_prod">Finished Item
                                                        </td>
                                <td width="15px" class="headerColCenter_prod"></td>
                                                    <td width="150px" class="headerColCenter_prod">Item
                                                    </td>
                                                    ...
                                                    <td width="80px" class="headerColCenter_prod">Closing Qty
                                                     ...
                                                     <td width="80px" class="headerColCenter_prod"> Rejected Qty
                                                        ...
                                                        <td width="80px" class="headerColCenter_prod"> Std Used Qty
                                                    </td>
                    ...
                    <div id="dvGridClosing" style=" width: 1280px; height: 100px; overflow: auto;" class="dvGrid">
                      <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                                <asp:GridView ID="grdClosingRowMaterial" runat="server" Width="1280px" AutoGenerateColumns="False" ShowHeader="False" 
                                                                    ...
                                                                    <div>
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                     <td>
                                                                        <asp:TextBox ID="txtFINISH_ITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="115px" Text='<%# Bind("FINISH_ITEM_NAME") %>'></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnFINISHED_ITEM_ID" runat="server" Value='<%# Bind("FINISHED_ITEM_ID") %>' />
                                                                    <%--  <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Bind("CLOSING_ID") %>' />
                                                                     <asp:HiddenField ID="HiddenField2" runat="server" Value='<%# Bind("PROD_MST_ID") %>' />--%>
                                                                    ...
                                                                    <td>
                                                                        <input id="btnFinishItem" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
                                                                                    ...
                                                                                    <td>
                                                                                     ...
                                                                                     <td>
                                                                                        <asp:TextBox ID="txtSYSTEM_OPENING_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="120px" align="right" Text='<%# Bind("SYSTEM_OPENING_STOCK") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    </td>
                                                                                    ...
                                                                                    <%-- <td >
                                                                                     ...
                                                                                     <td>
                                                                                        <asp:TextBox ID="txtCLOSING_QTY" runat="server" CssClass="textBox textAutoSelect"   Width="76" align="right" Text='<%# Bind("CLOSING_QTY") %>' onchange="calcIssueStock(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtWASTAGE_QTY" runat="server" CssClass="textBox textAutoSelect"   Width="76" align="right" Text='<%# Bind("WASTAGE_QTY") %>' onkeypress="return isNumberKey(event,this);"  ></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtREJECTED_QTY" runat="server" CssClass="textBox textAutoSelect"   Width="74" align="right" Text='<%# Bind("REJECTED_QTY") %>' onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                                     <td>
                                                                                        <asp:TextBox ID="txtSTD_USED_QTY" runat="server" CssClass="txtgQty textBox textAutoSelect" Width="74"  align="right" style="text-align:right;"  Text='<%# Bind("STD_USED_QTY") %>' onchange="TestOnTextChangegqty(this)"   onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                     </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtPOSITIVE_DEV" runat="server" CssClass=" txtgQty textBox textAutoSelect"   Width="78" align="right" Text='<%# Bind("POSITIVE_DEV") %>' onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtNEGATIVE_DEV" runat="server" CssClass="txtgQty textBox textAutoSelect"   Width="76" align="right" Text='<%# Bind("NEGATIVE_DEV") %>' onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                                      <td>
                                                                                        <asp:TextBox ID="txtISSUE_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="74" BackColor="Khaki"  align="right" Text='<%# Bind("ISSUE_STOCK") %>' onchange="calcCloseingStock(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
