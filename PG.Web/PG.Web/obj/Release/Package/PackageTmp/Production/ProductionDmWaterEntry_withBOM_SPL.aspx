<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionDmWaterEntry_withBOM_SPL.aspx.cs" Inherits="PG.Web.Production.ProductionDmWaterEntry_withBOM_SPL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;" onkeydown="if(event.keyCode==13){event.keyCode=9; return event.keyCode;}">
        ...
        <asp:HiddenField ID="hdnStoragelocationID" runat="server" Value="11" />
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production DM Water Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
                ...
                <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%;font-size:12px; margin:5px;" id="tblProductionMstEntry">
                    ...
                    <tr>
                       ...
                       <td style="text-align: right" class="auto-style1">
                        ...
                        <td>
                             <asp:TextBox ID="TextBox1" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="DM Water" Width="150px" ReadOnly="true"></asp:TextBox>
                        </td>
 ...
 <div id="tabs-1">
            ...
            <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                 <div id="dvGridHeader2" style="float: left; width: 1224px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                       ...
                                                                       <td>
                                                                        <asp:TextBox ID="txtSupName" runat="server" CssClass="textBox textAutoSelect" Width="100px" Text='<%#Bind("SUP_NAME") %>' Visible="false"></asp:TextBox>
                                                                        <asp:HiddenField ID="hdnSupId" runat="server" Value='<%# Bind("RM_SUP_ID") %>' />
                                                                    </td>
                                                                    <td>
                                                                        <input id="btnSupId" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" visible="false" />
                                                                    </td>
                                                                     ...
                                                                     <td>
                                                                      ...
                                                                      <td>
                                                                                <asp:TextBox ID="txtFalseLugName" runat="server" CssClass="textBox textAutoSelect" Width="100px" Text='<%#Bind("FALSE_LUG_NAME") %>' Visible="false"></asp:TextBox>
