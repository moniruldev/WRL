<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="MRB_Plate_List.aspx.cs" ViewStateMode="Disabled" Inherits="PG.Web.Production.MRB_Plate_List" %>
    ...
    <script language="javascript" type="text/javascript">
       ...
       <%-- var chkIS_PACKING = '<%=chkIS_PACKING.ClientID%>';--%>
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/MRB_Plate_Entry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "MRB Plate Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "MRB Plate Entry";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="MRB Plate List"></asp:Label>
                </div>
                <!--Message Div -->
                        ...
                        <div id="dvGrid" style="width: 100%; height: auto; overflow: auto;">
                            <dx:ASPxGridView ID="grdPureLeadList" runat="server" AutoGenerateColumns="False" Width="98%"  ClientInstanceName="grdPureLeadList" >
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Entry NO" Name="lblPROD_NO" VisibleIndex="2"  Width="150px" FieldName="PROD_NO">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Entry By" Name="lblENTRY_BY_ID" Width="80px" VisibleIndex="4" FieldName="ENTRY_BY">
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataDateColumn Caption="Entry Date" FieldName="PRODUCTION_DATE" Width="100px"   Name="lblPRODUCTION_DATE" VisibleIndex="3">
