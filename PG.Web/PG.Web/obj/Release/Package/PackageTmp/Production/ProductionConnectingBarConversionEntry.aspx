<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionConnectingBarConversionEntry.aspx.cs" Inherits="PG.Web.Production.ProductionConnectingBarConversionEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <%--    var txtTotQty = '<%=txtTotQty.ClientID%>';
        ...
        function bindFinishedItem(gridViewID) {
            ...
            serviceURL += "&ispaging=1&isFinished=Y&for_production=Y";  //&isFinished=Y
        ...
        function ClearClosingItemData(txtRejectItemName) {
            ...
            $(detRow).find('input[id$="hdnConvertedUomId"]').val('0');
        ...
        function SetClosingItemData(txtRejectItemName, data) {
            ...
            $(detRow).find('input[id$="hdnConvertedUomId"]').val(data.uomid);
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Connection Bar Conversion"></asp:Label>
            </div>
            <!--Message Div -->
            <div id="dvMsg" runat="server" class="dvMessage" style="">
                            <asp:HiddenField ID="hdnCONVERSION_MST_ID" runat="server" />
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <div id="dvControls" style="width: 100%; height: 400px;">
                <div id="Div3" runat="server" class="" style="width: 100%; text-align: left;border-top: solid 1px #0b07f5;">
                    <span style="font-weight: bold;font-size : 15px;color :#ff3b00;">Conversion Details: </span>
                </div>
                            ...
                            <tr class="headerRow_Prod">
                             ...
                             <%--   <td width="15px" class="headerColLeft">
                                ...
                                <td width="15px" class="headerColLeft"></td>
                                 <td width="200px" class="headerColCenter_prod"> Converted Item
                                 </td>
                                                ...
                                                <div>
                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <asp:HiddenField ID="hdnPROD_REJECTION_ID" runat="server" Value='<%# Bind("CONVERSION_MST_ID") %>' />
                                                                   ...
                                                                   <td>
                                                                    ...
                                                                    <td>
                                                                     <asp:TextBox ID="txtRejectItemName" runat="server" CssClass="textBox textAutoSelect" Width="200px" Text='<%# Bind("CONVERTED_ITEM_NAME") %>'></asp:TextBox>
                                                                      <asp:HiddenField ID="hdnRejectItemId" runat="server" Value='<%# Bind("CONVERTED_ITEM_ID") %>' />
                                                                  ...
                                                                  <td>
                                                                    <asp:TextBox ID="txtRejection_QTY" runat="server" style="text-align: right;font-size:14px;color:black;" CssClass="textBox textAutoSelect txtQty"  Width="80px" align="right" Text='<%# Bind("ITEM_QTY") %>'  onkeypress=" return isNumberKey(event,this);"></asp:TextBox>
                                                                 </td>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="txtREJECTION_DET_REMARKS" runat="server" CssClass="textBox textAutoSelect" Width="150px" Text='<%# Bind("REMARKS") %>' Style=""></asp:TextBox>
                                                                </td>
