<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionSmallPartsEntry_ItemWise.aspx.cs" Inherits="PG.Web.Production.ProductionSmallPartsEntry_ItemWise" %>
     ...
     <script language="javascript" type="text/javascript">
         ...
         function bindSupporvisorList() {
             ...
             var cgColumns = [{ 'columnName': 'empid', 'width': '80', 'align': 'left', 'highlight': 4, 'label': 'Emp ID' }
                              , { 'columnName': 'fullname', 'width': '250', 'align': 'left', 'highlight': 4, 'label': ' Name' }
                              //, { 'columnName': 'designationName', 'width': '200', 'align': 'left', 'highlight': 4, 'label': ' Designation' }
             ...
             $(groupIDElem).combogrid({
                 ...
                 search: function (event, ui) {
                     ...
                     var newServiceURL = serviceURL + "&deptid=139&name=" + name;
                    //+ dept_id
                     $(this).combogrid("option", "url", newServiceURL);
                 },
                 select: function (event, ui) {
             ...
             $(gridSelector).find('input[id$="txtOPERATOR_NAME"]').each(function (index, elem) {
                 ...
                 $(elem).blur(function () {
                     ...
                     if (eCode == '') {
                         ...
                         var dept_id = e.options[e.selectedIndex].value;
                         var serviceURL = SupporvisorListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
                         serviceURL += "&ispaging=0&isOperator=1&deptid=139";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div id="dvGridHeader2" style="float:left; width: 1400px; height: 25px; font-size: smaller;" class="subHeader_Prod">
                                    <table style="height: 80%; color: #FFFFFF;  font-weight: bold; text-align: left;"
                                        ...
                                        <tr class="headerRow_Prod">
                                            ...
                                            <td width="225px" class="headerColCenter_prod">Item
                                            </td>
                                          ...
                                          <td width="15px" class="headerColLeft"></td>--%>
                                             <td width="58px" class="headerColCenter_prod">UOM
                                            </td>
                                            ...
                                            <td width="46px" class="headerColCenter_prod">   UOM
                                            </td>
                                            <td width="175px" class="headerColCenter_prod"> Operator
                                            </td>
                                            <td width="150px" Style="display: none;"  class="headerColCenter_prod">Used Item
                                            </td>
                                             <td width="180px"    class="headerColCenter_prod">BOM
                                            </td>
                                            <td width="215px" class="headerColCenter_prod">Remarks
                                            </td>
                        ...
                        <div id="groupDataDetails" style=" width: 100%; height: auto;">
                            ...
                            <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width : 100%">
                                ...
                                <div id="dvGrid" style="width: 1424px; height: 250px; overflow: auto;" class="dvGrid">
                                                                ...
                                                                <table border="0" cellpadding="1" cellspacing="1">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="55px" align="right" Text='<%# Bind("ITEM_QTY") %>' onchange="TestOnTextChange(this)" onBlur="AddAutoRM(this)"  BackColor="Khaki"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            </td>
 ...
 <%--
     ...
     <td>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtBOM_Name" runat="server" CssClass="textBox textAutoSelect" Width="175px" Text='<%#Bind("BOM_NAME") %>'></asp:TextBox>
                            ...
                            <div id="Div3" runat="server" class="" style="width: 100%; text-align: left;">
                                <span style="font-weight: bold; font-size : 15; color :#ff3b00;">Closing Raw Materials Details: </span>
                                    ...
                                    <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left;width : 100%">
                                        ...
                                        <div id="dvGridClosing" style="width: 1424px; height: 200px; overflow: auto;" class="dvGrid">
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtSTD_USED_QTY" runat="server" CssClass="textBox textAutoSelect" Width="72"  align="right" style="text-align:right;" Text='<%# Eval( "STD_USED_QTY", "{0:#,##0.00}") %>'  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtPOSITIVE_DEV" runat="server" CssClass="txtgQty textBox textAutoSelect"   Width="45px" align="right" style="text-align:right;" BackColor="Yellow" Text='<%# Bind("POSITIVE_DEV") %>' onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtNEGATIVE_DEV" runat="server" CssClass=" txtgQty textBox textAutoSelect"   Width="45px" align="right" style="text-align:right;" BackColor="Yellow" Text='<%# Bind("NEGATIVE_DEV") %>' onchange="TestOnTextChangegqty(this)" onBlur=" calcCloseingDevStock(this)" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                                                                    </td>
                                                                                      <td>
                                                                                        <asp:TextBox ID="txtISSUE_STOCK" runat="server" CssClass="textBox textAutoSelect" Width="80px" align="right" Text='<%# Eval("ISSUE_STOCK", "{0:#,##0.00}") %>' onchange="calcCloseingStock(this)"  onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
