<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionGridCastingEntry_withBOM_SPL_V1.aspx.cs" Inherits="PG.Web.Production.ProductionGridCastingEntry_withBOM_SPL_V1" %>
                ...
                <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 90%" id="tblProductionMstEntry">
                    ...
                    <tr>
                       ...
                       <td style="text-align: right" class="auto-style1">
                        ...
                        <td>
                             <asp:TextBox ID="TextBox1" runat="server" CssClass="textBox" Style="text-align: left;background-color:gray; color : white;font-size:larger; font-weight: 700;" Text="GridCast" Width="150px" ReadOnly="true"></asp:TextBox>
                        </td>
            ...
            <div id="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                ...
                <table style="height: 80%; color: #FFFFFF; font-weight: bold; text-align: left;"
                    ...
                    <tr class="headerRow_Prod">
                        ...
                        <td width="60px" class="headerColCenter_prod">Item (Pcs) Qty
                        </td>
                        <td width="30px" class="headerColCenter_prod">UOM
                        </td>
                        <td width="30px" class="headerColCenter_prod">STD Weight
                        </td>
                        <td width="50px" class="headerColCenter_prod">Item Weight
                        </td>
                        <td width="30px" class="headerColCenter_prod">Weight UOM
                        </td>
                       <%-- <td width="10px" class="headerColCenter_prod"></td>--%>
                        <td width="80px" class="headerColCenter_prod">BatchNo
                        </td>
                        <td width="120px" class="headerColCenter_prod">Operator
                        </td>
                         <td width="120px" class="headerColCenter_prod">Supplier
                        </td>
                          <td width="15px" class="headerColCenter_prod">Del.
                        </td>
                       
                         <td width="90px" class="headerColCenter"> BOM
                                            </td>
                        <td width="90px" class="headerColCenter"> False Lug
                                            </td>
                ...
                <div id="groupDataDetails" style="width: 100%; height: auto;">
                    ...
                    <div id="dvGridContainer2" class=" " runat="server" style="height: auto; text-align: left; width: 100%">
                        ...
                        <div id="dvGrid" style="width: 1240px; height: 200px; overflow: auto;" class="dvGrid">
                                                        ...
                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="215px" Text='<%# Bind("ITEM_NAME") %>' Style="font-size:11px;font-weight:bold; color:black;"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtUOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="30px" Text='<%# Bind("UOM_NAME") %>'></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtITEM_STANDARD_WEIGHT_KG" runat="server" CssClass="txtstdweightQty textBox textAutoSelect" Width="30px" style="text-align:right;font-size : 11px;" Text='<%# Bind("ITEM_STANDARD_WEIGHT_KG") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <asp:TextBox ID="txtWEIGHT_UOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="30px" Text='<%# Bind("WEIGHT_UOM_NAME") %>' Style=""></asp:TextBox>
                                                                  ...
                                                                  <%--  <td>
                                                                       ...
                                                                       <td>
                                                                        ...
                                                                        <asp:TextBox ID="txtBatchNoDtl" runat="server" CssClass="textBox textAutoSelect" Width="80px" Text='<%# Bind("PROD_BATCH_NO_DTL") %>' Style=""></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="txtOPERATOR_NAME" runat="server" CssClass="textBox textAutoSelect" Width="100px" Text='<%#Bind("OPERATOR_NAME") %>' Style="font-size:11px;"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                       ...
                                                                       <td>
                                                                        <asp:TextBox ID="txtSupName" runat="server" CssClass="textBox textAutoSelect" Width="100px" Text='<%#Bind("SUP_NAME") %>' Style="font-size:11px;"></asp:TextBox>
                                                                    ...
                                                                    <td>
                                                                        <asp:LinkButton ID="btnDeleteRow" CssClass="buttonDeleteIcon" Height="16px" Width="18px" CommandName="delete" runat="server"> </asp:LinkButton>
                                                                    </td>

                                                                     <td>
                                                                                <asp:TextBox ID="txtBOM_Name" runat="server" CssClass="textBox textAutoSelect" Width="90px" Text='<%#Bind("BOM_NAME") %>'></asp:TextBox>
                                                                                 <asp:HiddenField ID="hdnITEM_BOM_ID" runat="server" Value='<%# Bind("BOM_ID") %>' />
                                                                            </td>
                                                                      <td>
                                                                                <asp:TextBox ID="txtFalseLugName" runat="server" CssClass="textBox textAutoSelect" Width="90px" Text='<%#Bind("FALSE_LUG_NAME") %>'></asp:TextBox>
