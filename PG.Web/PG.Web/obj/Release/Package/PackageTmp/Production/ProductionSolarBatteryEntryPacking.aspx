<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionSolarBatteryEntryPacking.aspx.cs" Inherits="PG.Web.Production.ProductionSolarBatteryEntryPacking" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Production Charging Battery Packing Entry" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
        ...
        <div id="dvContentMain" class="dvContentMain" align="left">
            ...
            <div id="tabs" style="height: 95%; background: url(../image/bg_greendot.gif) !important;">
                <ul>
                    ...
                    <li><a href="#tabs-1">Packing</a></li>
                     <li><a href="#tabs-2">Used RM </a></li>
                     <li style="display:none"><a href="#tabs-3">Unloading</a></li>
