<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="RecoveryProcesList.aspx.cs" ViewStateMode="Disabled" Inherits="PG.Web.Production.RecoveryProcesList" %>
    ...
    <script language="javascript" type="text/javascript">
       ...
       <%-- var chkIS_PACKING = '<%=chkIS_PACKING.ClientID%>';--%>
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Production/RecoveryProcesEntry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Recovery Lead Process Entry";
                //tdata.label = "User: " + userid;
                tdata.label = "Recovery Lead Process Entry";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
          <div id="dvContentHeader" class="dvContentHeader">
                <div id="dvHeader" class="dvHeader_Prod">
                    <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Recovery Lead Reporocess List"></asp:Label>
                </div>
                <!--Message Div -->
         ...
         <div id="dvContentMain" class="dvContentMain">
                <div id="dvControlsHead" style="height: auto; width: 100%;">
                    ...
                    <tr>
                        ...
                        <td> &nbsp;</td>
                        <td> 
                            <asp:Button ID="btnAddNew" runat="server" CssClass="buttonNew" Text="New Recovery Process" Height="26px" Width="160px" EnableViewState="False"/>
