<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master"  AutoEventWireup="true" CodeBehind="GLTranCodeList.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.GLTranCodeList" %>
...
function tbopen(key, userid)
{
  ...
  var url = IForm.RootPath + "Accounting/GeneralLedger/GLTranCode.aspx?id=" + key;
    ...
    if (IForm.PageMode == Enums.PageMode.InTab)
    {
       ...
       tdata.id = 0;
       tdata.name = "GLTranCode";
       //tdata.label = "User: " + userid;
       tdata.label = "GL Tran. Code";
       tdata.type = 0;
       tdata.url = url;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvContentHeader" class="dvContentHeader">
       <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="GL Tran. Code List"></asp:Label>
    </div>
      ...
      <table>
            ...
            <asp:Button ID="btnRefresh" runat="server"  CssClass="buttonRefresh" style="padding-left:22px;"
               ...
               <td>
                ...
                <input id="btnAddNew" type="button" runat="server" value="New GL Tran Code" class="buttonNew" style="padding-left:22px; width:130px;" />
    ...
    <div id="dvGridContainer" style="width:100%; height: auto; text-align:left;">
        <div id="dvGridHeader" style="width:100%;height:25px; font-size: smaller;" class="subHeader">
            ...
            <tr>
                ...
                <td width="202px" align="left">Cetagory</td>
            </tr>
            </table>
        </div> 
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            DataKeyNames="AccRefID" onrowdatabound="GridView1_RowDataBound" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="AccRefCode" HeaderText="Code" ItemStyle-Width="100px" />
                <asp:BoundField DataField="AccRefName" HeaderText="Name" >
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="200px" HorizontalAlign="Left" />
                </asp:BoundField> 
                <asp:BoundField DataField="AccRefCategoryName" HeaderText="Category" ItemStyle-Width="200px" />               
            </Columns>
