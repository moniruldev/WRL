<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master"  AutoEventWireup="true" CodeBehind="LocationwiseLedgerList.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.LocationwiseLedgerList" %>
...
function tbopen(key, userid)
{
    ...
    var url = IForm.RootPath + "Accounting/GeneralLedger/LocationwiseLedgerBinding.aspx?id=" + key;
    ...
    if (IForm.PageMode == Enums.PageMode.InTab)
    {
       ...
       tdata.id = 0;
       tdata.name = "LocationwiseLedger";
       //tdata.label = "User: " + userid;
       tdata.label = "Location wise Ledger";
       tdata.type = 0;
       tdata.url = url;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvContentHeader" class="dvContentHeader">
       <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Location wise Ledger List"></asp:Label>
    </div>
    ...
    <div id="dvGridContainer" style="width:100%; height: auto; text-align:left;">
        <div id="dvGridHeader" style="width:100%;height:25px; font-size: smaller;" class="subHeader">
            ...
            <tr>
                ...
                <td width="222px" align="left">GLAccountID</td>
                <td width="102px" align="left">GLAccountCode</td>
                <td width="222px" align="left">GLAccountName</td>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            DataKeyNames="LocationGLAccountID" onrowdatabound="GridView1_RowDataBound" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="GLAccountID" HeaderText="GLAccountID" ItemStyle-Width="100px" />
                <asp:BoundField DataField="GLAccountCode" HeaderText="GLAccountCode" >
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="220px" HorizontalAlign="Left" />
                </asp:BoundField> 
                <asp:BoundField DataField="GLAccountName" HeaderText="GLAccountName" >
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="220px" HorizontalAlign="Left" />
                </asp:BoundField> 
