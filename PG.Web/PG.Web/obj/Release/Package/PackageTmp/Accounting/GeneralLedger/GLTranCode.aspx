<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="GLTranCode.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.GLTranCode" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="GL Tran. Code"></asp:Label>
    </div>
    <!--Message Div -->
             ...
             <div id="groupBox">
              ...
              <table style="text-align:left;" border="0" cellspacing="4" cellpadding="2">
                ...
                <td>
                 ...
                 <td style="" align="right">
                   <asp:Label id="Label9" runat="server" Text="Catagory:" ></asp:Label>
                    </td>
                 <td style="" align="left">
                     <asp:DropDownList ID="ddlCategory" runat="server" CssClass="dropDownList" Width="130">
                     </asp:DropDownList>
