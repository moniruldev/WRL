<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master"  AutoEventWireup="true" CodeBehind="CostCenterList.aspx.cs" Inherits="PG.Web.Accounting.CostCenterList" %>
...
function tbopen(key, userid)
{
  ...
  var url = IForm.RootPath + "Accounting/GeneralLedger/CostCenter.aspx?id=" + key;
    ...
    if (IForm.PageMode == Enums.PageMode.InTab)
    {
       ...
       tdata.id = 0;
       tdata.name = "CostCenter";
       //tdata.label = "User: " + userid;
       tdata.label = "Cost Center";
       tdata.type = 0;
       tdata.url = url;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvContentHeader" class="dvContentHeader">
       <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Cost Center List"></asp:Label>
    </div>
      ...
      <table>
            ...
            <asp:Button ID="btnRefresh" runat="server"  CssClass="buttonRefresh" style="padding-left:22px;"
               ...
               <td>
                ...
                <input id="btnAddNew" type="button" runat="server" value="New Cost Center" class="buttonNew" style="padding-left:22px; width:130px;" />
