<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="CostCenter.aspx.cs" Inherits="PG.Web.Accounting.GeneralLedger.CostCenter" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div id="dvHeader" class="dvHeader" >
		<asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Cost Center"></asp:Label>
	</div>
	<!--Message Div -->
