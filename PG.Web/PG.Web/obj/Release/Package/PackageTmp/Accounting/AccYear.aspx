<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="AccYear.aspx.cs" Inherits="PG.Web.Accounting.AccYear" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Accounting Year"></asp:Label>
    </div>
    <!--Message Div -->
              ...
              <table style="text-align:left;" border="0" cellspacing="4" cellpadding="2">
                 <tr>
                   ...
                   <td>
                       &nbsp;</td>
                   <td>
                       <asp:HiddenField ID="hdnAccYearID" runat="server" Value="0" />
                   </td>
                                      <td>
                   </td>
                   <td>
                 ...
                 <td style="" align="right">
                   <asp:Label id="Label1" runat="server" Text="Year Name" ></asp:Label>
                 </td>
                 <td style="" align="left">
                    <asp:TextBox id="txtAccYearName" runat="server" CssClass="textBox fldRequired enableIsDirty" 
                ...
                <td>
                 ...
                 <td style="" align="left">
                      <asp:TextBox id="txtStartDate" runat="server" Width="130px" 
                            CssClass="textBox textDate dateParse fldRequired enableIsDirty" ></asp:TextBox>
                      </td>
                  <td style="" align="right">
                 ...
                 <td style="" align="left">
                     <asp:TextBox id="txtEndDate" runat="server" Width="130px" 
                            CssClass="textBox textDate dateParse fldRequired enableIsDirty" ></asp:TextBox>
                ...
                <tr>
                 ...
                 <td style="" align="right">
                   <asp:Label id="Label2" runat="server" Text="Op. Balance Date" ></asp:Label>
                 </td>
                 <td style="" align="left">
                     <asp:TextBox id="txtOpBalDate" runat="server" Width="130px" 
                            CssClass="textBox textDate dateParse fldRequired enableIsDirty" ></asp:TextBox>
                ...
                <td>
                 ...
                 <td style="" align="right">
                   <asp:Label id="Label9" runat="server" Text="Closed?" ></asp:Label>
                    </td>
                 <td style="" align="left">
                      
                     <asp:DropDownList ID="ddlIsClosed" runat="server" Width="130"  CssClass="dropDownList enableIsDirty">
