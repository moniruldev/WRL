<%@ Page Title="InstrumentReceiveList" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="InstrumentReceiveList.aspx.cs" Inherits="PG.Web.Accounting.InstrumentReceiveList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script language="javascript" type="text/javascript">
         ...
         function tbopen(key, userid) {
             ...
             var url = IForm.RootPath + "Accounting/InstrumentReceive.aspx?id=" + key;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvContentHeader" class="dvContentHeader">
       <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Instrument Receive List"></asp:Label>
    </div>
      ...
      <table>
             <tr>
               ...
               <td>
                ...
                <td>
                   <asp:DropDownList ID="ddlInstrumentMode" runat="server"  CssClass="dropDownList" AutoPostBack="True" Visible="false">
