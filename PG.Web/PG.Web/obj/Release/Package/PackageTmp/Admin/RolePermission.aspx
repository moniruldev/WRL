<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master"  AutoEventWireup="true" CodeBehind="RolePermission.aspx.cs" Inherits="PG.Web.Admin.RolePermission" %>
 ...
 <div  id="dvPageContent" style="width:100%; height:100%;" >
   ...
   <div id="dvContentHeader" class="dvContentHeader">  
    ...
    <div id="dvHeader" class="dvHeader">
        <asp:Label ID="lblHeader" runat="server" Text="Role Permission" 
    ...
    <div id="dvControlsHead" style="height:auto;width:100%;">
       <table>
        ...
        <asp:CheckBox ID="chkCopy" runat="server" Text="Copy From" 
                style="" onclick="return chkCopy_Click()" />
             </td>
       ...
       <div id="dvGridContainer" class="gridContainer"  
         ...
         <div id="dvGridHeader" style="width:100%;height:25px; font-size: smaller;" class="subHeader">
            ...
            <tr>
                ...
                <td width="152px" align="left">Object Name</td>
                <td width="62px" align="left">Type</td>
                <td width="52px" align="center">Read</td>
                <td width="52px" align="center">Add</td>
                <td width="52px" align="center">Edit</td>
                <td width="52px" align="center">Delete</td>
                <td width="52px" align="center">List</td>
                <td width="52px" align="center">Execute</td>
                <td width="52px" align="center">Enabled</td>
                <td width="52px" align="center">Visible</td>
            </tr>
            </table>
        </div> 
    ...
    <asp:GridView style="Z-INDEX: 100;" 
            id="GridView1" runat="server" DataKeyNames="AppObjectID,RoleID" 
        ...
        <Columns >
            <asp:BoundField DataField="AppObjectName" HeaderText="Object Name" >
                <ItemStyle BorderColor="Gray" Width="150px"  />
            </asp:BoundField>
            <asp:BoundField DataField="AppObjectTypeName" HeaderText="Type" >
                <ItemStyle BorderColor="Gray" Width="50px"  />
            </asp:BoundField>
