<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewDirectITCFormAdminStore.aspx.cs" Inherits="PG.Web.Inventory.INVNewDirectITCFormAdminStore" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var EmployeeListServiceLink = '<%=this.EmployeeListServiceLink%>';
        var txtEmpName = '<%=txtEmpName.ClientID%>';
        var btnEmpID = '<%=btnEmpID.ClientID%>';
        var txtEmpId = '<%=txtEmpId.ClientID%>';
      ...
      <%--  var txtCustomerID = '<%=txtCustomerID.ClientID%>';--%>
        ...
        function bindEmpList() {
            ...
            var cgColumns = [
                              { 'columnName': 'empid', 'width': '100', 'align': 'left', 'highlight': 4, 'label': 'Emp Id' }
                             , { 'columnName': 'empname', 'width': '200', 'align': 'left', 'highlight': 4, 'label': 'Name' }
                             , { 'columnName': 'emp_deg', 'width': '100', 'align': 'left', 'highlight': 4, 'label': 'Designation' }
                              , { 'columnName': 'department', 'width': '120', 'align': 'left', 'highlight': 4, 'label': 'Department' }
                             , { 'columnName': 'company', 'width': '160', 'align': 'left', 'highlight': 4, 'label': 'Company' }

            ];

            var itemServiceURL = EmployeeListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;

            itemServiceURL += "&ispaging=1";
            var itemIDElem = $('#' + txtEmpName);

            $('#' + btnEmpID).click(function (e) {
            ...
            $(itemIDElem).combogrid({
                ...
                search: function (event, ui) {
                    var DeptID = $('[id*=ddlToDepartment] option:selected').val();
                    //var lcid = $('#' + hdnLcId).val();
                    var newServiceURL = itemServiceURL + "&deptid=" + DeptID;
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.itemid == '') {
                        ...
                        $('#' + txtEmpId).val(ui.item.empid);
                        $('#' + txtEmpName).val(ui.item.empname);
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        var newServiceURL = serviceURL + "&groupid=" + vgroupid + "&deptid=" + DeptID + "&storeid=" + storeid;
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            $(detRow).find('input[id$="txtUnitPrice"]').val(data.unitprice);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hdnToStoreID" runat="server" />
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="ITC:Direct Issue from Store"></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>ITC:Direct Issue from Store</span>
                        </div>
                            ...
                            <div id="groupContenInner">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <%-- onblur="checkDt(this)"--%>
                                                          <td>To.Department:<span style="color:red">*</span></td>
                                                        <td align="left">
                                                            <asp:DropDownList ID="ddlToDepartment" runat="server" CssClass="dropDownList required" Visible="false">
                                                            </asp:DropDownList>
                                                    ...
                                                    <tr>
                                                          <td>From Department:<span style="color: red">*</span></td>
                                                        <td align="left">
                                                            <asp:DropDownList ID="ddlFromDepartment" runat="server" CssClass="dropDownList required" OnSelectedIndexChanged="ddlFromDepartment_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtEmpName" runat="server" CssClass="textBox textAutoSelect" Width="202px" Height="20px"></asp:TextBox>
                                                        <input id="btnEmpID" type="button" value="" runat="server" class="buttonDropdown" style="width: 15px " tabindex="-1" />
                                                    </td>
                                                        <td align="right">
                                                            <asp:Label runat="server" ID="lblEmpId" Text="Employee ID:"></asp:Label>
                                                        </td>
                                                     <td>
                                                       <asp:TextBox ID="txtEmpId" runat="server" CssClass="textBox textAutoSelect" Width="100px" Height="20px"></asp:TextBox>
                                                      </td>
                                                    <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <asp:CheckBox runat="server" ID="chkEnableStrTransfer" OnCheckedChanged="chkEnableStrTransfer_CheckedChanged" AutoPostBack="true" />
                                                            <asp:Label runat="server" ID="lblchkEnableStrTransfer" Text="Enable Store Transfer" Style="font-size:12px; color:green;font-weight:bold"></asp:Label>
                                                        </td>
                                                    </tr>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="60px" class="headerColLeft">Weight. Avg. Price
                                                    </td>
                                                    <td width="60px" class="headerColLeft">Total Cost
                                                    </td>
                                                     <td width="50px" class="headerColLeft">Stock Qty
                                                    </td>
                                        ...
                                        <div id="dvGrid" style="width: 90%; height: 200px; overflow: auto;" class="dvGrid">
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect textNumberOnly" Width="58" Text='<%# Bind("ISSUE_QNTY") %>' OnTextChanged="txtItem_qty_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <td>
                                                                                        <asp:TextBox ID="txtUnitPrice" Enabled="false" runat="server" CssClass="textBox textAutoSelect textNumberOnly" Width="58" Text='<%# Bind("UNIT_PRICE") %>' ></asp:TextBox>

                                                                                    </td>


                                                                                        <td>
                                                                                        <asp:TextBox ID="txtTotalCost"  Enabled="false"  runat="server" CssClass="textBox textAutoSelect textNumberOnly" Width="58" Text='<%# Bind("TOTAL_COST") %>' ></asp:TextBox>
