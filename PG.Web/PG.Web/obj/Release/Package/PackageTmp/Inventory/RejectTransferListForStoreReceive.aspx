<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="RejectTransferListForStoreReceive.aspx.cs" Inherits="PG.Web.Inventory.RejectTransferListForStoreReceive" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/RejectionReceiveByStoreEntry.aspx?id=" + key + "&type=" + "";
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Reject Receive From Department"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <div id="dvControls" style="width: 100%;">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 600px">
                        ...
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="170px" align="left">Issue No
                                    </td>
                                    <td width="100px" align="left">Issue Date
                                    </td>
                                  
                                    <td width="200px" align="left">Issue By Dept</td>
                                  

                                </tr>
                            </table>
                        </div>
                        <div id="dvGrid" style="width: 520px; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="REJ_ISSUE_NO" HeaderText=" ISSUE No" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="REJ_ISSUE_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="100" />
                                    <asp:BoundField DataField="DEPARTMENT_NAME" HeaderText="Issue Dept" ItemStyle-Width="200px" />
