<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewDirectItemReceive.aspx.cs" Inherits="PG.Web.Inventory.INVNewDirectItemReceive" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function bindItemList(gridViewID) {
            ...
            //var serviceURL = GLAccountServiceLink + "?isterm=1&includeempty=1&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&deptid=26&storeid=1&isdirectitc=1&isdirectitc=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            //serviceURL += "&companyid=" + companyid;
            serviceURL += "&ispaging=1";
            //serviceURL += "&locationid=" + locationid;
            // serviceURL += "&empstatus=" + "A";
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        if (itemName != "") {
                            ...
                            itemtypeid = $(elemRowCur).find('[id*=ddlItemType] option:selected').val();
                            itemid = $(elemRowCur).find('input[id$="hdnItemID"]').val();
                        ...
                        //alert(itemtypeid);
                        var newServiceURL = serviceURL + "&groupid=" + vgroupid + "&itemtypeid=" + itemtypeid + "&itemid=" + 4759;
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Direct Item Receive"></asp:Label>
            </div>
                            ...
                            <div id="groupContenInner">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblReceiveNO" runat="server" Text="Receive No:"></asp:Label>
                                                        </td>

                                                        <td>

                                                            <asp:TextBox ID="txtReceiveNo" runat="server" CssClass="colourdisabletextBox" ReadOnly="True" BackColor="#FFFFCC"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                        <td align="right">
                                                            <asp:Label ID="lblRecieveDate" runat="server" Text="Receive Date:"></asp:Label><span style="color:red">*</span>

                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtReceiveDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                                                            <asp:RegularExpressionValidator runat="server" ControlToValidate="txtReceiveDate" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$" ErrorMessage="Invalid date format." ValidationGroup="Group1" ForeColor="Red" />
                                                        </td>
                                                        <%-- onblur="checkDt(this)"--%>
                                                          <td>Receive Department:<span style="color:red">*</span></td>
                                                        <td align="right">
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        ...
                                        <div id="dvGrid" style="width: 95%; height: 200px; overflow: auto;" class="dvGrid">
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="SL#">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSLNo" runat="server" Text='<%# Bind("RCV_DET_SLNO") %>' Style="text-align: center;"
                                                                        Width="64px">
                                                                    </asp:Label>
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect textNumberOnly" Width="58" Text='<%# Bind("RECEIVE_QNTY") %>' ></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <%--<td >--%>
                                                                                        <%--<asp:TextBox ID="txtUnitPrice" Enabled="true" runat="server" CssClass="textBox textAutoSelect textNumberOnly" Width="58" Text='<%# Bind("UNIT_PRICE") %>' style="display:none;" ></asp:TextBox>--%>

                                                                                  <%--  </td>--%>


                                                                                       <%-- <td>--%>
                                                                                        <%--<asp:TextBox ID="txtTotalCost"  Enabled="false"  runat="server" CssClass="textBox textAutoSelect textNumberOnly" Width="58" Text='<%# Bind("TOTAL_COST") %>' style="display:none;" ></asp:TextBox>--%>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="150" Text='<%# Bind("RCV_DET_NOTE") %>' Style=""></asp:TextBox>
                                                                                    </td>
