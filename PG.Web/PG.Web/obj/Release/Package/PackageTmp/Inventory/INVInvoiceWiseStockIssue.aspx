<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVInvoiceWiseStockIssue.aspx.cs" Inherits="PG.Web.Inventory.INVInvoiceWiseStockIssue" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Delivery Order Wise Stock Issue: DC,GP Generate:"></asp:Label>
            </div>
            <!--Message Div -->
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 650px">
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                           ...
                           <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;" class="defFont"  cellspacing="1" cellpadding="1" rules="all">
                                <tr>
                                  ...
                                  <%--  <td width="152px" align="left">Invoice Id
                                    ...
                                    <td width="100px" align="left">Invoice No
                                    </td>
                                    <td width="80px" align="left">Invoice Date
                                    </td>
                                    <td width="130px" align="left">Invoice Time
                                    </td>
                                     <td width="130px" align="left">Remarks
                                    </td>
                                     <td width="130px" align="left">Type
                                    </td>
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    <asp:HyperLinkField HeaderText="" Text="New GP">
                                        <ControlStyle Height="20px" Width="65px" />
                 ...
                 <asp:Label ID="lblINVOICEID" runat="server" Text='<%# Bind("INVOICE_ID") %>' Style="text-align: center;" Width="150px"></asp:Label>
                   ...
                   <ItemStyle VerticalAlign="Top" />
                                    ...
                                    <asp:BoundField DataField="INVOICE_NO" HeaderText="Invoice no" ItemStyle-Width="100px" />
                                    <asp:BoundField DataField="INVOICE_DATE" HeaderText="Invoice Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="80px" />

                                    <asp:BoundField DataField="INVOICE_TIME" HeaderText="Invoice Time" ItemStyle-Width="130px" />
                                    <asp:BoundField DataField="INVOICE_REMARKS" HeaderText="Remarks" ItemStyle-Width="130px" />
                                    <asp:BoundField DataField="ITEMTYPEQTY" HeaderText="Type" ItemStyle-Width="130px" />
