<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewIRRByDepartment.aspx.cs" Inherits="PG.Web.Inventory.INVNewIRRByDepartment" %>
                ...
                <table border="0" cellspacing="4" cellpadding="2" align="center" style="width: 100%" id="tblItemEntry">
                    ...
                    <tr>
                        ...
                        <td align="left" class="auto-style3">
                          ...
                          <td align="right" class="auto-style2">
                            <asp:Label ID="lblIGRNo" runat="server" Text="IGR No :" Font-Bold="true" Font-Size="9"></asp:Label>
                        </td>
                        <td align="left" class="auto-style3">
                            <asp:TextBox ID="txtIGRNo" runat="server" CssClass="textBox" ReadOnly="true" Font-Bold="true" Width="150"></asp:TextBox>
                        </td>
                        <td align="right" class="auto-style2">
                ...
                <ItemStyle BorderColor="Gray" HorizontalAlign="Center" Width="100px"  />
                                    ...
                                    <asp:TemplateField HeaderText="Item Name" Visible="true">
                                     ...
                                     <asp:TemplateField HeaderText="Uom" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblUomName" runat="server" Text='<%# Bind("UOM_CODE") %>' Style="text-align: center;" Width="60px"></asp:Label>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="txtReqQty" runat="server" Text='<%# Bind("REQ_QNTY") %>' Style="text-align: center;" Width="60px"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Issue Qty" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="txtPurchaseQty" runat="server" Text='<%# Bind("RCV_QNTY") %>' Style="text-align: center;" Width="60px"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Rcv Qty" Visible="true">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtMrrQty" Text='<%# Bind("RCV_QNTY") %>' runat="server" CssClass=" textBox textNumberOnly" Style="text-align: center;" Width="60px" OnTextChanged="txtMrrQty_TextChanged" AutoPostBack="true" ReadOnly="true" onkeypress="return isNumberKey(event,this);" ></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblUnitPrice" runat="server" Text='<%# Bind("UNIT_PRICE") %>' Style="text-align: center; display:none;" Width="60px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>
