<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Category_Entry.aspx.cs" Inherits="PG.Web.Inventory.Category_Entry" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Category"></asp:Label>
            </div>
            <!--Message Div -->
                                ...
                                <table cellpadding="2" cellspacing="4">
                                    <tr>
                                     ...
                                     <tr>
                                        <td></td>
                                        <td align="right">
                                            <asp:Label ID="lblCategoryCode" runat="server" Text="Category Code:"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtCategoryCode" runat="server" CssClass="textBoxReadOnly"
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:TextBox ID="txtCategoryName" runat="server" CssClass="textBox fldRequired enableIsDirty"
