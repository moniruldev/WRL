<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewIGRApproval.aspx.cs" Inherits="PG.Web.Inventory.INVNewIGRApproval" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IGR:INTERNAL GOODS REQUISITION APPROVAL "></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>IGR:INTERNAL GOODS REQUISITION APPROVAL </span>
                        </div>
                                            ...
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="60px" class="headerColLeft">Item Qty
                                                      ...
                                                      <td width="60px" class="headerColLeft">Approved Qty
                                                    </td>
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtApprovedQty" runat="server"   CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("REQ_APRV_QNTY") %>' onkeypress="return onlyNos(event,this);" ></asp:TextBox>
