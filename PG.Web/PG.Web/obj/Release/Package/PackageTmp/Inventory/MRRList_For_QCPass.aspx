<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="MRRList_For_QCPass.aspx.cs" Inherits="PG.Web.Inventory.MRRList_For_QCPass" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/QC_Pass_Entry.aspx?id=" + key;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="MRR List For QC"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="btnAddNew" type="button" runat="server" value="New MRR" class="buttonNew"
                        ...
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="152px" align="left">MRR No
                                    </td>
                                    <td width="80px" align="left">MRR Date
                                    </td>

                                    <td width="150px" align="left">Pur No
                                    </td>
                                    <td width="100px" align="left">Purchase Date
                                    </td>
                                     <td width="100px" align="left">Item's
                                    </td>
                                    <td width="300px" align="left">Supplier
                                    </td>
                        ...
                        <div id="dvGrid" style="width:auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MRR_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="80" />
                                    <asp:BoundField DataField="PURCHASE_NO" HeaderText="Purchase No" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="PURCHASE_DATE" HeaderText="Purchase Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="100px" />
                                     <%--<asp:BoundField DataField="ITEM_NAME" HeaderText="Supplier" ItemStyle-Width="400px" />--%>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" ID="lnkItemDtl"  CssClass="btn btn-default"  CommandName="itemdtl" CommandArgument='<%# Bind("MRR_NO") %>'><i class="glyphicon glyphicon-info-sign" style="padding-right:4px; font-size:14px; color:#4695cf"></i>Items</asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle Width="100px" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="SUP_NAME" HeaderText="Supplier" ItemStyle-Width="300px" />
                ...
                <div class="modal-content" style="max-width:500px;">  
                    ...
                    <div class="modal-body" style="overflow-y:scroll; overflow-x:scroll; max-height: 95%; max-width:1080px; margin-top: 10px; margin-bottom: 10px;"> <%-- --%>
                        <asp:Label ID="Label8" runat="server" ClientIDMode="Static"></asp:Label>  
                         <asp:Label ID="lblMRRNo" runat="server" Text="MRR No : " ></asp:Label>
                        <asp:Label ID="lblMRRNoText" runat="server" Visible="true"  Font-Bold="true" ></asp:Label>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ITEM_NAME" HeaderText="ITEM NAME" ItemStyle-Width="300px" />
                  <asp:BoundField DataField="MRR_QTY" HeaderText="QTY" ItemStyle-Width="80px" />
