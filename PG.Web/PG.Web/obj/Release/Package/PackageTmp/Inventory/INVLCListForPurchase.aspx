<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVLCListForPurchase.aspx.cs" Inherits="PG.Web.Inventory.INVLCListForPurchase" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVIMPInvoice.aspx?lcMasterId=" + key;
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    <td width="62px" align="left"></td>
                                    <td width="100px" align="left">LC No
                                    </td>
                                    <td width="100px" align="left">LC Date
                                    </td>
                                    <td width="200px" align="left">Bank Name</td>


                                    <td width="150px" align="left">LC Type
                                    </td>
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="LC_TYPE_DESC" ItemStyle-Width="150">

                                        <ItemStyle Width="150px"></ItemStyle>
                                    </asp:BoundField>

                                    <asp:BoundField DataField="SUP_NAME" ItemStyle-Width="200">
