<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ReceiveFromSupReturnList.aspx.cs" Inherits="PG.Web.Inventory.ReceiveFromSupReturnList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewReceiveFromReturn.aspx?rcvId=" + key;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Receive From Supplier Return List"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="lblRcvNo" runat="server" Text="Receive No:"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtRcvNo" runat="server" CssClass="textBox required " Width="200"></asp:TextBox>
                        </td>
                        ...
                        <td>
                            <asp:TextBox ID="txtMrrNo" runat="server" CssClass="textBox required " Width="200"></asp:TextBox>
                        </td>
                                ...
                                <tr>
                                   ...
                                   <%--   <td width="150px" align="left">Purchase Date
                                    ...
                                    <td width="150px" align="left">MRR No</td>
                                     <td width="200px" align="left">Received By
                                    </td>
                                </tr>
                            </table>
                        </div>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="hdnRtnId" runat="server" Text='<%# Bind("RECEIVE_ID") %>' Style="text-align: center;" Width="80px"> </asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="RECEIVE_NO" HeaderText="Return No" ItemStyle-Width="150px">
                                  ...
                                  <%--      <asp:BoundField DataField="PURCHASE_DATE" HeaderText="Date"  DataFormatString="{0:dd-MMM-yyyy}"
                                    ...
                                    <asp:BoundField DataField="RECEIVE_DATE" HeaderText="Date"  DataFormatString="{0:dd-MMM-yyyy}"
                                     ...
                                     <asp:BoundField DataField="MRR_NO" HeaderText="Purchase No" ItemStyle-Width="150px" />
