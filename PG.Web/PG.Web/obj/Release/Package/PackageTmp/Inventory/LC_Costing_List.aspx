<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="LC_Costing_List.aspx.cs" Inherits="PG.Web.Inventory.LC_Costing_List" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script language="javascript" type="text/javascript">
        ...
        var txtGridPageNo = '<%=txtGridPageNo.ClientID %>';
         ...
         var hdnAuthoEnable = '<%=hdnAuthoEnable.ClientID %>';
         ...
         function tbopen(key, userid) {
             key = key || '';
             var url = IForm.RootPath + "Inventory/LC_Costing_Entry.aspx?id=" + key + "&authoEnable=" + document.getElementById("<%=hdnAuthoEnable.ClientID%>").value;
             ...
             if (IForm.PageMode == Enums.PageMode.InTab) {
                 ...
                 tdata.id = 0;
                 tdata.name = "LC Costing Entry";
                 //tdata.label = "User: " + userid;
                 tdata.label = "LC Costing Entry";
                 tdata.type = 0;
                 tdata.url = url;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <asp:HiddenField runat="server" ID="hdnAuthoEnable" />
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="LC Costing List"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtLcNo" runat="server" CssClass="textBox notEnterToTab" Width="150"></asp:TextBox>
                        </td>
                           <td>
                            <asp:Label ID="lblCostingNo" runat="server" Text="Costing No:"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtCostingNo" runat="server" CssClass="textBox notEnterToTab" Width="150"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td> <asp:Button ID="btnAddNew" runat="server" CssClass="buttonNew"    Text="New Entry" Width="90px" Height="26px" /></td>
                        <td>&nbsp;
                        </td>
                        <td>&nbsp;
                        </td>
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                            ...
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="130px" align="center">LC No
                                     ...
                                     <td width="180px" align="center">Costing No
                                    </td>
                                     <td width="95px" align="center">Costing Date
                                    </td>
                                    <td width="200px" align="center">Item Name</td>

                                   <td width="100px" align="center">Autho Status
                                    </td>
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                DataKeyNames="COSTING_ID" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="hdnCostingId" runat="server" Text='<%# Bind("COSTING_ID") %>' Style="text-align: center;" Width="80px"> </asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:BoundField DataField="LC_NO" HeaderText="LC No" ItemStyle-Width="120px">
                                       ...
                                       <asp:BoundField DataField="COSTING_NO" HeaderText="Costing No" ItemStyle-Width="180px">
                                        <ItemStyle Width="180px"></ItemStyle>
                                    </asp:BoundField>
                                      <asp:BoundField DataField="COSTING_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="95">
                                        <ItemStyle Width="95px"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="ITEM_NAME" ItemStyle-Width="200">

                                        <ItemStyle Width="200px"></ItemStyle>
                                    </asp:BoundField>
                                      <asp:BoundField DataField="AUTHO_STATUS" ItemStyle-Width="100">
