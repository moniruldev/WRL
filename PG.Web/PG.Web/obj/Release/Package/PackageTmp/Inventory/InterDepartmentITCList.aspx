<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="InterDepartmentITCList.aspx.cs" Inherits="PG.Web.Inventory.InterDepartmentITCList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVInterDepartmentITCAgainstIGRWithBatch.aspx?itcMasterId=" + key + "&type=" + "";
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="ITC List :Inter Department"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="LblLocation" runat="server" Text=" ITC From"></asp:Label><span style="color: red">*</span>
                        </td>
                        <td>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width:920px">
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; width:100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                class="" cellspacing="1" cellpadding="1" rules="all">
                                <tr class="headerRow_Prod">
                                    <td width="50px" align="left"></td>
                                   
                                   
                                    <td width="150px" align="left">ITC No
                                    </td>
                                     <td width="80px" align="left">ITC
                                        Date
                                    </td>
                                     <td width="100px" align="left">ITC Department</td>
                                     <td width="150px" align="left">IRR No
                                    </td>
                                     <td width="100px" align="left">IGR Department</td>
                                   
                                    <td width="150px" align="left">IGR No
                                    </td>
                                    <td width="80px" align="left">IGR
                                        Date
                                    </td>
                        ...
                        <div id="dvGrid" style="width: 920px; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" Width="920" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="REQ_ISSUE_NO" HeaderText=" ISSUE No" ItemStyle-Width="150px" ControlStyle-Width="150px" />
                                     <asp:BoundField DataField="REQ_ISSUE_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="80" ControlStyle-Width="80px" />
                                    <asp:BoundField DataField="from_department_name" HeaderText="Rece Dept" ItemStyle-Width="100px" ControlStyle-Width="100px" />
                                    <asp:BoundField DataField="ISSUE_RECEIVE_NO" HeaderText=" ISSUE No" ItemStyle-Width="150px" ControlStyle-Width="150px" />
                                     <asp:BoundField DataField="to_department_name" HeaderText="Iss Dept" ItemStyle-Width="100px" ControlStyle-Width="100px" />
                                    <asp:BoundField DataField="REQ_NO" HeaderText=" IGR No" ItemStyle-Width="150px" ControlStyle-Width="150px" />
