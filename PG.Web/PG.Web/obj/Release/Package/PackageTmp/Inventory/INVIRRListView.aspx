<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="INVIRRListView.aspx.cs" Inherits="PG.Web.Inventory.INVIRRListView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVIRRListForDepartment.aspx?id=" + key ;
            //var url = IForm.RootPath + "Inventory/INVNewIRRByDepartment.aspx?id=" + key + "&type=" + "";
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "IRR: By Department";
                //tdata.label = "User: " + userid;
                tdata.label = "IRR: By Department";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IRR List For Department"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        <td align="right">
                            <asp:Label ID="LblLocation" runat="server" Text="IRR Department:"></asp:Label><span style="color: red">*</span>
                        </td>
                        <td>
                        ...
                        <td align="right">
                            <asp:Label ID="Label5" runat="server" Text="Receive No:"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtIRRNo" runat="server" CssClass="textBox notEnterToTab" Width="200"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td></td>
                         <td>
                        <asp:Button ID="btnRefresh" runat="server" CssClass="buttonRefresh" Style="padding-left: 22px;" Text="Show Data" OnClick="btnRefresh_Click" />
                        </td>
                           <td>
                            <input id="btnAddNew" type="button" runat="server" value="New IRR" class="buttonNew"
                                style="padding-left: 22px; width: 80px;" />
                        </td>
            ...
            <div id="dvControls" style="width: 100%;">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 920px">
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    <td width="50px" align="center"> SL </td>
                                  <td width="170px" align="left"> IRR No
                                    </td>
                                      <td width="82px" align="left">IRR
                                        Date
                                    </td>
                                     <td width="20px" align="left">
                                        
                                    </td>
                                    <td width="170px" align="left"> ITC No
                                    </td>
                                    <td width="82px" align="left">ITC
                                        Date
                                    </td>
                        ...
                        <div id="dvGrid" style="width: 920px; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" Width="920" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                CellSpacing="1" ForeColor="#333333" GridLines="None" Font-Names="Arial" Font-Size="9pt" DataKeyNames="ISSUE_RECEIVE_ID"
                                ...
                                <Columns>
                                 ...
                                 <%--   <asp:HyperLinkField HeaderText="" Text="New IRR">
                                     ...
                                     <asp:BoundField DataField="ISSUE_RECEIVE_NO" HeaderText="IRR No" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="ISSUE_RECEIVE_DATE" HeaderText="IRR Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="80" />
                                     <asp:BoundField DataField="ITEM_NAME" HeaderText=" Item's" ItemStyle-Width="200px" Visible="false" />

                                    <asp:BoundField DataField="REQ_ISSUE_NO" HeaderText=" ISSUE No" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="REQ_ISSUE_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="80" />

                                     <asp:BoundField DataField="REQ_NO" HeaderText=" IGR No" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="REQ_DATE" HeaderText="IGR Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="80" />
