<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="NewDCGPAgainstInvoice.aspx.cs" Inherits="PG.Web.Inventory.NewDCGPAgainstInvoice" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Generate DC and GP Against Invoice/DO" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
        ...
        <div id="dvContentMain" class="dvContentMain" align="left">
            <div id="dvControlsHead" style="height: auto; width: 100%;" align="left">
                <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 1124px" id="tblItemEntry">
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblInvoiceNo" runat="server" Text="DO No :" Font-Bold="true"></asp:Label>
                        </td>
                        <td >
                        ...
                        <td align="right">
                            <asp:Label ID="lblInvoiceDate" runat="server" Text="DO Date :" Font-Bold="true"></asp:Label><span style="color:red">*</span>
                        ...
                        <td >
                         ...
                         <td align="right">
                            <asp:Label ID="lblInvoiceTime" runat="server" Text="DO Time :" Font-Bold="true"></asp:Label><span style="color:red">*</span>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td align="right">
                                                            <asp:Label ID="lblInvoiceRemarks" runat="server" Text="DO Remarks:" style="font-weight: 700"></asp:Label>
                                                        </td>
                                                        <td colspan="6">
                    ...
                    <tr>
                        <td align="right">
                                                        ...
                                                        <td colspan="6">
                                                            ...
                                                            <asp:Label ID="lblSalesInvoiceNo" runat="server" Width="150px" Visible="false"></asp:Label>
                                                        </td>
                    ...
                    <tr>
                        <td align="right">
                                                        ...
                                                        <td colspan="6">
                                                            <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox" Height="20px" Width="700px"></asp:TextBox>
                ...
                <ItemStyle BorderColor="Gray" HorizontalAlign="Center" Width="100px"  />
                                    ...
                                    <asp:TemplateField HeaderText="SL#">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblMrrDetSlNo" runat="server" Text='<%# Bind("INV_DET_SLNO") %>' Style="text-align: center;" Width="80px"> </asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="INV Qty" Visible="true">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtItemQty" runat="server" Text='<%# Bind("ITEM_QNTY_APRROVED") %>' CssClass=" textBox textNumberOnly"  Style="text-align: center;" Width="100px"></asp:TextBox>

                                        </ItemTemplate>
                                        <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>

                                     <asp:TemplateField HeaderText="DC Qty" Visible="true">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtDCQty" runat="server" Text='<%# Bind("DC_QTY") %>' CssClass=" textBox textNumberOnly"  Style="text-align: center;" Width="100px"></asp:TextBox>
                                     ...
                                     <asp:TemplateField HeaderText="Item Rate" Visible="false">
                                        <ItemTemplate>
                                     ...
                                     <asp:TemplateField HeaderText="Remain Qty" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="txtRemainQty" runat="server" Text='<%# Bind("REMAIN_QTY") %>' CssClass=" textBox textNumberOnly"  Style="text-align: center;" Width="100px"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Already Issued" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label  ID="lblAlreadyIssued" Text='<%# Bind("ALREADY_ISSUED_QTY") %>' runat="server" CssClass=" textBox textNumberOnly" Style="text-align: center;" Width="100px" ></asp:Label>
                                     ...
                                     <asp:TemplateField HeaderText="Unit Name" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblUnitName" runat="server" Text='<%# Bind("UOM_NAME") %>' Style="text-align: center;" Width="150px"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Inv. Dtl. Remarks" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblInv_DETAILS_REMARKS" runat="server" Text='<%# Bind("INV_DET_REMARKS") %>' Style="text-align: center;" Width="150px"></asp:Label>

                                        </ItemTemplate>
                                        <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Detail Remarks" Visible="true">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtDC_DETAILS_REMARKS" runat="server" Text='<%# Bind("DC_DET_REMARKS") %>' Style="text-align: center;" Width="150px"></asp:TextBox>
            ...
            <table>
                <tr>
                    ...
                    <td>
                     ...
                     <td>
                        <asp:Button ID="btnInvoicePrint" runat="server" Text="Print Invoice" CssClass="buttoncommon" Enabled="false" OnClick="btnInvoicePrint_Click" />
                    </td>
                    ...
                    <td>
                        <asp:Button ID="btnGpPrint" runat="server" Text="Print GP" CssClass="buttoncommon" Enabled="false" OnClick="btnGpPrint_Click" OnClientClick="if ( ! UserDeleteConfirmation()) return false;" />
                    </td>
