<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVOutStationTransfer.aspx.cs" Inherits="PG.Web.Inventory.INVOutStationTransfer" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Out Station Transfer Entry"></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Out Station Transfer Entry</span>
                        </div>
                            ...
                            <div id="groupContenInner">
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold">Out Station Transfer Details: </span>
                                    </div>
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtITEMRate" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("ITEM_RATE") %>' Style=""></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="lblTotalAmt" runat="server" CssClass="textBox textAutoSelect" Width="68" Text='<%# Bind("total_amount") %>'  Style=""></asp:TextBox>
                                                                                    </td>
                                        ...
                                        <div id="divGridControls2" style="width: 100%; height: 25px; border-top: solid 1px #C0C0C0;">
                                            <table style="width: auto; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <asp:Label ID="lbltotalQnty" runat="server" Text="Total Qnty:" Font-Bold="True"></asp:Label>
                                                    </td>
                                                    <td align="right">
        ...
        <div id="dvContentFooter" class="dvContentFooter">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSave" runat="server" Text="Generate DC,GP" CssClass="buttonSave checkRequired" AccessKey="s" OnClick="btnSave_Click" OnClientClick="if ( ! UserDeleteConfirmation()) return false;" Width="120px"  />
                    ...
                    <td>
                        <asp:Button ID="btnPost" runat="server" Text="Post" CssClass="buttoncommon" />
                    </td>
                    <td>
