<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Item_Color_List.aspx.cs" Inherits="PG.Web.Inventory.Item_Color_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/Item_Color_Entry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Item Color";
                //tdata.label = "User: " + userid;
                tdata.label = "Item Color";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item Color List"></asp:Label>
            </div>
                ...
                <table>
                    ...
                    <tr>
                                        ...
                                        <td>
                                             ...
                                             <asp:DropDownList ID="ddlIsActive" runat="server" CssClass="dropDownList enableIsDirty"  Width="270px">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="btnAddNew" type="button" runat="server" value="New Color" class="buttonNew" style="padding-left: 22px; width: 120px;" />
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                ...
                                DataKeyNames="ITEM_COLOR_ID" OnRowDataBound="GridView1_RowDataBound"
