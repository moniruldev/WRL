<%@ Page Title="" Language="C#" ViewStateMode="Disabled" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVRepareItemReceiveList.aspx.cs" Inherits="PG.Web.Inventory.INVRepareItemReceiveList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewRepareItemReceive.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Repair Item Receive";
                tdata.label = "Repair Item Receive";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Repair Item Receive List"></asp:Label>
            </div>
            <!--Message Div -->
                        ...
                        <div id="dvGrid" style="width:100%x; height: 250px; overflow: auto;">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Width="100%" AutoGenerateColumns="False" KeyFieldName="PURCHASE_NO">
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Receive No" FieldName="PURCHASE_NO" VisibleIndex="1" Width="140px">
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Purchase Date" FieldName="PURCHASE_DATE" VisibleIndex="3" Width="80px">
                                     ...
                                     <dx:GridViewDataTextColumn Caption="Mrr No" FieldName="MRR_NO" VisibleIndex="8" Width="130px" />                                    
