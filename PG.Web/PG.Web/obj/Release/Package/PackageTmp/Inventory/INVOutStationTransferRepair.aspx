<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVOutStationTransferRepair.aspx.cs" Inherits="PG.Web.Inventory.INVOutStationTransferRepair" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var RepairBatteryItemListServiceLink = '<%=this.RepairBatteryItemListServiceLink%>';
      ...
      <%--  var txtCompanyID = '<%=txtCompanyID.ClientID%>';--%>
        ...
        function bindItemList(gridViewID) {
            ...
            //var serviceURL = GLAccountServiceLink + "?isterm=1&includeempty=1&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            var serviceURL = RepairBatteryItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            //serviceURL += "&companyid=" + companyid;
            serviceURL += "&ispaging=1";
            //serviceURL += "&locationid=" + locationid;
            // serviceURL += "&empstatus=" + "A";
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Transfer to Repair Battery For Service Center"></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Transfer to Repair Battery For Service Center</span>
                        </div>
                                                ...
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td   >
                                                            <asp:CheckBox ID="chkIsRepair" runat="server" Checked="true"  />
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtITEMRate" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("ITEM_RATE") %>' Style="" Visible="false"></asp:TextBox>
                                                                                    </td>
