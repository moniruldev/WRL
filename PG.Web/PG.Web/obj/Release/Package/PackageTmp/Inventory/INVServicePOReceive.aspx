<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVServicePOReceive.aspx.cs" Inherits="PG.Web.Inventory.INVServicePOReceive" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OnTextChangegAmt(texbx) {
            ...
            totalamt = parseFloat(itemqty).toFixed(2) * parseFloat(itemrate).toFixed(2);
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Purchase Against Service PR" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
        ...
        <div id="dvContentMain" class="dvContentMain" align="center">
          ...
          <%--       <div id="tabs" style="height:auto; font-size:12px; background : url(../image/bg_greendot.gif) !important;">
                 <ul>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                 ...
                                                                                 <%--    <td>
                                                                                    ...
                                                                                    <td>
                                                                                       <asp:TextBox ID="txtITEMRate" runat="server" CssClass="textBox textAutoSelect" Width="80" Text='<%# Bind("UNIT_RATE") %>' Style="" onkeypress="return isNumberKey(event,this);" onchange="OnTextChangegAmt(this)"  Enabled="true" Visible="false"></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                         <asp:TextBox ID="txtTotalAmt" runat="server" CssClass="textBox textAutoSelect" Width="100" Text='<%# Bind("UNIT_PRICE") %>'   Enabled="true" Visible="false"></asp:TextBox>
        ...
        <div id="dvContentFooter" class="dvContentFooter">
            <table align="center">
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSave" runat="server" Text="Receive" CssClass="buttonSave" OnClick="btnSave_Click" OnClientClick="if ( ! UserDeleteConfirmation()) return false;" />
                    ...
                    <td>
                       ...
                       <td>
                        <asp:Button ID="btnPrintPreview" runat="server" Visible="false" Text="Preview PO" CssClass="buttoncommon buttonPrintPreview" Enabled="True" OnClick="btnPrintPreview_Click" />
                    </td>
