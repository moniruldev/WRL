<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="Direct_ITC_Dept_To_Dept_List.aspx.cs" Inherits="PG.Web.Inventory.Direct_ITC_Dept_To_Dept_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/DEPT_DIRECT_ITCToDept.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "ITC: Direct ITC Department To Department";
                //tdata.label = "User: " + userid;
                tdata.label = "ITC: Direct ITC Department To Department";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="ITC: Direct ITC Department To Department"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="Label3" runat="server" Text=" From Department"></asp:Label>
                        </td>
                        <td>
                        ...
                        <td align="right">
                            <asp:Label ID="Label5" runat="server" Text="Issue/TC No:"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <%--<td>
                            <asp:Label ID="Label4" runat="server" Text="Authorize?"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlPostOption" runat="server" CssClass="dropDownList" OnSelectedIndexChanged="ddlPostOption_SelectedIndexChanged">
                                <asp:ListItem Value="0">(all)</asp:ListItem>
                                <asp:ListItem Value="1">Authorized</asp:ListItem>
                                <asp:ListItem Value="2">Unauthorized</asp:ListItem>
                            </asp:DropDownList>
                        </td>--%>
                        <td align="right"> 
                    ...
                    <tr>
                        ...
                        <td>
                               <input id="btnAddNew" type="button" runat="server" value="New ITC" class="buttonNew"
                                style="padding-left: 22px; height:26px; width: 80px;" />        
                                    </td>
                        <td>
            ...
            <div id="dvControls" style="width: 100%;">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 850px">
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader_Prod">
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                DataKeyNames="REQ_ISSUE_ID" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="REQ_ISSUE_NO" HeaderText="Issue/TC No" ItemStyle-Width="175px" />
                                    <asp:BoundField DataField="REQ_ISSUE_TIME" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}"
                                        ItemStyle-Width="150" />
                                        <asp:BoundField DataField="CREATE_BY_NAME" HeaderText="Name" 
                                        ItemStyle-Width="160" />
                                   
                                    <asp:BoundField DataField="to_department_name" HeaderText="To Department" ItemStyle-Width="100px" />
                                     <asp:BoundField DataField="ISSUE_RECEIVE_NO" HeaderText="IRR No" ItemStyle-Width="150px" />
                                     <asp:BoundField DataField="ISSUE_RECEIVE_DATE" HeaderText="IRR Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="120px" />
