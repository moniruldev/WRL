<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVPurchaseRequisitionService.aspx.cs" Inherits="PG.Web.Inventory.INVPurchaseRequisitionService" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                 <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Purchase Requisition For Service "></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                             PUR<span>:Service Purchase Requisition</span>
                        </div>
                                            ...
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <%--    <td width="80px" class="headerColLeft">Item Group
                                                  ...
                                                  <td width="80px" class="headerColLeft">Item Code
                                                    ...
                                                    <td width="300px" class="headerColLeft">Item
                                                    </td>
                                                                                ...
                                                                                <%--    <td>
                                                                                  ...
                                                                                  <%--   <td>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="300" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                  ...
                                                                                  <%--  <td>
                                                                                   ...
                                                                                   <%-- <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtUOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="49" Text="Pcs" Style=""></asp:TextBox>
