<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="LP_Purchase_Approval_Purchase_H.aspx.cs" Inherits="PG.Web.Inventory.LP_Purchase_Approval_Purchase_H" %>
     ...
     <%--   var BankListServiceLink = '<%=this.BankListServiceLink%>';--%>
      ...
      <%--  var txtBankCode = '<%=txtBankCode.ClientID%>';
        ...
        function tbopenp(key, userid) {
            key = key || '';
           // alert(key);
            var url = IForm.RootPath + "SND/HRRequesttoSalaryAdjust.aspx?id=" + key;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Purchase Approval:"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <tr>
              ...
              <td align="right">
                    <asp:Label ID="lblToDate" runat="server" Text="To Date:" style="height: 19px; width: 43px; " Font-Bold="True" Visible="true"></asp:Label>
              ...
              <td>
                 ...
                 <asp:RegularExpressionValidator runat="server" ControlToValidate="txtTodate" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$" ErrorMessage="Invalid date format." ValidationGroup="Group1" ForeColor="Red" />
                   ...
                   <tr>
                       ...
                       <td colspan="3"> 
                     <asp:TextBox ID="txtPurchaseNo" runat="server" CssClass="textBox" Width="200px"></asp:TextBox>
                        </td>
                   </tr>
            ...
            <div id="dvControls" style="width: 100%;">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 100%">
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width: 1100px; height: 350px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1" Width="100%"
                                CellSpacing="1" ForeColor="#333333" GridLines="None" Font-Names="Arial" Font-Size="9pt" DataKeyNames="PURCHASE_ID"
                                ...
                                <Columns>
                                  <%--  <asp:HyperLinkField HeaderText="" Text="View">
                                        <ControlStyle Height="20px" Width="35px" />
                                    ...
                                    <asp:TemplateField HeaderText="DC ID" Visible="false">
                                      <ItemTemplate>
                                     <asp:Label ID="lblDepositID" runat="server" Text='<%# Bind("PURCHASE_ID") %>' Style="text-align: center;"></asp:Label>
                                     ...
                                     <asp:TemplateField HeaderText="Sub type ID" Visible="false">
                                      <ItemTemplate>
                                     <asp:Label ID="lblSubtypeID" runat="server" Text='<%# Bind("PURCHASE_ID") %>' Style="text-align: center;" ></asp:Label>
                                                                   
                                      </ItemTemplate>
                                       <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>

                                     <asp:TemplateField HeaderText="PurchaseNo" Visible="true">
                                      <ItemTemplate>
                                     <asp:Label ID="lblPurchaseNo" runat="server" Text='<%# Bind("PURCHASE_NO") %>' Style="text-align: center;" Width="180px"></asp:Label>
                                         <asp:HiddenField ID="hdnPOType" runat="server" Value='<%# Bind("PO_TYPE") %>' />                            
                                      </ItemTemplate>
                                       <ItemStyle VerticalAlign="Middle" />
                                    </asp:TemplateField>
                                  <%--     <asp:TemplateField HeaderText="Purchase Type" Visible="true">
                                      <ItemTemplate>
                                     <asp:Label ID="lblPurchaseType" runat="server" Text='<%# Bind("PURCHASE_TYPE") %>' Style="text-align: center;" Width="150px"></asp:Label>
                                                                   
                                      </ItemTemplate>
                                       <ItemStyle VerticalAlign="Middle" />
                                    </asp:TemplateField>--%>
                                     <asp:BoundField DataField="PURCHASE_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Left" />

                                    <asp:TemplateField HeaderText="Supplier Name" Visible="true">
                                      <ItemTemplate>
                                     <asp:Label ID="lblSupplierName" runat="server" Text='<%# Bind("SUP_NAME") %>' Style="text-align: center;" Width="200px"></asp:Label>
                                                                   
                                      </ItemTemplate>
                                       <ItemStyle VerticalAlign="Middle" />
                                    </asp:TemplateField>
                                     <asp:BoundField DataField="PO_TYPE" HeaderText="PO Type" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Left"  />
                                     <asp:BoundField DataField="STATUS_NAME" HeaderText="STATUS" ItemStyle-Width="200px" ItemStyle-HorizontalAlign="Left"  />

                                
                                     <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                    <asp:LinkButton ID="btnStatusdtl" runat="server"  CssClass="buttonAttach" CommandName="statusd"  CommandArgument='<%# Bind("PURCHASE_NO") %>' ><i class="" style="padding-right:4px;color:red;font-size:14px;"></i>Details</asp:LinkButton>
                                    </ItemTemplate>
                                         
                                   </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Action"  ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                    <asp:LinkButton ID="btnMemoprint" runat="server"  CommandName="app" CssClass="buttonAttach" CommandArgument='<%# Bind("PURCHASE_NO") %>' ><i class="glyphicon glyphicon-print" style="padding-right:4px;color:blue;font-size:14px;"></i>View PO</asp:LinkButton>
                       ...
                       <asp:TemplateField HeaderText="Comments"  ItemStyle-HorizontalAlign="Center">  
                        <ItemTemplate>  
                            <asp:LinkButton ID="lnkdetailcom"  CommandName="comments"  CssClass="buttonAttach"  CommandArgument='<%# Bind("PURCHASE_NO") %>' runat="server" CausesValidation="false" ><i class="glyphicon glyphicon-comment" style="padding-right:4px;color:blue;font-size:14px"></i>Comments</asp:LinkButton>  
                              <asp:HiddenField ID="hdnPurchaseNo" runat="server" Value='<%# Bind("PURCHASE_NO") %>' />
                        </ItemTemplate>  
                          
                    </asp:TemplateField>  
                          <asp:TemplateField >
                            <ItemTemplate>
                           <asp:Label ID="lblComments" style=" padding:4px 4px; margin:0px 2px 0 -12px;  border-radius:4px; font-weight:bold; float:left;  color:red;background-color:#0094ff;" Text="0" runat="server"></asp:Label>
                         </ItemTemplate>  
                                  ...
                                  <%--   <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                    <asp:LinkButton ID="btnNegotiate" runat="server"  CssClass="buttonAttach" CommandName="negotiate"  CommandArgument='<%# Bind("RESIG_APP_NO") %>' ><i class="glyphicon glyphicon-arrow-left" style="padding-right:4px;color:red;font-size:14px;"></i>Negotiate</asp:LinkButton>
                                    </ItemTemplate>
                                         
                                   </asp:TemplateField>--%>
                                      <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                    <asp:LinkButton ID="btnforward" runat="server"  CssClass="buttonAttach" CommandName="forward"   style="text-align:center;border-radius:2px;"  CommandArgument='<%# Bind("PURCHASE_NO") %>' ><i class="glyphicon glyphicon-arrow-right" style="padding-right:4px;color:green;font-size:14px;"></i> Forward</asp:LinkButton>
                                    </ItemTemplate>
      ...
      <%--Modal Comments Strat--%>
                ...
                <div class="modal-content">  
                    ...
                    <div class="modal-body" style="overflow-y: scroll; max-height: 85%; margin-top: 10px; margin-bottom: 10px;">  
                        ...
                        <table> 
                               <tr>
                                <td align="right">
                                    <asp:Label ID="lblPurchaseNoComments" runat="server" Text="Purchase No :" ></asp:Label>
                                </td>
                                <td>
                                     <asp:Label ID="lblPurchaseNotxt" runat="server" Visible="true" BackColor="YellowGreen" ></asp:Label>
                                </td>
                            </tr>
           ...
           <asp:GridView ID="grdCommentDetails" runat="server" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="Black"
            ...
            <Columns>
                  ...
                  <asp:BoundField DataField="CREATE_BY_NAME" HeaderText="Comment By" ItemStyle-Width="250px" />
                  <asp:BoundField DataField="COMMENTS_DESC" HeaderText="Comment" ItemStyle-Width="250px" />
                  <asp:BoundField DataField="CREATE_DATE" HeaderText="Time" ItemStyle-Width="170px" />
                    ...
                    <div class="modal-footer"> 
                        <table>
                            <tr>
                        <td>
                      <%--  <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="buttonSave" OnClick="btnSave_Click" Visible="true"   />--%>
            ...
            <div class="modal-dialog" style="max-width:1024px; align-content:space-around;">  
                <div class="modal-content" style="max-width:1024px;">  
                    <div class="modal-header" style="max-width:1024px;">  

                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>  
                        <h4 class="modal-title">Status details page</h4>  
                    </div>  
                    <div class="modal-body" style="overflow-y: scroll; max-height: 85%; max-width:1024px; margin-top: 10px; margin-bottom: 10px;">  
                        <asp:Label ID="Label8" runat="server" ClientIDMode="Static"></asp:Label>  
                         <asp:Label ID="lblPurchNo" runat="server" Text="Purchase No :" ></asp:Label>
                        <asp:Label ID="lblStatusDetailsPurno" runat="server" Visible="true" BackColor="Yellow" ></asp:Label>
                        <asp:HiddenField ID="hdnStatusDetailsPurID" runat="server" />
                       <asp:GridView ID="grdStatusDetails" runat="server" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="Black"
            RowStyle-BackColor="#A1DCF2" AlternatingRowStyle-BackColor="White" AlternatingRowStyle-ForeColor="#000" BorderStyle="None" BorderWidth="5px" CellPadding="10"  GridLines="Vertical"
            AutoGenerateColumns="false">
            <Columns>
                 <asp:BoundField DataField="STATUS_NAME" HeaderText="Action" ItemStyle-Width="300px" />
                 <asp:BoundField DataField="ID_NAME" HeaderText="Action By" ItemStyle-Width="400px" />
                 <asp:BoundField DataField="DATE_TIME" HeaderText="Date" ItemStyle-Width="280px" />
                <asp:BoundField DataField="DURATION_TIME" HeaderText="Duration" ItemStyle-Width="170px" />
                <%--<asp:BoundField DataField="DURATION_DAY" HeaderText="Day" ItemStyle-Width="40px" />
                 <asp:BoundField DataField="DURATION_HRS" HeaderText="HO" ItemStyle-Width="40px" />
                 <asp:BoundField DataField="DURATION_MIN" HeaderText="MIN" ItemStyle-Width="40px" />
                 <asp:BoundField DataField="DURATION_SEC" HeaderText="SEC" ItemStyle-Width="40px" />--%>
