<%@ Page Title="" ViewStateMode="Disabled" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="PurchaseSpecialUpdateByStoreList.aspx.cs" Inherits="PG.Web.Inventory.PurchaseSpecialUpdateByStoreList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            key = key || '';
            var url = IForm.RootPath + "Inventory/PurchaseSpecialUpdateByStore.aspx?id=" + key;
