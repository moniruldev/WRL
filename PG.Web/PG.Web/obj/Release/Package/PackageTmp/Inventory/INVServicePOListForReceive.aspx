<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVServicePOListForReceive.aspx.cs" Inherits="PG.Web.Inventory.INVServicePOListForReceive" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVServicePOReceive.aspx?purchaseMasterId=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "New Receive";
                //tdata.label = "User: " + userid;
                tdata.label = "New Receive";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Service PO Receive List"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtReqNo" runat="server" CssClass="textBox required " Width="200"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        <td></td>
                       <td align="right">
                           <asp:Label ID="Label3" runat="server" Text="Department:"></asp:Label><span style="color: red">*</span>
                    ...
                    <tr>
                     ...
                     <tr>
                          <td></td>
                        <td align="right">
                            <asp:Label ID="Label8" runat="server" Text="Item Group:" Visible="false"></asp:Label>

                        </td>
                        <td>
                            <table>
                                <tr>
                                    <td> <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox required" Enabled="true" Width="200" Visible="false"></asp:TextBox></td>
                                    <td> <input id="btnGroupID" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" visible="false" /></td>
                                </tr>
                            </table>
                        ...
                        <td colspan="2"> <asp:HiddenField ID="hdnGroupID" runat="server" /></td>
                        ...
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="152px" align="left">Purchase No
                                    </td>
                                   <%--   <td width="150px" align="left">Purchase Date
                                    </td>--%>
                                    <td width="200px" align="left">Purchase Time
                                    </td>
                                     <td width="250px" align="left">Supplier Name
                                    </td>
                                    <td width="220px" align="left">Purchase Type</td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="hdnPurchaseId" runat="server" Text='<%# Bind("PURCHASE_ID") %>' Style="text-align: center;" Width="80px"> </asp:Label>
                                        </ItemTemplate>
                                  ...
                                  <%--      <asp:BoundField DataField="PURCHASE_DATE" HeaderText="Date"  DataFormatString="{0:dd-MMM-yyyy}"
                                    ...
                                    <asp:BoundField DataField="PURCHASE_TIME" HeaderText="Date"  DataFormatString="{0:dd-MMM-yyyy hh:mm tt}"
                                        ItemStyle-Width="200">
                                    ...
                                    <asp:TemplateField HeaderText="Purchase Type" ItemStyle-Width="220px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsPosted" Text='<%# Eval("PURCHASE_TYPE") %>'
