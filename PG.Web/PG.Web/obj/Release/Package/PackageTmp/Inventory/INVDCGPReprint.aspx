<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVDCGPReprint.aspx.cs" Inherits="PG.Web.Inventory.INVDCGPReprint" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            ...
            <tr>
              ...
              <td>
               <asp:Label ID="lblFromDate" runat="server" Text="DC From Date" style="height: 19px; width: 43px; " Font-Bold="True" Visible="true"></asp:Label>
              </td>
              <td align="left">
           ...
           <tr>
              ...
              <td>
                ...
                Text="Preview" OnClick="buttonIRRPreview_Click" />
              </td>
              <td>
                           ...
                           <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;" class="defFont"  cellspacing="1" cellpadding="1" rules="all">
                                <tr>
                                   <%-- <td width="70px" align="left"></td>--%>
                                     <td width="60px" align="left">SL#</td>
                                  <%--  <td width="152px" align="left">Invoice Id
                                    </td>--%>
                                    <td width="130px" align="left">DO No
                                    </td>
                                     <td width="150px" align="left">Invoice No
                                    </td>
                                    <td width="80px" align="left">DO Date
                                    </td>
                                    <td width="140px" align="left">DO Time
                                    </td>
                                     <td width="130px" align="left">DC NO
                                    </td>
                                     <td width="130px" align="left">GP NO
                                    </td>
                                     <td width="130px" align="left">DC Date
                                    </td>
                                    <td width="130px" align="left">Customer
                                    </td>
                                    
                                     <td width="150px" align="left">Remarks
                                    </td>
                                   <%--  <td width="150px" align="left">Type
                                    </td>--%>

                                    <td width="90px" align="left">DC Reprint
                                    </td>
                                    <td width="90px" align="left">GP Reprint
                                    </td>

                                    <td width="100px" align="left">Invoice Reprint
                                    </td>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Invoice ID" Visible="false">
                                     ...
                                     <asp:TemplateField HeaderText="Invoice No" >
                                      <ItemTemplate>
                                     <asp:Label ID="lblDONO" runat="server" Text='<%# Bind("INVOICE_NO") %>' Style="text-align: center;" Width="130px"></asp:Label>
                                                                   
                                      </ItemTemplate>
                                       <ItemStyle VerticalAlign="Top" />
                                     </asp:TemplateField>
                                    <%--<asp:BoundField DataField="INVOICE_NO" HeaderText="Invoice no" ItemStyle-Width="130px" />--%>

                                    <asp:TemplateField HeaderText="Invoice No" >
                                      <ItemTemplate>
                                     <asp:Label ID="lblSalesInvoice" runat="server" Text='<%# Bind("SALES_INVOICE_NO") %>' Style="text-align: center;" Width="150px"></asp:Label>
                                                                   
                                      </ItemTemplate>
                                       <ItemStyle VerticalAlign="Top" />
                                     </asp:TemplateField>

                                    <asp:BoundField DataField="INVOICE_DATE" HeaderText="Invoice Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="80px" />

                                    <asp:BoundField DataField="INVOICE_TIME" HeaderText="Invoice Time" ItemStyle-Width="140px" />
                                   ...
                                   <%-- <asp:BoundField DataField="DC_NO" HeaderText="DC No" ItemStyle-Width="130px" />
                                    <asp:BoundField DataField="GP_NO" HeaderText="GP No" ItemStyle-Width="130px" />--%>
                                    <asp:BoundField DataField="DC_DATE" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="DC Date" ItemStyle-Width="130px" />
                                     <asp:BoundField DataField="CUST_NAME" HeaderText="Customer" ItemStyle-Width="130px" />
                                    
                                    <asp:BoundField DataField="INVOICE_REMARKS" HeaderText="Remarks" ItemStyle-Width="150px" />
                                   <%-- <asp:BoundField DataField="ITEMTYPEQTY" HeaderText="Type" ItemStyle-Width="150px" />--%>

                                    <asp:TemplateField HeaderText="DC Reprint">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnLinkDc" runat="server" CommandName="DC_RP" Width="90px" Font-Bold="true" >DC Reprint</asp:LinkButton>
                                    </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="GP Reprint">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnLinkGP" runat="server" CommandName="GP_RP" Width="90px"  Font-Bold="true" >GP Reprint</asp:LinkButton>
                                    </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Invoice Reprint">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnLinkInv" runat="server" CommandName="INV_RP" Width="100px"  Font-Bold="true" >Invoice Reprint</asp:LinkButton>
                                    </ItemTemplate>
                                    </asp:TemplateField>
        ...
        <div id="dvContentFooter" class="dvContentFooter">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSave" runat="server" Text="Generate DC,GP" CssClass="buttonSave checkRequired" AccessKey="s" OnClick="btnSave_Click" OnClientClick="if ( ! UserDeleteConfirmation()) return false;" Width="100px" Visible="false"   />
