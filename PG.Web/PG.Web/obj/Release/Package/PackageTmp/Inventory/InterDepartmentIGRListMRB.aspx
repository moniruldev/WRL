<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="InterDepartmentIGRListMRB.aspx.cs" Inherits="PG.Web.Inventory.InterDepartmentIGRListMRB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewInterDepartmentMRBIGR.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "IGR:Item Requisition Of Goods";               
                tdata.label = "IGR:Item Requisition Of Goods";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="INTER DEPARTMENT IGR FROM MRB"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="LblLocation" runat="server" Text=" Requisition Department"></asp:Label><span style="color: red">*</span>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlDepartment" runat="server" Width="165"></asp:DropDownList>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnAddNew" runat="server" CssClass="buttonNew" Text="New IGR" Height="26px" />
            ...
            <div id="dvControls" style="width: 100%;">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1100px">
                            ...
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="150px" align="left">IGR No
                                     ...
                                     <td width="100px" align="left">IGR Date
                                    </td>
                                    <td width="170px" align="left">Creation Time
                                    </td>
                                    <td width="170px" align="left">IGR By
                                    </td>
                                    <td width="200px" align="left">From Department
                                    </td>
                                    <td width="200px" align="left">To Department
                                    </td>
                                    <td width="120px" align="left">ITC No 
                                    </td>
                                    <td width="170px" align="left">ITC Date Time 
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div id="dvGrid" style="width: 1100px; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                DataKeyNames="REQ_ID" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="REQ_NO" HeaderText="Req. No" ItemStyle-Width="150px" />
                                     <asp:BoundField DataField="REQ_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="100" />
                                    <asp:BoundField DataField="REQ_TIME" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}"
                                        ItemStyle-Width="170" />
                                    ...
                                    <asp:BoundField DataField="to_department_name" HeaderText="Type" ItemStyle-Width="200px" />

                                    <asp:TemplateField HeaderText="ITC No">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsPosted" Text='<%# Eval("REQ_ISSUE_NO") %>'
                                                runat="server"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Wrap="false" Width="120px" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="REQ_ISSUE_TIME" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}" ItemStyle-Width="170" />
