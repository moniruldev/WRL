<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="ItemRequisitionList.aspx.cs" Inherits="PG.Web.Inventory.ItemRequisitionList" %>
                        ...
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="170px" align="left">IGR Date Time
                                    </td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <%--<asp:BoundField DataField="REQ_ISSUE_TIME" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}"    ItemStyle-Width="170" />--%>
                                     <%--<asp:BoundField DataField="RCV_QTY" HeaderText="IRR Qty" ItemStyle-Width="100px" />--%>
                                       <asp:TemplateField HeaderText="IRR Qty">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIRRQty" Text='<%#(Eval("RCV_QTY") == "" ? "No" : "Yes") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
