<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewIGR.aspx.cs" Inherits="PG.Web.Inventory.INVNewIGR" %>
    ...
    <script language="javascript" type="text/javascript">
      ...
      <%--  var txtCustomerID = '<%=txtCustomerID.ClientID%>';--%>
        ...
        function bindItemList(gridViewID) {
            var cgColumns = [{ 'columnName': 'itemname', 'width': '250', 'align': 'left', 'highlight': 4, 'label': 'Name' }
            ...
            serviceURL += "&ispaging=1";
            //serviceURL += "&locationid=" + locationid;
            //serviceURL += "&itemtypeid=" + itemtypeid;
            // serviceURL += "&empstatus=" + "A";
            //serviceURL += "&acctypefilter=" + Enums.GLAccountTypeFilter.AllAccount;
            // serviceURL += "&namecomptype=" + Enums.DataCompareType.Contains;
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        //alert(DeptID);
                        newServiceURL = newServiceURL + "&deptid=" + DeptID + "&storeid=" + storeid;  //+ "&itemtypeid=" + ddlItemType
                        //newServiceURL = newServiceURL + "&isigr=1";
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
        ...
        function ClearItemData(txtItemID) {
            ...
            $(detRow).find('input[id$="txtItemCode"]').val('');
        }
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            //$(detRow).find('input[id$="hdnStockQty"]').val(data.closing_qty);
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IGR:INTERNAL GOODS REQUISITION"></asp:Label>
            </div>
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <asp:HiddenField ID="hdnREQ_ID" runat="server" />
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>IGR:INTERNAL GOODS REQUISITION </span>
                        </div>
                            ...
                            <div id="groupContenInner">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblPurchaseNO" runat="server" Text="Requisition No:"></asp:Label>
                                                        </td>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblInvoiceDate" runat="server" Text="Requisition Date:"></asp:Label><span style="color: red">*</span>
                                                        ...
                                                        <%-- onblur="checkDt(this)"--%>
                                                        <td>Req. From Department:<span style="color: red">*</span></td>
                                                        <td align="right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="">
                                                            <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox" TextMode="MultiLine" Height="30px" Width=""></asp:TextBox>

                                                        </td>

                                                          <td align="right">
                                                         <asp:Label ID="Label7" runat="server" Text="To Department:"></asp:Label><span style="color: red">*</span>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold">REQUISITION DETAILS</span>
                                    </div>
                                            ...
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                  ...
                                                  <%--  <td width="100px" class="headerColLeft">Item Type
                                                    ...
                                                    <td width="40px" class="headerColLeft">UOM
                                                    </td>
                                                      <td width="50px" class="headerColLeft">Available Stock
                                                    </td>
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="SL#">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSLNo" runat="server" Text='<%# Bind("REQ_DET_SLNO") %>' Style="text-align: center;"
                                                                        Width="64px">
                                                                    </asp:Label>
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                ...
                                                                                <%--    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("REQ_QNTY") %>' onkeypress="return onlyNos(event,this);" OnTextChanged="txtItem_qty_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                                                        <asp:HiddenField ID="hdnStockQty" runat="server" Value='<%# Bind("stock_qty") %>' />
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtUOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="39" Text='<%# Bind("UOM_NAME") %>' Style=""></asp:TextBox>
                                                                                        <asp:HiddenField ID="hdnUomID" runat="server" Value='<%# Bind("UOM_ID") %>' />
                                                                                    </td>
                                                                                        <td>
                                                                                        <asp:TextBox ID="txtStockQty" runat="server" CssClass="textBox textAutoSelect" Width="49" Text='<%# Bind("stock_qty") %>' Style=""></asp:TextBox>
                                                                                      
                                                                                    </td>

                                                                                     <td>
                                                                                        <asp:TextBox ID="txtUnitPrice" Enabled="false" runat="server" Visible="false" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("UNIT_PRICE") %>' onkeypress="return onlyNos(event,this);"></asp:TextBox>

                                                                                    </td>

                                                                                     <td>
                                                                                        <asp:TextBox ID="txtTotalCost" Enabled="false" runat="server" Visible="false" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("TOTAL_COST") %>' onkeypress="return onlyNos(event,this);"></asp:TextBox>

                                                                                    </td>


                                                                                    <td>
                                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="150" Text='<%# Bind("REQ_NOTE") %>' Style=""></asp:TextBox>
                                                                                    </td>
