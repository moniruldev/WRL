<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="INVItemReceiveDirectList.aspx.cs" Inherits="PG.Web.Inventory.INVItemReceiveDirectList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewDirectItemReceive.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Direct Item Receive";
                //tdata.label = "User: " + userid;
                tdata.label = "Direct Item Receive";
                tdata.type = 0;
                tdata.url = url;
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtReceiveNo" runat="server" CssClass="textBox notEnterToTab" Width="90"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                               <input id="btnAddNew" type="button" runat="server" value="New Receive" class="buttonNew"
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                DataKeyNames="RECEIVE_ID" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="RECEIVE_NO" HeaderText="Receive No" ItemStyle-Width="175px" />
                                    <asp:BoundField DataField="RECEIVE_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="150" />
                                        <asp:BoundField DataField="CREATE_BY" HeaderText="Name" 
                                        ItemStyle-Width="160" />
