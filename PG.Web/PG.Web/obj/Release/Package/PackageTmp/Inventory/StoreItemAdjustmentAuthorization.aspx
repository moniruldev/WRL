<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="StoreItemAdjustmentAuthorization.aspx.cs" Inherits="PG.Web.Inventory.StoreItemAdjustmentAuthorization" %>
    ...
    <script language="javascript" type="text/javascript">
      ...
      <%--  var txtCustomerID = '<%=txtCustomerID.ClientID%>';--%>
        ...
        function UserAuthorizeConfirmation() {
            return confirm("Are you sure you want to Authorize?");
        }
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Store Item Adjustment Authorization "></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Store Item Adjustment Authorization </span>
                        </div>
                            ...
                            <div id="groupContenInner">
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold">ADJUSTMENT AUTHORIZATION DETAILS</span>
                                    </div>
                                            ...
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="10px" class="headerColLeft"></td>
                                                      <td width="110px" class="headerColLeft">Item Type
                                                    </td>
                                                    <td width="200px" class="headerColLeft">Item
                                                    </td>
                                                    <td width="70px" class="headerColLeft">Add Qty
                                                    </td>
                                                  <%--  <td width="80px" class="headerColLeft">Auth Add Qty
                                                    </td>--%>
                                                    <td width="70px" class="headerColLeft">Deduct Qty
                                                    </td>
                                                 <%--     <td width="80px" class="headerColLeft">Auth Ded Qty
                                                    </td>--%>
                                                    <td width="70px" class="headerColLeft">Target Qty
                                                    </td>
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                  ...
                                                                                  <%--    <td>
                                                                                        <asp:TextBox ID="txtAuthAddAdjustQty" runat="server" Visible="false" CssClass="textBox textAutoSelect txtQty txtAddQty" Width="75" Text='<%# Bind("AUTH_ADD_ADJUST_QTY") %>' Style="text-align:right" ></asp:TextBox>
                                                                                   ...
                                                                                   <%--   <td>
                                                                                        <asp:TextBox ID="txtAuthDedAdjustQty" runat="server" Visible="false" CssClass="textBox textAutoSelect txtQty txtDeductQty" Width="75" Text='<%# Bind("AUTH_DEDUCT_ADJUST_QTY") %>' Style="text-align:right" ></asp:TextBox>
        ...
        <div id="dvContentFooter" class="dvContentFooter">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnAuthorize" runat="server" Text="Authorize" CssClass="buttonSave checkRequired" AccessKey="s" OnClick="btnAuthorize_Click" OnClientClick="if ( ! UserAuthorizeConfirmation()) return false;" />
