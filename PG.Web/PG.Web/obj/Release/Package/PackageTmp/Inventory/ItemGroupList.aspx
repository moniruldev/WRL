<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master"  AutoEventWireup="true" CodeBehind="ItemGroupList.aspx.cs" Inherits="PG.Web.Inventory.ItemGroupList" %>
...
function tbopen(key, userid)
{
  ...
  var url = IForm.RootPath + "Inventory/ItemGroup.aspx?id=" + key;
    ...
    if (IForm.PageMode == Enums.PageMode.InTab)
    {
       ...
       tdata.id = 0;
       tdata.name = "ItemGroup";
       //tdata.label = "User: " + userid;
       tdata.label = "Item Group";
       tdata.type = 0;
       tdata.url = url;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvContentHeader" class="dvContentHeader">
       <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item Group List"></asp:Label>
    </div>
   ...
   <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width:700px;">
    ...
    <div id="dvGridContainer" style="width:100%; height: auto; text-align:left;">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            DataKeyNames="ITEM_GROUP_ID" onrowdatabound="GridView1_RowDataBound" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ITEM_GROUP_CODE" HeaderText="Code" ItemStyle-Width="80px" />
               
                <asp:BoundField DataField="ITEM_GROUP_NAME" HeaderText="Name" >
                
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="200px" HorizontalAlign="Left" />
                </asp:BoundField> 
                <asp:BoundField DataField="ITEM_GROUP_NAME_PARENT" HeaderText="Under" ItemStyle-Width="200px" /> 
