<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewStoreItemAdjustment.aspx.cs" Inherits="PG.Web.Inventory.INVNewStoreItemAdjustment" %>
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        newServiceURL = newServiceURL + "&itemtypeid=" + ddlItemType + "&deptid=" + DeptID + "&storeid=" + storeid;
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Store Item Adjustment "></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Store Item Adjustment </span>
                        </div>
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>   
                                                        ...
                                                        <td></td>
                                                         <td>
                                                            <asp:CheckBox ID="cbAuthStatus" runat="server" Text="Authorised" Visible="false" />
                                                        </td>
                                                        <td></td>
                                                         <td align="right">
                                                            <asp:CheckBox runat="server" ID="cbIsTarget" Text="Is Target" Visible="false" Checked="true" />
                                                        </td>
                                        ...
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="68px" class="headerColLeft">Stock 
                                                    </td>
                                                    <td width="120px" class="headerColCenter">Reason
                                                    </td>
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect txtQty txtAddQty" Width="80" Text='<%# Bind("ADD_ADJUST_QTY") %>' OnTextChanged="CalculateTargetQty" AutoPostBack="true" style="text-align:right" ></asp:TextBox>      

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtDeductQty" runat="server" CssClass="textBox textAutoSelect txtQty txtDeductQty" Width="75" Text='<%# Bind("DEDUCT_ADJUST_QTY") %>'  OnTextChanged="CalculateTargetQty" AutoPostBack="true"  style="text-align:right"  ></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txt_Target_qty" runat="server" CssClass="textBox textAutoSelect txtQty" Width="77" Text='<%# Bind("TARGET_QTY") %>'  OnTextChanged="CalculateTargetQty" AutoPostBack="true" style="text-align:right" ></asp:TextBox>   
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="120" Text='<%# Bind("REMARKS_DTL") %>' Style=""></asp:TextBox>
                                                                                    </td>
                                        ...
                                        <div id="divGridControls2" style="width: 100%; height: 25px; border-top: solid 1px #C0C0C0;">
                                            <table style="width: auto; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <asp:Label ID="lbltotalSalesAmount" runat="server" Text="Total Add Qnty:" Font-Bold="True" ></asp:Label>   
                                                    </td>
                                                    <td align="right">
