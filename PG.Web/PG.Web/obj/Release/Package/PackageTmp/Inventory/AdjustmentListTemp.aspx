<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="AdjustmentListTemp.aspx.cs" Inherits="PG.Web.Inventory.AdjustmentListTemp" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Department Closing-WIP";
                tdata.label = "Department Closing-WIP";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Department Consumption"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                             <asp:TextBox ID="txtAdjNo" runat="server" CssClass="textBox notEnterToTab"></asp:TextBox>
                        </td>
                            ...
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="200px" align="left">Department
                                      ...
                                      <td width="80px" align="left">Auth Status
                                    </td>
                        ...
                        <div id="dvGrid" style="width: 900px; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="FROM_DEPT_NAME" HeaderText="Type" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="AUTH_STATUS" HeaderText="Status" ItemStyle-Width="80px" />
