<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVServicePRForNewPurchase.aspx.cs" Inherits="PG.Web.Inventory.INVServicePRForNewPurchase" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewPurchaseAgainstServicePR.aspx?id=" + key;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Service PR List For Purchase"></asp:Label>
            </div>
            <!--Message Div -->
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                 ...
                                 <asp:BoundField DataField="DEPARTMENT_NAME" HeaderText="Required Dept" 
                                        ItemStyle-Width="200" />
