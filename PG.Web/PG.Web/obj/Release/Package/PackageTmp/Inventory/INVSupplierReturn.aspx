<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVSupplierReturn.aspx.cs" Inherits="PG.Web.Inventory.INVSupplierReturn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
      ...
      <%--  var btnSupplierID = '<%=btnSupplierID.ClientID%>';--%>
        ...
        var QcRefListServiceLink = '<%=this.QcRefListServiceLink%>';
        var txtRefNo = '<%=txtRefNo.ClientID%>';
        var btnRefNo = '<%=btnRefNo.ClientID%>';
        var hdnQcId = '<%=hdnQcId.ClientID%>';
        var txtPurchaseNo = '<%=txtPurchaseNo.ClientID%>';
       <%-- var txtQcNo = '<%=txtQcNo.ClientID%>';--%>
      ...
      <%--  var txtCustomerID = '<%=txtCustomerID.ClientID%>';--%>
        ...
        function bindItemList(gridViewID) {
            ...
            //var serviceURL = GLAccountServiceLink + "?isterm=1&includeempty=1&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            var serviceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&isDirectPurchase=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            //serviceURL += "&companyid=" + companyid;
            serviceURL += "&ispaging=1";
            //serviceURL += "&locationid=" + locationid;
            // serviceURL += "&empstatus=" + "A";
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        newServiceURL = newServiceURL + "&itemtypeid=" + ddlItemType + "&isreturnstock=Y";
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
        ...
        function bindQcRefList() {
            var cgColumns = [{ 'columnName': 'mrrno', 'width': '150', 'align': 'left', 'highlight': 2, 'label': 'MRR No' }
                             , { 'columnName': 'qcdate', 'width': '100', 'align': 'left', 'highlight': 4, 'label': 'MRR DATE' }
                             , { 'columnName': 'qcno', 'width': '150', 'align': 'left', 'highlight': 4, 'label': 'QC No' }
                             , { 'columnName': 'supname', 'width': '150', 'align': 'left', 'highlight': 0, 'label': 'Supplier' }
            ...
            var serviceURL = QcRefListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            serviceURL += "&ispaging=1";

            var supplierIDElem = $('#' + txtRefNo);

            $('#' + btnRefNo).click(function (e) {
                $(supplierIDElem).combogrid("dropdownClick");
            });
            ...
            $(supplierIDElem).combogrid({
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.qcno == '') {
                        ...
                        // $('#' + hdnDealerID).val(ui.item.dealerid);
                        $('#' + hdnQcId).val(ui.item.qcid);
                        $('#' + txtRefNo).val(ui.item.mrrno);
                        $("[id*=btnLoad]").click();
                        //$('#' + txtSupplierName).val(ui.item.supname);
                        //$('#' + txtPurchaseNo).val(ui.item.purchaseno);
                        //$('#' + txtQcNo).val(ui.item.qcno);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField runat="server" ID="hdnMrrId" Value="0" />
    <asp:HiddenField ID="hdnPurchaseId" runat="server" Value="0" />
    <asp:HiddenField ID="hdnStoreId" runat="server" Value="" />
     <asp:HiddenField ID="hdnLoggedInUser" runat="server" />
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Supplier Return"></asp:Label>
            </div>
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <div id="dvControls" style="height: auto; width: 100%">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width:1067px;">
                    <div id="groupBox">
                            ...
                            <div id="groupContenInner">
                                <div id="groupDataMaster" style="width: 109%; height: auto;">
                                    ...
                                    <table style="width: 101%" border="0" cellspacing="2" cellpadding="1">
                                        <tr>
                                                ...
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="txtReturnNo" runat="server" CssClass="textBox" Enabled="false" BackColor="#FFFFCC"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                        <td align="right">
                                                            <asp:Label ID="lblReturnDate" runat="server" Text="Return Date:"></asp:Label><span style="color:red">*</span></td>

                                                       
                                                        <td>
                                                            <asp:TextBox ID="txtReturnDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                                                            <asp:RegularExpressionValidator runat="server" ControlToValidate="txtReturnDate" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$" ErrorMessage="Invalid date format." ValidationGroup="Group1" ForeColor="Red" />
                                                        </td>
                                           ...
                                           <td >
                                        <asp:TextBox ID="txtSupplierName" runat="server" CssClass="textBox" Width="180px" ReadOnly="true"></asp:TextBox>
                                        <%--<input id="btnSupplierID" type="button" value="" runat="server" class="buttonDropdown"
                                            tabindex="-1" />--%>
                                                  ...
                                                  <td>
                                                      &nbsp;DC :&nbsp;
                                                             <asp:Label ID="lblDCNO" runat="server" Width="200px"></asp:Label>
                                                  </td>
                                                    ...
                                                    <tr>
                                                        <td align="right">
                                                          <asp:Label ID="lblRefNo" runat="server" Text="MRR No:"></asp:Label><span style="color:red">*</span>
                                                            
                                                         </td>
                                                        
                                                           <td >
                                                        <asp:TextBox ID="txtRefNo" runat="server" CssClass="textBox" Width="180px"></asp:TextBox>
                                                        <input id="btnRefNo" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
                                                        ...
                                                        <td></td>
                                                          ...
                                                          <asp:Label ID="lblPurchaseNo" runat="server" Text="Purchase No:"></asp:Label>
                                                           ...
                                                           <td >
                                                        <asp:TextBox ID="txtPurchaseNo" runat="server" CssClass="textBox" Width="180px" ReadOnly="true"></asp:TextBox>
                                                               
                                                         </td>
                                                <%--          <td align="right">
                                                          <asp:Label ID="lblQcNo" runat="server" Text="QC No:"></asp:Label>

                                                         </td>
                                                        
                                                           <td >
                                                        <asp:TextBox ID="txtQcNo" runat="server" CssClass="textBox" Width="180px" ReadOnly="true"></asp:TextBox>
                                                        ...
                                                        <td>
                                                            &nbsp;GP :&nbsp;
                                                             <asp:Label ID="lblGPNO" runat="server" Width="200px"></asp:Label>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                         ...
                                                         <td align="right">
                                                            <asp:Label ID="lblSupChallan" runat="server" Text="Sup. Challan:"></asp:Label>
                                                        </td>
                                                        <td >
                                                            <asp:TextBox ID="txtSupChallan" runat="server" CssClass="textBox"  Width="180px" ReadOnly="true"></asp:TextBox>

                                                        </td>
                                                        <td colspan="2">
                                                            <asp:CheckBox runat="server" ID="chkIsReplacable" Checked="true"  />
                                                            <asp:Label runat="server" ID="lblIsReplacable" Text="Is Replacable?" Style="color:green; font-weight:bold;"></asp:Label>
                                                        </td>
                                                         
                                                        <td><asp:Button runat="server" ID="btnLoad" OnClick="btnLoad_Click" Style="display:none;" /></td>
                                                    </tr>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold">Supplier Return Details: </span>
                                    </div>
                                            ...
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="50px" class="headerColLeft">UOM
                                                      ...
                                                      <td width="80px" class="headerColLeft">QC Rtn Qty
                                                    </td>
                                                     <td width="80px" class="headerColLeft">Closing
                                                    </td>
                                                  ...
                                                  <%--  <td width="60px" class="headerColRight">Item Rate
                                                    ...
                                                    <td width="72px" class="headerColCenter">Total Amt
                                                     ...
                                                     <td width="60px" class="headerColCenter">DC NO
                                                    </td>--%>
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="SL#">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSLNo" runat="server" Text='<%# Bind("RTN_DET_SLNO") %>' Style="text-align: center;"
                                                                        Width="64px">
                                                                    </asp:Label>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox textAutoSelect" Width="80" Text='<%# Bind("ITEM_GROUP_NAME") %>' Visible="false"></asp:TextBox>
                                                                                        <asp:HiddenField ID="hdngroupId" runat="server" Value='<%# Bind("ITEM_GROUP_ID") %>' />
                                                                                         <asp:HiddenField ID="hdnRtnDetId" runat="server" Value='<%# Bind("RTN_DET_ID") %>' />
                                                                                         <asp:HiddenField ID="hdnQcDetId" runat="server" Value='<%# Bind("QC_DET_ID") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                        <input id="btnItemGroup" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" visible="false" />
                                                                                    </td>
                                                                                    <td>
                                                                                      ...
                                                                                      <%--  <asp:DropDownList ID="ddlItemType" runat="server" CssClass="dropDownList" Width="120" >
                                                                                         ...
                                                                                         <asp:TextBox ID="txtItemType" runat="server" CssClass="textBox textAutoSelect" Width="115" Text='<%# Bind("ITEM_TYPE_CODE") %>'></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <%-- <asp:DropDownList ID="ddlItem" runat="server" CssClass="dropDownList" Width="195"></asp:DropDownList>--%>
                                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="195" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("RTN_QNTY") %>' onkeypress="return onlyNos(event,this);" ></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                     ...
                                                                                     <td>
                                                                                        <asp:TextBox ID="txtQcReturnQty" runat="server" CssClass="textBox textAutoSelect" Width="80" Text='<%# Bind("QC_RTN_QTY") %>' Style="" ></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtClosingQty" runat="server" CssClass="textBox textAutoSelect" Width="80" Text='<%# Bind("CLOSING_QTY") %>' Style="" ></asp:TextBox>
                                                                                    </td>
                                                                                  
                                                                                    <td>
                                                                                        
                                                                                        <asp:TextBox ID="txtITEMRate" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("UNIT_RATE") %>' Style="" OnTextChanged="txtITEMRate_TextChanged" AutoPostBack="true" Enabled="true" Visible="false"></asp:TextBox>
                                                                                        <asp:HiddenField ID="hdnItemRate" runat="server" Value='<%# Bind("UNIT_RATE") %>' />
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:Label ID="lblTotalAmt" runat="server" CssClass="textBox textAutoSelect" Width="68" Text='<%# Bind("TOTAL_AMOUNT") %>' Style="" Visible="false"></asp:Label>
                                                                                    </td>
                                                                                     <td>
                                                                                        <asp:TextBox ID="txtSUPDCNO" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("DC_NO") %>'  Style="" Visible="false" ></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="150" Text='<%# Bind("RTN_DET_NOTE") %>' Style=""></asp:TextBox>
                                                                                    </td>
                                                            ...
                                                            <asp:TemplateField HeaderText="Delete" ShowHeader="false">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="btnDeleteRow" CssClass="buttonDeleteIcon" Height="16px" Width="16px"
                                                                        CommandName="delete" runat="server" Visible="false">
                                                                    </asp:LinkButton>
                                                                </ItemTemplate>
                                                                <ItemStyle VerticalAlign="Top" />
                                                            </asp:TemplateField>
                                            ...
                                            <table style="width: auto; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 90px" align="left">
                                                        <asp:Button ID="btnNewRow2" runat="server" CssClass="buttonNewRow" Text="" OnClientClick="ShowProgress()" OnClick="btnNewRow2_Click" Visible="false" />
                                                    </td>
                                                    <td style="width: 20px;">
            ...
            <table>
                <tr>
                    ...
                    <td>
                     ...
                     <td>
                        <asp:Button ID="btnDcPrint" runat="server" Text="Print DC" CssClass="buttoncommon" Enabled="true" OnClick="btnDcPrint_Click" />
                    </td>

                    <td>
                        <asp:Button ID="btnGpPrint" runat="server" Text="Print GP" CssClass="buttoncommon" Enabled="true" OnClick="btnGpPrint_Click" />
                    </td>
