<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="InterDepartmentIRRList.aspx.cs" Inherits="PG.Web.Inventory.InterDepartmentIRRList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewInterDepartmentIRR.aspx?irrId=" + key + "&type=" + "";
                        ...
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; width:100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="80px" align="left">IRR
                                        Date
                                    </td>
                                    <td width="100px" align="left">Department</td>
                        ...
                        <div id="dvGrid" style="width: 920px; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" Width="920" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ISSUE_RECEIVE_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="80" ControlStyle-Width="80px" />
                                    <asp:BoundField DataField="DEPARTMENT_NAME" HeaderText="Iss Dept" ItemStyle-Width="100px" ControlStyle-Width="100px" />
