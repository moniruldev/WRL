<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVDirectPurchase_SP_Update_New.aspx.cs" Inherits="PG.Web.Inventory.INVDirectPurchase_SP_Update_New" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Direct Purchase Special Update"></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width:1067px;">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Direct Purchase Special Update</span>
                        </div>
                                        ...
                                        <input id="btnSupplierID" type="button" value="" runat="server" class="buttonDropdown"
                                            tabindex="-1" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="9">
                                                            <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox" TextMode="MultiLine" Height="30px" Width="700px" ReadOnly="true"></asp:TextBox>
                                        ...
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="60px" class="headerColRight" style="display:none">Item Rate
                                                    </td>
                                                    ...
                                                    <td width="160px" class="headerColCenter">Remarks/ Work order no by Accounts
                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:HiddenField ID="hdnMrrDtlId" runat="server" Value='<%# Bind("MRR_DET_ID") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("PURCHASE_QTY") %>' onkeypress="return onlyNos(event,this);" ></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtITEMRateView" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("UNIT_RATE") %>' Style="" OnTextChanged="txtITEMRate_TextChanged" AutoPostBack="true" Enabled="false" onkeypress="return onlyNos(event,this);"></asp:TextBox>
                                                                                    </td>


                                                                                    <td style="display:none">
                                                                                        <asp:TextBox ID="txtITEMRate" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("UNIT_RATE") %>' Style="" OnTextChanged="txtITEMRate_TextChanged" AutoPostBack="true" Enabled="false" onkeypress="return onlyNos(event,this);"></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtTotalAmt" runat="server" CssClass="textBox textAutoSelect" Width="68" Text='<%# Bind("total_amount") %>' Style="" Enabled="false"></asp:TextBox>
                                                                                    </td>
                                                                                     <td>
                                            ...
                                            <table style="width: auto; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 90px" align="left">
                                                        <asp:Button ID="btnNewRow2" runat="server" CssClass="buttonNewRow" Visible="false" Text="" OnClientClick="ShowProgress()" OnClick="btnNewRow2_Click" />
                                                    </td>
                                                    <td style="width: 20px;">
                                                    ...
                                                    <td align="right">
                                                        <asp:Label ID="lbltotalSalesAmount" runat="server" Text="Total Quantity:" Font-Bold="True"></asp:Label>
                                                    </td>
                                                    <td align="right">
