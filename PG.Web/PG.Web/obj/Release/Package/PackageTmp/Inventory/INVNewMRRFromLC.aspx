<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewMRRFromLC.aspx.cs" Inherits="PG.Web.Inventory.INVNewMRRFromLC" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="NEW MRR From LC" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;" align="center">
                <table border="0" cellspacing="4" cellpadding="2" align="center" style="width: 100%" id="tblItemEntry">
                    ...
                    <tr>
                        ...
                        <td align="right" class="auto-style2">
                            <asp:Label ID="Label1" runat="server" Text="MRR Date :" Font-Bold="true"></asp:Label><span style="color: red">*</span>
                        </td>
                        <td align="left" class="auto-style3">
                    ...
                    <tr>
                        ...
                        <td align="left" class="auto-style3">
                           ...
                           <%-- <asp:TextBox ID="txtChallanNo" runat="server" CssClass="textBox" Font-Bold="true"></asp:TextBox>--%>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td align="right" class="auto-style1">
                            <asp:Label ID="Label6" runat="server" Text="LC No :" Font-Bold="true"></asp:Label>
                        </td>
                        <td align="left" class="auto-style1">
                            <asp:TextBox ID="txtLcNo" runat="server" CssClass="textBox" ReadOnly="true" Font-Bold="true"></asp:TextBox>
                        </td>
                        <td align="right" class="auto-style1">
                            <asp:Label ID="Label7" runat="server" Text="Lc Date :" Font-Bold="true"></asp:Label>
                        </td>
                        <td align="left" class="auto-style1">

                            <asp:TextBox ID="txtLcDate" runat="server" ReadOnly="true" CssClass="textBox" Font-Bold="true"></asp:TextBox>
                        </td>
                    </tr>
                     ...
                     <%--   <td align="right" class="auto-style2">
                        ...
                        <td align="left" class="auto-style2">
                            <asp:TextBox ID="txtPurchaseRemarks" runat="server" CssClass="textBox" TextMode="MultiLine" Height="30px" Enabled="false"></asp:TextBox>

                        </td>--%>

                           <td align="right">
                             <asp:Label ID="Label9" runat="server" Font-Bold="true" Text="Department:"></asp:Label><span style="color: red">*</span>
                ...
                <ItemStyle BorderColor="Gray" HorizontalAlign="Center" Width="100px"  />
                                    ...
                                    <asp:TemplateField HeaderText="SL#">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblMrrDetSlNo" runat="server" Text='<%# Bind("MRR_DET_SLNO") %>' Style="text-align: center;" Width="30px"> </asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Item Name" Visible="true">
                                     ...
                                     <asp:TemplateField HeaderText="Item Type" Visible="true">
                                        <ItemTemplate>
                                         <asp:DropDownList ID="ddlItemType" runat="server" CssClass="dropDownList" Width="100px" >
                                    ...
                                    <asp:TemplateField HeaderText="Purchase Qty" Visible="true">
                                        ...
                                        <ItemStyle VerticalAlign="Top" />
                                           ...
                                           <asp:TemplateField HeaderText="Purchase Uom" Visible="true">
                                        <ItemTemplate>
                                           <asp:Label ID="lblUomName" runat="server" Text='<%# Bind("PURCHASE_UOM_CODE") %>' Style="text-align: center;" Width="50px"></asp:Label>
                                             <asp:HiddenField ID="hdnPurchaseUomId" runat="server" Value='<%# Bind("PURCHASE_UOM_ID") %>' />
                                        </ItemTemplate>
                                        <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>
                                       <asp:TemplateField HeaderText="Already MRR Qty" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAlreadyMRRQty" runat="server"   Text='<%# Bind("alreadymrrqty") %>' Style="text-align: center;" Width="100px"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="MRR Qty" Visible="true">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtMrrQty" Text='<%# Bind("MRR_QTY") %>' runat="server" CssClass=" textBox textNumberOnly" Style="text-align: center;" Width="100px" onkeypress="return onlyNos(event,this);" OnTextChanged="txtItemRate_TextChanged" AutoPostBack="true"></asp:TextBox>
                                   ...
                                   <asp:TemplateField HeaderText="MRR Uom" Visible="true">
                                                <ItemTemplate>
                                                    <%--<asp:Label ID="lblUomName" runat="server" Text='<%# Bind("UOM_NAME") %>' Style="text-align: center;" Width="50px"></asp:Label>--%>
                                                      ...
                                                      <asp:DropDownList ID="ddlUOM" runat="server"  CssClass="dropDownList"> </asp:DropDownList>
                                                </ItemTemplate>
                                                <ItemStyle VerticalAlign="Top" />
                                            </asp:TemplateField>
                              

                                    <asp:TemplateField HeaderText="Reject Qty" Visible="false">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtRejectQty" Text='0' runat="server" CssClass=" textBox textNumberOnly" Style="text-align: center;" Width="100px" Enabled="false" onkeypress="return onlyNos(event,this);" ></asp:TextBox>
                                     ...
                                     <asp:TemplateField HeaderText="Weighted Avg Price" Visible="false">
                                        <ItemTemplate>
                                           <asp:Label ID="lblWeighAvgPrice" runat="server" Text='<%# Bind("WEIGHTED_AVERAGE_PRICE") %>' Style="text-align: center;" Width="100px"></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Unit Price" Visible="false">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtUnitPrice" Text='<%# Bind("unit_rate") %>' CssClass="textBox textNumberOnly" runat="server" Style="text-align: center;" Width="100px" ReadOnly="true" onkeypress="return onlyNos(event,this);" OnTextChanged="txtItemRate_TextChanged" AutoPostBack="true" ></asp:TextBox>
                                      ...
                                      <asp:TemplateField HeaderText="Total Cost" Visible="false">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtTotalCost" Text='<%# Bind("TOTAL_COST") %>' CssClass="textBox textNumberOnly" runat="server" Style="text-align: center;" Width="100px" onkeypress="return onlyNos(event,this);" Enabled="false"></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="MRR.Remarks" Visible="true">
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtRemarks" Text='<%# Bind("NOTE") %>' TextMode="MultiLine" CssClass="textBox" runat="server" Style="text-align: center;" Height="20px" Width="100px"></asp:TextBox>
        ...
        <div id="dvContentFooter" class="dvContentFooter">
            <table align="center">
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="buttonDelete" Visible="false" Enabled="false" />
                    </td>
                    ...
                    <td>
                        <asp:Button ID="btnRefresh" runat="server" Text="Refresh" CssClass="buttonRefresh checkIsDirty" Visible="false" Enabled="false" />
                    </td>
