<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVItemOpeningPriceEntry.aspx.cs" Inherits="PG.Web.Inventory.INVItemOpeningPriceEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ClearItemData(txtItemID) {
            ...
            $(detRow).find('input[id$="txtItem_qty"]').val('');
        }
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            $(detRow).find('input[id$="txtItem_qty"]').val(data.Opening_Price);
        }
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item Opening Price Entry And Update"></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Item Opening Price Entry And Update</span>
                        </div>
                                        ...
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="200px" class="headerColLeft">Item Group
                                                    </td>
                                                    <td width="10px" class="headerColLeft"></td>
                                                    <td width="250px" class="headerColLeft">Item
                                                    </td>
                                                    <td width="10px" class="headerColLeft"></td>
                                                    <td width="100px" class="headerColLeft">Opening Price
                                                    </td>
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="SL#">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSLNo" runat="server" Text='<%# Bind("ITEM_SLNO") %>' Style="text-align: center;"
                                                                        Width="64px">
                                                                    </asp:Label>
                                                                    <asp:HiddenField ID="hdnRecordStateInt" runat="server" Value='<%# Bind("_RecordStateInt") %>' />
                                                                    <asp:HiddenField ID="hdnReqDetId" runat="server" Value='<%# Bind("ITEM_ID") %>' />
                                                                </ItemTemplate>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox textAutoSelect" Width="200" Text='<%# Bind("ITEM_GROUP_NAME") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Font-Bold="true" BackColor="Yellow" Font-Size="Medium" Width="98" Text='<%# Bind("OPENING_PRICE") %>' onkeypress="return onlyNos(event,this);"></asp:TextBox>
