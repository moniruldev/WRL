<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVIndentListForNewPurchase.aspx.cs" Inherits="PG.Web.Inventory.INVIndentListForNewPurchase" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewPurchaseAgainstIndent.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "PUR:Purchase Against Indent";
                //tdata.label = "User: " + userid;
                tdata.label = "PUR:Purchase Against Indent";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Indent List For Purchase"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="LblLocation" runat="server" Text=" From Department : "></asp:Label><span style="color:red">*</span>
                        </td>
                        <td>
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="100px" align="left">Item's
                                    </td>
                                    <td width="150px" align="left">INDT No
                                    </td>
                                    <td width="100px" align="left">INDT Date
                                    </td>
                                    <td width="100px" align="left">Required Date
                                    </td>
                                    <td width="200px" align="left">Required Dept
                                    </td>
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting" OnRowCommand="GridView1_RowCommand"
                                ...
                                <Columns>
                                   <asp:HyperLinkField HeaderText="" Text="New PUR">
                                        <ControlStyle Height="20px" Width="60px" />
                                        <ItemStyle Width="60px" />
                                    </asp:HyperLinkField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton runat="server" ID="lnkItemDtl"  CssClass="btn btn-default"  CommandName="itemdtl" CommandArgument='<%# Bind("INDT_NO") %>'><i class="glyphicon glyphicon-info-sign" style="padding-right:4px; font-size:14px; color:#4695cf"></i>Items</asp:LinkButton>
                                        </ItemTemplate>
                                        <ItemStyle Width="100px" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="INDT_NO" HeaderText="Req. No" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="INDT_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="100" />
                                   <asp:BoundField DataField="REQUIRED_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="100" />

                                 <asp:BoundField DataField="from_department_name" HeaderText="Required Dept" 
                                        ItemStyle-Width="200" />
           ...
           <div id="myModalItemDetails" class="modal fade" >  
                ...
                <div class="modal-content" style="max-width:500px;">  
                    ...
                    <div class="modal-body" style="overflow-y:scroll; overflow-x:scroll; max-height:300px; max-width:1080px; margin-top: 10px; margin-bottom: 10px;"> <%-- --%>
                        <asp:Label ID="Label8" runat="server" ClientIDMode="Static"></asp:Label>  
                         <asp:Label ID="lblIndtNo" runat="server" Text="Indent No : " ></asp:Label>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ITEM_NAME" HeaderText="ITEM NAME" ItemStyle-Width="300px" />
                  <asp:BoundField DataField="INDT_QTY" HeaderText="QTY" ItemStyle-Width="80px" />
