<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewITCToStore.aspx.cs" Inherits="PG.Web.Inventory.INVNewITCToStore" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function bindItemList(gridViewID) {
           ...
           var e = document.getElementById("<%=ddlFromDepartment.ClientID%>");
            var dept_id1 = e.options[e.selectedIndex].value;
            //if (dept_id1 == 54)
            //{
                
            //    var serviceURL = BOMNameListServiceLink + "?isterm=1&includeempty=0&iscodename=1&isFinished=Y&codecomptype=" + Enums.DataCompareType.StartsWith;
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    //if (dept_id1 == 54) {
                    //    var newServiceURL = serviceURL + "&groupid=" + vgroupid + "&deptid=" + dept_id;
                    //}
                        //else
                        var newServiceURL = serviceURL + "&groupid=" + vgroupid + "&batterytypeid=" + vbatterytypeid + "&chkisrepair=" + vchk + "&specid=" + specId + "&deptid=" + dept_id + "&isdeptstock=Y";
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="ITC:Issue to Store"></asp:Label>
            </div>
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td align="right">
                                                            <asp:Label ID="lblInvoiceDate" runat="server" Text="Issue Date:"></asp:Label><span style="color: red">*</span></td>
                                                        <td>
                                                        ...
                                                        <%-- onblur="checkDt(this)"--%>
                                              <td>Issue.Department:<span style="color: red">*</span></td>
                                            </td>
                                            <td align="right">
                                        ...
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="90px" class="headerColLeft">Item Spac.
                                                    </td>
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtUnitPrice" runat="server" OnTextChanged="txtItemRate_TextChanged" Visible="false" AutoPostBack="true" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("UNIT_PRICE") %>' onkeypress="return onlyNos(event,this);"></asp:TextBox>

                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" OnTextChanged="txtItemRate_TextChanged" AutoPostBack="true" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("ISSUE_QNTY") %>' onkeypress="return onlyNos(event,this);"></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                      ...
                                                                                      <td>
                                                                                        <asp:TextBox ID="txtItemTotalCost" Enabled="false" runat="server" Visible="false" CssClass="textBox textAutoSelect" Width="68" Text='<%# Bind("TOTAL_COST") %>' Style=""></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
            ...
            <table>
                <tr>
                  ...
                  <%--  <td>
                      ...
                      <td>
                        <asp:Button ID="btnPrint" runat="server" Text="Print" CssClass="buttonPrintPreview" Enabled="True" OnClick="btnPrint_Click" />
                    </td>
                    <td>
