<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="LC_ENTRY_Against_Indent.aspx.cs" Inherits="PG.Web.Inventory.LC_ENTRY_Against_Indent" %>
       ...
       <%-- var hdnCompanyIDtxt = '<%=hdnCompanyIDtxt.ClientID%>';--%>
        ...
        function bindCNFList() {
            var cgColumns = [{ 'columnName': 'cnfcode', 'width': '80', 'align': 'left', 'highlight': 2, 'label': 'Code' }
                             ...
                             , { 'columnName': 'cnfddress', 'width': '200', 'align': 'left', 'highlight': 4, 'label': 'Address' }
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlCurrency" runat="server" Width="165px" CssClass="dropDownList"></asp:DropDownList>
                                                        </td>

                                                        <td align="right">
                                                            <asp:Label ID="lblConversionRate" runat="server" Text="Conv. Rate:"></asp:Label>
                                                ...
                                                <ContentTemplate>
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="true"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Manufacture" Visible="true">
                                                                <ItemTemplate>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                            ...
                                                            <asp:TemplateField HeaderText="HS Code1" Visible="true">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txthscode1" runat="server" CssClass="textBox textAutoSelect" MaxLength="4" Width="98" Text='<%# Bind("HS_CODE1") %>' Style=""></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle VerticalAlign="Top" />
                                                            </asp:TemplateField>
                                                            ...
                                                            <asp:TemplateField HeaderText="HS Code2" Visible="true">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txthscode2" runat="server" CssClass="textBox textAutoSelect" MaxLength="2" Width="98" Text='<%# Bind("HS_CODE2") %>' Style=""></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle VerticalAlign="Top" />
                                                            </asp:TemplateField>

                                                            <asp:TemplateField HeaderText="HS Code3" Visible="true">
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txthscode3" runat="server" CssClass="textBox textAutoSelect" MaxLength="2" Width="98" Text='<%# Bind("HS_CODE3") %>' Style=""></asp:TextBox>
                                                                </ItemTemplate>
                                                                <ItemStyle VerticalAlign="Top" />
                                                            </asp:TemplateField>
