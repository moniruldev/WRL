<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVDirectITCListForStore.aspx.cs" Inherits="PG.Web.Inventory.INVDirectITCListForStore" %>
      ...
      <script language="javascript" type="text/javascript">
        ...
        var txtGridPageNo = '<%=txtGridPageNo.ClientID %>';
          ...
          function tbopen(key, userid) {
              ...
              var url = IForm.RootPath + "Inventory/INVNewDirectITCFormStore.aspx?id=" + key;
              ...
              if (IForm.PageMode == Enums.PageMode.InTab) {
                  ...
                  tdata.id = 0;
                  tdata.name = "ITC:Direct From Store";
                  //tdata.label = "User: " + userid;
                  tdata.label = "ITC:Direct From Store";
                  tdata.type = 0;
                  tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text=" ITC: Internal Transfer Challan List(Direct) From Store"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="ITC To Department"></asp:Label>
                        </td>
                        <td>
                        ...
                        <div id="dvGrid" style="width: 900px; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="REQ_ISSUE_NO" HeaderText="Issue/TC No" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="REQ_ISSUE_TIME" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}"
                                        ItemStyle-Width="150" />

                                     <asp:BoundField DataField="CREATE_BY_NAME" HeaderText="Create By"  ItemStyle-Width="170px" />
                                   
                                    <asp:BoundField DataField="to_department_name" HeaderText="To Department" ItemStyle-Width="170px" />

                                      <asp:BoundField DataField="ISSUE_RECEIVE_NO" HeaderText="IRR No" ItemStyle-Width="150px" />
                                     <asp:BoundField DataField="ISSUE_RECEIVE_TIME" HeaderText="IRR Date" DataFormatString="{0:dd-MMM-yyyy mm:hh tt}" ItemStyle-Width="150px" />
