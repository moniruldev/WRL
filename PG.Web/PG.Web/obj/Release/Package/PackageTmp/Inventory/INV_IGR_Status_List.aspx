<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INV_IGR_Status_List.aspx.cs" Inherits="PG.Web.Inventory.INV_IGR_Status_List" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IGR Register:"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <tr>
             ...
             <tr>
              ...
              <td align="right">
               <asp:Label ID="lblReqNo" runat="server" Text="Requisition No:" style="height: 19px; width: 43px; " Font-Bold="True" Visible="true"></asp:Label>
              </td>
              <td align="left" colspan="4">
                 <asp:TextBox ID="txtReqNo" runat="server" CssClass="textBox  enableIsDirty" Style="text-align: left;" Width="200px"></asp:TextBox>
            ...
            <div id="dvControls" style="width: 1150px">
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width: auto; height: 350px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1" Width="830px"
                                CellSpacing="1" ForeColor="#333333" GridLines="None" Font-Names="Arial" Font-Size="9pt" DataKeyNames="REQ_ID"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Req ID" Visible="false">
                                      <ItemTemplate>
                                     <asp:Label ID="lblReqID" runat="server" Text='<%# Bind("REQ_ID") %>' Style="text-align: center;" ></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Sub type ID" Visible="false">
                                      <ItemTemplate>
                                     <asp:Label ID="lblSubtypeID" runat="server" Text='<%# Bind("REQ_ID") %>' Style="text-align: center;" ></asp:Label>
                                     ...
                                     <asp:TemplateField HeaderText="RowNumber" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center">   
                                         <ItemTemplate>
                                      ...
                                      <ItemTemplate>
                                     <asp:Label ID="lblReqNo" runat="server" Text='<%# Bind("REQ_NO") %>' Style="text-align: center;"></asp:Label>
                                                                   
                                      </ItemTemplate>
                                       <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>
                                       <asp:BoundField DataField="REQ_NO" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="200px" />
                                     <asp:BoundField DataField="REQ_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="100px" />
                                ...
                                <%--   <asp:BoundField DataField="ITEM_NAME" HeaderText="Type" ItemStyle-Width="200px" ItemStyle-HorizontalAlign="Center"  />--%>
                                    ...
                                    <ItemTemplate>
                                    <asp:LinkButton ID="btnStatusdtl" runat="server"  CssClass="buttonAttach" CommandName="statusd"  CommandArgument='<%# Bind("REQ_NO") %>' ><i class="glyphicon glyphicon-info-sign" style="padding-right:4px;color:blue;font-size:14px;"></i>Details</asp:LinkButton>
                                    </ItemTemplate>
                ...
                <%--         <asp:TemplateField HeaderText="Attachment"  ItemStyle-HorizontalAlign="Center">  
                       ...
                       <asp:TemplateField HeaderText="Comments"  ItemStyle-HorizontalAlign="Center">  
                        <ItemTemplate>  
                            <asp:LinkButton ID="lnkdetailcom"  CommandName="comments"  CssClass="buttonAttach"  CommandArgument='<%# Bind("REQ_NO") %>' runat="server" CausesValidation="false" ><i class="glyphicon glyphicon-comment" style="padding-right:4px;color:blue;font-size:14px"></i>Comments</asp:LinkButton>  
                             <asp:HiddenField ID="hdnReqNo" runat="server" Value='<%# Bind("REQ_NO") %>' />
                        </ItemTemplate>  
                          
                    </asp:TemplateField>  
                     <asp:TemplateField >
                            <ItemTemplate>
                           <asp:Label ID="lblComments" style=" padding:4px 4px; margin:0px 0px 0px -18px;  border-radius:50px; font-weight:bold; float:left;  color:red;background-color:#0094ff;" Text="0" runat="server"></asp:Label>
                         </ItemTemplate>  
                ...
                <div class="modal-content">  
                    ...
                    <div class="modal-body"  style="overflow-y: scroll; max-height: 85%; margin-top: 10px; margin-bottom: 10px;"  >  
                        ...
                        <table> 
                             <tr>
                                <td align="right">
                                    <asp:Label ID="lblReq_No" runat="server" Text="Requisition No:" Font-Bold="true" ></asp:Label>
                                </td>
                                <td>
                                     <asp:Label ID="lblReqNotxt" runat="server" Visible="true" Font-Bold="true"  ></asp:Label>
                                </td>
                            </tr>
                ...
                <div class="modal-content" style="max-width:1080px;">  
                    ...
                    <div class="modal-body" style="overflow-y:scroll; overflow-x:scroll; max-height: 95%; max-width:1080px; margin-top: 10px; margin-bottom: 10px;"> <%-- --%>
                        <asp:Label ID="Label8" runat="server" ClientIDMode="Static"></asp:Label>  
                         <asp:Label ID="lblRequisitionNo" runat="server" Text="Requisition No : " ></asp:Label>
                        <asp:Label ID="lblReqDetailsAppno" runat="server" Visible="true"  Font-Bold="true" ></asp:Label>
                        <asp:HiddenField ID="hdnStatusDetailsReqID" runat="server" />
