<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="INVCustomerOPBalanceEntry.aspx.cs" Inherits="PG.Web.Inventory.INVCustomerOPBalanceEntry" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   ...
   <%-- <script src="../../javascript/jquery.ui.combogrid.js" type="text/javascript"></script>--%>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var GetApproval_EmpList = '<%=this.GetApproval_EmpList%>';
...
--%>
      ...
      <%--  var txtCustomerID = '<%=txtCustomerID.ClientID%>';--%>
        ...
        var hdnApprovedByID = '<%=hdnApprovedByID.ClientID%>';
        var txtApprovedBy = '<%=txtApprovedBy.ClientID%>';
        var btnApprovedby_ID = '<%=btnApprovedby_ID.ClientID%>';

        var hdnAuditByID = '<%=hdnAuditByID.ClientID%>';
        var txtAuditBy = '<%=txtAuditBy.ClientID%>';
        var btnAuditBy = '<%=btnAuditBy.ClientID%>';
      ...
      <%--  var hdnCompanyIDtxt = '<%=hdnCompanyIDtxt.ClientID%>';
        ...
        $(document).ready(function () {
            ...
            if ($('#' + txtApprovedBy).is(':visible')) {
                    
                bindApprovalList();
            }
            
            if ($('#' + txtAuditBy).is(':visible')) {

                bindApprovalAuditList();
            }
        ...
        function bindApprovalList() {
            var cgColumns = [{ 'columnName': 'empid', 'width': '80', 'align': 'left', 'highlight': 2, 'label': 'Emp ID' }
                             , { 'columnName': 'empname', 'width': '80', 'align': 'left', 'highlight': 4, 'label': 'Name' }
                             , { 'columnName': 'emp_deg', 'width': '150', 'align': 'left', 'highlight': 4, 'label': 'Deg' }
            ...
            //var serviceURL = GLAccountServiceLink + "?isterm=1&includeempty=1&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            var serviceURL = GetApproval_EmpList + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.StartsWith;
            //serviceURL += "&companyid=" + companyid;
            serviceURL += "&ispaging=1";
            //serviceURL += "&locationid=" + locationid;
            // serviceURL += "&empstatus=" + "A";
            ...
            var appNameElem = $('#' + txtApprovedBy);

            $('#' + btnApprovedby_ID).click(function (e) {
                //elmID = $(elem).attr('id');
                //$(elem).combogrid("show");
                $(appNameElem).combogrid("dropdownClick");
            });


            $(appNameElem).combogrid({
                debug: true,
                searchButton: false,
                resetButton: false,
                alternate: true,
                ...
                search: function (event, ui) {
                    ...
                    //var locationid = $('#' + lblLocationID).val();
                    //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
                    var newServiceURL = serviceURL+"&appstatus=A";
                    $(this).combogrid("option", "url", newServiceURL);
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.seid == '') {
                        ...
                        // $('#' + hdnExecutiveID).val(ui.item.seid);
                        $('#' + hdnApprovedByID).val(ui.item.emp_key);
                        $('#' + txtApprovedBy).val(ui.item.empname);
                    }
                    return false;
                },
        ...
        function bindApprovalAuditList() {
            var cgColumns = [{ 'columnName': 'empid', 'width': '80', 'align': 'left', 'highlight': 2, 'label': 'Emp ID' }
                             , { 'columnName': 'empname', 'width': '80', 'align': 'left', 'highlight': 4, 'label': 'Name' }
                             , { 'columnName': 'emp_deg', 'width': '150', 'align': 'left', 'highlight': 4, 'label': 'Deg' }
            ...
            var appNameElem = $('#' + txtAuditBy);

            $('#' + btnAuditBy).click(function (e) {
                //elmID = $(elem).attr('id');
                //$(elem).combogrid("show");
                $(appNameElem).combogrid("dropdownClick");
            });
            ...
            $(appNameElem).combogrid({
                ...
                search: function (event, ui) {
                    ...
                    //var locationid = $('#' + lblLocationID).val();
                    //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
                    var newServiceURL = serviceURL + "&appstatus=I";
                    $(this).combogrid("option", "url", newServiceURL);
                ...
                select: function (event, ui) {
                    ...
                    if (ui.item.seid == '') {
                        ...
                        // $('#' + hdnExecutiveID).val(ui.item.seid);
                        $('#' + hdnAuditByID).val(ui.item.emp_key);
                        $('#' + txtAuditBy).val(ui.item.empname);
                    }
                    return false;
                },
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Customer Openning Balance Entry"></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Customer Openning Balance Entry</span>
                        </div>
                        <div id="groupContent" class="groupContent scrollBar">
                            <div id="groupContenInner">
                                                ...
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" class="auto-style2">
                                                            <asp:Label ID="lblCustomer" runat="server" Text="Customer:" style="font-weight: 700"></asp:Label>
                                                        </td>
                                                        ...
                                                        <td colspan="4" class="auto-style2">
                                                            ...
                                                            <asp:TextBox ID="txtCustomerAddress" runat="server" CssClass="textBox" Enabled="false" Width="300px"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" class="auto-style2">
                                                            <asp:Label ID="lbl" runat="server" Text="OP Date:" style="font-weight: 700"></asp:Label>
                                                        </td>

                                                        <td >

                                                            <asp:TextBox ID="txtCustomerOPDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="120px"  ></asp:TextBox> 
                                                        </td>
                                                       <td></td>
                                                        <td colspan="4" class="auto-style2">

                                                            <asp:HiddenField ID="hdnApprovedByID" runat="server" />
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td align="right" class="auto-style2">
                                                            <asp:Label ID="lblApprovedBy" runat="server" Text="Approved By:" style="font-weight: 700"></asp:Label>
                                                        </td>

                                                       
                                                     <td style="text-align: left">
                                                     <asp:TextBox ID="txtApprovedBy" runat="server" CssClass="textBox textAutoSelect" ></asp:TextBox>
                                 
                                                       </td>
                                                       <td>
                                                           <input id="btnApprovedby_ID" type="button" value="" runat="server" class="buttonDropdown" style="width: 15px" tabindex="-1" />
                                                       </td>
                                                       <td align="right" class="auto-style2">
                                                            <asp:Label ID="lblApprovedDate" runat="server" Text="Approved Date:" style="font-weight: 700"></asp:Label>
                                                        </td>

                                                        <td >

                                                            <asp:TextBox ID="txtApprovedDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="120px"  ></asp:TextBox> 
                                                        </td>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td align="right" class="auto-style2">
                                                            <asp:Label ID="lblAuditBy" runat="server" Text="Audit By:" style="font-weight: 700"></asp:Label>
                                                        </td>

                                                       
                                                     <td style="text-align: left">
                                                     <asp:TextBox ID="txtAuditBy" runat="server" CssClass="textBox textAutoSelect" ></asp:TextBox>
                                 
                                                       </td>
                                                       <td>
                                                           <input id="btnAuditBy" type="button" value="" runat="server" class="buttonDropdown" style="width: 15px" tabindex="-1" />
                                                       </td>
                                                       <td align="right" class="auto-style2">
                                                            <asp:Label ID="lblAuditDate" runat="server" Text="Audit Date:" style="font-weight: 700"></asp:Label>
                                                        </td>

                                                        <td >

                                                            <asp:TextBox ID="txtAuditDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="120px"  ></asp:TextBox> 
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" class="auto-style2">
                                                            <asp:Label ID="lblOpAmount" runat="server" Text="OP Balance Amt:" style="font-weight: 700"></asp:Label>
                                                        </td>

                                                        <td class="auto-style2">

                                                            <asp:TextBox ID="txtOPAmount" runat="server" CssClass="textBox" Style="text-align: left;"  ></asp:TextBox> 
                                                        </td>
                                                       <td></td>
                                                        <td colspan="4" class="auto-style2">
                                                            <asp:HiddenField ID="hdnAuditByID" runat="server" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="6">
                                                            <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox" TextMode="MultiLine" Height="30px" Width="500px"></asp:TextBox>
                               ...
                               <%-- <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 75%; text-align: center;">
                                        <span style="font-weight: bold">Customer Openning Balance List: </span>
                                    </div>
                                        ...
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 95%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="80px" class="headerColLeft">Customer Name
                                                    </td>
                                                   <td width="10px" class="headerColLeft">
                                                    </td>
                                                    <td width="195px" class="headerColLeft">Openning Date
                                                    </td>
                                                       <td width="10px" class="headerColLeft">
                                                    </td>
                                                    <td width="60px" class="headerColLeft">Openning Balance
                                                    </td>
                                                    <td width="60px" class="headerColLeft">Approved By
                                                    </td>
                                                    <td width="50px" class="headerColLeft">Approved Date
                                                    </td>
                                                    
                                                    <td width="60px" class="headerColRight">Create By
                                                    </td>

                                                    <td width="72px" class="headerColCenter">Create Date
                                                    </td>
                                                    <td width="72px" class="headerColCenter">Auth Status
                                                    </td>
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtITEMRate" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("ITEM_RATE") %>' Style=""  OnTextChanged="txtITEMRate_TextChanged"  AutoPostBack="true" Enabled="false" Visible="false" ></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="lblTotalAmt" runat="server" CssClass="textBox textAutoSelect" Width="68" Text='<%# Bind("total_amount") %>'  Style="" Visible="false"></asp:TextBox>
                                                                                    </td>
                                        ...
                                        <div id="divGridControls2" style="width: 100%; height: 25px; border-top: solid 1px #C0C0C0;">
                                            <table style="width: auto; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <asp:Label ID="lbltotalSalesAmount" runat="server" Text="Total Qnty:" Font-Bold="True" Visible="false"></asp:Label>
                                                    </td>
                                                    <td align="right">
                                                        <asp:TextBox ID="txtTotSalesAmt" runat="server" CssClass="textBox" Style="text-align: right;"
                                                            Width="100" TabIndex="-1" Font-Bold="True" Visible="false"></asp:TextBox>
                                                    </td>
                                                    <td align="right">&nbsp;
                                                    </td>
