<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="AdjustmentListFormation.aspx.cs" Inherits="PG.Web.Inventory.AdjustmentListFormation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewFormationDeptAdjustment.aspx?id=" + key;
            if (IForm.PageMode == Enums.PageMode.InTab) {

                var tdata = new xtabdata();
                tdata.linktype = Enums.LinkType.Direct;
                tdata.id = 0;
                tdata.name = "Formation Department Adjustment";                
                tdata.label = "Formation Department Adjustment";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Formation Adjustment"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnAddNew" runat="server" CssClass="buttonNew"    Text="New Adjust" Height="26px" />
