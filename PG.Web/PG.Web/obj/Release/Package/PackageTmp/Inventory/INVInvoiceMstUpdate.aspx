<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVInvoiceMstUpdate.aspx.cs" Inherits="PG.Web.Inventory.INVInvoiceMstUpdate" %>
    ...
    <script language="javascript" type="text/javascript">
      ...
      <%--  var txtCustomerID = '<%=txtCustomerID.ClientID%>';--%>
        ...
        function bindCustomerList() {
            var cgColumns = [{ 'columnName': 'customerid', 'width': '80', 'align': 'left', 'highlight': 2, 'label': 'Cust ID' }
                             , { 'columnName': 'custcode', 'width': '50', 'align': 'left', 'highlight': 4, 'label': 'Code' }
                             , { 'columnName': 'custname', 'width': '180', 'align': 'left', 'highlight': 4, 'label': 'Name' }
