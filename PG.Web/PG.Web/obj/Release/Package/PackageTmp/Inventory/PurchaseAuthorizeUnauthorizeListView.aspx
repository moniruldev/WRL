<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" ViewStateMode="Disabled" AutoEventWireup="true" CodeBehind="PurchaseAuthorizeUnauthorizeListView.aspx.cs" Inherits="PG.Web.Inventory.PurchaseAuthorizeUnauthorizeListView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlAuthorizationStatus" runat="server" CssClass="dropDownList">
                                <asp:ListItem Text="UnAuthorized" Value="N" Selected="True"></asp:ListItem>
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Width="100%" AutoGenerateColumns="False" KeyFieldName="PURCHASE_NO">
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Action" UnboundType="String" Width="55px" VisibleIndex="1">
                                     ...
                                     <dx:GridViewDataCheckColumn Caption="Select" FieldName="PURCHASE_ID" VisibleIndex="1" Width="10px">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/PurchaseAuthorization.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Purchase Against Indent Authorization";
                tdata.label = "Purchase Against Indent Authorization";
                tdata.type = 0;
                tdata.url = url;
