<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Item_Group_Wise_Att_List.aspx.cs" Inherits="PG.Web.Inventory.Item_Group_Wise_Att_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/Item_Group_Wise_Att_Entry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Item Group Wise Attribute";
                //tdata.label = "User: " + userid;
                tdata.label = "Item Group Wise Attribute";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item Group Wise Attribute List"></asp:Label>
            </div>
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;" class="defFont"
                               ...
                               <%--     <td width="82px" align="center">Code</td>--%>
                                    <td width="202px" align="center">Group Name</td>
                                    <td width="190px" align="center">Brand Name</td>
                                    <td width="190px" align="center">Category Name</td>
                                    <td width="220px" align="center">Size Name</td>
                                    <td width="200px" align="center">Color Name</td>
                                    <td width="200px" align="center">Generation Name</td>
                                    <td width="200px" align="center">Entry By</td>
                                </tr>
                            </table>
                        </div>
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                ...
                                DataKeyNames="ITEM_GROUP_ATT_ID" OnRowDataBound="GridView1_RowDataBound"
                                ...
                                <Columns>
                                 ...
                                 <%--   <asp:BoundField DataField="COLOR_CODE" HeaderText="Code" ItemStyle-Width="80px" />--%>
                                    ...
                                    <asp:BoundField DataField="ITEM_GROUP_NAME" HeaderText="Group Name">
                                     ...
                                     <asp:BoundField DataField="BRAND_NAME" HeaderText="BRAND_NAME" ItemStyle-Width="200px" />
                                      <asp:BoundField DataField="CAT_NAME" HeaderText="CAT_NAME" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="ITEM_SIZE" HeaderText="ITEM_SIZE" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="COLOR_NAME" HeaderText="COLOR_NAME" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="GENERATION_NAME" HeaderText="GENERATION_NAME" ItemStyle-Width="200px" />
                                      <asp:BoundField DataField="CREATE_BY" HeaderText="CREATE_BY" ItemStyle-Width="200px" />
                                </Columns>
