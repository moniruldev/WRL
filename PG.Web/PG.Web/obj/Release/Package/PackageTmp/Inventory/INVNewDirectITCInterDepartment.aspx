<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewDirectITCInterDepartment.aspx.cs" Inherits="PG.Web.Inventory.INVNewDirectITCInterDepartment" %>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Direct ITC:Inter Department</span>
                        </div>
                                    ...
                                    <table style="width: 101%" border="0" cellspacing="2" cellpadding="1">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:TextBox ID="txtIssueNo" runat="server" CssClass="colourdisabletextBox" Width="150px" ReadOnly="True" BackColor="#FFFFCC"></asp:TextBox>
                                            </td>
                                            <td></td>
                                            <td align="right">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlFromDepartment" Width="150px" runat="server" CssClass="dropDownList required">
                                                </asp:DropDownList>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlToDepartment" Width="124px" runat="server" CssClass="dropDownList required">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="9">
                                                <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox" TextMode="MultiLine" Height="30px" Width="595px"></asp:TextBox>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox textAutoSelect" Width="150" Text='<%# Bind("ITEM_GROUP_DESC") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="250" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("ISSUE_QNTY") %>' onkeypress="return onlyNos(event,this);"></asp:TextBox>
