<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Invoice_Price_Update_ListAcc.aspx.cs" Inherits="PG.Web.Inventory.Invoice_Price_Update_ListAcc" %>
    ...
    <script language="javascript" type="text/javascript">
      ...
      <%--  var txtCustomerID = '<%=txtCustomerID.ClientID%>';--%>
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/InvoicePriceUpdateByAcc.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "DO Price Update";
                //tdata.label = "User: " + userid;
                tdata.label = "DO Price Update";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Delivery Order Price Update:"></asp:Label>
            </div>
            <!--Message Div -->
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width: auto; height: 350px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    <asp:HyperLinkField HeaderText="" Text="Price">
                                   ...
                                   <asp:BoundField DataField="INVOICE_NO" HeaderText="Purchase No" ItemStyle-Width="150px" />
                                    ...
                                    <asp:BoundField DataField="INVOICE_TIME" HeaderText="INVOICE_TIME" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}" ItemStyle-Width="120" />
