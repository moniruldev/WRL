<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Item_Generation_Entry.aspx.cs" Inherits="PG.Web.Inventory.Item_Generation_Entry" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item Generation"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                ...
                                <table cellpadding="2" cellspacing="4">
                                    <tr>
                                        <td></td>
                                        <td>
                                            <asp:HiddenField ID="hdnItemGenID" runat="server" Value="0" OnValueChanged="hdnColorID_ValueChanged" />
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:TextBox ID="txtGenName" runat="server" CssClass="textBox fldRequired enableIsDirty"
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="lblGenDesc" runat="server" Text="Generation Desc.:"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:TextBox ID="txtGenDesc" runat="server" CssClass="textBox fldRequired enableIsDirty"
                                                Width="200px" MaxLength="200"></asp:TextBox>
                                        </td>
                                        <td style="" align="right">&nbsp;</td>
                                        <td style="" align="left">&nbsp;</td>
