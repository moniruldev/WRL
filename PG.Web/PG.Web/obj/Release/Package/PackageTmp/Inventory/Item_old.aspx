<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Item_old.aspx.cs" Inherits="PG.Web.Inventory.Item_old" %>
                                ...
                                <table cellpadding="2" cellspacing="4">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            ...
                                            <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox required" Enabled="true" Width="360"></asp:TextBox>
					 ...
					 &nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="right">
                                            ...
                                            <asp:Label ID="Label6" runat="server" Text="Item Status:" Visible="False"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlIsActive" runat="server"
                                                CssClass="dropDownList enableIsDirty" Width="90" Visible="False">
