<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" ViewStateMode="Disabled" AutoEventWireup="true" CodeBehind="Dept_Adj_Temp_Autho_List.aspx.cs" Inherits="PG.Web.Inventory.Dept_Adj_Temp_Autho_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Department Adjustment List"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="LblLocation" runat="server" Text=" Adjustment Department"></asp:Label><span style="color: red">*</span>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlDepartment" runat="server" ViewStateMode="Enabled"></asp:DropDownList>
                        </td>
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="Adjustment No:"></asp:Label>

                        </td>
                        <td>
                            <asp:TextBox ID="txtAdjustmentNo" runat="server" CssClass="textBox notEnterToTab"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlAuthorizationStatus" runat="server" CssClass="dropDownList">
                                <asp:ListItem Text="UnAuthorized" Value="U" Selected="True"></asp:ListItem>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width:90%">
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width:100%; height: 250px; overflow: auto;">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Width="100%" AutoGenerateColumns="False" KeyFieldName="INV_ADJUST_NO">
                                <Settings VerticalScrollableHeight="250" ShowFooter="True" ShowGroupFooter="VisibleAlways" />
                                <TotalSummary>
                                    <dx:ASPxSummaryItem FieldName="Size" SummaryType="Sum" />
                                    <dx:ASPxSummaryItem FieldName="CONSUMPTION_QTY" ShowInColumn="CONSUMPTION_QTY" DisplayFormat="Total:{0}" ShowInGroupFooterColumn="CONSUMPTION_QTY" SummaryType="Sum" />
                                </TotalSummary>
                                <GroupSummary>
                                    <dx:ASPxSummaryItem SummaryType="Count" />
                                    <dx:ASPxSummaryItem FieldName="CONSUMPTION_QTY" ShowInGroupFooterColumn="CONSUMPTION_QTY" SummaryType="Sum" />
                                </GroupSummary>
                                <Columns>
                                    ...
                                    <%--  <dx:GridViewCommandColumn     ShowSelectCheckbox="True" Caption="Select All" ShowClearFilterButton="true" VisibleIndex="1" Width="10px"   SelectAllCheckboxMode="Page" />--%>
                                     <dx:GridViewDataCheckColumn Caption="Select" FieldName="INV_ADJUST_ID"  VisibleIndex="1" Width="10px">
                
                                    
                                             

                                        <DataItemTemplate>
                                            <input type="hidden" id="hdnPurchaseId" value="<%#Eval("INV_ADJUST_ID")%>" />
                                            <input type="checkbox" name="cbIsSelected" class="cbIgr" />
                                        </DataItemTemplate>
                                    </dx:GridViewDataCheckColumn>
                                    <dx:GridViewDataTextColumn Caption="Adjustment No" FieldName="INV_ADJUST_NO" VisibleIndex="1" Width="100px">
                                    </dx:GridViewDataTextColumn>
                              
                                    <dx:GridViewDataTextColumn Caption="Item's" FieldName="ITEM_NAME" VisibleIndex="2" Width="150px" Visible="false">
                                    </dx:GridViewDataTextColumn>

                                    <dx:GridViewDataTextColumn Caption="Adjustment Date" FieldName="INV_ADJUST_DATE" VisibleIndex="3" Width="80px">
                                        <DataItemTemplate>
                                            <%#Eval("INV_ADJUST_DATE", "{0:dd-MMM-yyyy}")%>
                                        </DataItemTemplate>
                                    </dx:GridViewDataTextColumn>
                                 
                                    <dx:GridViewDataTextColumn Caption="Dept" FieldName="FROM_DEPT_NAME" VisibleIndex="9" Width="100px" />
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Button ID="btnAuthorizePurchase" runat="server" CssClass="buttonAthorize" Text="Authorize"  OnClientClick="AuthorizeSelectedPurchase()"  />
                    </td>
                    <td>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewDeptAdjustmentTemp.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Adjustment Authorization";
                tdata.label = "Adjustment  Authorization";
                tdata.type = 0;
                tdata.url = url;
        ...
        function AuthorizeSelectedPurchase() {
            ...
            if (isselect) {
                var y = confirm('Are you sure to authorize ?');
                if (y) {
                    $.ajax({
                        type: "POST",
                        url: "../Inventory/Dept_Adj_Temp_Autho_List.aspx/AuthorizeSelectedPurchase",
