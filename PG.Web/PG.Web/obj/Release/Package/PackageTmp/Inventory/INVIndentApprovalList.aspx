<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" ViewStateMode="Disabled" AutoEventWireup="true" CodeBehind="INVIndentApprovalList.aspx.cs" Inherits="PG.Web.Inventory.INVIndentApprovalList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Indent List"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Width="100%" AutoGenerateColumns="False" KeyFieldName="INDT_NO">
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Action" UnboundType="String" Width="55px" VisibleIndex="1">
                                     ...
                                     <dx:GridViewDataCheckColumn Caption="Select" FieldName="INDT_ID" VisibleIndex="1" Width="10px">
                                        <DataItemTemplate>
                                            <input type="hidden" id="hdnIndentId" value="<%#Eval("INDT_ID")%>" />
                                             <input type="hidden" id="hdnIndtType" value="<%#Eval("INDT_TYPE")%>" />
                                 ...
                                 <%--    <dx:GridViewDataTextColumn Caption="Item Code" FieldName="ITEM_CODE" VisibleIndex="3" Width="70px">
                                   ...
                                   <%-- <dx:GridViewDataTextColumn Caption="Supplier" FieldName="SUP_NAME" VisibleIndex="8" Visible="false" Width="80px" />--%>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Indt No" FieldName="INDT_NO" VisibleIndex="1" Width="80px" />
                                     <dx:GridViewDataTextColumn Caption="Indt Type" FieldName="INDT_TYPE" VisibleIndex="10" Width="80px" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVIndentApproval.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Indent Approval";
                tdata.label = "Indent Approval";
                tdata.type = 0;
                tdata.url = url;
        ...
        function AuthorizeSelectedPurchase() {
            ...
            $(".cbIgr:checked").each(function () {
                if ($(this).is(':checked')) {
                    var id = $(this).parent().parent().find('#hdnIndentId').val();
                    type = $(this).parent().parent().find('#hdnIndtType').val();
                    cObjList.push(id);
                    isselect = true;
                }
            });
            ...
            if (isselect) {
                var y = confirm('Are you sure to Approve selected Indent?');
                if (y) {
                    if (type == "NORMAL_PR")
                    {
                    $.ajax({
                        ...
                        url: "../Inventory/INVIndentApprovalList.aspx/AuthorizeSelectedPurchase",
                        ...
                        success: function (result) {
                            ...
                            if (returnObj.Status == "Success") {
                                alert('Selected Indent Approved successfully.');
                                $("[id*=btnShow]").click();
                    ...
                    $.ajax({
                        ...
                        url: "../Inventory/INVIndentApprovalList.aspx/AuthorizeSelectedPRService",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                        data: JSON.stringify({ reqIdList: cObjList }),
