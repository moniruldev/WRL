<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" ViewStateMode="Disabled" AutoEventWireup="true" CodeBehind="INV_ITC_ApprovalList.aspx.cs" Inherits="PG.Web.Inventory.INV_ITC_ApprovalList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td class="auto-style1">
                            <asp:TextBox ID="txtIssueNo" runat="server" CssClass="textBox notEnterToTab"></asp:TextBox>
                        </td>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width:90%">
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width:100%x; height: 250px; overflow: auto;">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Width="100%" AutoGenerateColumns="False" KeyFieldName="REQ_ISSUE_ID">
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Action" UnboundType="String" Width="55px" VisibleIndex="1" Visible="false">
                                        <DataItemTemplate>
                                            <dx:ASPxHyperLink ID="hyperLink" runat="server" OnInit="hyperLink_Init">
                                            </dx:ASPxHyperLink>
                                        </DataItemTemplate>
                                    </dx:GridViewDataTextColumn>
                                     <dx:GridViewDataCheckColumn Caption="Select" FieldName="REQ_ISSUE_ID" VisibleIndex="1" Width="10px">
                                        <DataItemTemplate>
                                            <input type="hidden" id="hdnReqIssueID" value="<%#Eval("REQ_ISSUE_ID")%>" />
                                 ...
                                 <%--   <dx:GridViewDataTextColumn Caption="Group Name" FieldName="ITEM_GROUP_NAME" VisibleIndex="2" Visible="false" Width="100px">
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Item(s)" FieldName="ISSUE_ITEM" VisibleIndex="2" Width="150px">
                                    </dx:GridViewDataTextColumn>
                                 <%--    <dx:GridViewDataTextColumn Caption="Item Code" FieldName="ITEM_CODE" VisibleIndex="3" Width="70px">
                                   ...
                                   <%-- <dx:GridViewDataTextColumn Caption="Supplier" FieldName="SUP_NAME" VisibleIndex="8" Visible="false" Width="80px" />--%>
                                    <dx:GridViewDataTextColumn Caption="To Dept" FieldName="to_department_name" VisibleIndex="9" Width="100px" />
                                      <dx:GridViewDataTextColumn Caption="Is Approved" FieldName="AUTH_STATUS" VisibleIndex="8" Width="20px" />
                                    <dx:GridViewDataTextColumn Caption="Issue No" FieldName="REQ_ISSUE_NO" VisibleIndex="1" Width="80px" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "" + key; //Inventory/INVNewIGRApproval.aspx?id=
        ...
        function AuthorizeSelectedPurchase() {
            ...
            $(".cbIgr:checked").each(function () {
                if ($(this).is(':checked')) {
                    var id = $(this).parent().parent().find('#hdnReqIssueID').val();
                    cObjList.push(id);
                    isselect = true;
                }
            });
            ...
            if (isselect) {
                var y = confirm('Are you sure to Approve selected ITC?');
                if (y) {
                    $.ajax({
                        type: "POST",
                        url: "../Inventory/INV_ITC_ApprovalList.aspx/AuthorizeSelectedITC",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        async: false,
                        data: JSON.stringify({ reqIssueIdList: cObjList }),
                        success: function (result) {
                            var returnObj = JSON.parse(result.d);
                            if (returnObj.Status == "Success") {
                                alert('Selected ITC Approved successfully.');
                                $("[id*=btnShow]").click();
