<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="CustomerOpenningBalanceList.aspx.cs" Inherits="PG.Web.Inventory.CustomerOpenningBalanceList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVCustomerOPBalanceEntry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Customer Openning Balance";
                //tdata.label = "User: " + userid;
                tdata.label = "Customer Openning Balance";
                tdata.type = 0;
                tdata.url = url;
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                          <asp:DropDownList ID="ddlAuthStatus" runat="server" CssClass="dropDownList">
                              <asp:ListItem Selected="True" Text="Un Authourized" Value="U"></asp:ListItem>
                               <asp:ListItem  Text="Authourized" Value="A"></asp:ListItem>
                    ...
                    <tr>
                        ...
                        <td>
                           <input id="btnAddNew" type="button" runat="server" value="New Entry" class="buttonNew"
                                style="padding-left: 22px; width: 120px;" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                DataKeyNames="COB_ID" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="COB_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="80" />
                                    <asp:BoundField DataField="APPROVED_BY_NAME" HeaderText="APPROVED_BY_NAME" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="COB_APPROVED_DATE" HeaderText="Approved Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="80" />
                                    <asp:BoundField DataField="AUDIT_BY_NAME" HeaderText="AUDIT_BY_NAME" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="COB_AUDIT_DATE" HeaderText="COB_AUDIT_DATE" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="80" />
                                    <asp:BoundField DataField="COB_AMOUNT" HeaderText="COB Amount" ItemStyle-Width="80px" />
                                    <asp:BoundField DataField="COB_REMARKS" HeaderText="Remarks" ItemStyle-Width="150px" />
