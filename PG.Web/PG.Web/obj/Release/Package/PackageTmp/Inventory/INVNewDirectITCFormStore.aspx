<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewDirectITCFormStore.aspx.cs" Inherits="PG.Web.Inventory.INVNewDirectITCFormStore" %>
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        //alert(itemtypeid);
                        var newServiceURL = serviceURL + "&groupid=" + vgroupid + "&itemtypeid=" + itemtypeid ;
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
