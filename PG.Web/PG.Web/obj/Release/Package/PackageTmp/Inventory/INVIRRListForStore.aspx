<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVIRRListForStore.aspx.cs" Inherits="PG.Web.Inventory.INVIRRListForStore" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewIRRByStore.aspx?id=" + key + "&type=" + "stockupdate";
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IRR By Store"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label3" runat="server" Text="Issued By Dept"></asp:Label>
                        </td>

                        <td>
                            <asp:DropDownList ID="ddlIssueDepartment" runat="server" CssClass="dropDownList required">
                            </asp:DropDownList>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtReqNo" runat="server" CssClass="textBox notEnterToTab" Width="90"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <input id="btnAddNew" type="button" runat="server" value="New IRR" class="buttonNew"
                                style="padding-left: 22px; width: 80px; display: none" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox required" Enabled="true" Width="200"></asp:TextBox><input id="btnGroupID" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <input id="Button2" type="button" runat="server" value="New IRR" class="buttonNew"
                                style="padding-left: 22px; width: 80px; display: none" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtItemName" Width="200px" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox><input id="btnItemLoad" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
                        ...
                        <td>
                            &nbsp;</td>
                        <td>
                            <input id="Button4" type="button" runat="server" value="New IRR" class="buttonNew"
                                style="padding-left: 22px; width: 80px; display: none" />
                        </td>
                    ...
                    <tr>
                           <td>Receive Department:<span style="color: red">*</span>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <input id="Button1" type="button" runat="server" value="New IRR" class="buttonNew"
                                style="padding-left: 22px; width: 80px; display: none" />
                        </td>
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="152px" align="left">ITC No
                                    </td>
                                    <td width="82px" align="left" style="display: none">ITC
                                        Date
                                    </td>
                                    <td width="152px" align="left">ITC Date
                                        Time
                                    </td>
                                    <td width="102px" align="left">Issued By Dept</td>
                                    <td width="120px" align="left">Issued By Name</td>
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    <asp:HyperLinkField HeaderText="" Text="New IRR">
                                        <ControlStyle Height="20px" Width="60px" />
                                        <ItemStyle Width="50px" />
                                    </asp:HyperLinkField>

                                    <asp:BoundField DataField="REQ_ISSUE_NO" HeaderText=" IRR No" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="REQ_ISSUE_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" Visible="false"
                                        ItemStyle-Width="80" />
                                    <asp:BoundField DataField="REQ_ISSUE_TIME" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy hh:mm tt} "
                                        ItemStyle-Width="150" />
                                    <asp:BoundField DataField="from_department_name" HeaderText="Iss Dept" ItemStyle-Width="100px" />
                                    <asp:BoundField DataField="CREATE_BY_NAME" HeaderText="Iss Dept" ItemStyle-Width="120px" />
