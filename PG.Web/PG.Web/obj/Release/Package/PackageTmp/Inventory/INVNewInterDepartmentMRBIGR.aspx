<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewInterDepartmentMRBIGR.aspx.cs" Inherits="PG.Web.Inventory.INVNewInterDepartmentMRBIGR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        var e = document.getElementById("<%=ddlToDepartment.ClientID%>");
                        var dept_id = e.options[e.selectedIndex].value;
                        //var vgroupid = $('#' + hdngroupId).val();
                        var newServiceURL = serviceURL + "&isFinished=Y&groupid=" + vgroupid + "&deptid=" + dept_id;
    ...
    <style type="text/css">
        ...
        .groupHeader {
            height: 20px;
            background-image: url('../../image/header21.png');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:TextBox ID="txtRefNo" Visible="false" runat="server" CssClass="colourdisabletextBox"></asp:TextBox>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IGR:INTER DEPARTMENT "></asp:Label>
            </div>
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <div id="dvControls" style="height: auto; width: 100%">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1150px; height: 460px">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>IGR:INTER DEPARTMENT </span>
                        </div>
                            ...
                            <div id="groupContenInner">
                                                ...
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="txtRequsitionNo" runat="server" CssClass="colourdisabletextBox" ReadOnly="True" BackColor="#FFFFCC" Width="200"></asp:TextBox>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtRequsitionDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="131px"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">IGR Department: <span style="color: red">*</span>
                                                        </td>

                                                        <td>
                                                            <asp:DropDownList ID="ddlFromDepartment" runat="server" CssClass="dropDownList required" Width="200px">
                                                            </asp:DropDownList>

                                                        </td>

                                                        <td align="right">To Department: <span style="color: red">*</span>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlToDepartment" runat="server" CssClass="dropDownList required" Width="155px">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox" TextMode="MultiLine" Width="754px"></asp:TextBox>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow_Prod">
                                                    ...
                                                    <td width="150px" class="headerColLeft">Item Group
                                                    </td>
                                                    <td width="10px" class="headerColLeft"></td>
                                                    <td width="350px" class="headerColLeft">Item
                                                    </td>
                                                    <td width="10px" class="headerColLeft"></td>
                                                    <td width="60px" class="headerColLeft">Item Qty
                                                    </td>
                                                    <td width="100px" class="headerColLeft">Specification
                                                    </td>
                                        ...
                                        <div id="dvGrid" style="width: 80%; height: 270px; overflow: auto;" class="dvGrid">
                                                                    ...
                                                                    <div>
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox textAutoSelect" Width="150" Text='<%# Bind("ITEM_GROUP_NAME") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="341" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("REQ_QNTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:DropDownList ID="ddlSpecificationType" runat="server" CssClass="dropDownList" Width="100px">
                                                                                           <asp:ListItem Value="0" Selected="True">--Select--</asp:ListItem>
                                                                                             <asp:ListItem Value="1">P Battery</asp:ListItem>
                                                                                            <asp:ListItem Value="2">Service Battery</asp:ListItem>
                                                                                            <asp:ListItem Value="3">Return Battery</asp:ListItem>
                                                                                        </asp:DropDownList>
                                                                                    </td>
                                                                                    <td>
