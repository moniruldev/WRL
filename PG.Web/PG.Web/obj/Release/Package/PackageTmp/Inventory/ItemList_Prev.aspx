<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master"  AutoEventWireup="true" CodeBehind="ItemList_Prev.aspx.cs" Inherits="PG.Web.Inventory.ItemList_Prev" %>
						   ...
						   <tr>
							   <td style="">
								   <asp:TextBox ID="txtItemGroupNameParent" runat="server" 
									   CssClass="group_linkText textBoxReadOnlyEdit fldRequired enableIsDirty" Width="250px" 
										></asp:TextBox>
							   </td>
							   <td>
								   <div class="btnPopup">
               ...
               <td>
					...
					<div id="Div1" class="group_linkControl dvGroup" runat="server">
					   <table cellpadding="0" cellspacing="0" border="0">
						   <tr>
							   <td style="">
								    <asp:TextBox ID="txtItemName" Width="250px" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox><input id="btnItemLoad" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
							   </td>
    ...
    <div id="dvGridContainer" style="width:100%; height: auto; text-align:left;">
        <div id="dvGridHeader" style="width:100%;height:25px; font-size: smaller;" class="subHeader">
            ...
            <tr>
                ...
                <td width="202px" align="left">Group</td>
                <td width="102px" align="left">Class</td>
                <td width="32px" align="center">Active</td>
            </tr>
            </table>
        </div> 
