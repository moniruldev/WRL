<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVIndentApproval.aspx.cs" Inherits="PG.Web.Inventory.INVIndentApproval" %>
                                    ...
                                    <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    <td width="40px" class="headerColLeft">SL#
                                                    </td>
                                                  ...
                                                  <%--  <td width="10px" class="headerColLeft"></td>--%>
                                                    ...
                                                    <td width="80px" class="headerColLeft">App. Qty
                                                    </td>
                                                                    ...
                                                                    <div>
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox textAutoSelect" Width="140" Text='<%# Bind("ITEM_GROUP_NAME") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="lblItemCode" Enabled="false" Width="80px" runat="server" Text='<%# Bind("ITEM_CODE")%>'></asp:TextBox>

                                                                                    </td>
                                                                                     <td>
                                                                                        <asp:TextBox ID="txtItemType" Enabled="false" Width="80px" runat="server" Text='<%# Bind("ITEM_TYPE_CODE")%>'></asp:TextBox>
                                                                                         <asp:HiddenField ID="hdnItemType" runat="server" Value='<%# Bind("ITEM_TYPE_ID")%>' />

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" Style="text-align: right" CssClass="textBox textAutoSelect" Width="70" Text='<%# Bind("INDT_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtAppQty" runat="server" Style="text-align: right" CssClass="textBox textAutoSelect" Width="80" Text='<%# Bind("INDT_QTY_APPROVED") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                 ...
                                                                                 <%--   <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="150" Text='<%# Bind("APPROVED_REMARKS") %>' Style=""></asp:TextBox>
                                                                                    </td>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Button ID="btnCancel" runat="server" Text="Revert" CssClass="buttonCancel checkIsDirty" OnClick="btnCancel_Click" />
                    </td>
                    <td>
                        <asp:Button ID="btnSave" runat="server" Text="Approve" CssClass="buttonAthorize " AccessKey="s" OnClick="btnSave_Click" OnClientClick="if ( ! UserDeleteConfirmation()) return false;" />
                        <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="buttonEdit" OnClick="btnEdit_Click" />
                    </td>
                     <td style="display:none;">
                        <asp:Button ID="btnAuthorized" runat="server" Text="Authorize" CssClass="buttonAthorize" OnClick="btnAuthorized_Click" OnClientClick="return confirm('Are you sure to Approve?');"  />
                    </td>
