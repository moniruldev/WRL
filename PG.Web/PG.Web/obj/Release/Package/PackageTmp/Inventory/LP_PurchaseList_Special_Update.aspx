<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="LP_PurchaseList_Special_Update.aspx.cs" Inherits="PG.Web.Inventory.LP_PurchaseList_Special_Update" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Purchase List For Special Update"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtFromDate" runat="server" Width="150px" CssClass="textBox textDate dateParse"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                        <td>
                        ...
                        <td>
                             ...
                             <input id="btnAddNew" type="button" runat="server" value="New Purchase" class="buttonNew" style=" width: 120px;" visible="false" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtToDate" runat="server" Width="150px" CssClass="textBox textDate dateParse"></asp:TextBox>
                        </td>
                        <td>
                            ...
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="170px" align="left">Purchase Time
                                     ...
                                     <td width="120px" align="left">MRR Date
                                    </td>
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MRR_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"   ItemStyle-Width="120" />
