<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="DepartmentWiseItem.aspx.cs" Inherits="PG.Web.Inventory.DepartmentWiseItem" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewDeptItemBinding.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Department Wise Item Bindings";
                //tdata.label = "User: " + userid;
                tdata.label = "Department Wise Item Bindings";
                tdata.type = 0;
                tdata.url = url;
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="btnAddNew" type="button" runat="server" value="New Assign" class="buttonOpenWindow" style="padding-left: 22px; width: 130px;" />
        ...
        <div id="dvControls" style="height: auto; width: 100%;">
            <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1000px !important">
                <div id="dvGridContainer" class="gridContainer" style="width: 100%; height: auto;">
                    <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                        <table style="height: 90%; color: #FFFFFF; font-weight: bold; text-align: center;" class="defFont" cellspacing="1" cellpadding="1" rules="all">
                            <tr>
                                ...
                                <td width="235px" align="left">Item Name</td>
                                <td width="62px" align="left">Code</td>
                                <td width="235px" align="left">Description</td>
                    ...
                    <div id="dvGrid" style="width:990px; height: 350px; overflow: auto;">
