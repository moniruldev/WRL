<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="OutSaleList.aspx.cs" Inherits="PG.Web.Inventory.OutSaleList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVInvoiceMst.aspx?id=" + key;
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="Invoice No:"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDCNo" runat="server" CssClass="textBox notEnterToTab" Width="200"></asp:TextBox>
                        </td>
                         <td>
                            <asp:Label ID="Label4" runat="server" Text="GP No:"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtGPNo" runat="server" CssClass="textBox notEnterToTab" Width="200"></asp:TextBox>
                        </td>
                        <td>
                        </td>
                        <td>
                        ...
                        <td>
                           <input id="btnAddNew" type="button" runat="server" value="New Sale" class="buttonNew"
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="INVOICE_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="80" />
                                    ...
                                    <asp:BoundField DataField="DC_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="80" />
                                    <asp:BoundField DataField="GP_NO" HeaderText="Purchase No" ItemStyle-Width="150px" />
                                    <asp:BoundField DataField="GP_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="80" />
