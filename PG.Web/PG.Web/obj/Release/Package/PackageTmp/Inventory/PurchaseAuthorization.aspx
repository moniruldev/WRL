<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="PurchaseAuthorization.aspx.cs" Inherits="PG.Web.Inventory.PurchaseAuthorization" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="PURCHASE AGAINST INDENT(PO-AUTHORIZATION) "></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>PURCHASE AGAINST INDENT(Authorization) </span>
                        </div>
                        <div id="groupContent" class="groupContent scrollBar">
                            <div id="groupContenInner">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtPurchaseDate" runat="server" CssClass="textBox" Style="text-align: left;" Width="100px" Enabled="false" ReadOnly="true"></asp:TextBox>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <table style="width: 90%;display:none" border="0" cellspacing="2" cellpadding="1">
                                          <tr>     

                                            <td align="right">Indent From:</td>
                                            <td>
                                           ...
                                           <td>Indent Department:<span style="color: red">*</span></td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlFromDepartment" Width="170px" runat="server" CssClass="dropDownList required">
                                                            </asp:DropDownList>
                                                        </td>      
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtIndentNo" runat="server" CssClass="textBox required" Width="120px" Enabled="true"></asp:TextBox>
                                        ...
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="184px" class="headerColLeft">Item
                                                    </td>
                                                    <td width="70px" class="headerColLeft">Item Code
                                                    </td>
                                                       <td width="60px" class="headerColLeft">Item type
                                                    </td>
                                                    <%--<td width="10px" class="headerColLeft"></td>--%>
                                                    <td width="75px" class="headerColLeft">Purchase Qty
                                                    </td>

                                                     <td width="70px" class="headerColLeft" >Weight. Avg. Price
                                                    </td>

                                                      <td width="100px" class="headerColLeft" style="display:none">Weight. Avg. Price
                                                    </td>

                                                    <td width="60px" class="headerColLeft">Indt Qty
                                                    </td>
                                                    <td width="70px" class="headerColLeft">Already Pur Qty
                                                    </td>
                                                    <td width="50px" class="headerColLeft">UOM
                                                    </td>

                                                    <td width="134px" class="headerColLeft">INDT No
                                                    </td>
                                                    <td width="100px" class="headerColLeft">Dept
                                                    </td>
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="SL#">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblItemSlNo" runat="server" Text='<%#Container.DataItemIndex+1%>' Style="text-align: center;"
                                                                        Width="44px">
                                                                    </asp:Label><%--'<%# Bind("SLNO") %>--%>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="155" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="lblItemCode" Enabled="false" Width="73px" runat="server" Text='<%# Bind("ITEM_CODE")%>'></asp:TextBox> 

                                                                                    </td>
                                                                                   <td>
                                                                                    <asp:TextBox ID="txtItemType" Enabled="false" Width="60px" runat="server" Text='<%# Bind("ITEM_TYPE_CODE")%>'></asp:TextBox>
                                                                                    <asp:HiddenField ID="hdnItemTypeID" runat="server" Value='<%# Bind("ITEM_TYPE_ID")%>' />

                                                                                </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtPurchaseQty" runat="server" style="text-align: right" CssClass="textBox textAutoSelect"  Width="75" Text='<%# Bind("PURCHASE_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                    </td>

                                                                                      <td >
                                                                                        <asp:TextBox ID="txtWeightAvgPriceView" Enabled="false"  style="text-align: right" runat="server" CssClass="textBox textAutoSelect" Width="70" Text='<%# Bind("UNIT_RATE") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                    </td>  

                                                                                     <td style="display:none">
                                                                                        <asp:TextBox ID="txtWeightAvgPrice" Enabled="false" runat="server" CssClass="textBox textAutoSelect" Width="60" Text='<%# Bind("UNIT_RATE") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                    </td>     

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtIndtQty" runat="server"  style="text-align: right" CssClass="textBox textAutoSelect" Width="60" Text='<%# Bind("INDT_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtAlreadyPurchaseQty"  style="text-align: right" runat="server" CssClass="textBox textAutoSelect" Width="65" Text='<%# Bind("ALREADRY_PURCHASE_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtIndtNo" runat="server" Text='<%# Bind("INDT_NO") %>' Width="134px" CssClass="textBox textAutoSelect"></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtFromDept" runat="server" Text='<%# Bind("DEPARTMENT_NAME") %>' Width="80px" CssClass="textBox textAutoSelect"></asp:TextBox>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Button ID="btnAuthorize" runat="server" Text="Authorize" CssClass="buttonAthorize" AccessKey="a" OnClick="btnAuthorize_Click" OnClientClick="if ( ! UserAuthorizeConfirmation()) return false;" />
                    </td>
     ...
     <%--   var ItemGroupListServiceLink = '<%=this.ItemGroupListServiceLink%>';
      ...
      <%--  var txtCustomerID = '<%=txtCustomerID.ClientID%>';--%>
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            $.ajax({
                url: 'INVNewIndentPurchase.aspx/IsPriceViewPermissible',
                type: 'POST',
