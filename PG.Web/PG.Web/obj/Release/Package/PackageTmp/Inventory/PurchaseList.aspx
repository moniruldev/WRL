<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="PurchaseList.aspx.cs" Inherits="PG.Web.Inventory.PurchaseList" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Purchase List"></asp:Label>
            </div>
            <!--Message Div -->
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button ID="btnRefresh" runat="server" CssClass="buttonRefresh" Text="Load" OnClick="btnRefresh_Click" />
                       
                             <input id="btnAddNew" type="button" runat="server" value="New Purchase" class="buttonNew" style=" width: 120px;" />
                        </td>
                        ...
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="150px" align="left">Purchase No
                                    </td>
                                       <td width="100px" align="left">Purchase Date
                                    </td>
                                   <%-- <td width="170px" align="left">Purchase Time
                                    </td>--%>
                                      <td width="80px" align="left">Purchase Approved?
                                    </td>
                                      <td width="80px" align="left">Finance Approved?
                                    </td>
                                      <td width="80px" align="left">Director Approved?
                                    </td>
                                     <td width="300px" align="left">Supplier Name
                                    </td>
                                   <%--  <td width="150px" align="left">MRR NO
                                    </td>--%>
                                     <td width="150px" align="left">Delivery Date
                                    </td>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <%--   <asp:BoundField DataField="PURCHASE_TIME" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}"
                                        ItemStyle-Width="150" />--%>
                                     <asp:BoundField DataField="APPROVED_STATUS_PUR_H" HeaderText="Purchase Approved"  ItemStyle-Width="80" />
                                     <asp:BoundField DataField="APPROVED_STATUS_FINANCE_H" HeaderText="Finance Approved"  ItemStyle-Width="80" />
                                     <asp:BoundField DataField="APPROVED_STATUS_DIRECTOR" HeaderText="Director Approved"  ItemStyle-Width="80" />
                                      <asp:BoundField DataField="SUP_NAME" HeaderText="Sup Name"  ItemStyle-Width="300" />
                                      <%--<asp:BoundField DataField="MRR_NO" HeaderText="MRR No" ItemStyle-Width="150px" />--%>
                                    <asp:BoundField DataField="DELIVERY_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"   ItemStyle-Width="150" />
                                     <asp:BoundField DataField="CREATE_BY_NAME" HeaderText="Date"  ItemStyle-Width="200" />
