<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewPurchaseIndentBak.aspx.cs" Inherits="PG.Web.Inventory.INVNewPurchaseIndentBak" %>
                            ...
                            <div id="groupContenInner">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:DropDownList ID="ddlItemType" runat="server" CssClass="dropDownList required">
                                                                <asp:ListItem Value="S">Storeable</asp:ListItem>
                                                                <asp:ListItem Value="N">Non Storeable</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                         <td style="text-align: right">Local/Foreign:<span style="color: red">*</span></td>
                                                        <td align="right">
                                                            <asp:DropDownList ID="ddlLocalOrForeign" runat="server" CssClass="dropDownList required">
                                                                <asp:ListItem Value="S">Local</asp:ListItem>
                                                                <asp:ListItem Value="N">Foreign</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td align="right">&nbsp;</td>
                                                        <td colspan="4">&nbsp;</td>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Button ID="btnLoad" runat="server" Text="Load" CssClass="buttoncommon" OnClick="btnLoad_Click" />
                                    ...
                                    <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        ...
                                        <div id="dvGridTop" style="width: 80%; height: 200px; overflow: auto;" class="dvGrid">
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("INDT_QTY_APPROVED") %>' onkeypress="return onlyNos(event,this);"></asp:TextBox>
