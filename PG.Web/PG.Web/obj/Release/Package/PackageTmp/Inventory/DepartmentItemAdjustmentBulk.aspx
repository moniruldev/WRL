<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="DepartmentItemAdjustmentBulk.aspx.cs" Inherits="PG.Web.Inventory.DepartmentItemAdjustmentBulk" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Department Item Adjustment Bulk"></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Department Item Adjustment Bulk</span>
                        </div>
                        <div id="groupContent" class="groupContent scrollBar">
                            <div id="groupContenInner">
                                <div id="groupDataMaster" style="width: 98%; height: auto;">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblPurchaseNO" runat="server" Text="Adjust No:"></asp:Label>
                                                        </td>

                                                        <td>

                                                            <asp:TextBox ID="txtRequsitionNo" runat="server" CssClass="colourdisabletextBox" ReadOnly="True" BackColor="#FFFFCC"></asp:TextBox>
                                                        </td>

                                                        <td align="right">
                                                            <asp:Label ID="lblInvoiceDate" runat="server" Text="Adjustment Date:"></asp:Label><span style="color: red">*</span>

                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtRequsitionDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                                                            <asp:RegularExpressionValidator runat="server" ControlToValidate="txtRequsitionDate" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$" ErrorMessage="Invalid date format." ValidationGroup="Group1" ForeColor="Red" />
                                                        </td>
                                                        <%-- onblur="checkDt(this)"--%>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="Label4" runat="server" Text="Adjustment Type:"></asp:Label><span style="color: red">*</span>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlAdjustmentType" runat="server" CssClass="dropDownList required">
                                                                <asp:ListItem Value="D" Selected="True">Department</asp:ListItem>
                                                                <asp:ListItem Value="S" >Store</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td></td>
                                                        <td>
                                                            <asp:CheckBox ID="cbAuthStatus" runat="server" Text="Authorised" Checked="true" />
                                                        </td>
                                                        <td></td>
                                                        <td align="right">
                                                            <asp:CheckBox runat="server" ID="cbIsTarget" Text="Is Target" Checked="true" />
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="Label1" runat="server" Text="Doc.Ref No:"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtRefNo" runat="server" CssClass="colourdisabletextBox"></asp:TextBox>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="Label5" runat="server" Text="File Upload:"></asp:Label>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="Label6" runat="server" Text="Sheet Name:"></asp:Label><span style="color: red">*</span>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlSheetName" runat="server" CssClass="DropDownListWide2">
                                                            </asp:DropDownList>
                                                            <asp:HiddenField ID="hdnSheetName" runat="server" Value="" />

                                                        </td>
                                                        <td colspan="2">
                                                            <asp:Button ID="btnUpload" CssClass="buttonSearch" runat="server" OnClick="btnUpload_Click" Text="Load Data" /></td>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold">ADJUSTMENT DETAILS</span>
                                    </div>
                                    <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    <td width="64px" class="headerColCenter">SL#
                                                    </td>
                                                    <td width="80px" class="headerColCenter">Item Group
                                                    </td>
                                                    <td width="10px" class="headerColCenter"></td>
                                                    <td width="195px" class="headerColCenter">Item
                                                    </td>
                                                    <td width="10px" class="headerColCenter"></td>
                                                    <td width="80px" class="headerColCenter">Add Qty
                                                    </td>
                                                    <td width="80px" class="headerColCenter">Deduct Qty
                                                    </td>
                                                    <td width="80px" class="headerColCenter">Target Qty
                                                    </td>


                                                    <td width="50px" class="headerColCenter">UOM
                                                    </td>
                                                    <td width="50px" class="headerColCenter">Item Type
                                                    </td>
                                                    <td width="80px" class="headerColCenter">Stock
                                                    </td>
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="SL#">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSLNo" runat="server" Text='<%# Bind("ADJ_SL_NO") %>' Style="text-align: center;"
                                                                        Width="64px"> </asp:Label>
                                                                    <asp:HiddenField ID="hdnRecordStateInt" runat="server" Value='<%# Bind("_RecordStateInt") %>' />
                                                                    <asp:HiddenField ID="hdnReqDetId" runat="server" Value='<%# Bind("INV_ADJUST_DET_ID") %>' />
                                                                </ItemTemplate>
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect txtQty txtAddQty" Width="80" Text='<%# Bind("ADD_ADJUST_QTY") %>'></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtDeductQty" runat="server" CssClass="textBox textAutoSelect txtQty txtDeductQty" Width="80" Text='<%# Bind("DEDUCT_ADJUST_QTY") %>'></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txt_Target_qty" runat="server" CssClass="textBox textAutoSelect txtQty" Width="80" Text='<%# Bind("TARGET_QTY") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:HiddenField ID="hdnAdjustMentType" runat="server" Value='<%# Bind("ADJUSTMENT_TYPE_ID") %>' />
                                                                                        <asp:DropDownList ID="ddlAdjustmentType" runat="server" CssClass="dropDownList" Width="50px">
                                                                                          <asp:ListItem Value="601">Normal Adjustment</asp:ListItem>
                                                                                            <asp:ListItem Value="603">Formed</asp:ListItem>
                                                                                            <asp:ListItem Value="604">Un Formed</asp:ListItem>
                                                                                            <asp:ListItem Value="602">WIP</asp:ListItem>
                                                                                            <asp:ListItem Value="8001">Packing Adjustment</asp:ListItem>
                                                                                            <asp:ListItem Value="8002">Assembly Adjustment</asp:ListItem>
                                                                                            <asp:ListItem Value="8006">Recovery Adjustment</asp:ListItem>
                                                                                            <asp:ListItem Value="8007">Rejection Adjustment</asp:ListItem>
                                                                                            <asp:ListItem Value="1001">Solar Packing Adjustment</asp:ListItem>
                                                                                            <asp:ListItem Value="9008">Charged Battery Adjustment</asp:ListItem> 
                                                                                            <asp:ListItem Value="9003">Green Battery Adjustment</asp:ListItem>
                                                                                            <asp:ListItem Value="9005">Formed Battery Adjustment</asp:ListItem>
                                                                                             <asp:ListItem Value="4001">Electrolye Adjustment</asp:ListItem>
                                                                                        </asp:DropDownList>
                                                                                    </td>

                                                                                    <td style="display: inline-block; width: 75px; text-align: right">
                                                                                        <asp:Label runat="server" Text='<%# Bind("CLOSING_QTY") %>' ID="lblCurrentStock"></asp:Label>

                                                                                    </td>


                                                                                    <td>
                                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="150" Text='<%# Bind("REMARKS_DTL") %>' Style=""></asp:TextBox>
                                                                                    </td>
                                        ...
                                        <div id="divGridControls2" style="width: 100%; height: 25px; border-top: solid 1px #C0C0C0;">
                                            <table style="width: auto; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <asp:TextBox ID="txtTotSalesAmt" runat="server" CssClass="textBox" Style="text-align: right;" Enabled="false"
                                                            Width="100" TabIndex="-1" Font-Bold="True"></asp:TextBox>
                                                    </td>
                                                    <td align="right" style="padding-left: 8px">
                                                        <asp:Label ID="Label3" runat="server" Text="Total Deduct Qnty:" Font-Bold="True"></asp:Label>
                                                    </td>
                                                    <td align="right">
                                                        <asp:TextBox ID="txtTotalDeductQty" runat="server" CssClass="textBox" Style="text-align: right;" Enabled="false"
                                                            Width="100" TabIndex="-1" Font-Bold="True"></asp:TextBox>
                                                    </td>
    ...
    <script src="../javascript/jquery.attributeobserver.js" type="text/javascript"></script>
     <script src="../javascript/jszip.js" type="text/javascript"></script>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var txtTotalAddQty = '<%=txtTotSalesAmt.ClientID%>';
        var txtTotalDeductQty = '<%=txtTotalDeductQty.ClientID%>';


        var fuExcel = '<%=fuExcel.ClientID%>';
        var ddlSheetName = '<%=ddlSheetName.ClientID%>';
        var hdnSheetName = '<%=hdnSheetName.ClientID%>';
            ...
            pageInstance.add_pageLoaded(function (sender, args) {
                ...
                for (i = 0; i < panels.length; i++) {
                    ...
                    if (panels[i].id == gridUpdatePanelIDDet) {
                        ...
                        $('#' + fuExcel).on('change', function (evt) {
                        ...
                        var result, zip = new JSZip(), processStartTime, s, i, index, id, newOption, dropdownItem;
                        ...
                        var getTab = function (base64file) {
                            ...
                            if (s = zip.file('xl/workbook.xml')) {
                                ...
                                for (i = 1; i < s.length; i++) {
                                    ...
                                    dropdownItem = id.substring(0, id.indexOf('"'));
                                    $('#' + ddlSheetName).append($("<option     />").val(dropdownItem).text(dropdownItem));
                                    if (i == 1) {
                                        $('#' + hdnSheetName).val($('#' + ddlSheetName + " option:selected").text());
                                    }

                                    //newOption = "<option value='" + dropdownItem + "'>"+dropdownItem+"</option>";
                                    //$('#' + ddlSheetName).append(newOption);
                                }
                            }
        ...
        function GetTotalSumAddedQty() {
            var totAdd = 0;
            $(document).find('.txtAddQty').each(function (index, elem) {
        ...
        function GetTotalSumDeductQty() {
            var totDeduct = 0;
            $(document).find('.txtDeductQty').each(function (index, elem) {
                deductQty = parseFloat(JSUtility.GetNumber($(elem).val()));
                if (!isNaN(deductQty)) {
                    totDeduct += deductQty;
                }
            });
        ...
        function sumGrandQty() {
            ...
            var totDeduct = GetTotalSumDeductQty();
            $("#" + txtTotalAddQty).val(JSUtility.FormatCurrency(totAdded));
            $("#" + txtTotalDeductQty).val(JSUtility.FormatCurrency(totDeduct));
