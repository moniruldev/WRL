<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVDirectPurchaseNew.aspx.cs" Inherits="PG.Web.Inventory.INVDirectPurchaseNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var hdnSupplierCode = '<%=hdnSupplierCode.ClientID%>';
        var txtPrefix = '<%=txtPrefix.ClientID%>';
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        newServiceURL = newServiceURL + "&itemtypeid=" + ddlItemType + "&storeid=" + storeid;
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
        ...
        function bindSupplierList() {
            ...
            $(supplierIDElem).combogrid({
                    ...
                    if (ui.item.dealerid == '') {
                        ...
                        $('#' + hdnSupplierCode).val(ui.item.supcode);
                        $('#' + txtSupplierName).val(ui.item.supname);
                        $('#' + txtPrefix).val(ui.item.supcode);
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Direct Purchase(Without Indent)"></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width:1067px;">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Direct Purchase(Without Indent)</span>
                        </div>
                                                ...
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="txtPurchaseNo" runat="server" CssClass="textBox" Enabled="false" BackColor="#FFFFCC"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                        <td align="right">
                                                            <asp:Label ID="lblInvoiceDate" runat="server" Text="Purchase Date:"></asp:Label><span style="color:red">*</span></td>
                                                        ...
                                                        <td>
                                                         ...
                                                         <td align="right">
                                                          <asp:Label ID="Label1" runat="server" Text="Supplier:"></asp:Label><span style="color:red">*</span></td>
                                                        </td>
 <td >
                                        ...
                                        <input id="btnSupplierID" type="button" value="" runat="server" class="buttonDropdown"
                                            tabindex="-1" />
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="" class="auto-style10">
                                                            <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox" TextMode="MultiLine" Height="30px" Width="250px"></asp:TextBox>

                                                        </td>
                                                        <td class="auto-style10"></td>
                                                          <td align="right" class="auto-style10">
                                                            <asp:Label ID="lblDeliveryDate" runat="server" Text="Delivery Date:"></asp:Label><span style="color:red">*</span></td>

                                                        <td class="auto-style10">
                                                            <asp:TextBox ID="txtDeliveryDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                                                            <asp:RegularExpressionValidator runat="server" ControlToValidate="txtDeliveryDate" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$" ErrorMessage="Invalid date format." ValidationGroup="Group1" ForeColor="Red" />
                                                        </td>
                                                        <td align="right" class="auto-style10">
                                                            <asp:Label ID="lblDeliveryLocation" runat="server" Text="Delivery Location:"></asp:Label>
                                                        </td>
                                                        <td colspan="" class="auto-style10">
                                                            <asp:TextBox ID="txtDeliveryLocation" runat="server" CssClass="textBox" TextMode="MultiLine" Height="30px" Width="240px"></asp:TextBox>
                                        ...
                                        <tr>
                                               ...
                                               <td colspan="2">
                                                     <asp:TextBox ID="txtPrefix" runat="server" Width="80px" CssClass="textBox" Style="float:left;"  ></asp:TextBox>
                                                      <asp:TextBox ID="txtChallanNo" runat="server" placeholder="Type Here" CssClass="textBox" Width="120px"  Enabled="true" Style="border-left:0; float:left"></asp:TextBox>
                                             </td>
                                              <td align="right">
                                              <asp:Label ID="Label7" runat="server" Text="For Department:"></asp:Label><span style="color: red">*</span>

                                              </td>
                                            <td align="left">
                                              <asp:DropDownList ID="ddlToDepartment" runat="server" CssClass="dropDownList required" OnSelectedIndexChanged="ddlToDepartment_SelectedIndexChanged" AutoPostBack="true">
                                               </asp:DropDownList>
                                            </td>
                                        </tr>
                ...
                <div id="dvControlsInnerTC" class="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold">Direct Purchase Details: </span>
                                    </div>
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:HiddenField ID="hdngroupId" runat="server" Value='<%# Bind("ITEM_GROUP_ID") %>' />
                                                                                         <asp:HiddenField ID="hdnPurDetId" runat="server" Value='<%# Bind("PURCHASE_DET_ID") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("PURCHASE_QTY") %>' onkeypress="return onlyNos(event,this);" OnTextChanged="txtITEMRate_TextChanged" AutoPostBack="true" ></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtITEMRate" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("UNIT_RATE") %>' Style="" OnTextChanged="txtITEMRate_TextChanged" AutoPostBack="true" Enabled="true"></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:Label ID="lblTotalAmt" runat="server" CssClass="textBox textAutoSelect" Width="68" Text='<%# Bind("UNIT_PRICE") %>' Style=""></asp:Label>
                                                                                    </td>
                                                                                     <td>
                                                                                        <asp:TextBox ID="txtSUPDCNO" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("SUP_DC_NO") %>'  Style="" ></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="150" Text='<%# Bind("NOTE") %>' Style=""></asp:TextBox>
                                                                                    </td>
