<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ItemEntrywithatt.aspx.cs" Inherits="PG.Web.Inventory.ItemEntrywithatt" %>
	...
	<div id = "dvControls" style="height:auto; width:100%">
		<div id="dvControlsInner" class="groupBoxContainer boxShadow">    
			 <div id="groupBox">
				  ...
				  <div id="groupContent" class="groupContent" style="width:100%;height:600px; overflow:auto;">
			...
			<%--<tr>
                ...
                <tr style="display:none">
				 ...
				 <td style="" align="right">
				   <asp:Label id="Label12" runat="server" Visible="false" Text="Alter. Item Name:" ></asp:Label>
				 </td>
				 <td style="" align="left">
					<asp:TextBox id="txtALTER_ITEM_NAME" runat="server" Visible="false" CssClass="textBox fldRequired enableIsDirty" 
						width="380px" MaxLength="200" ></asp:TextBox>
				 </td>
				  <td style="" align="right">
					  &nbsp;</td>
				 ...
				 <td style="" align="left">
				  ...
				  <td style="display:none" align="left">
					<asp:CheckBox ID="chkIS_PRIME" runat="server" Text="Prime Item " />
                  </td>
				 <td style="" align="left">
					 &nbsp;</td>
				 </tr> 
				 ...
				 <td style="" align="left">
				  ...
				  <td style="display:none" align="left">
					<asp:CheckBox ID="chkFOR_PRODUCTION" runat="server" Text="For Production " />  
                  </td>
				 <td style="" align="left">
					 &nbsp;</td>
				 </tr> 
				 ...
				 <td style="" align="right">
				   ...
				   <asp:Label id="Label11" runat="server" Text="Safety Stock Level:" style="display:none;" ></asp:Label>
					  </td>
				 <td style="" align="left">
					<asp:TextBox ID="txtSafetyLevel" runat="server" CssClass="textBox" style="display:none;" ></asp:TextBox>
					  </td>
				  <td style="" align="right">
					  &nbsp;</td>
				 <td style="" align="left">
			  ...
			  <tr>
                ...
                <tr>
				 ...
				 <td align="right" >
				   <asp:Label id="Label7" runat="server" Text="Safty Stock Level:" ></asp:Label>
				 </td>
				 <td align="left" >
				...
				<td>
				 ...
				 <td style="" align="left">
					 <asp:DropDownList ID="ddlBrand" runat="server" 
						 CssClass="dropDownList enableIsDirty" width="190px" >
				...
				<td>
				 ...
				 <td style="" align="left">
				  ...
				  <td>
                       ...
                       <td style="" align="right">
				   <asp:Label id="lblSize" runat="server" Text="Item Size Name:" ></asp:Label>
					</td>
				 <td style="" align="left">
					 <asp:DropDownList ID="ddlItemSize" runat="server" 
						 CssClass="dropDownList enableIsDirty" width="190px" >
						 <asp:ListItem Value="0" Selected="True">(Select Item Size)</asp:ListItem>
					 </asp:DropDownList>
					</td>
				 <td style="" align="right">
					 &nbsp;</td>
				 ...
				 <td style="" align="left">
				  ...
				  <td>
                       ...
                       <td style="" align="right">
				   <asp:Label id="lblColor" runat="server" Text="Item Color Name:" ></asp:Label>
					</td>
				 <td style="" align="left">
					 <asp:DropDownList ID="ddlColor" runat="server" 
						 CssClass="dropDownList enableIsDirty" width="190px" >
						 <asp:ListItem Value="0" Selected="True">(Select Item Color)</asp:ListItem>
					 </asp:DropDownList>
					</td>
				 <td style="" align="right">
					 &nbsp;</td>
	 ...
	 <div id="dvContentFooter" class="dvContentFooter">
		 <table>
			  <tr>
               ...
               <asp:Button ID="btnGrpAttLoad" runat="server" Text="load" Width="35px" Style="display: none;"  OnClick="btnGrpAttLoad_Click" />
              </td>
