<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewPurchaseIndent.aspx.cs" Inherits="PG.Web.Inventory.INVNewPurchaseIndent" %>
                        ...
                        <div id="groupContent" class="groupContent scrollBar">
                            <div id="groupContenInner">
                                                ...
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:TextBox ID="txtIndtNo" runat="server" CssClass="colourdisabletextBox" ReadOnly="True" BackColor="#FFFFCC"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                        <td align="right">
                                                    ...
                                                    <tr>
                                                        <td>Indent Department:<span style="color: red">*</span></td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlFromDepartment" Width="170px" runat="server" CssClass="dropDownList required DropDownListWide2">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td></td>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <table style="width: 98%;" border="0" cellspacing="2" cellpadding="1">

                                        <tr>
                                            <td style="text-align: right">Item Type:<span style="color: red">*</span></td>
                                            <td>
                                                <asp:DropDownList ID="ddlItemType" runat="server" Width="170px" CssClass="dropDownList required">
                                            ...
                                            <td style="text-align: right">Local/Foreign:<span style="color: red">*</span></td>
                                            <td>
                                                <asp:DropDownList ID="ddlLocalOrForeign" runat="server" Width="105px" CssClass="dropDownList required">
                                            ...
                                            <td style="text-align: right">Against IGR:<span style="color: red">*</span></td>
                                            <td>
                                                <asp:DropDownList ID="ddlIsAgainstRequisition" Width="105px" runat="server" CssClass="dropDownList required">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:DropDownList ID="ddlSafetyStock" runat="server">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <asp:ListItem Value="N">No</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        <td><asp:TextBox ID="txtItemName" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox></td>
                                                        <td><input id="btnItemID" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" /></td>
                                                    </tr>
                                                </table>
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center; display: none;">
                                        ...
                                        <div id="dvGridHeaderTop" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="260px" class="headerColLeft">Item
                                                    </td>
                                                    <td width="60px" class="headerColLeft">Item Code
                                                    </td>
                                                    <td width="60px" class="headerColLeft">Item Type
                                                    </td>
                                                    <td id="tdWeighAvgPriceView" runat="server" width="60px" class="headerColLeft">Weight. Avg. Price</td>
                                                    <td  style="display:none" width="60px" class="headerColLeft">Weight. Avg. Price</td>
                                                    <td width="80px" class="headerColLeft">Final Qty
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Req Qty
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Safety Stock
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Stock Qty
                                                    </td>
                                                    <td width="50px" class="headerColLeft">UOM
                                                    </td>
                                                    <td width="70px" class="headerColLeft">Priority
                                                    </td>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="178" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="lblItemCode" Enabled="false" Width="52px" runat="server" Text='<%# Bind("ITEM_CODE")%>'></asp:TextBox>


                                                                            </td>  
                                                            <%--                 <td>
                                                                                <asp:TextBox ID="txtItemType" Enabled="false" Width="52px" runat="server" Text='<%# Bind("ITEM_TYPE_CODE")%>'></asp:TextBox>
                                                                            ...
                                                                            <td>
                                                                               <asp:HiddenField ID="hdnItemType" runat="server" Value='<%# Bind("ITEM_TYPE_ID") %>' />
                                                                                <asp:DropDownList ID="ddlItemType" runat="server" CssClass="dropDownList" Width="60" >
                                                                                           
                                                                                </asp:DropDownList>
                                                                              </td>
                                                                         
                                                                            <td>
                                                                                <asp:TextBox ID="txtWeightAvgPriceView" Visible="true" Style="text-align: right" Width="55px" CssClass="textBox textAutoSelect" Enabled="false" runat="server" Text='<%# Bind("UNIT_PRICE")%>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            ...
                                                                            <td style="display:none">
                                                                                <asp:TextBox ID="txtWeightAvgPrice" Visible="true" Style="text-align: right" Width="55px" CssClass="textBox textAutoSelect" Enabled="false" runat="server" Text='<%# Bind("UNIT_PRICE")%>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                            </td>

                                                                         
                                                                            <td>
                                                                                <asp:TextBox ID="txtItem_qty" Style="text-align: right" runat="server" CssClass="textBox textAutoSelect" Width="65" Text='<%# Bind("FINAL_INDT_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                            </td>


                                                                            <td>
                                                                                <asp:TextBox ID="txtReqQty" runat="server" Style="text-align: right" CssClass="textBox textAutoSelect" Width="68" Text='<%# Bind("TOTAL_REQ_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtSafetyStock" runat="server" Style="text-align: right" CssClass="textBox textAutoSelect" Width="69" Text='<%# Bind("SAFTY_STOCK_LEVEL") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                            </td>
                                                                            <td>
                                                                                <asp:TextBox ID="txtStockQty" runat="server" Style="text-align: right" CssClass="textBox textAutoSelect" Width="69" Text='<%# Bind("CLOSING_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <asp:DropDownList ID="ddlPriority" runat="server" Width="65px">
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="90" Text='<%# Bind("INDT_REMARKS") %>' Style=""></asp:TextBox>
                                                                            </td>
                                    ...
                                    <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                class="defFont" cellspacing="1" cellpadding="1">
                                                <tr class="headerRow">
                                                    <td width="44px" class="headerColLeft">SL#
                                                    </td>
                                                    <td width="140px" class="headerColLeft">Item Group
                                                    </td>
                                                    <td width="20px" class="headerColLeft"></td>
                                                    <td width="250px" class="headerColLeft">Item
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Item Code
                                                    </td>
                                                     <td width="70px" class="headerColLeft">Item Type
                                                    </td>
                                                  <%--  <td width="10px" class="headerColLeft"></td>--%>
                                                    <td width="75px" class="headerColLeft">Indt Qty
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Req Qty
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Weight. Avg. Price
                                                    </td>
                                                    <td width="80px" class="headerColLeft" style="display:none">Weight. Avg. Price
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Safety Stock
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Stock Qty
                                                                    ...
                                                                    <div>
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox textAutoSelect" Width="108" Text='<%# Bind("ITEM_GROUP_NAME") %>'></asp:TextBox>
                                                                                        <asp:HiddenField ID="hdngroupId" runat="server" Value='<%# Bind("ITEM_GROUP_ID") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                        <input id="btnItemGroup" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="170" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                        <asp:HiddenField ID="hdnItemID" runat="server" Value='<%# Bind("ITEM_ID") %>' />
                                                                                    </td>
                                                                                    <td>
                                                                                        <input id="btnITEM_NAME" type="button" value="" runat="server" class="buttonDropdown"
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="lblItemCode" Enabled="false" Width="64px" runat="server" Text='<%# Bind("ITEM_CODE")%>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" Style="text-align: right" CssClass="textBox textAutoSelect" Width="60" Text='<%# Bind("INDT_QTY_APPROVED") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtReqQty" runat="server" Style="text-align: right" CssClass="textBox textAutoSelect" Width="63" Text='<%# Bind("TOTAL_REQ_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                    </td>
                                                                                    <td >
                                                                                        <asp:TextBox ID="txtWeightAvgPriceView" runat="server" Style="text-align: right" Enabled="false" CssClass="textBox textAutoSelect" Width="63" Text='<%# Bind("UNIT_PRICE") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    </td>
                                                                                    <td style="display:none">
                                                                                        <asp:TextBox ID="txtWeightAvgPrice" runat="server" Style="text-align: right" Enabled="false" CssClass="textBox textAutoSelect" Width="63" Text='<%# Bind("UNIT_PRICE") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtSafetyStock" runat="server" Style="text-align: right" CssClass="textBox textAutoSelect" Width="64" Text='<%# Bind("SAFTY_STOCK_LEVEL") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtStockQty" runat="server" Style="text-align: right" CssClass="textBox textAutoSelect" Width="67" Text='<%# Bind("CLOSING_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:HiddenField ID="hdnPriority" runat="server" Value='<%# Bind("PRIORITY") %>' />
                                                                                        <asp:DropDownList ID="ddlPriority" runat="server" Width="70px">
                                                                                            <asp:ListItem Value="High">High</asp:ListItem>
                                                                                            <asp:ListItem Value="Medium">Medium</asp:ListItem>
                                                                                            <asp:ListItem Value="Low">Low</asp:ListItem>
                                                                                        </asp:DropDownList>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="100" Text='<%# Bind("INDT_REMARKS") %>' Style=""></asp:TextBox>
                                                                                    </td>
