<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewInterDepartmentIGR.aspx.cs" Inherits="PG.Web.Inventory.INVNewInterDepartmentIGR" %>
                            ...
                            <div id="groupContenInner">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlFromDepartment" runat="server" CssClass="dropDownList required" Width="200px" OnSelectedIndexChanged="ddlFromDepartment_SelectedIndexChanged" AutoPostBack="true">
                                                            </asp:DropDownList>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        ...
                                        <div id="dvGrid" style="width: 90%; height: 270px; overflow: auto;" class="dvGrid">
