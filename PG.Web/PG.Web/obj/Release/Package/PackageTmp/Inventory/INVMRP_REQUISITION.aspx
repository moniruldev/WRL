<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVMRP_REQUISITION.aspx.cs" Inherits="PG.Web.Inventory.INVMRP_REQUISITION" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="MRP Requisition"></asp:Label>
            </div>
                            ...
                            <div id="groupContenInner">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblMRPCODE" runat="server" Text="MRP REQ Code:"></asp:Label>
                                                        </td>

                                                        <td >

                                                            <asp:TextBox ID="txtMRP_REQ_CODE" runat="server" CssClass="textBox"></asp:TextBox>
                                                        </td>
                                                        <td align="right">
                                                             <asp:Label ID="lblMRPDate" runat="server" Text="MRP Date:"></asp:Label>
                                                        </td>
                                                        
                                                        <td>
                                                            <asp:TextBox ID="txtMRPDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                                                            <%--<asp:RegularExpressionValidator runat="server" ControlToValidate="txtMRPDate" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$" ErrorMessage="Invalid date format." ValidationGroup="Group1" ForeColor="Red" />--%>
                                                        </td>

                                                        <td align="right">
                                                             <asp:Label ID="lblMRPREQUREDDATE" runat="server" Text="Required Date:"></asp:Label>
                                                        </td>
                                                        
                                                        <td>
                                                            <asp:TextBox ID="txtMRPREQUREDDATE" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                                                            <%--<asp:RegularExpressionValidator runat="server" ControlToValidate="txtMRPDate" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$" ErrorMessage="Invalid date format." ValidationGroup="Group1" ForeColor="Red" />--%>
                                                        </td>
                                                        <td></td>
                                                  ...
                                                  <%--  <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblMRPNote" runat="server" Text="MRP Note:"></asp:Label>
                                                        </td>
                                                        <td colspan="8">
                                                            <asp:TextBox ID="txtMRPNote" runat="server" CssClass="textBox" TextMode="MultiLine" Height="30px" Width="700px"></asp:TextBox>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold">MRP Requisition Details: </span>
                                    </div>
                                    <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        ...
                                        <div id="dvGrid" style="width: 80%; height: 200px; overflow: auto;" class="dvGrid">
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="SL#">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSLNo" runat="server" Text='<%# Bind("MRP_DET_SLNO") %>' Style="text-align: center;"
                                                                        Width="64px">
                                                                    </asp:Label>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                       ...
                                                                                       <%-- <asp:CompareValidator runat="server" Operator="DataTypeCheck" Type="Integer" ControlToValidate="txtItem_qty" ErrorMessage="Value must be a whole number" />--%>
                                                                                    </td>
                                                                                   ...
                                                                                   <%-- <td>
                                                                                        <asp:TextBox ID="txtITEMRate" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("ITEM_RATE") %>' Style=""  OnTextChanged="txtITEMRate_TextChanged"  AutoPostBack="true" Enabled="false" ></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:Label ID="lblTotalAmt" runat="server" CssClass="textBox textAutoSelect" Width="68" Text='<%# Bind("total_amount") %>'  Style=""></asp:Label>
                                                                                    </td>--%>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="150" Text='<%# Bind("DETAILS_NOTE") %>' Style=""></asp:TextBox>
                                                                                    </td>
