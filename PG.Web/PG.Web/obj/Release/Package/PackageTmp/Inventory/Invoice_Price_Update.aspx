<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Invoice_Price_Update.aspx.cs" Inherits="PG.Web.Inventory.Invoice_Price_Update" %>
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    <asp:HyperLinkField HeaderText="" Text="Price">
                                        <ControlStyle Height="20px" Width="45px" />
                                   ...
                                   <asp:BoundField DataField="INVOICE_NO" HeaderText="Purchase No" ItemStyle-Width="150px" />
                                    ...
                                    <asp:BoundField DataField="INVOICE_TIME" HeaderText="INVOICE_TIME" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}" ItemStyle-Width="160" />
