<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="StoreItemAdjustmentBulk.aspx.cs" Inherits="PG.Web.Inventory.StoreItemAdjustmentBulk" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Store Item Adjustment Bulk"></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Store Item Adjustment Bulk</span>
                        </div>
                                        ...
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="50px" class="headerColLeft">Item Type
                                                    </td>
