<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="StoreItemAdjustmentVerification.aspx.cs" Inherits="PG.Web.Inventory.StoreItemAdjustmentVerification" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Store Item Adjustment Verification "></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Store Item Adjustment Verification</span>
                        </div>
                            ...
                            <div id="groupContenInner">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblInvoiceDate" runat="server" Text="Adjustment Date:" Enabled="false"></asp:Label><span style="color: red">*</span>

                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtRequsitionDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px" Enabled="false"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlAdjustmentType" runat="server" CssClass="dropDownList required" Enabled="false">
                                                                <asp:ListItem Value="D">Department</asp:ListItem>
                                                                <asp:ListItem Value="S" Selected="True">Store</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td></td>
                                                         <td>
                                                            <%--<asp:CheckBox ID="cbAuthStatus" runat="server" Text="Authorised" />--%>
                                                        </td>
                                                        <td></td>
                                                         <td align="right">
                                                            <%--<asp:CheckBox runat="server" ID="cbIsTarget" Text="Is Target" />--%>
                                                        </td>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold">ADJUSTMENT VERIFICATION DETAILS</span>
                                    </div>
                                    <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    <td width="24px" class="headerColLeft">SL#
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Item Group
                                                    </td>
                                                    <td width="10px" class="headerColLeft"></td>
                                                     <td width="100px" class="headerColLeft">Item Type
                                                    </td>
                                                    <td width="240px" class="headerColLeft">Item
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Add Qty
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Auth Add Qty
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Deduct Qty
                                                    </td>
                                                      <td width="80px" class="headerColLeft">Auth Ded Qty
                                                    </td>
                                                    ...
                                                    <td width="50px" class="headerColLeft">Adj. Type
                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                     ...
                                                                                     <td>
                                                                                        ...
                                                                                        <asp:DropDownList ID="ddlItemType" runat="server" CssClass="dropDownList" Width="100" >
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="175" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect txtQty txtAddQty" Width="65" Text='<%# Bind("ADD_ADJUST_QTY") %>' Style="text-align:right" ></asp:TextBox>

                                                                                    </td>
                                                                                      <td>
                                                                                        <asp:TextBox ID="txtAuthAddAdjustQty" runat="server" CssClass="textBox textAutoSelect txtQty txtAddQty" Width="75" Text='<%# Bind("AUTH_ADD_ADJUST_QTY") %>' OnTextChanged="CalculateTargetQty" AutoPostBack="true" Style="text-align:right" ></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtDeductQty" runat="server" CssClass="textBox textAutoSelect txtQty txtDeductQty" Width="65" Text='<%# Bind("DEDUCT_ADJUST_QTY") %>' Style="text-align:right" ></asp:TextBox>

                                                                                    </td>
                                                                                      <td>
                                                                                        <asp:TextBox ID="txtAuthDedAdjustQty" runat="server" CssClass="textBox textAutoSelect txtQty txtDeductQty" Width="75" Text='<%# Bind("AUTH_DEDUCT_ADJUST_QTY") %>' OnTextChanged="CalculateTargetQty" AutoPostBack="true" Style="text-align:right" ></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txt_Target_qty" runat="server" CssClass="textBox textAutoSelect txtQty" Width="72" Text='<%# Bind("TARGET_QTY") %>'  Style="text-align:right"> </asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:DropDownList ID="ddlAdjustmentType" runat="server" CssClass="dropDownList" Width="50px">
                                                                                            <asp:ListItem Value="901">Normal Adjustment</asp:ListItem>
        ...
        <div id="dvContentFooter" class="dvContentFooter">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnVerification" runat="server" Text="Verify" CssClass="buttonSave checkRequired" AccessKey="s" OnClick="btnVerification_Click" OnClientClick="if ( ! UserVerificationConfirmation()) return false;" />
