<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ItemList.aspx.cs" Inherits="PG.Web.Inventory.ItemList" %>
    ...
    <script language="javascript" type="text/javascript">
       ...
       <%-- var groupPopupID = '<%=dvPopupItemGroup.ClientID %>';--%>
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/Item.aspx?id=" + key;
        ...
        function bindItemList() {
            ...
            $(groupIDElem).combogrid({
                ...
                search: function (event, ui) {
                    ...
                    newServiceURL = newServiceURL + "&itemtypeid=1";// + ddlItemType;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item List"></asp:Label>
            </div>
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                             <asp:Label ID="lblGroup" runat="server" Text="Item Group:" ></asp:Label>
                        </td>

                        <td>
                            <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox required" Enabled="true" Width="280px"></asp:TextBox>
                             <input id="btnGroupID" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" style="float: right;" />
                        </td>
                        <td>
                        ...
                        <td>
                         <asp:DropDownList ID="ddlItemType" runat="server" CssClass="dropDownList" Width="120" Visible="false" >
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div id="Div1" class="group_linkControl dvGroup" runat="server">
                                <table cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                        <td style="">
                                            <asp:TextBox ID="txtItemName"   runat="server" CssClass="textBox required" Enabled="true" Width="280px"></asp:TextBox>
                                            </td>
                                        ...
                                        <td>
                                            <div class="btnClear" style="display : none;">
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <tr>
                                        ...
                                        <td>
                                             ...
                                             <asp:DropDownList ID="ddlItemSNS" runat="server" CssClass="dropDownList enableIsDirty"  Width="270px">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="btnAddNew" type="button" runat="server" value="New Item" class="buttonNew" style="padding-left: 22px; width: 120px;" />
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;" class="defFont"
                                ...
                                <tr>
                                    ...
                                    <td width="82px" align="center">Code</td>
                                    <td width="202px" align="center">Name</td>
                                    <td width="190px" align="center">SNS Type</td>
                                    <td width="220px" align="center">Group</td>
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                ...
                                DataKeyNames="ITEM_ID" OnRowDataBound="GridView1_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ITEM_CODE" HeaderText="Code" ItemStyle-Width="80px" />
                                    ...
                                    <asp:BoundField DataField="ITEM_NAME" HeaderText="Name">
                                     ...
                                     <asp:BoundField DataField="ITEM_SNS_NAME" HeaderText="SNS Type" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="ITEM_GROUP_NAME" HeaderText="Group" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="ITEM_CLASS_NAME" HeaderText="Class" ItemStyle-Width="200px" />
                                    <asp:BoundField DataField="IS_ACTIVE" HeaderText="Active" ItemStyle-Width="30px" />
                                </Columns>
