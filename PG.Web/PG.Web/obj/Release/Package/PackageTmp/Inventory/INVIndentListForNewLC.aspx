<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVIndentListForNewLC.aspx.cs" Inherits="PG.Web.Inventory.INVIndentListForNewLC" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/LC_ENTRY_Against_Indent.aspx?indt_id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "LC Against Indent";
                //tdata.label = "User: " + userid;
                tdata.label = "LC Against Indent";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Indent List For LC"></asp:Label>
            </div>
            <!--Message Div -->
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="200px" align="left">INDT No
                                    </td>
                                    <td width="150px" align="left">INDT Date
                                    </td>
                                    <td width="150px" align="left">Required Date
                                    </td>
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                   <asp:HyperLinkField HeaderText="" Text="New LC">
                                        <ControlStyle Height="20px" Width="60px" />
                                        <ItemStyle Width="50px" />
                                    </asp:HyperLinkField>
                                   
                                    <asp:BoundField DataField="INDT_NO" HeaderText="Req. No" ItemStyle-Width="200px" />
