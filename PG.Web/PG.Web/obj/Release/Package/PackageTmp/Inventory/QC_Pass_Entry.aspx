<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="QC_Pass_Entry.aspx.cs" Inherits="PG.Web.Inventory.QC_Pass_Entry" %>
            ...
            <div id="dvControls" style="height: auto; width: 100%;">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="height: auto; width: 100%;">
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: 100%;">
                        ...
                        <div  id="dvGrid" style="width: 95%; height: 300px; overflow: auto; float:left; align-content: flex-start;">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SL#" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hdnMRRDetId" runat="server" Value='<%# Bind("MRR_DET_ID") %>' />
                                    ...
                                    <asp:TemplateField HeaderText="Already QC Qty" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="txtAlreadyTransferQty" runat="server" Text='<%# Bind("ALREADY_QC_QTY") %>' Style="text-align: center;" Width="100px"></asp:Label>
