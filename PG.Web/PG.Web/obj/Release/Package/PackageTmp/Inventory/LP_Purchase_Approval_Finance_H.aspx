<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="LP_Purchase_Approval_Finance_H.aspx.cs" Inherits="PG.Web.Inventory.LP_Purchase_Approval_Finance_H" %>
                                ...
                                <Columns>
                                  <%--  <asp:HyperLinkField HeaderText="" Text="View">
                                    ...
                                    <%--    <asp:TemplateField HeaderText="Purchase Type" Visible="true">
                                      <ItemTemplate>
                                     <asp:Label ID="lblPurchaseType" runat="server" Text='<%# Bind("PURCHASE_TYPE") %>' Style="text-align: center;" Width="200px"></asp:Label>
