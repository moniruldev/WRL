<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="InterDepartmentITCListForNewIRR.aspx.cs" Inherits="PG.Web.Inventory.InterDepartmentITCListForNewIRR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewInterDepartmentIRR.aspx?id=" + key + "&type=" + "";
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IRR:Inter Department"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width: 200px;">
                                        <asp:CheckBox ID="chkDITCDD" runat="server"  Text="Direct ITC Dept TO Dept" />
                                    </td>
                                    <td>&nbsp;</td>
                                </tr>
                            </table>
                        ...
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="150px" align="left">ITC Time
                                    </td>
                                    <td width="102px" align="left">ITC By Dept</td>
                                    <%--  <td width="102px" align="left">Issue To Dept
                                    </td>--%>
                            ...
                            <asp:GridView ID="GridView1" Width="920" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="REQ_ISSUE_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="80" />
                                    <asp:BoundField DataField="REQ_ISSUE_TIME" HeaderText="Date" ItemStyle-Width="150" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}" />
                                    <asp:BoundField DataField="from_department_name" HeaderText="Iss Dept" ItemStyle-Width="100px" />
                                    <%--<asp:BoundField DataField="to_department_name" HeaderText="Rece Dept" ItemStyle-Width="100px" />--%>
                                ...
                                <%--    <asp:BoundField DataField="REQ_DATE" HeaderText="IGR Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="80" />--%>
                                    <asp:BoundField DataField="REQ_TIME" HeaderText="IGR Time" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}"
                                        ItemStyle-Width="150" />
