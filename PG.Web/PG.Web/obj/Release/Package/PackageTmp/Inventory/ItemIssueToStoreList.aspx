<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="ItemIssueToStoreList.aspx.cs" Inherits="PG.Web.Inventory.ItemIssueToStoreList" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item Issue To Store List"></asp:Label>
            </div>
            <!--Message Div -->
