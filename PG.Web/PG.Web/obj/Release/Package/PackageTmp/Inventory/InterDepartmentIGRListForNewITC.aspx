<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="InterDepartmentIGRListForNewITC.aspx.cs" Inherits="PG.Web.Inventory.InterDepartmentIGRListForNewITC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            //var url = IForm.RootPath + "Inventory/INVNewInterDepartmentITCAgainstIGR.aspx?id=" + key;
            var url = IForm.RootPath + "Inventory/INVInterDepartmentITCAgainstIGRWithBatch.aspx?id=" + key;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="ITC:Inter Department"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label3" runat="server" Text=" IGR From"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlFromDept" runat="server" Width="165px"></asp:DropDownList>
                        </td>

                        <td>
                            <asp:Label ID="Label5" runat="server" Text="IGR To:"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlIGRTo" runat="server" Width="165px"></asp:DropDownList>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtFromDate" runat="server" Width="165px" CssClass="textBox textDate dateParse"></asp:TextBox>
                        </td>
                        ...
                        <td>
                            <asp:TextBox ID="txtToDate" runat="server" Width="165px" CssClass="textBox textDate dateParse"></asp:TextBox>
                        </td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <input id="btnAddNew" type="button" runat="server" value="New ITC" class="buttonNew" visible="false" style="padding-left: 22px; height: 26px; width: 80px;" />
                        </td>
            ...
            <div id="dvControls" style="width: 100%;">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1000px">
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr class="headerRow_Prod">
                                    ...
                                    <td width="200px" align="left">IGR From
                                    </td>

                                      <td width="200px" align="left">IGR To
                                    </td>
                        ...
                        <div id="dvGrid" style="width: 1000px; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="to_department_name" HeaderText="To Department" ItemStyle-Width="200px" />
