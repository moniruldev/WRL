<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVMrrFromLC.aspx.cs" Inherits="PG.Web.Inventory.INVMrrFromLC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVNewMRRFromLC.aspx?id=" + key + "&type=" + "LC" + "&storeId=" + storeId;
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtReqNo" runat="server" CssClass="textBox notEnterToTab" Width="180"></asp:TextBox>
                        </td>
                        <td></td>
                         <td>
                      ...
                      <tr>
                        ...
                        <td>
                            <table>
                                <tr>
                                    <td> <asp:TextBox ID="txtSupplierName" runat="server" CssClass="textBox" Width="180px"></asp:TextBox></td>
                       ...
                       <asp:DropDownList ID="ddlFromDepartment" runat="server" CssClass="dropDownList required">
                        ...
                        <td style="text-align: right">
                            <asp:Label ID="lblIsCost" runat="server" Text="Is Cost :"></asp:Label>
                            
                        </td>
                         <td>
                             <asp:DropDownList ID="ddlIsCost" runat="server" CssClass="dropDownList">
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    <td width="58px" align="left"></td>
                                    <td width="140px" align="left">Purchase No
                                    </td>
                              <%--      <td width="150px" align="left">Purchase Date
                                    </td>--%>
                                    <td width="150px" align="left">Purchase Time
                                    </td>
                                   <%-- <td width="82px" align="left">Invoice No</td>--%>
                                    <td width="120px" align="left">Lc No</td>
                                    <td width="100px" align="left">Lc date</td>
                                    <td width="150px" align="left">Supplier</td>
                                    <td width="120px" align="left">Purchase By
                                    </td>
                                    <td width="50px" align="left">Is Cost
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    <asp:HyperLinkField HeaderText="" Text="New MRR">
                                        <ControlStyle Height="20px" Width="60px" />
                                        <ItemStyle Width="50px" />
                                    </asp:HyperLinkField>
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="hdnPurchaseId" runat="server" Text='<%# Bind("IMP_PURCHASE_ID") %>' Style="text-align: center;" Width="80px"> </asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="IMP_PURCHASE_NO" HeaderText="Purchase No" ItemStyle-Width="140px">
                                ...
                                <%--    <asp:BoundField DataField="IMP_PURCHASE_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                    ...
                                    <asp:BoundField DataField="IMP_PURCHASE_TIME" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy hh:mm tt}"
                                        ItemStyle-Width="150">

                                        <ItemStyle Width="150px"></ItemStyle>
                                    </asp:BoundField>
                                  <%--  <asp:BoundField DataField="IMP_INVOICE_NO" ItemStyle-Width="80">

                                        <ItemStyle Width="80px"></ItemStyle>
                                    </asp:BoundField>--%>
                                    <asp:BoundField DataField="LC_NO" ItemStyle-Width="120">
                                    ...
                                    <asp:BoundField DataField="SUP_NAME" ItemStyle-Width="150">

                                        <ItemStyle Width="150px"></ItemStyle>
                                    </asp:BoundField>
                                    <asp:BoundField DataField="CREATE_BY_NAME" HeaderText="Iss Dept" ItemStyle-Width="120px" />
                                     <%-- <asp:BoundField DataField="IS_COSTING_FROM_LC" HeaderText="Is Cost" ItemStyle-Width="50px" />--%>
                                    <asp:TemplateField HeaderText="Is Cost" ItemStyle-Width="50">
                                        <ItemTemplate>
                                            <asp:Label Text='<%# Eval("IS_COSTING_FROM_LC").ToString()=="True" ? "Yes" : "No" %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
