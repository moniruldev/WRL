<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Category_List.aspx.cs" Inherits="PG.Web.Inventory.Category_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/Category_Entry.aspx?id=" + key;
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="btnAddNew" type="button" runat="server" value="New Category" class="buttonNew" style="padding-left: 22px; width: 120px;" />
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                ...
                                DataKeyNames="CAT_ID" OnRowDataBound="GridView1_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CAT_CODE" HeaderText="Code" ItemStyle-Width="80px" />
