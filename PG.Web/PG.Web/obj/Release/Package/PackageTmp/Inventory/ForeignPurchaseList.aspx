<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ForeignPurchaseList.aspx.cs" Inherits="PG.Web.Inventory.ForeignPurchaseList" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/INVIMPInvoice.aspx?id=" + key;
            //alert(key);
