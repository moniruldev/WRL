<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewPurchaseAgainstServicePR.aspx.cs" Inherits="PG.Web.Inventory.INVNewPurchaseAgainstServicePR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var txtTotPurQty = '<%=txtTotPurQty.ClientID%>';
        ...
        function CalculateTotalAmt() {
            ...
            for (var i = 0; i < grid.rows.length; i++) {
                ...
                //totalAmt += parseFloat(tval);
                //totalQty += parseFloat(tqty);
        ...
        //    var totqty = GetTotalSumAddedQty();
            
        //    var totAmt = GetTotalSumAmount();
        //    $("#" + txtTotPurQty).val(JSUtility.FormatCurrency(totqty));
        //    $("#" + txtTotalAmount).val(JSUtility.FormatCurrency(totAmt));
        ...
        //    $(document).find('.txtcQty').each(function (index, elem) {
        //        totalQty = parseFloat(JSUtility.GetNumber($(elem).val()));
        ...
        //function GetTotalSumAmount() {

        //    debugger;
        //    var totAddAmt = 0;

        //    $(document).find('.txtcamt').each(function (index, elem) {
        //        TotalAmount = parseFloat(JSUtility.GetNumber($(elem).val()));


        //        //if (!isNaN(addQty)) {

        //        totAddAmt += TotalAmount;
        //        //}
        //    });
        //    return totAddAmt;
        //}
