<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="SalesReturn.aspx.cs" Inherits="PG.Web.Inventory.SalesReturn" %>
...
<%--        var hdnCompanyID = '<%=hdnCompanyID.ClientID%>';--%>
        ...
        function UserDeleteConfirmation() {
            return confirm("Are you sure you want to Sales Return !!?");
        }
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="Sales Return Against Invoice" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;" align="left">
                <table border="0" cellspacing="4" cellpadding="2" align="left" style="width: 1124px" id="tblItemEntry">
                    ...
                    <tr>
                        ...
                        <td align="right">
                            <asp:Label ID="lblInvoiceDate" runat="server" Text="DC Date :" Font-Bold="true"></asp:Label>
                        ...
                        <td align="right">
                            <asp:Label ID="lblInvoiceTime" runat="server" Text="DC Time :" Font-Bold="true"></asp:Label>
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblReturnNo" runat="server" Text="Return No:" Style="font-weight: 700"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="lblReturnNoText" runat="server" CssClass="textBox" Height="15px" Width="200px" ReadOnly="true"></asp:TextBox>

                        </td>
                        <td align="right">
                            <asp:Label ID="lblRTNDATE" runat="server" Text="Return Date :" Font-Bold="true"></asp:Label><span style="color: red">*</span>

                        </td>

                        <td colspan="4">

                            <asp:TextBox ID="txtReturnDate" runat="server" CssClass="textBox textDate" Font-Bold="true"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblRemarks" runat="server" Text="Return Remarks:" Style="font-weight: 700"></asp:Label>
                        </td>
                        <td colspan="3">
                            <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox" Height="20px" Width="400px"></asp:TextBox>

                        </td>
                         <td align="right">
                            <asp:Label ID="Label1" Font-Bold="true" runat="server" ForeColor="Green" Text="Return/Cancel:"  Height="20px"></asp:Label>

                        </td>

                        <td align="left">
                            <asp:DropDownList ID="ddlReturnOrCancel" runat="server" Width="80px" CssClass="dropDownList" >
                                <asp:ListItem Value="N">Return</asp:ListItem>
                                <asp:ListItem Value="Y">Cancel</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                         <td>                            
                             <asp:Label ID="lblGrandTotalAmount" runat="server" Visible="false"></asp:Label>
                        </td>
                ...
                <ItemStyle BorderColor="Gray" HorizontalAlign="Center" Width="100px"  />
                                    ...
                                    <asp:TemplateField HeaderText="SL#">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblRTNDetSlNo" runat="server" Text='<%# Bind("DC_DET_SLNO") %>' Style="text-align: center;" Width="80px"> </asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="INV Qty" Visible="true">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtDCQty" runat="server" Text='<%# Bind("ITEM_QTY") %>' CssClass=" textBox textNumberOnly" Style="text-align: center;" Width="100px"></asp:TextBox>

                                        </ItemTemplate>
                                        <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Already Return" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAlreadyQty" runat="server" Text='<%# Bind("ALREADY_RNT_QNTY") %>' CssClass=" textBox textNumberOnly" Style="text-align: center;" Width="100px"></asp:Label>

                                        </ItemTemplate>
                                        <ItemStyle VerticalAlign="Top" />
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="RTN Qnty" Visible="true">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtRTNQTY" Text='<%# Bind("RTN_QNTY") %>' runat="server" CssClass=" textBox textNumberOnly" Style="text-align: center;" Width="100px" OnTextChanged="txtRTNQTY_TextChanged" AutoPostBack="true" ></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Item Rate" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="txtITEMRate" runat="server" Text='<%# Bind("ITEM_RATE") %>' Style="text-align: center;" Width="100px"></asp:Label>
                                     ...
                                     <asp:TemplateField HeaderText="Item Total" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblITEMTotal" runat="server" Text='<%# Bind("total_amount") %>' Style="text-align: center;" Width="100px"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Unit Name" Visible="true">
                                        <ItemTemplate>
                                            <asp:Label ID="lblUnitName" runat="server" Text='<%# Bind("UOM_CODE") %>' Style="text-align: center;" Width="150px"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="Details Note" Visible="true">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtRTN_DETAILS_NOTE" runat="server" Text='<%# Bind("RTN_DET_NOTE") %>' Style="text-align: center;" Width="150px"></asp:TextBox>
        ...
        <div id="dvContentFooter" class="dvContentFooter">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="buttonSave checkRequired" AccessKey="s" OnClick="btnSave_Click" OnClientClick="if ( ! UserDeleteConfirmation()) return false;" Width="100px" />
                        <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="buttonEdit" Visible="false" />
                    </td>
                    <td>
                        <asp:Button ID="btnInvoicePrint" runat="server" Text="Print Invoice" CssClass="buttoncommon" Enabled="false" OnClick="btnInvoicePrint_Click" Visible="false" />
                    </td>
                    ...
                    <td>
                        <asp:Button ID="btnPost" runat="server" Text="Post" CssClass="buttoncommon" Visible="false" OnClick="btnPost_Click" />
                    </td>
                    <td>
                    ...
                    <td></td>
                    <td>
                        <asp:Label ID="Label2" runat="server" Text="Print Format:" Visible="false"></asp:Label>
                    </td>
                    <td>
