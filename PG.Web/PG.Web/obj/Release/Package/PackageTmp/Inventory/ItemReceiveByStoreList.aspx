<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true"
    CodeBehind="ItemReceiveByStoreList.aspx.cs" Inherits="PG.Web.Inventory.ItemReceiveByStoreList" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item Receive By Store List"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="LblLocation" runat="server" Text=" From Department"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                       ...
                       <%-- <td>
                        ...
                        <td>
                            <input id="btnAddNew" type="button" runat="server" value="New Requisition" class="buttonNew"
                                style="padding-left: 22px; width: 130px;" />
                        </td>
                        <td>
                            &nbsp;
                        </td>
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="REQ_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}"
                                        ItemStyle-Width="80" />
                                    <asp:BoundField DataField="from_department_name" HeaderText="Type" ItemStyle-Width="100px" />

                                   <%-- <asp:TemplateField HeaderText="Authorize?">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsPosted" Text='<%# Eval("AUTH_STATUS").ToString() == "N" ? "Unauthorize": "Authorize" %>'
