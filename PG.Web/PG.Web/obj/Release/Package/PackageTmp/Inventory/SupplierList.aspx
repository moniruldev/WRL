<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="SupplierList.aspx.cs" Inherits="PG.Web.Inventory.SupplierList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, supId) {
            ...
            var url = "Inventory/Supplier.aspx?id=" + key
            //if (pageInTab == 1)
            if (ZForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 6310;
                tdata.name = "Supplier";
                //tdata.label = "Supplier: " + supid;
                tdata.label = "Supplier";
                tdata.type = 0;
                tdata.url = url;
 ...
 <div  id="dvPageContent" style="width:100%; height:100%;" >
  ...
  <div id="dvContentHeader" class="dvContentHeader">  
    <div id="dvHeader" class="dvHeader">
        <asp:Label ID="lblHeader" runat="server" Text="Supplier" CssClass="lblHeader"></asp:Label>
    </div>
    ...
    <div id="dvControlsHead" style="height:auto;width:100%;">
        <table style="" cellspacing="2" border="0">
            <tr>
              ...
              <td>
                 <input id="btnAddNew" type="button" runat="server" value="New Supplier" class="buttoncommon" style="" /> 
       ...
       <div id="dvGridContainer" class="gridContainer" style="width:100%; height: auto;">
         <div id="dvGridHeader" style="width:100%;height:25px; font-size: smaller;" class="subHeader">
            ...
            <tr>
                ...
                <td  style="display:none;" width="40px" align="left"></td>
                <td width="70px" align="left">Sup. Code</td>
                <td width="140px" align="left">Name</td>
                <td width="150px" align="left">Address</td>
                <td width="40px" align="left">Mobile</td>
            </tr>
            </table>
        </div> 
  ...
  <div id="dvGrid" style="width:auto; height: 100px; overflow:auto;" >  
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            DataKeyNames="SUP_ID" onrowdatabound="GridView1_RowDataBound" 
            ...
            <Columns>
              ...
              <%--  <asp:ButtonField Text="" ItemStyle-Width="40px" >
                ...
                <asp:BoundField DataField="SUP_CODE" HeaderText="Supplier Code" ItemStyle-Width="60px" />
                <asp:BoundField DataField="SUP_NAME" HeaderText="Name" ItemStyle-Width="145px" />
                <asp:BoundField DataField="SUP_ADDRESS" HeaderText="Address" ItemStyle-Width="150px" />
                <asp:BoundField DataField="SUP_PHONE" HeaderText="Mobile" ItemStyle-Width="40px" />
