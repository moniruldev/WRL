<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="LP_Indent_Approval.aspx.cs" Inherits="PG.Web.Inventory.LP_Indent_Approval" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Indent Approval:"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <tr>
              ...
              <td align="right">
               <asp:Label ID="lblFromDate" runat="server" Text="From Date:" style="height: 19px; width: 43px; " Font-Bold="True" Visible="false"></asp:Label>
              </td>
              <td align="left">
                 <asp:TextBox ID="txtFromDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px" Visible="false"></asp:TextBox>
                
              </td>
              <td align="right">
                    <asp:Label ID="lblToDate" runat="server" Text="To Date:" style="height: 19px; width: 43px; " Font-Bold="True" Visible="false"></asp:Label>
                   
              </td>
            
              <td>
                 <asp:TextBox ID="txtTodate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px" Visible="false"></asp:TextBox>&nbsp;
                 ...
                 <asp:RegularExpressionValidator runat="server" ControlToValidate="txtTodate" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$" ErrorMessage="Invalid date format." ValidationGroup="Group1" ForeColor="Red" />
                   ...
                   <tr>
                       ...
                       <td align="right">
                       <asp:Label ID="lblPurchaseNo" runat="server" Text="Indent No:" Font-Bold="true" ></asp:Label>
                       </td>
                       <td colspan="3"> 
                    ...
                    <tr>
                      <td></td>
                        <td align="right">
                         <asp:Label ID="lblDept" runat="server" Text="Indent Dept.:" Font-Bold="true"></asp:Label>
                        </td>
                        <td align="left">
            ...
            <div id="dvControls" style="width: 100%;">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 100%">
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width: 1000px; height: 350px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="1" Width="100%"
                                ...
                                <Columns>
                                  <%--  <asp:HyperLinkField HeaderText="" Text="View">
                                    ...
                                    <asp:TemplateField HeaderText="DC ID" Visible="false">
                                     ...
                                     <asp:TemplateField HeaderText="PurchaseNo" Visible="true">
                                      <ItemTemplate>
                                     <asp:Label ID="lblIndtNo" runat="server" Text='<%# Bind("INDT_NO") %>' Style="text-align: center;" Width="150px"></asp:Label>
                                              <asp:HiddenField ID="hdnIndtType" runat="server" Value='<%# Bind("INDT_TYPE") %>' />                        
                                      </ItemTemplate>
                                  ...
                                  <%--     <asp:TemplateField HeaderText="Purchase Type" Visible="true">
                                     ...
                                     <asp:BoundField DataField="INDT_DATE" HeaderText="Date" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="100" ItemStyle-HorizontalAlign="Left" />
                             ...
                             <%--       <asp:TemplateField HeaderText="Supplier Name" Visible="true">
                                     ...
                                     <asp:Label ID="lblSupplierName" runat="server" Text='<%# Bind("SUP_NAME") %>' Style="text-align: center;" Width="200px"></asp:Label>
                                       ...
                                       <asp:BoundField DataField="DEPARTMENT_NAME" HeaderText="STATUS" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Left"  />
                                     <asp:BoundField DataField="STATUS_NAME" HeaderText="STATUS" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Left"  />
                                     <asp:BoundField DataField="INDT_TYPE" HeaderText="STATUS" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Left"  />

                                
                                     <asp:TemplateField HeaderText="Action" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                    <asp:LinkButton ID="btnStatusdtl" runat="server"  CssClass="buttonAttach" CommandName="statusd"  CommandArgument='<%# Bind("INDT_NO") %>' ><i class="" style="padding-right:4px;color:red;font-size:14px;"></i>Details</asp:LinkButton>
                                    </ItemTemplate>
                                         
                                   </asp:TemplateField>
                                 <asp:TemplateField HeaderText="Action"  ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                    <asp:LinkButton ID="btnMemoprint" runat="server"  CommandName="app" CssClass="buttonAttach" CommandArgument='<%# Bind("INDT_NO") %>' ><i class="glyphicon glyphicon-print" style="padding-right:4px;color:blue;font-size:14px;"></i>View PR</asp:LinkButton>
                           ...
                           <asp:Label ID="lblComments" style=" padding:4px 4px; margin:0px 2px 0 -12px;  border-radius:4px; font-weight:bold; float:left;  color:red;background-color:#0094ff;" Text="0" runat="server"></asp:Label>
                                  ...
                                  <%--   <asp:TemplateField HeaderText="Action">
                                    ...
                                    <asp:LinkButton ID="btnNegotiate" runat="server"  CssClass="buttonAttach" CommandName="negotiate"  CommandArgument='<%# Bind("RESIG_APP_NO") %>' ><i class="glyphicon glyphicon-arrow-left" style="padding-right:4px;color:red;font-size:14px;"></i>Negotiate</asp:LinkButton>
                                      ...
                                      <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                    <asp:LinkButton ID="btnforward" runat="server"  CssClass="buttonAttach" CommandName="forward"   style="text-align:center;border-radius:2px;"  CommandArgument='<%# Bind("INDT_NO") %>' ><i class="glyphicon glyphicon-ok-circle" style="padding-right:4px;color:green;font-size:14px;"></i> Approve</asp:LinkButton>
                                    </ItemTemplate>
                ...
                <div class="modal-content" style="max-width:1024px;">  
                    ...
                    <div class="modal-body" style="overflow-y: scroll; max-height: 85%; max-width:1024px; margin-top: 10px; margin-bottom: 10px;">  
                        <asp:Label ID="Label8" runat="server" ClientIDMode="Static"></asp:Label>  
                         <asp:Label ID="lblPurchNo" runat="server" Text="Indent No :" ></asp:Label>
