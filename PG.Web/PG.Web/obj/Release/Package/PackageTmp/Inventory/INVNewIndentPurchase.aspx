<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewIndentPurchase.aspx.cs" Inherits="PG.Web.Inventory.INVNewIndentPurchase" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="PURCHASE AGAINST INDENT(PO) "></asp:Label>
            </div>
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <div id="dvControls" style="height: auto; width : 1200px; ">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>PURCHASE AGAINST INDENT(PO of Local Item) </span>
                        </div>
                                        ...
                                        <div id="Div1" runat="server" class="" style="width: auto; height: auto; text-align: left;">
                                            <div id="dvGridHeaderTop" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                                <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                    ...
                                                    <tr class="headerRow">
                                                        <td width="34px" class="headerColLeft">SL#
                                                        </td>
                                                        <td width="40px" class="headerColLeft">Select  
                                                        </td>
                                                        <td width="80px" class="headerColLeft">Item Group
                                                        </td>
                                                        <td width="10px" class="headerColLeft"></td>
                                                        <td width="215px" class="headerColLeft">Item
                                                        </td>
                                                        ...
                                                        <td width="10px" class="headerColLeft"></td>
                                                        <td width="80px" class="headerColLeft">Purchase Qty
                                                        </td>
                                                        ...
                                                        <td width="100px" class="headerColLeft">Already Pur Qty
                                                        </td>

                                                        <td width="150px" class="headerColLeft">INDT No
                                                        </td>
                                                        <td width="150px" class="headerColLeft">Dept
                                                        </td>
                                                                    ...
                                                                    <table border="0" cellpadding="1" cellspacing="1">
                                                                        <tbody>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtPurchaseQty" runat="server" CssClass="textBox textAutoSelect txtTopPurchaseQty" Width="90" Text='<%# Bind("BALANCE_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                </td>  
                                                                                  <td>
                                                                                    <asp:TextBox ID="txtWeightAvgPriceView" runat="server" Enabled="false" CssClass="textBox textAutoSelect" Width="80" Text='<%# Bind("WEIGHTED_AVERAGE_PRICE") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                </td> 
                                                                                 <td style="display:none">
                                                                                    <asp:TextBox ID="txtWeightAvgPrice" runat="server" Enabled="false" CssClass="textBox textAutoSelect" Width="60" Text='<%# Bind("WEIGHTED_AVERAGE_PRICE") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                </td>
                                                                                <td>
                                                                                    <asp:TextBox ID="txtIndtQty" runat="server" CssClass="textBox textAutoSelect" Width="95" Text='<%# Bind("INDT_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                ...
                                                                                <td>
                                                                                    <asp:TextBox ID="txtIndtNo" runat="server" Text='<%# Bind("INDT_NO") %>' Width="150px" CssClass="textBox textAutoSelect"></asp:TextBox>
                                        ...
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="10px" class="headerColLeft"></td>
                                                    <td width="100px" class="headerColLeft">Purchase Qty
                                                    </td>

                                                     <td width="100px" class="headerColLeft" >Weight. Avg. Price
                                                    </td>
                                                    ...
                                                    <td width="120px" class="headerColLeft">Already Pur Qty
                                                    </td>
                                                    <td width="50px" class="headerColLeft">UOM
                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                      ...
                                                                                      <td >
                                                                                        <asp:TextBox ID="txtWeightAvgPriceView" Enabled="false" runat="server" CssClass="textBox textAutoSelect" Width="100" Text='<%# Bind("UNIT_RATE") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                    </td>  

                                                                                     <td style="display:none">
                                                                                        <asp:TextBox ID="txtWeightAvgPrice" Enabled="false" runat="server" CssClass="textBox textAutoSelect" Width="100" Text='<%# Bind("UNIT_RATE") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtAlreadyPurchaseQty" runat="server" CssClass="textBox textAutoSelect" Width="115" Text='<%# Bind("ALREADRY_PURCHASE_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>
        ...
        function bindItemListFilter() {
            ...
            $(itemIDElem).combogrid({
                ...
                search: function (event, ui) {
                    ...
                    var newServiceURL = itemServiceURL + "&groupid=" + vgroupid + "&fromDate=" + fromDate + "&toDate=" + toDate;
                    $(this).combogrid("option", "url", newServiceURL);
