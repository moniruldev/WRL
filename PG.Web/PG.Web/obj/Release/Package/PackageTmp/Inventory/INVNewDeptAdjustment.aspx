<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewDeptAdjustment.aspx.cs" Inherits="PG.Web.Inventory.INVNewDeptAdjustment" %>
    ...
    <script language="javascript" type="text/javascript">
      ...
      <%--  var txtCustomerID = '<%=txtCustomerID.ClientID%>';--%>
        ...
        function bindItemList(gridViewID) {
            ...
            //serviceURL += "&companyid=" + companyid;
            serviceURL += "&ispaging=1&isdeptstock=Y";
            //serviceURL += "&locationid=" + locationid;
            // serviceURL += "&empstatus=" + "A";
            //serviceURL += "&acctypefilter=" + Enums.GLAccountTypeFilter.AllAccount;
            // serviceURL += "&namecomptype=" + Enums.DataCompareType.Contains;
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        var e = document.getElementById("<%=ddlStorageLocation.ClientID%>");
                        var stlm_id = e.options[e.selectedIndex].value;
                        //var vgroupid = $('#' + hdngroupId).val();
                        var newServiceURL = serviceURL + "&groupid=" + vgroupid + "&deptid=" + dept_id + "&stlmid=" + stlm_id;
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
        ...
        function ClearItemData(txtItemID) {
            ...
            $(detRow).find('input[id$="txtCurrentStock"]').val('0');
        }
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            $(detRow).find('input[id$="txtCurrentStock"]').val(data.closing_qty);
            

        }

        function CalculateQty(txt)
        {
            $("[id*=btnCalculateStock]").click();
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="DEPARTMENT ADJUSTMENT "></asp:Label>
            </div>
        ...
        <div id="dvContentMain" class="dvContentMain" style="width: 100%;">
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>DEPARTMENT ADJUSTMENT </span>
                        </div>
                        <div id="groupContent" class="groupContent scrollBar" style="width: 100%;">
                            <div id="groupContenInner" style="width: 100%;">
                                                ...
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                         ...
                                                         <td align="right">
                                                             <asp:Label ID="lblStorageLocation" runat="server" Text="Storage Loc:" style=""></asp:Label>
                                                          </td>
                                                          <td>
                                        ...
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    ...
                                                    <td width="200px" class="headerColLeft">Item
                                                    </td>
                                                    <td width="15px" class="headerColLeft"></td>
                                                      <td width="80px" class="headerColLeft">Batch
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Add Qty
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Deduct Qty
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Target Qty
                                                    </td>


                                                    <td width="50px" class="headerColLeft">UOM
                                                    </td>
                                                    <td width="60px" class="headerColLeft">Adj. Type
                                                    </td>
                                                    <td width="80px" class="headerColLeft">Stock
                                                    </td>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox textAutoSelect" Width="75" Text='<%# Bind("ITEM_GROUP_NAME") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:TextBox ID="txtITEM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="180" Text='<%# Bind("ITEM_NAME") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                       ...
                                                                                       <td>
                                                                                        <asp:TextBox ID="txtBatchNo" runat="server" CssClass="textBox textAutoSelect" Width="75" Text='<%# Bind("BATCH_NO") %>' ></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect txtQty txtAddQty" Width="75"  onBlur="CalculateQty(this)"  Text='<%# Bind("ADD_ADJUST_QTY") %>' ></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtDeductQty" runat="server" CssClass="textBox textAutoSelect txtQty txtDeductQty" Width="78"  onBlur="CalculateQty(this)"  Text='<%# Bind("DEDUCT_ADJUST_QTY") %>' ></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txt_Target_qty" runat="server" CssClass="textBox textAutoSelect txtQty" Width="76"  onBlur="CalculateQty(this)"  Text='<%# Bind("TARGET_QTY") %>'></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtUOM_NAME" runat="server" CssClass="textBox textAutoSelect" Width="46" Text='<%# Bind("UOM_NAME") %>' Style=""></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:DropDownList ID="ddlAdjustmentType" runat="server" CssClass="dropDownList" Width="60px">
                                                                                            <asp:ListItem Value="601">Normal</asp:ListItem>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox runat="server" Text='<%# Bind("CLOSING_QTY") %>' Width="78" ID="txtCurrentStock"></asp:TextBox>
                                                ...
                                                <Triggers>
                                                    <asp:AsyncPostBackTrigger ControlID="btnNewRow2" EventName="Click" />
                                                     <asp:AsyncPostBackTrigger ControlID="btnCalculateStock" EventName="Click" />
                                                </Triggers>
                                            </asp:UpdatePanel>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 90px" align="left">
                                                        <asp:Button ID="btnNewRow2" runat="server" CssClass="buttonNewRow" Text="" OnClientClick="ShowProgress()" OnClick="btnNewRow2_Click" />
                                                         <asp:Button ID="btnCalculateStock" runat="server" Style="display: none;" OnClick="btnCalculateStock_Click" />
                                                    </td>
                                                    <td style="width: 20px;">
                                                    ...
                                                    <td align="right">
                                                        <asp:TextBox ID="txtTotalDeductQty" runat="server" CssClass="textBox" Style="text-align: right;"
                                                            Width="100" TabIndex="-1" Font-Bold="True"></asp:TextBox>
                                                    </td>
