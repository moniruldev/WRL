<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewMRR.aspx.cs" Inherits="PG.Web.Inventory.INVNewMRR" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader" align="left">
                <asp:Label ID="lblHeader" runat="server" Text="NEW MRR From (LP/LC)" CssClass="lblHeader" Font-Bold="true" Font-Size="15px"></asp:Label>
            </div>
                ...
                <table border="0" cellspacing="4" cellpadding="2" align="center" style="width: 100%" id="tblItemEntry">
                    ...
                    <tr>
                        ...
                        <td align="left" class="auto-style3">
                            ...
                            <asp:TextBox ID="txtMrrNo" ReadOnly="true" runat="server" CssClass="textBox" Font-Bold="true"></asp:TextBox>
                        </td>
                        <td align="right" class="auto-style2">
                    ...
                    <tr>
                        ...
                        <td colspan="3" align="left" class="auto-style2">
                            <asp:TextBox ID="txtPurchaseRemarks" runat="server" CssClass="textBox" TextMode="MultiLine" Height="30px" Width="300px" Enabled="false"></asp:TextBox>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="MRR Qty" Visible="true">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtMrrQty" Text='<%# Bind("MRR_QTY") %>' runat="server" CssClass="textBox textNumberOnly " Style="text-align: center;" Width="100px" Enabled="true" OnTextChanged="txtItemRate_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            ...
                                            <asp:TemplateField HeaderText="Unit Price" Visible="false">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtUnitPrice" Text='<%# Bind("UNIT_PRICE") %>' CssClass="textBox" runat="server" Style="text-align: center;" Width="100px" onkeypress="return onlyNos(event,this);" OnTextChanged="txtItemRate_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            ...
                                            <asp:TemplateField HeaderText="Total Cost" Visible="false">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtTotalCost" Text='<%# Bind("TOTAL_COST") %>' Enabled="false" CssClass="textBox" runat="server" Style="text-align: center;" Width="100px" onkeypress="return onlyNos(event,this);"></asp:TextBox>
