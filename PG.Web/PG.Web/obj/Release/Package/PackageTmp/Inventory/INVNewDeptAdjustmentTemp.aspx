<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVNewDeptAdjustmentTemp.aspx.cs" Inherits="PG.Web.Inventory.INVNewDeptAdjustmentTemp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
      ...
      <%--  var txtCustomerID = '<%=txtCustomerID.ClientID%>';--%>
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                        ...
                        var newServiceURL = serviceURL + "&groupid=" + vgroupid+"&specid=1"+"&deptid=" + dept_id + "&isdeptstock=Y";
        ...
        function CalculationData(txtItemID) {
            ...
            var REJECT_QTY = 0;
            var DEDUCT_QTY = 0;
            var CONSUMPTION_QTY = 0;
            STOCK_QTY = parseFloat($(detRow).find('input[id$="txtCurrentStock"]').val());
            TARGET_QTY = parseFloat($(detRow).find('input[id$="txt_Target_qty"]').val());
            CONSUMPTION_QTY = STOCK_QTY - TARGET_QTY;
            $(detRow).find('input[id$="txtItem_qty"]').val(CONSUMPTION_QTY);
        }
        ...
        function calcConsumptionQty(txtbox) {
            ...
            STOCK_QTY = parseFloat($(detRow).find('input[id$="txtCurrentStock"]').val());
             TARGET_QTY = parseFloat($(detRow).find('input[id$="txt_Target_qty"]').val());
             //REJECT_QTY =parseFloat( $(detRow).find('input[id$="txtDeductQty"]').val());
             //DEDUCT_QTY = TARGET_QTY + REJECT_QTY;
             CONSUMPTION_QTY = STOCK_QTY - TARGET_QTY;
            $(detRow).find('input[id$="txtItem_qty"]').val(CONSUMPTION_QTY);
        }

        function AddNewRow(txtbox) {
        ...
        //function calcConsumptionQtyReject(txtbox) {
        //    var detRow = $(txtbox).closest('tr.gridRow');
        //    var STOCK_QTY = 0;
        //    var TARGET_QTY = 0;
        //    var REJECT_QTY = 0;
        //    var DEDUCT_QTY = 0;
        //    var CONSUMPTION_QTY = 0;
        //    STOCK_QTY = $(detRow).find('input[id$="txtCurrentStock"]').val();
        //    alert(STOCK_QTY);
        //    TARGET_QTY = $(detRow).find('input[id$="txt_Target_qty"]').val();
        //    alert(TARGET_QTY);
        //    REJECT_QTY = $(detRow).find('input[id$="txtDeductQty"]').val();
        //    DEDUCT_QTY = TARGET_QTY + REJECT_QTY;
        //    CONSUMPTION_QTY = STOCK_QTY - DEDUCT_QTY;
        //    $(detRow).find('input[id$="txtItem_qty"]').val(CONSUMPTION_QTY);
        //}
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="DEPARTMENT CLOSING/WIP "></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>DEPARTMENT CLOSING/WIP </span>
                        </div>
                            ...
                            <div id="groupContenInner">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:CheckBox ID="cbAuthStatus" runat="server" Text="Authorized" Checked="True" Visible="false" />
                                                        </td>
                                                      <%--  <td align="right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:CheckBox runat="server" ID="cbIsTarget" Text="Is Target" Checked="True" Visible="false" />
                                                        </td>
                                                        <td></td>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold">CLOSING DETAILS</span>
                                    </div>
                                            ...
                                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                 ...
                                                 <%--    <td width="80px" class="headerColLeft">Item Type
                                                    ...
                                                    <td width="10px" class="headerColLeft"></td>
                                                    <td width="80px" class="headerColLeft">Cons. Qty
                                                    </td>
                                                  <%--  <td width="80px" class="headerColLeft">Reject Qty
                                                    </td>--%>
                                                    <td width="80px" class="headerColLeft">Closing Qty
                                                    </td>
                                                  ...
                                                  <%--  <td width="60px" class="headerColLeft">Adj. Type
                                                    ...
                                                    <td width="100px" class="headerColLeft">Stock
                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                  ...
                                                                                  <%--   <td>
                                                                                        ...
                                                                                        <asp:DropDownList ID="ddlItemType" runat="server" CssClass="dropDownList" Width="80" >
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect txtQty txtAddQty" Width="80" Text='<%# Bind("CONSUMPTION_QTY") %>' ></asp:TextBox>

                                                                                    </td>

                                                                                <%--    <td>
                                                                                        <asp:TextBox ID="txtDeductQty" runat="server" CssClass="textBox textAutoSelect txtQty txtDeductQty" onchange="calcConsumptionQty(this)" Width="80" Text='<%# Bind("REJECT_QTY") %>' ></asp:TextBox>

                                                                                    </td>--%>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txt_Target_qty" runat="server" CssClass="textBox  txtQty" Width="80" onchange="calcConsumptionQty(this)" onBlur="AddNewRow(this)" Text='<%# Bind("TARGET_QTY") %>'></asp:TextBox>
...
<%--                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                      <%--  <asp:Label runat="server" Text='<%# Bind("CLOSING_QTY") %>' ID="lblCurrentStock" Width="100px" CssClass="textBox"></asp:Label>--%>
                                                                                          <asp:TextBox ID="txtCurrentStock" runat="server" CssClass="textBox textAutoSelect" Width="100" Text='<%# Bind("CLOSING_QTY") %>' ></asp:TextBox>
                                        ...
                                        <div id="divGridControls2" style="width: 100%; height: 25px; border-top: solid 1px #C0C0C0;">
                                            <table style="width: auto; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <asp:Label ID="lbltotalSalesAmount" runat="server" Text="Total Consumption Qnty:" Font-Bold="True" Visible="false"></asp:Label>
                                                    </td>
                                                    <td align="right">
                                                    ...
                                                    <td align="right">
                                                        <asp:Label ID="Label3" runat="server" Text="Total Reject Qnty:" Font-Bold="True" Visible="false"></asp:Label>
                                                    </td>
                                                    <td align="right">
