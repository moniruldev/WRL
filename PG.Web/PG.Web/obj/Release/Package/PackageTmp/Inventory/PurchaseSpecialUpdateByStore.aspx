<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="PurchaseSpecialUpdateByStore.aspx.cs" Inherits="PG.Web.Inventory.PurchaseSpecialUpdateByStore" %>
                                                ...
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    <tr>
                                                        ...
                                                        <td>
                                                         ...
                                                         <td align="right">
                                                          <asp:Label ID="Label1" runat="server" Text="Supplier:"></asp:Label><span style="color:red">*</span>
                                    ...
                                    <table style="display: none;" border="0" cellspacing="0" cellpadding="1">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:HiddenField ID="hdnAuthStatus" runat="server" Value="" />
                                            </td>
                                        </tr>
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                        ...
                                                        <Columns>
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItemRateView" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("UNIT_RATE") %>' Style="text-align:right" onkeypress="return onlyNos(event,this);" OnTextChanged="txtItemRate_TextChanged" AutoPostBack="true" ></asp:TextBox>
                                                                                    </td>

                                                                                     <td style="display:none">
                                                                                        <asp:TextBox ID="txtItemRate" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("UNIT_RATE") %>' Style="text-align:right" Enabled="false"></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtTotalAmt" runat="server" CssClass="textBox textAutoSelect" Width="68" Text='<%# Bind("total_amount") %>' Style="text-align:right" Enabled="false"></asp:TextBox>
                                                                                    </td>
                                                                                     <td>
                                                            ...
                                                            <asp:TemplateField HeaderText="Delete" ShowHeader="false">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="btnDeleteRow" CssClass="buttonDeleteIcon" Height="16px" Width="16px" Visible="false"
