<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVOutStationTransferRotary.aspx.cs" Inherits="PG.Web.Inventory.INVOutStationTransferRotary" %>
            ...
            $(gridSelector).find('input[id$="txtITEM_NAME"]').each(function (index, elem) {
                ...
                $(elem).combogrid({
                    ...
                    search: function (event, ui) {
                       ...
                       // var vbatterytypeid = $('#' + ddlBatteryType).val();
                        ...
                        //    vchk = "N";
                        //}
                        //var vchk = $('#' + chkIsRepair).val();
                        //var vgroupid = $('#' + hdngroupId).val();
                        var newServiceURL = serviceURL + "&groupid=" + vgroupid //+ "&batterytypeid=" + vbatterytypeid + "&chkisrepair=" + vchk
                        //var newServiceURL = serviceURL + "&companycode=" + companyCode + "&branchcode=" + branchCode + "&deptcode=" + deptCode
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Transfer to Rotary"></asp:Label>
            </div>
            <div id="dvMsg" runat="server" class="dvMessage" style="width: 100%; min-height: 30px; height: auto; text-align: center;">
                <asp:Label ID="lblMessage" runat="server" Font-Size="Large" Width="100%" Height="30px"></asp:Label>
            </div>
        </div>
                            ...
                            <div id="groupContenInner">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblInvoiceNO" runat="server" Text="Transfer No:"></asp:Label>
                                                        </td>

                                                        <td>

                                                            <asp:TextBox ID="txtInvoiceNo" runat="server" CssClass="colourdisabletextBox" Enabled="false"></asp:TextBox>
                                                            
                                                        </td>
                                                        <td></td>
                                                        <td align="right">
                                                            <asp:Label ID="lblInvoiceDate" runat="server" Text="Trans Date:"></asp:Label>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblInvoiceTime" runat="server" Text="Trans Time:"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtInvoiceTime" runat="server" CssClass="textBox" Width="100px"></asp:TextBox>&nbsp;DC&nbsp;
                                                             <asp:Label ID="lblDCNO" runat="server" Width="120px"></asp:Label>&nbsp;GP
                                                             <asp:Label ID="lblGPNO" runat="server" Width="120px"></asp:Label>
                                                        </td>
                                                        <td></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="auto-style2">
                                                            ...
                                                            <asp:TextBox ID="txtCustomerName" runat="server" CssClass="textBox" Enabled="true" Width="150px"></asp:TextBox>
                                                        </td>
                                                        <td class="auto-style2">
                                                        ...
                                                        <td colspan="8" class="auto-style2">
                                                            ...
                                                            <asp:TextBox ID="txtCustomerAddress" runat="server" CssClass="textBox" Enabled="false" Width="500px"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblTRANSPORTDTL" runat="server" Text="Transport Details:"></asp:Label><span style="color:red;">*</span>
                                                        </td>
                                                        <td colspan="9">
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblBatteryTypeID" runat="server" Text="Battery Type:" Visible="false"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlBatteryType" runat="server" CssClass="dropDownList" Visible="false" ></asp:DropDownList>

                                                        </td>

                                                        <td align="right">
                                                            <asp:Label ID="lblIsRepair" runat="server" Text="IS Repair:" Visible="false"></asp:Label>
                                                        </td>
                                                        <td  colspan="4" >
                                                            <asp:CheckBox ID="chkIsRepair" runat="server" Visible="false"  />
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold">Rotary Transfer Details: </span>
                                    </div>
                                    <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        ...
                                        <div id="dvGrid" style="width: 87%; height: 200px; overflow: auto;" class="dvGrid">
                                                                        ...
                                                                        <table border="0" cellpadding="1" cellspacing="1">
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtClsQty" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("CLOSING_QTY") %>' onkeypress="return isNumberKey(event,this);"></asp:TextBox>

                                                                                    </td>
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("ITEM_QNTY") %>' onkeypress="return isNumberKey(event,this);"  OnTextChanged="txtItemQty_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtITEMRate" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("ITEM_RATE") %>' Style="" Visible="true" OnTextChanged="txtItemRate_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="lblTotalAmt" runat="server" CssClass="textBox textAutoSelect" Width="68" Text='<%# Bind("total_amount") %>'  Style="" Visible="true"></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="150" Text='<%# Bind("INV_DET_REMARKS") %>' Style=""></asp:TextBox>
                                                                                    </td>
                                        ...
                                        <div id="divGridControls2" style="width: 100%; height: 25px; border-top: solid 1px #C0C0C0;">
                                            <table style="width: auto; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right">
                                                        <asp:Label ID="lbltotalQnty" runat="server" Text="Total Qnty:" Font-Bold="True" Visible="false"></asp:Label>
                                                    </td>
                                                    <td align="right">
        ...
        <div id="dvContentFooter" class="dvContentFooter">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnSave" runat="server" Text="Generate DC,GP" CssClass="buttonSave checkRequired" AccessKey="s" OnClick="btnSave_Click" OnClientClick="if ( ! UserDeleteConfirmation()) return false;" Width="100px"  />
                        <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="buttonEdit" />
                    </td>

                    <td>
                        <asp:Button ID="btnDcPrint" runat="server" Text="Print DC" CssClass="buttoncommon" Enabled="false" OnClick="btnDcPrint_Click" />
                    </td>

                    <td>
                        <asp:Button ID="btnGpPrint" runat="server" Text="Print GP" CssClass="buttoncommon" Enabled="false" OnClick="btnGpPrint_Click" />
                    </td>
