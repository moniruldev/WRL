<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="INVInvoiceMst.aspx.cs" Inherits="PG.Web.Inventory.INVInvoiceMst" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Delivery Order Entry (DO)"></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Delivery Order Entry (DO)</span>
                        </div>
                            ...
                            <div id="groupContenInner">
                                            ...
                                            <td style="width: 100%">
                                                <table style="" border="0" cellspacing="2" cellpadding="1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblInvoiceNO" runat="server" Text="DO No:"></asp:Label>
                                                        </td>
                                                        ...
                                                        <td></td>
                                                        <td align="right">
                                                            <asp:Label ID="lblInvoiceDate" runat="server" Text="DO Date:"></asp:Label>

                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtInvoiceDate" runat="server" CssClass="textBox textDate dateParse" Style="text-align: left;" Width="100px"></asp:TextBox>
                                                            <asp:RegularExpressionValidator runat="server" ControlToValidate="txtInvoiceDate" ValidationExpression="(((0|1)[0-9]|2[0-9]|3[0-1])\/(0[1-9]|1[0-2])\/((19|20)\d\d))$" ErrorMessage="Invalid date format." ValidationGroup="Group1" ForeColor="Red" />
                                                        </td>
                                                       <%-- onblur="checkDt(this)"--%>
                                                        <td align="right">
                                                            <asp:Label ID="lblInvoiceTime" runat="server" Text="DO Time:"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:TextBox ID="txtInvoiceTime" runat="server" CssClass="textBox" Width="100px"></asp:TextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="8" class="auto-style2">
                                                            ...
                                                            <asp:TextBox ID="txtCustomerAddress" runat="server" CssClass="textBox" Enabled="false" Width="520px"></asp:TextBox>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td align="right" class="auto-style2">
                                                            <asp:Label ID="lblCustomerBalance" runat="server" Text="Balance:"></asp:Label>
                                                        </td>

                                                        <td class="auto-style2" colspan="10">
                                                             <asp:Label ID="lblCustomerBalanceValue" runat="server"></asp:Label>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input id="btnCompanyID" type="button" value="" runat="server" class="buttonDropdown"
                                                                tabindex="-1" visible="true" />
                                                        </td>
                                                        <td colspan="2">
                                                            <%--<asp:TextBox ID="txtCompanyID" runat="server" CssClass="textBox"  Width="150px" Visible="true"></asp:TextBox>--%>
                                                             <asp:HiddenField ID="hdnCompanyIDtxt" runat="server" Value="0"  />
                                                        </td>
                                                        <td align="right"></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right">
                                                            <asp:Label ID="lblTRANSPORTDTL" runat="server" Text="Transport Details:" Visible="false"></asp:Label>
                                                        </td>
                                                        <td colspan="9">
                                                            <asp:TextBox ID="txtTRANSPORTDTL" runat="server" CssClass="textBox" Height="20px" Width="700px" Visible="false"></asp:TextBox>
                                ...
                                <div id="groupDataDetails" style="width: 100%; height: auto;">
                                    ...
                                    <div id="groupDataHeaderCredit" runat="server" class="" style="width: 100%; text-align: center;">
                                        <span style="font-weight: bold">Delivery Order Details: </span>
                                    </div>
                                    <div id="dvGridContainer2" runat="server" class="" style="width: auto; height: auto; text-align: left">
                                        <div id="dvGridHeader2" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                                            <table style="height: 95%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                                ...
                                                <tr class="headerRow">
                                                    <td width="14px" class="headerColLeft">SL#
                                                    </td>
                                                   ...
                                                   <td width="10px" class="headerColLeft">
                                                    ...
                                                    <td width="60px" class="headerColLeft">Cls Qty
                                                    </td>
                                                    ...
                                                    <td width="72px" class="headerColCenter">Total Amt
                                                    </td>
                                                    <td width="55px" class="headerColCenter">Cash Sale
                                                    </td>
                                                    <td width="170px" class="headerColCenter">Remarks
                                                    </td>
                                          ...
                                          <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                        <div id="dvGrid" style="width: 88%; height: 200px; overflow: auto;" class="dvGrid">
                                            <%--<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>--%>
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                                        CellPadding="1" CellSpacing="1" ForeColor="#333333" GridLines="Both" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting" OnRowCreated="GridView1_RowCreated" OnRowCommand="GridView1_RowCommand" DataKeyNames="ITEM_ID"
                                                        EnableModelValidation="True" ClientIDMode="AutoID">
                                                        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                                                        <Columns>
                                                            <asp:TemplateField HeaderText="SL#">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblSLNo" runat="server" Text='<%# Bind("INV_DET_SLNO") %>' Style="text-align: center;"
                                                                        Width="22px">  
                                                                    </asp:Label>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                     ...
                                                                                     <td>
                                                                                        <asp:TextBox ID="txtClsQty" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("CLOSING_QTY") %>' onkeypress="return onlyNos(event,this);"></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtItem_qty"  Style="text-align: right;" runat="server" TabIndex="1" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("ITEM_QNTY")%>'  OnTextChanged="txtItemQty_TextChanged" AutoPostBack="true" onkeypress="return onlyNos(event,this);" ReadOnly="false"></asp:TextBox>

                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtUOM_NAME" runat="server" TabIndex="1" CssClass="textBox textAutoSelect" Width="48" Text='<%# Bind("UOM_NAME") %>' Style=""></asp:TextBox>
                                                                                        <asp:HiddenField ID="hdnUomID" runat="server" Value='<%# Bind("UOM_ID") %>' />
                                                                                    </td>
                                                                                    
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtITEMRate" Style="text-align: right;" runat="server" CssClass="textBox textAutoSelect" Width="58" Text='<%# Bind("ITEM_RATE") %>'  OnTextChanged="txtItemRate_TextChanged"  AutoPostBack="true"  Visible="true"></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="lblTotalAmt" Style="text-align: right;" runat="server" CssClass="textBox textAutoSelect" Width="68" Text='<%# Bind("total_amount") %>'  Visible="true" ></asp:TextBox>
                                                                                    </td>
                                                                                      
                                                                                       <td>
                                                                                        <asp:TextBox ID="txtOutSaleCash" runat="server" TabIndex="1" CssClass="textBox textAutoSelect" Width="48" Text='<%# Bind("IS_OUTSALE_CASH") %>' ></asp:TextBox>
                                                                                    </td>

                                                                                    <td>
                                                                                        <asp:TextBox ID="txtRemarks" runat="server" CssClass="textBox textAutoSelect" Width="170" Text='<%# Bind("INV_DET_REMARKS") %>' Style=""></asp:TextBox>
                                                                                        <asp:HiddenField ID="hdnOutSaleCash" runat="server" Value='<%# Bind("IS_OUTSALE_CASH") %>' ></asp:HiddenField>
                                                                                        <asp:HiddenField ID="hdnIsDeleted" runat="server" Value="N" />
                                                                                    </td>
                                            ...
                                            <table style="width: auto; height: 100%; text-align: center;" cellspacing="1" cellpadding="1"
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" style="padding-right:5px">   
                                                        <asp:Label ID="lbltotalSalesAmount" runat="server" Text="Total Amount:" Font-Bold="True" Visible="true"></asp:Label>
                                                    </td>
                                                    <td align="right">
                                                        <asp:TextBox ID="txtTotSalesAmt" runat="server" CssClass="textBox" Style="text-align: right;" ReadOnly="true"
    ...
    <script language="javascript" type="text/javascript">
      ...
      <%--  var txtCustomerID = '<%=txtCustomerID.ClientID%>';--%>
        ...
        var lblCustomerBalanceValue = '<%=lblCustomerBalanceValue.ClientID%>';
        ...
        $(document).ready(function () {
            ...
            $('#' + txtInvoiceDate).datepicker("option", "onSelect", function (selectedDate) {
                var invoiceDate = GetJavaScriptDateForChrome($('#' + txtInvoiceDate).val());
                invoiceDate = new Date(invoiceDate);   
                var invoiceMonth = invoiceDate.getMonth() + 1;
                var currentDate = new Date();
                var currentMonth = currentDate.getMonth() + 1;

                if(parseInt(invoiceMonth)!=parseInt(currentMonth))
                {
                    alert('Please enter current month date. Current month is ' + fullMonthNames[currentMonth - 1]);
                    ...
                    var currentFullDate = day + '-' + shortMonthNames[currentDate.getMonth()] + '-' + currentDate.getFullYear();

                    $('#' + txtInvoiceDate).val(currentFullDate);
                    return false;
                }
            ...
            $('#' + txtCustomerName).blur(function () {
                ...
                if (customerID != '0') {
                    ...
                    arrayCustomer.push($('#' + hdnCustomerID).val());
                    arrayCustomer.push($('#' + txtInvoiceDate).val());


                    $.ajax({
                        url: 'INVInvoiceMst.aspx/GetCustomerBalance',
                        type: 'POST',
                        data: JSON.stringify({ 'arrayCustomer': arrayCustomer }),
                        contentType: 'application/json; charset=UTF-8',
                        dataType: 'json',
                        success: function (result) {
                            var customerBalance = result.d;
                            $('#' + lblCustomerBalanceValue).text(customerBalance);
                        },
                        error: function () {
                        }
            ...
            //$(gridSelector).find('input[id$="txtITEMRate"]').each(function (index, elem) {
            //    var elemRow = $(elem).closest('tr.gridRow');

            //    $(elem).closest('tr').find('input[id$="txtITEMRate"]').change(function (e) {

            //        var ItemQty = $(elem).closest('tr').find('input[id$="txtItem_qty"]').val();
            //        var ItemRate = $(elem).closest('tr').find('input[id$="txtITEMRate"]').val();
            //        var TotalAmount = $(elem).closest('tr').find('input[id$="lblTotalAmt"]');
            //        alert(ItemQty);
            //        alert(ItemRate);
            //        TotalAmount.val(parseFloat(ItemQty) * parseFloat(ItemRate));
            ...
            //$(gridSelector).find('input[id$="txtItem_qty"]').each(function (index, elem) {
            //    var elemRow = $(elem).closest('tr.gridRow');

            //    $(elem).closest('tr').find('input[id$="txtItem_qty"]').change(function (e) {
        ...
        var fullMonthNames = ["January", "February", "March", "April", "May", "Jun", "July", "August", "September", "October", "November", "December"];
        ...
        function ClearItemData(txtItemID) {
            ...
            //$(detRow).find('input[id$="txtClsQty"]').val('0');
        ...
        function SetItemData(txtItemCodeID, data) {
            ...
            $(detRow).find('input[id$="txtClsQty"]').val(data.closing_qty);

            var isOutSaleCash = '';   
            if (data.is_outsale_cash == 'Y')
                isOutSaleCash = 'Yes';
            if (data.is_outsale_cash == 'N')
                isOutSaleCash = 'No';

            $(detRow).find('input[id$="txtOutSaleCash"]').val(isOutSaleCash); 
            $(detRow).find('input[id$="hdnOutSaleCash"]').val(data.is_outsale_cash);     

            var arrayItemID = new Array();
            arrayItemID.push(data.itemid);

            $.ajax({
                url: 'INVInvoiceMst.aspx/IsPriceViewPermissible',
                type: 'POST',
                ...
                success: function (result) {
                    ...
                    if (isPermissible == 1) {
                        $(detRow).find('input[id$="txtITEMRate"]').prop('readonly', false);
                        $(detRow).find('input[id$="txtITEMRate"]').prop('disabled', false);
                    }
                    else {
                        $(detRow).find('input[id$="txtITEMRate"]').prop('readonly', true);
                        $(detRow).find('input[id$="txtITEMRate"]').prop('disabled', true);
                    }

                    $(detRow).find('input[id$="txtITEMRate"]').val("0");
        ...
        function GetJavaScriptDate(value) {
            ...
            return dt.getDate() + "-" + monthNames[intMonth] + "-" + dt.getFullYear().toString().substring(2, 4);
        }

        function GetJavaScriptDateForChrome(value) {
            return value.substring(7, 11) + "-" + value.substring(3, 6) + "-" + value.substring(0, 2);
        }
