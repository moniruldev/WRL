<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Item_Generation_List.aspx.cs" Inherits="PG.Web.Inventory.Item_Generation_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/Item_Generation_Entry.aspx?id=" + key;
            ...
            if (IForm.PageMode == Enums.PageMode.InTab) {
                ...
                tdata.id = 0;
                tdata.name = "Item Generation";
                //tdata.label = "User: " + userid;
                tdata.label = "Item Generation";
                tdata.type = 0;
                tdata.url = url;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item Generation List"></asp:Label>
            </div>
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;" class="defFont"
                                ...
                                <tr>
                                  ...
                                  <td width="190px" align="center">Description</td>
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                ...
                                DataKeyNames="ITEM_GENERATION_ID" OnRowDataBound="GridView1_RowDataBound"
                                ...
                                <Columns>
                                  ...
                                  <%--  <asp:BoundField DataField="COLOR_CODE" HeaderText="Code" ItemStyle-Width="80px" />--%>
                                    ...
                                    <asp:BoundField DataField="GENERATION_NAME" HeaderText="Name">

                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle Width="200px" HorizontalAlign="Left" />
                                    </asp:BoundField>
                                  <asp:BoundField DataField="GENERATION_DESC" HeaderText="Description" ItemStyle-Width="200px" />
