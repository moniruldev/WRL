<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="LP_Indent_Checked.aspx.cs" Inherits="PG.Web.Inventory.LP_Indent_Checked" %>
                           ...
                           <asp:Label ID="lblComments" style=" padding:4px 4px; margin:0px 2px 0 -12px;  border-radius:4px; font-weight:bold; float:left;  color:red;background-color:#0094ff;" Text="0" runat="server"></asp:Label>
                                  ...
                                  <%--   <asp:TemplateField HeaderText="Action">
                                    ...
                                    <asp:LinkButton ID="btnNegotiate" runat="server"  CssClass="buttonAttach" CommandName="negotiate"  CommandArgument='<%# Bind("RESIG_APP_NO") %>' ><i class="glyphicon glyphicon-arrow-left" style="padding-right:4px;color:red;font-size:14px;"></i>Negotiate</asp:LinkButton>
                                      ...
                                      <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                    <asp:LinkButton ID="btnforward" runat="server"  CssClass="buttonAttach" CommandName="forward"   style="text-align:center;border-radius:2px;"  CommandArgument='<%# Bind("INDT_NO") %>' ><i class="glyphicon glyphicon-arrow-right" style="padding-right:4px;color:green;font-size:14px;"></i> Forward</asp:LinkButton>
                                    </ItemTemplate>
