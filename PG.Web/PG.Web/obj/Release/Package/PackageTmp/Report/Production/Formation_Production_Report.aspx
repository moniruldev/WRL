<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Formation_Production_Report.aspx.cs" Inherits="PG.Web.Report.Production.Formation_Production_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Formation Production Report"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControls" style="height: auto; width: 100%">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="height: auto; width: 50%">
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Formation Production Report</span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                <table style="text-align: left;" border="0" cellspacing="4" width="100%" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlFromDepartment" runat="server" Width="200" CssClass="dropDownList enableIsDirty" ViewStateMode="Enabled"></asp:DropDownList>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="right">
                                            <asp:Label ID="Label5" runat="server" Text="Formed/Unformed/Reject Type :"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlFormedUnformedType" runat="server" Width="200" CssClass="dropDownList enableIsDirty">
                                                <%--<asp:ListItem Value="F">Formed</asp:ListItem>
                                                <asp:ListItem Value="U">Unformed</asp:ListItem>
                                                <asp:ListItem Value="R">Rejected</asp:ListItem>--%>
                                                <asp:ListItem Selected="True" Value="Production_Summary">Production Summary Report</asp:ListItem>
                                                 <asp:ListItem Value="Loading_Summary">Loading Details Report</asp:ListItem>
                                                <%--<asp:ListItem Value="Unloading_Summary">Unloading Details Report</asp:ListItem>--%>
                                            </asp:DropDownList>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
                                    ...
                                    <tr style="display:none">
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtGroupName" runat="server" Width="180" CssClass="textBox required" Enabled="true"></asp:TextBox><input id="btnGroupID" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtItemName" Width="180px" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox><input id="btnItemLoad" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
