<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Inter_Dept_IGR_Report.aspx.cs" Inherits="PG.Web.Report.INV.Inter_Dept_IGR_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Inter Department IGR Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Inter Department IGR Report</span>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="right">
                                            <asp:Label ID="Label6" runat="server" Text="ITC/IRR Status"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="left">
                                            <asp:Label ID="lblDeptName" runat="server" Text="IGR From"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlFromDepartment" runat="server" Width="200" CssClass="dropDownList enableIsDirty"></asp:DropDownList>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlToDepartment" runat="server" Width="200" CssClass="dropDownList enableIsDirty"></asp:DropDownList>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="Label8" runat="server" Text="Requisition No"></asp:Label>
                                        </td>
                                        <td style="" align="left">

                                            <asp:TextBox ID="txtRequisitionNo" runat="server" Width="200px" CssClass="textBox fldRequired enableIsDirty"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="right"></td>
                                        <td>
                                            <asp:Button ID="buttonIRRPreview" runat="server" CssClass="buttoncommon buttonPrint"
