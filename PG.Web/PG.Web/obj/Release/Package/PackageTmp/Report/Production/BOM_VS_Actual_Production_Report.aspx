<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="BOM_VS_Actual_Production_Report.aspx.cs" Inherits="PG.Web.Report.INV.BOM_VS_Actual_Production_Report" %>
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" style="height: auto; width: 100%;">
                                        <tr>
                                            <td style="border-bottom: 1px solid grey;">
                                                <asp:Label ID="lblReportName" runat="server" Text="BOM VS Actual Production Report" Font-Bold="True"
                                    ...
                                    <table id="tblParam" cellspacing="4" cellpadding="2" border="0" class="tblParam">
                                        ...
                                        <tr class="rowParam">
                                            <td style="" align="right">
                                                <asp:Label ID="Label4" runat="server" Text="Report Type:" Visible="True"></asp:Label>
                                             </td>
                                            <td>
                                         ...
                                         <tr class="rowParam">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlDepartment" runat="server" Width="180px" CssClass="dropDownList required" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged" AutoPostBack="true">
                                                </asp:DropDownList>
                                             </td>
                                            <td>
                                            </td>
                                        ...
                                        <tr class="rowParam">
                                         ...
                                         <tr class="rowParam">
                                            <td style="" align="right">
                                                <asp:Label ID="lblAuthStatus" runat="server" Text="Status:" Visible="True"></asp:Label>
                                            </td>
                                            <td>
                                              <asp:DropDownList ID="ddlAuthoStatus" runat="server" CssClass="dropDownList">
                                                  <asp:ListItem  Text="With UnAuthorized" Value="N"></asp:ListItem>
                                                   <asp:ListItem Selected="True" Text="Authorized" Value="Y"></asp:ListItem>
                                              </asp:DropDownList>
