<%@ Page Title="" Language="C#" EnableViewState="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Production_AssemblyDataExport.aspx.cs" Inherits="PG.Web.Report.Production.Production_AssemblyDataExport" %>
       ...
       <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
         ...
         <asp:HiddenField ID="hdnCompanyID" runat="server" Value="0" />
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Assembly Production Status"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
                    ...
                    <tr>
                     ...
                     <tr>
                                    <td>
                                     ...
                                     <td>
                                         <asp:CheckBox ID="chkISPACKING" runat="server" Text="Packing" />
                                     </td>
                                </tr>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Line Name" FieldName="MACHINE_NAME" VisibleIndex="14"  >
                     <CellStyle Wrap="False"></CellStyle>
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn Caption="BAR_TYPE_NAME" FieldName="BAR_TYPE_NAME" VisibleIndex="15" >
                     <CellStyle Wrap="False"></CellStyle>
                </dx:GridViewDataTextColumn>
