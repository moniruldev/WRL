<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Plastic_Monthly_Inventory_Report.aspx.cs" Inherits="PG.Web.Report.Production.Plastic_Monthly_Inventory_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Plastic Production Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;" class="dvHeader_Prod">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Plastic Production Report</span>
                                        </td>
                                    </tr>
                                </table>
