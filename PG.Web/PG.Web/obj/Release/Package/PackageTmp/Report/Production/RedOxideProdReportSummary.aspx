<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="RedOxideProdReportSummary.aspx.cs" Inherits="PG.Web.Report.Production.RedOxideProdReportSummary" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Gray Oxide Production Summary Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Gray Oxide Production Summary Report</span>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="right">
                                            <asp:Label ID="Label5" runat="server" Text="Formed/Unformed/Reject Type :" Visible="false"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlFormedUnformedType" runat="server" Width="200" CssClass="dropDownList enableIsDirty" Visible="false">
