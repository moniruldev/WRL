<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="VRLA_AssemblyProductionReport.aspx.cs" Inherits="PG.Web.Report.Production.VRLA_AssemblyProductionReport" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="VRLA Assembly Production Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>VRLA Assembly Production Report</span>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <table>
                                                <tr>
                                                <td>  <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox required" Enabled="true" Width="195"></asp:TextBox></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <table>
                                               <tr>
                                                   <td><asp:TextBox ID="txtItemName" Width="190px" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox></td>
