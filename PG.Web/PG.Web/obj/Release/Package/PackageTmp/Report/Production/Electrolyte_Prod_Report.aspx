<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Electrolyte_Prod_Report.aspx.cs" Inherits="PG.Web.Report.Production.Electrolyte_Prod_Report" %>
        ...
        function bindItemList() {
            ...
            $(groupIDElem).combogrid({
                ...
                search: function (event, ui) {
                    ...
                    //    }
                    //} else {
                    //    $('#' + hdnGroupID).val('0');+ "&groupid=" + vgroupid
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Electrolyte Production Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Electrolyte Production Report</span>
                                        </td>
                                    </tr>
                                </table>
