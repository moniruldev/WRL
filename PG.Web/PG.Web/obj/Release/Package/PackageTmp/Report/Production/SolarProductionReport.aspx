<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="SolarProductionReport.aspx.cs" Inherits="PG.Web.Report.Production.SolarProductionReport" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Solar Production Report"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControls" style="height: auto; width: 100%">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="height: auto; width: 50%">
                    <div id="groupBox" style="height: auto; width: 100%">
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Solar Production Report</span>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <div id="groupContent" class="groupContent" style="width: 60%; height: auto; overflow: auto;">
                                ...
                                <table style="text-align: left; width: 100%;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width : 350px;" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="200" CssClass="dropDownList enableIsDirty">                                                             
                                                <asp:ListItem Value="PD">Production Details Report</asp:ListItem>  
                                                <asp:ListItem Value="PS">Production Stock Report</asp:ListItem>    
                                                <asp:ListItem Value="RS">Raw Material Summary Report</asp:ListItem>    
                                                  <asp:ListItem Value="LGR">Item Ledger</asp:ListItem>                                        
                                            </asp:DropDownList>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlFromDepartment" Enabled="false" runat="server" Width="200" CssClass="dropDownList enableIsDirty"></asp:DropDownList>
                                        </td>
                                    ...
                                    <tr style="display: none">
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlShift" runat="server" Width="200" CssClass="dropDownList enableIsDirty"></asp:DropDownList>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox required" Enabled="true" Width="195"></asp:TextBox><input id="btnGroupID" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
