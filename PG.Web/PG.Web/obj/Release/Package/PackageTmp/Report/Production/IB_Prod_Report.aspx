<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="IB_Prod_Report.aspx.cs" Inherits="PG.Web.Report.Production.IB_Prod_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IB Production Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>IB Production Report</span>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="200" CssClass="dropDownList enableIsDirty">
                                                <asp:ListItem Value="RM">Raw Material Stock Report</asp:ListItem>
                                                 <asp:ListItem Value="PD">Finished Items Stock Report</asp:ListItem>
