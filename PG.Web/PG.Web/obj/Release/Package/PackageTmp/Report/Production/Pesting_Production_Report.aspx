<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Pesting_Production_Report.aspx.cs" Inherits="PG.Web.Report.Production.Pesting_Production_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Pasting Production Report"></asp:Label>
            </div>
            <!--Message Div -->
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="height: auto; width: 50%">
                    <div id="groupBox" style="height: auto; width: 100%">
                        <div id="groupHeader" class="groupHeader">
                            <div style="width: 100%; height: 20px;" class="dvHeader_Prod">
                                <table>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <span>Pasting Production Report</span>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table style="text-align: left;" border="0" cellspacing="4" width="100%" cellpadding="2">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="256px" CssClass="dropDownList enableIsDirty">
                                                <asp:ListItem Value="F">Production Report</asp:ListItem>
                                                <asp:ListItem Value="R">Raw Materials Report</asp:ListItem>
                                                <asp:ListItem Value="REJ">Grid Summary Report</asp:ListItem>
                                                <asp:ListItem Value="RCP">Pasting Recipe Summary</asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlFromDepartment" runat="server" Width="256px" CssClass="dropDownList enableIsDirty"></asp:DropDownList>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlShift" runat="server" Width="256px" CssClass="dropDownList enableIsDirty"></asp:DropDownList>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="right"></td>
                                        <td>
                                            <asp:Button ID="btnLoadData" runat="server" CssClass="buttoncommon buttonPrint" Width="120px"
                                                Text="Preview Report" OnClick="btnIRRPreview_Click" />
                                            &nbsp;</td>
                                        <td style="" align="left">&nbsp;</td>
