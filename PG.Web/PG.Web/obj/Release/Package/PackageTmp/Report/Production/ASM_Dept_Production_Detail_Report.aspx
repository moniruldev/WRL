<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ASM_Dept_Production_Detail_Report.aspx.cs" Inherits="PG.Web.Report.Production.ASM_Dept_Production_Detail_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Assembly Production Details Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Assembly Production Details Report</span>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table style="text-align: left;" border="0" cellspacing="4" width="100%" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-color:red;" align="center">
                                            <asp:Label ID="lblAutho" Text="Authorized & Un-Authorized"  runat="server"></asp:Label>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:CheckBox ID="chk_isPacket" runat="server" Text="Is Finished" />
                                        </td>
                                        <td style="" align="left"></td>
