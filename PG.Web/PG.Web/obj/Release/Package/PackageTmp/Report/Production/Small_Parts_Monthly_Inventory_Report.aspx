<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Small_Parts_Monthly_Inventory_Report.aspx.cs" Inherits="PG.Web.Report.Production.Small_Parts_Monthly_Inventory_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Small Parts Inventory Report"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControls" style="height: auto; width: 100%">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="height: auto; width: 60%">
                            ...
                            <div style="width: 100%; height: 20px;" class="dvHeader_Prod">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Small Parts Inventory Report</span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                <table style="text-align: left;" border="0" cellspacing="4" width="100%" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="255px" CssClass="dropDownList enableIsDirty" >
                                                <asp:ListItem Value="MP">Finished Item Stock Report</asp:ListItem>
                                                <asp:ListItem Value="RW">Raw Material Stock Report</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlFromDepartment" runat="server" Width="255px" CssClass="dropDownList enableIsDirty" Enabled="False"></asp:DropDownList>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnLoadData" runat="server" CssClass="buttoncommon buttonPrint"
                                                Text="Load Data" OnClick="btnLoadData_Click" />
                                            &nbsp;</td>
                                        <td style="" align="left">&nbsp;</td>
