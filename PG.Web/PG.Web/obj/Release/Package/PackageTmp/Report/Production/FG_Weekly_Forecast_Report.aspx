<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="FG_Weekly_Forecast_Report.aspx.cs" Inherits="PG.Web.Report.Production.FG_Weekly_Forecast_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="FG Weekly Forecast Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;" class="dvHeader_Prod">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>FG Weekly Forecast Report</span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                <table style="text-align: left;" border="0" cellspacing="4" width="100%" cellpadding="2">
                                     ...
                                     <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="256px" CssClass="dropDownList enableIsDirty">
                                                <asp:ListItem Value="WK">Weekly Forecast Report</asp:ListItem>
                                    ...
                                    <tr style="display: none;">
                                        ...
                                        <td style="" align="right"><asp:HiddenField ID="hdnGroupID" runat="server" /></td>
                                        <td style="" align="left"></td>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr class="rowParam">
                                        <td></td>
                                        <td align="right">
                                            <asp:Label ID="lblFromDate" runat="server" Text=" Month-Year :"></asp:Label>
                                        </td>
                                        <td>
