<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="IB_Process_Type_Wise_Prod_Report.aspx.cs" Inherits="PG.Web.Report.Production.IB_Process_Type_Wise_Prod_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IB Proces Type Wise Production Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>IB Proces Type Wise Production Report</span>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="200" CssClass="dropDownList enableIsDirty">
                                                <asp:ListItem Selected="True" Value="C">Cutting</asp:ListItem>
                                                 <asp:ListItem Value="F">Filling</asp:ListItem>
                                                 <asp:ListItem Value="S">Sulphation</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                       <td  align="center">
                                            <asp:Label ID="lblAutho" Text="Authorized"  runat="server" Visible="false"></asp:Label>
                                        </td>
