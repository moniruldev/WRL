<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="VRLA_ChargingReport.aspx.cs" Inherits="PG.Web.Report.Production.VRLA_ChargingReport" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="VRLA Charging Report"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControls" style="height: auto; width: 100%">
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="height: auto; width: 50%">
                    <div id="groupBox" style="height: auto; width: 100%">
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>VRLA Charging Report</span>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <div id="groupContent" class="groupContent" style="width: 80%; height: auto; overflow: auto;">
                                ...
                                <table style="text-align: left; width: 100%;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width : 350px;" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="200" CssClass="dropDownList enableIsDirty">                                                             
                                                ...
                                                <asp:ListItem Value="PS" Selected="True" >Production Stock Report</asp:ListItem>    
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox required" Enabled="true" Width="195px"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtItemName" Width="190px" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox>
