<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Inter_Dept_IRR_Report.aspx.cs" Inherits="PG.Web.Report.INV.IRRByStorePrintReport" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Inter Department IRR Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Inter Department IRR Report</span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlITCDepartment" runat="server" Width="240" CssClass="dropDownList enableIsDirty"></asp:DropDownList>
                                        </td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="left">
                                            <asp:Label ID="Label1" runat="server" Text="IRR Department"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlIRRDepartment" runat="server" Width="240" CssClass="dropDownList enableIsDirty"></asp:DropDownList>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
