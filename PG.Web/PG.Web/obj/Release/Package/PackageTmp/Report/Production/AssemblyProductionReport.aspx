<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="AssemblyProductionReport.aspx.cs" Inherits="PG.Web.Report.Production.AssemblyProductionReport" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Assembly Production Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Assembly Production Report</span>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="200" CssClass="dropDownList enableIsDirty">
                                             <%--   <asp:ListItem Value="R">Raw Material Details Report</asp:ListItem>--%>
                                                ...
                                                <asp:ListItem Value="PL">Plate Summary Report</asp:ListItem>
