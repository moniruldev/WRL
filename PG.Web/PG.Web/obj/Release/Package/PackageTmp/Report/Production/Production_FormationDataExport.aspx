<%@ Page Title="" Language="C#" EnableViewState="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Production_FormationDataExport.aspx.cs" Inherits="PG.Web.Report.Production.Production_FormationDataExport" %>
       ...
       <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
         ...
         <asp:HiddenField ID="hdnCompanyID" runat="server" Value="0" />
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Formation Production Status"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <TotalSummary>
                 ...
                 <dx:ASPxSummaryItem FieldName="FORMED_QTY" SummaryType="Sum"   DisplayFormat="Total Qty : {0}"  ValueDisplayFormat=" {0}" />
                <dx:ASPxSummaryItem FieldName="UNFORMED_QTY" SummaryType="Sum"   ValueDisplayFormat=" {0}" />
                <dx:ASPxSummaryItem FieldName="REJECT_QTY" SummaryType="Sum"   ValueDisplayFormat=" {0}" />
                <dx:ASPxSummaryItem FieldName="ITEM_QTY" SummaryType="Sum" ValueDisplayFormat=" {0}" />
            </TotalSummary>
            <GroupSummary>
                <dx:ASPxSummaryItem FieldName="ITEM_QTY"  SummaryType="Sum" />
                <dx:ASPxSummaryItem SummaryType="Count"  />

                 <dx:ASPxSummaryItem FieldName="FORMED_QTY" ShowInGroupFooterColumn="Formed Qty" DisplayFormat="Sub Total : {0}" SummaryType="Sum" />
                 <dx:ASPxSummaryItem FieldName="UNFORMED_QTY" ShowInGroupFooterColumn="Unformed Qty" DisplayFormat="{0}" SummaryType="Sum" />
                 <dx:ASPxSummaryItem FieldName="REJECT_QTY" ShowInGroupFooterColumn="Rejected Qty" DisplayFormat="{0}" SummaryType="Sum" />
                <dx:ASPxSummaryItem FieldName="ITEM_QTY" ShowInGroupFooterColumn="Production Qty" DisplayFormat="{0}" SummaryType="Sum" />
            </GroupSummary>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Formed Qty" FieldName="FORMED_QTY" VisibleIndex="11"    >
                      <CellStyle Wrap="False" BackColor="AliceBlue"></CellStyle>
                 </dx:GridViewDataTextColumn>

                <dx:GridViewDataTextColumn Caption="Unformed Qty" FieldName="UNFORMED_QTY" VisibleIndex="11"    >
                      <CellStyle Wrap="False" BackColor="AliceBlue"></CellStyle>
                 </dx:GridViewDataTextColumn>

                <dx:GridViewDataTextColumn Caption="Rejected Qty" FieldName="REJECT_QTY" VisibleIndex="11"    >
                      <CellStyle Wrap="False" BackColor="AliceBlue"></CellStyle>
                 </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn Caption="Circuit Name" FieldName="MACHINE_NAME" VisibleIndex="14"  >
                     <CellStyle Wrap="False"></CellStyle>
                </dx:GridViewDataTextColumn>
                 <dx:GridViewDataTextColumn Caption="Grid BatchNO" FieldName="GRID_BATCH" VisibleIndex="8" Width="100px" /> 
                
                 <dx:GridViewDataTextColumn Caption="Pasting BatchNO" FieldName="PASTING_BATCH" VisibleIndex="8" Width="100px" /> 
                 <dx:GridViewDataTextColumn Caption="Start Time" FieldName="FORMATION_STARTTIME" VisibleIndex="8" Width="100px" /> 
                <dx:GridViewDataDateColumn Caption="Formation off" FieldName="FORMATION_OFFDATE"   VisibleIndex="15" >
                     <CellStyle Wrap="False"></CellStyle>
                    <PropertiesDateEdit DisplayFormatString="dd-MMM-yyyy" ></PropertiesDateEdit>
                </dx:GridViewDataDateColumn>
                   <dx:GridViewDataTextColumn Caption="off Time" FieldName="FORMATION_OFFTIME" VisibleIndex="8" Width="100px" /> 
                ...
                <dx:GridViewDataDateColumn Caption="Batch End" FieldName="BATCH_ENDTIME" VisibleIndex="18" > 
                 ...
                 <dx:GridViewDataTextColumn Caption="Ampere" FieldName="AMPERE" VisibleIndex="19" >
                      <CellStyle Wrap="False"></CellStyle>
                 </dx:GridViewDataTextColumn>

                 <dx:GridViewDataTextColumn Caption="Cycle Time" FieldName="CYCLETIME" VisibleIndex="19" >
                      <CellStyle Wrap="False"></CellStyle>
                 </dx:GridViewDataTextColumn>

                  <dx:GridViewDataTextColumn Caption="S. Gravity" FieldName="SULFURIC_GRAVITY" VisibleIndex="19" >
                      <CellStyle Wrap="False"></CellStyle>
                 </dx:GridViewDataTextColumn>

                <dx:GridViewDataTextColumn Caption="Temparature" FieldName="TEMPARATURE" VisibleIndex="19" >
                      <CellStyle Wrap="False"></CellStyle>
                 </dx:GridViewDataTextColumn>
