<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ProductionBatchWiseAgingStockReport.aspx.cs" Inherits="PG.Web.Report.Production.ProductionBatchWiseAgingStockReport" %>
        ...
        function bindItemList() {
            ...
            $(itemIDElem).combogrid({
                ...
                search: function (event, ui) {
                    ...
                    var ddlItemClass = $('[id*=ddlItemClass] option:selected').val();
                    newServiceURL = newServiceURL + "&classid=" + ddlItemClass;
                    $(this).combogrid("option", "url", newServiceURL);
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" style="height: auto; width: 100%;">
                                        <tr>
                                            <td style="border-bottom: 1px solid grey;">
                                                <asp:Label ID="lblReportName" runat="server" Text="Batch Wise Stock Aging Reports" Font-Bold="True"
