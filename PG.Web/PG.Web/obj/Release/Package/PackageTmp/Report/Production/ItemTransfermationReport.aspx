<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ItemTransfermationReport.aspx.cs" Inherits="PG.Web.Report.Production.ItemTransfermationReport" %>
        ...
        function bindItemList() {
            ...
            $(groupIDElem).combogrid({
                ...
                search: function (event, ui) {
                    ...
                    //}
                    var newServiceURL = serviceURL + "&isFinished=&deptid=" + deptid;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Item Transfermation Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Item Transfermation Report</span>
                                        </td>
                                    </tr>
                                </table>
                                 ...
                                 <tr>
                                        ...
                                        <td style="" align="left">
                                             <asp:DropDownList ID="ddlReportType" runat="server" Width="255px" CssClass="dropDownList enableIsDirty">
                                                <asp:ListItem Value="D" Selected="True"> Transferm Report</asp:ListItem>
