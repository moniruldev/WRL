<%@ Page Title="" Language="C#" EnableViewState="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Production_SulphationDataExport.aspx.cs" Inherits="PG.Web.Report.Production.Production_SulphationDataExport" %>
       ...
       <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
         ...
         <asp:HiddenField ID="hdnCompanyID" runat="server" Value="0" />
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Sulphation Production Status"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <tr>
                            <td> </td>
                            <td>
                                <asp:CheckBox ID="chkISSULPHATION" runat="server" Checked="true" Text="Sulphation" BackColor="Red" ForeColor="White" Enabled="False" />
                            </td>
                        <td> &nbsp;</td>
                        <td > &nbsp;</td>
            ...
            <div id="dvControls" style="width: 100%;">
             ...
             <Settings  ShowGroupPanel="True" ShowFilterBar="Visible" ShowFilterRowMenu="True"   ShowGroupedColumns="True"  ShowHeaderFilterButton="True" HorizontalScrollBarMode="Visible" ShowFooter="True" ShowGroupFooter="VisibleAlways" />
            <TotalSummary>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="ForeCast Year" FieldName="FORECUSTYEAR" VisibleIndex="8"  >
                 ...
                 <dx:GridViewDataTextColumn Caption="Filling Batch" FieldName="FILLING_BATCH" VisibleIndex="12" >
                      <CellStyle Wrap="False"></CellStyle>
                 </dx:GridViewDataTextColumn>
                 <dx:GridViewDataDateColumn Caption="Sul Start Time" FieldName="SULPHATION_STARTTIME" VisibleIndex="13"  >
                      <PropertiesDateEdit DisplayFormatString="dd-MMM-yyyy" ></PropertiesDateEdit>
                 </dx:GridViewDataDateColumn>

                <dx:GridViewDataTextColumn Caption="Sul. Off Date" FieldName="SULPHATION_OFFDATE" VisibleIndex="14"  >
                     <CellStyle Wrap="False"></CellStyle>
                </dx:GridViewDataTextColumn>
                
                <dx:GridViewDataTextColumn Caption="Sul. Gravity" FieldName="SULFURIC_GRAVITY" VisibleIndex="12" Width="100px" />
                <%--<dx:GridViewDataTextColumn Caption="Bar Name" FieldName="BAR_NAME" VisibleIndex="8" Width="100px" />--%>
                <%--<dx:GridViewDataTextColumn Caption="BOM NO" FieldName="BOM_NO" VisibleIndex="8" Width="100px" />--%>
                <dx:GridViewDataTextColumn Caption="Sul. OffTime" FieldName="SULPHATION_OFFTIME" VisibleIndex="15" >
                     <CellStyle Wrap="False"></CellStyle>
                </dx:GridViewDataTextColumn>
