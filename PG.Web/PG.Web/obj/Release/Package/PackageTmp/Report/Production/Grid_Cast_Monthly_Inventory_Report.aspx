<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Grid_Cast_Monthly_Inventory_Report.aspx.cs" Inherits="PG.Web.Report.Production.Grid_Cast_Monthly_Inventory_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Casting Production Report"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControls" style="height: auto; width: 60%">
                            ...
                            <div style="width: 100%; height: 20px;" class="dvHeader_Prod">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Casting Production Report</span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                <table style="text-align: left;" border="0"   cellspacing="4" width="100%" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        &nbsp;</td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="235px" CssClass="dropDownList enableIsDirty" >
                                                <asp:ListItem Value="MP">Finished Production Report</asp:ListItem>
                                                <%-- <asp:ListItem Value="RM">Raw Material Report</asp:ListItem>
                                                <asp:ListItem Value="US">Usuable Report</asp:ListItem>
                                                <asp:ListItem Value="LGR">Item Ledger</asp:ListItem>--%>
                                            </asp:DropDownList>
                                        </td>
                                       <td style="background-color:red;" align="center">
                                            <asp:Label ID="lblAutho" Text="Authorized"  runat="server"></asp:Label>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlFromDepartment" runat="server" Width="235px" CssClass="dropDownList enableIsDirty" Enabled="False"></asp:DropDownList>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlShift" runat="server" Width="235px" CssClass="dropDownList enableIsDirty"></asp:DropDownList>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
