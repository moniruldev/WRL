<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Finish_Vs_Used_Raw_Material_Report.aspx.cs" Inherits="PG.Web.Report.INV.Finish_Vs_Used_Raw_Material_Report" %>
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" style="height: auto; width: 100%;">
                                        <tr>
                                            <td style="border-bottom: 1px solid grey;">
                                                <asp:Label ID="lblReportName" runat="server" Text="Finish Product Vs Raw Material Report" Font-Bold="True"
