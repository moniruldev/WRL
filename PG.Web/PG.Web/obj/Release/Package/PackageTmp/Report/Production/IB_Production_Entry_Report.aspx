<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="IB_Production_Entry_Report.aspx.cs" Inherits="PG.Web.Report.Production.IB_Production_Entry_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IB Production Entry Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>IB Production Entry Report</span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                <table style="text-align: left;" border="0" cellspacing="4" width="100%" cellpadding="2">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="Label8" runat="server" Text="Process Type:"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlPROCESSTYPE" runat="server" Width="255px" CssClass="dropDownList enableIsDirty">
                                                 <asp:ListItem Selected="True" Value="">--All--</asp:ListItem>
                                                <asp:ListItem   Value="C">Cutting</asp:ListItem>
                                                 <asp:ListItem Value="F">Filling</asp:ListItem>
                                                 <asp:ListItem Value="S">Sulphation</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                       <td  align="center">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="Label9" runat="server" Text="Authorized Type :"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlAUTH_STATUS" runat="server" Width="255px"  CssClass="dropDownList enableIsDirty rmEnable">
                                                <asp:ListItem Value="" Selected="True">--All--</asp:ListItem>
                                                <asp:ListItem Value="Y">Authorized</asp:ListItem>
                                                <asp:ListItem Value="N">UnAuthorized</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td  align="center">
                                    ...
                                    <tr>
                                       ...
                                       <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="Label7" runat="server" Text="RM Item :"></asp:Label>
                                        </td>
                                        <td style="" align="left">
