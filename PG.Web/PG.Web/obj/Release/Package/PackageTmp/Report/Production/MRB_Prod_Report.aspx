<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="MRB_Prod_Report.aspx.cs" Inherits="PG.Web.Report.Production.MRB_Prod_Report" %>
...
<%--        var ItemGroupListServiceLink = '<%=this.ItemGroupListServiceLink%>';
        ...
        function bindItemList() {
            ...
            serviceURL += "&ispaging=1&deptid=24&for_production=Y";
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="MRB Production Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>MRB Production Report</span>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="255px" CssClass="dropDownList enableIsDirty">
                                                 <asp:ListItem Value="PLD">MRB Plate Details</asp:ListItem>
                                                <asp:ListItem Value="PLSM">MRB Plate Stock</asp:ListItem>
