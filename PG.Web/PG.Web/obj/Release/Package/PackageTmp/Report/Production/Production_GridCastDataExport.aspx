<%@ Page Title="" Language="C#" EnableViewState="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Production_GridCastDataExport.aspx.cs" Inherits="PG.Web.Report.Production.Production_GridCastDataExport" %>
        ...
        <div id="dvContentHeader" class="dvContentHeader">
         ...
         <asp:HiddenField ID="hdnCompanyID" runat="server" Value="0" />
            <div id="dvHeader" class="dvHeader_Prod">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Gridcast Production Status"></asp:Label>
            </div>
            <!--Message Div -->
