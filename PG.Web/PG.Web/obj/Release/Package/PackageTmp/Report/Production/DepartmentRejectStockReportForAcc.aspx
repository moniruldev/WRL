<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="DepartmentRejectStockReportForAcc.aspx.cs" Inherits="PG.Web.Report.INV.DepartmentRejectStockReportForAcc" %>
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" style="height: auto; width: 100%;">
                                        <tr>
                                            <td style="border-bottom: 1px solid grey;">
                                                <asp:Label ID="lblReportName" runat="server" Text="Department Reject Stock Reports" Font-Bold="True"
