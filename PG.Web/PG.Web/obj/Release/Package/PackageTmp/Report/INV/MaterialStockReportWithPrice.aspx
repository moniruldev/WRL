<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="MaterialStockReportWithPrice.aspx.cs" Inherits="PG.Web.Report.INV.MaterialStockReportWithPrice" %>
       ...
       <%-- var ddlLocation = '<%=ddlLocation.ClientID%>';--%>
        ...
        function bindGroupList() {
            var cgColumns = [
                            ...
                            , { 'columnName': 'itemgroupdesc', 'width': '200', 'align': 'left', 'highlight': 4, 'label': 'Name' }
        ...
        function bindItemList() {
            ...
            var cgColumns = [
                { 'columnName': 'itemcode', 'width': '80', 'align': 'left', 'highlight': 4, 'label': 'Code' }
                             ...
                             , { 'columnName': 'itemgroupdesc', 'width': '130', 'align': 'left', 'highlight': 4, 'label': 'Group' }
            ...
            var itemServiceURL = ItemListServiceLink + "?isterm=1&includeempty=0&iscodename=1&codecomptype=" + Enums.DataCompareType.Containts;
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvContentMainInner" class="dvContentMainInner" style="height: 100%;">
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" style="height: auto; width: 100%;">
                                        <tr>
                                            <td style="border-bottom: 1px solid grey;">
                                                <asp:Label ID="lblReportName" runat="server" Text="Material Stock Reports" Font-Bold="True"
                ...
                <div id="groupBox" style="height: auto; width: 100%">
                    <table id="tblMiddle" cellspacing="0" cellpadding="0" style="height: 100%; width: 100%; min-width: 500px;">
                        <tr style="height: 100%">
                            <td></td>
                                                ...
                                                <asp:TreeView ID="tvwReport" runat="server" OnSelectedNodeChanged="tvwReport_SelectedNodeChanged"
                                                    ...
                                                    <Nodes>
                                                        <asp:TreeNode Text="Stock Report" Value="Stock_Reports" Expanded="True" SelectAction="Expand">
                                                            <asp:TreeNode Text="Material Stock Report" Value="1601" Selected="True"></asp:TreeNode>
                                                          ...
                                                          <%--  <asp:TreeNode Text="Stock Price" Value="1602" Selected="false"></asp:TreeNode>--%>
                                                        </asp:TreeNode>
                                                    </Nodes>
                            ...
                            <td valign="top" style="height: 100%;">
                                    ...
                                    <table id="tblParam" cellspacing="4" cellpadding="2" border="0" class="tblParam">
                                        ...
                                        <tr class="rowParam">
                                            ...
                                            <td style="" align="right">
                                                <asp:Label ID="Label10" runat="server" Text="SNS Type:" Visible="false"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlItemSNS" runat="server" CssClass="dropDownList enableIsDirty" Width="180px" Visible="false">
                                        ...
                                        <tr class="rowParam">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlItemType" runat="server" Width="180px" CssClass="dropDownList" Visible="false">
                                        ...
                                        <tr class="rowParam">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlItemClass" runat="server" Width="180px" CssClass="DropDownListWide2" Visible="True">
                                                    <%--<asp:ListItem Selected="True" Text="List" Value="0"> </asp:ListItem>--%>
                                                </asp:DropDownList>
                                        ...
                                        <tr class="rowParam">
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        <td>  <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox></td>
                                        ...
                                        <tr class="rowParam">
                                          ...
                                          <%--   <tr class="rowParam">
                                            <td></td>
                                            <td style="" align="right">
                                                <asp:Label ID="lblCategory" runat="server" Text="Item Category:" Visible="true"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlCategory" runat="server" Width="180px" CssClass="dropDownList DropDownListWide2" Visible="true">
                                                </asp:DropDownList>
                                         ...
                                         <%--    <tr class="rowParam">
                                            <td></td>
                                            <td style="" align="right">
                                                <asp:Label ID="lblsize" runat="server" Text="Item Size:" Visible="true"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlSize" runat="server" Width="180px" CssClass="dropDownList DropDownListWide2" Visible="true">
                                                </asp:DropDownList>
                                          ...
                                          <%--   <tr class="rowParam">
                                            <td></td>
                                            <td style="" align="right">
                                                <asp:Label ID="lblColor" runat="server" Text="Item Color:" Visible="true"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlColor" runat="server" Width="180px" CssClass="dropDownList DropDownListWide2" Visible="true">
                                                </asp:DropDownList>
                              ...
                              <%--               <tr class="rowParam">
                                            <td></td>
                                            <td style="" align="right">
                                                <asp:Label ID="lblBrand" runat="server" Text="Item Brand:" Visible="true"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlBrand" runat="server" Width="180px" CssClass="dropDownList DropDownListWide2" Visible="true">
                                        ...
                                        <tr class="rowParam">
                                            <td></td>
                                            <td style="" align="right">
                                                <asp:Label ID="lblBatteryType" runat="server" Text="Battery Type:" Visible="false"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:DropDownList ID="ddlBatteryType" runat="server" Width="180px" CssClass="dropDownList DropDownListWide2" Visible="false">
                                                    <%--<asp:ListItem Selected="True" Text="List" Value="0"> </asp:ListItem>--%>
                                                </asp:DropDownList>
                                        ...
                                        <tr class="rowParam">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlStore" runat="server" Width="180px" CssClass="dropDownList DropDownListWide2" Visible="true">
                                        ...
                                        <tr class="rowParam">
                                            ...
                                            <td style="" align="right">&nbsp;</td>
                                            <td>
                                                <asp:CheckBox ID="chkWithPrice" runat="server" Text="" Visible="true"/>
                                                <asp:Label ID="lblChkWithPrice" runat="server" Text="With AVG Price" Style="color:green;font-size:12px; font-weight:bold"></asp:Label>
                                                </td>
                                            <td> </td>
                                            <td style="" align="right"></td>
                                            <td></td>
