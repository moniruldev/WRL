<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="IGRITCIRRListGridView.aspx.cs" Inherits="PG.Web.Report.INV.IGRITCIRRListGridView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id = "dvControls" style="height:auto; width:100%">
        <div id="dvControlsInner" class="groupBoxContainer boxShadow">    
         ...
         <br />
        <div id="dvGrid" style="width:90%; height: 300px; overflow: auto;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            ShowHeader="true" Width="90%"  style="margin-bottom: 0px">
           ...
           <%-- <asp:TemplateField HeaderText="SL#">
              <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="IGR Dept." Visible="true">
                  <ItemTemplate>
                 <asp:Label ID="lblREQNO" runat="server" Text='<%# Bind("DEPARTMENT_NAME") %>' Style="text-align: center;" Width="150px"></asp:Label>
                ...
                <asp:TemplateField HeaderText="Req. No." Visible="true" >
                  <ItemTemplate>
                 <asp:Label ID="lblReqtime" runat="server" Text='<%# Bind("REQ_NO") %>' Style="text-align: center;" Width="120px" ></asp:Label>
                                                                   
                  </ItemTemplate>
                   <ItemStyle VerticalAlign="Top" />
                </asp:TemplateField>

                <asp:boundfield datafield="REQ_DATE" DataFormatString="{0:dd/MM/yyyy}" htmlencode="false" HeaderText="Req. Date" />
             
                

                 <asp:TemplateField HeaderText="ITC No" Visible="true">
                  <ItemTemplate>
                 <asp:Label ID="lblIGRStatus" runat="server" Text='<%# Bind("REQ_ISSUE_NO") %>' Style="text-align: center;" Width="120px"></asp:Label>
                                                                   
                  </ItemTemplate>
                   <ItemStyle VerticalAlign="Top" />
                </asp:TemplateField>
                   <asp:boundfield datafield="REQ_ISSUE_DATE" DataFormatString="{0:dd/MM/yyyy}" htmlencode="false" HeaderText="ITC Date" />

                 <asp:TemplateField HeaderText="IRR No" Visible="true">
                  <ItemTemplate>
                 <asp:Label ID="lblITCNO" runat="server" Text='<%# Bind("ISSUE_RECEIVE_NO") %>' Style="text-align: center;" Width="120px"></asp:Label>
                  </ItemTemplate>
                   <ItemStyle VerticalAlign="Top" />
                </asp:TemplateField>
                 <asp:boundfield datafield="ISSUE_RECEIVE_DATE" DataFormatString="{0:dd/MM/yyyy}" htmlencode="false" HeaderText="IRR Date" />
