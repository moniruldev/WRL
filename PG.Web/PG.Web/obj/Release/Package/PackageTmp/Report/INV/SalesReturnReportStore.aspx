<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="SalesReturnReportStore.aspx.cs" Inherits="PG.Web.Report.INV.SalesReturnReportStore" %>
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" style="height: auto; width: 100%;">
                                        <tr>
                                            <td style="border-bottom: 1px solid grey;">
                                                <asp:Label ID="lblReportName" runat="server" Text="Sales Return From Customer Reports" Font-Bold="True"
                                                ...
                                                <asp:TreeView ID="tvwReport" runat="server" OnSelectedNodeChanged="tvwReport_SelectedNodeChanged"
                                                    ...
                                                    <Nodes>
                                                        <asp:TreeNode Text="Sales Return Report" Value="Stock_Reports" Expanded="True" SelectAction="Expand">
                                                            <asp:TreeNode Text="Sales Return Report" Value="1755" Selected="True"></asp:TreeNode>
