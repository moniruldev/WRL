<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="MaterialStockReport.aspx.cs" Inherits="PG.Web.Report.INV.MaterialStockReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Material Stock Report"></asp:Label>
    </div>
    <!--Message Div -->
    ...
    <div id = "dvControls" style="height:auto; width:100%">
        <div id="dvControlsInner" class="groupBoxContainer boxShadow">    
             <div id="groupBox">
              ...
              <table style="text-align:left;" border="0" cellspacing="4" cellpadding="2">
                 ...
                 <td style="" align="left">
                     ...
                     <asp:DropDownList ID="ddlItemType" runat="server" Width="240"  CssClass="dropDownList enableIsDirty">
                 ...
                 <td style="" align="left">
                     ...
                     <asp:DropDownList ID="ddlItemGroup" runat="server" Width="240"  CssClass="dropDownList enableIsDirty" OnSelectedIndexChanged="ddlItemGroup_SelectedIndexChanged"  AutoPostBack="true"> </asp:DropDownList>
                 ...
                 <td style="" align="left">
                     ...
                     <asp:DropDownList ID="ddlItem" runat="server" Width="240"  CssClass="dropDownList enableIsDirty">
                 ...
                 <td style="" align="left">
                     ...
                     <asp:DropDownList ID="ddlDepartment" runat="server" Width="240"  CssClass="dropDownList enableIsDirty">
                 ...
                 <td style="" align="right">
                   <asp:Label id="Label4" runat="server" Text="Store" ></asp:Label>
                 </td>
                 <td style="" align="left">
                      
                     <asp:DropDownList ID="ddlStore" runat="server" Width="240"  CssClass="dropDownList enableIsDirty">
             ...
             <tr class="rowParam">
                 ...
                 <td style="" align="left">
                     <asp:Button ID="buttonPreview" runat="server"  CssClass="buttoncommon buttonPrint" style="padding-left:22px;" Width="100px"
                Text=" Preview" onclick="btnStockPreview_Click" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:Button ID="btnAddNew" runat="server" Text="Reset" CssClass="buttoncommon buttonRefresh" onclick="btnReset_Click" />
                      </td>
