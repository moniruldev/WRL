<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="PurchaseIndentView.aspx.cs" Inherits="PG.Web.Report.INV.PurchaseIndentView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Purchase Indent Report"></asp:Label>
    </div>
    <!--Message Div -->
                      ...
                      <div style="width:100%;height:20px;">
                         <table>
                            <tr>
                             ...
                             <td>
                                <span>Purchase Indent View</span> 
                             </td>
                            </tr>
                         </table>
                      </div>
             ...
             <tr>
                 ...
                 <td style="" align="left">
                     <asp:DropDownList ID="ddlPurchaseIndentCondition" runat="server" Width="240"  CssClass="dropDownList enableIsDirty">
                         <asp:ListItem Text="Waiting For Approve" Value="1"></asp:ListItem>
                         <asp:ListItem Text="Approved/Waiting For Purchase" Value="2"></asp:ListItem>
                         <asp:ListItem Text="Rejected" Value="3"></asp:ListItem>
                         <asp:ListItem Text="Purchased/Waiting For MRR" Value="4"></asp:ListItem>
                         <asp:ListItem Text="Received(MRR)" Value="5"></asp:ListItem>
                    </asp:DropDownList>
                 </td>
                  <td style="" align="right">
                      </td>
...
<div id="dvGrid" style="height: 300px; overflow:auto;">
    <asp:GridView ID="GridView1" runat="server" HeaderStyle-BackColor="YellowGreen"
     AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" OnRowDataBound="GridView1_RowDataBound" >
        ...
        <Columns>
            <asp:TemplateField HeaderText="Indent No" HeaderStyle-Width="120px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="lblDis" runat="server" Text='<%#Eval("INDT_NO")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
         <Columns>
             <asp:BoundField DataField="INDT_DATE" HeaderText="Indent Date " >
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="100px" HorizontalAlign="Left" />
                </asp:BoundField>
        </Columns>
         <Columns>
            <asp:TemplateField HeaderText="Indent Qty" HeaderStyle-Width="60px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="lblDistID" runat="server" Text='<%#Eval("INDT_QTY")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <Columns>
             <asp:BoundField DataField="APPROVED_DATE" HeaderText="Aprv. Date " >
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle Width="100px" HorizontalAlign="Left" />
                </asp:BoundField>
        </Columns>
        <Columns>
            <asp:TemplateField HeaderText="Aprv. Qty" HeaderStyle-Width="60px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="lblDistID" runat="server" Text='<%#Eval("INDT_QTY_APPROVED")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <Columns>
