<%@ Page Title="" Language="C#" ViewStateMode="Disabled" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Dev_OutSale_Report.aspx.cs" Inherits="PG.Web.Report.INV.Dev_OutSale_Report" %>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="width: 1150px">
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width: 100%; height: 500px; overflow: auto;">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Width="100%" AutoGenerateColumns="False" KeyFieldName="ITEM_QTY">
                                <Settings VerticalScrollableHeight="250" ShowFooter="True" ShowGroupFooter="VisibleAlways" />

                                <TotalSummary>
                                    <dx:ASPxSummaryItem FieldName="Size" SummaryType="Sum" />
                                    <dx:ASPxSummaryItem FieldName="ITEM_QTY" ShowInColumn="ITEM_QTY" DisplayFormat="Total:{0}" ShowInGroupFooterColumn="ITEM_QTY" SummaryType="Sum" />
                                </TotalSummary>

                                <GroupSummary>
                                    <dx:ASPxSummaryItem SummaryType="Count" />
                                    <dx:ASPxSummaryItem FieldName="ITEM_QTY" ShowInGroupFooterColumn="ITEM_QTY" SummaryType="Sum" />
                                </GroupSummary>
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Quantity" FieldName="ITEM_QTY" VisibleIndex="3" Width="60px">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Uom" FieldName="UOM_NAME" VisibleIndex="4" Width="50px">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Customer" FieldName="CUST_NAME" VisibleIndex="5" Width="130px">
                                    </dx:GridViewDataTextColumn>

                                    <dx:GridViewDataTextColumn Caption="Invoice No" FieldName="SALES_INVOICE_NO" VisibleIndex="6" Width="100px" />
                                    <dx:GridViewDataTextColumn Caption="Dc No" FieldName="DC_NO" VisibleIndex="7" Width="100px" />
                                    <dx:GridViewDataTextColumn Caption="Do No" FieldName="INVOICE_NO" VisibleIndex="8" Width="100px" />
                                    <dx:GridViewDataTextColumn Caption="Do Date" FieldName="INVOICE_DATE" VisibleIndex="9" Width="80px">
                                        <DataItemTemplate>
                                            <%#Eval("INVOICE_DATE", "{0:dd-MMM-yyyy}")%>
                                        </DataItemTemplate>
                                    </dx:GridViewDataTextColumn>
