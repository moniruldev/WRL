<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="IRRByDepartmentReport.aspx.cs" Inherits="PG.Web.Report.INV.IRRByDepartmentReport" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IRR By Floor Report"></asp:Label>
            </div>
            <!--Message Div -->
                                ...
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="240" CssClass="dropDownList enableIsDirty">
                                                <asp:ListItem Selected="True"  Value="1">IRR Summary</asp:ListItem>
                                                <asp:ListItem Value="2">IRR Details</asp:ListItem>
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <td></td>
                                        <td style="" align="left">
                                            <asp:Label ID="lblTransType" runat="server" Text="Transfer Type :"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlTransType" runat="server" Width="240" CssClass="dropDownList enableIsDirty">
                                                <asp:ListItem Selected="True" Value="0" Text="--All--"></asp:ListItem>
                                                 <asp:ListItem  Value="7" Text="Store"></asp:ListItem>
                                                 <asp:ListItem  Value="8" Text="Inter Department"></asp:ListItem>
                                            </asp:DropDownList>
