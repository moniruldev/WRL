<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="IRRgridWithReport.aspx.cs" Inherits="PG.Web.Report.INV.IRRgridWithReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Requisition To IRR Report"></asp:Label>
    </div>
    <!--Message Div -->
                      ...
                      <div style="width:100%;height:20px;">
                         <table>
                            <tr>
                             ...
                             <td>
                                <span>Requisition To IRR Report</span> 
                             </td>
                            </tr>
                         </table>
              ...
              <table style="text-align:left;" border="0" cellspacing="4" cellpadding="2">
                 ...
                 <td style="" align="left">
                     <asp:DropDownList ID="ddlIRRCondition" runat="server" Width="240"  CssClass="dropDownList enableIsDirty">
                         ...
                         <asp:ListItem Text="Approved/Waiting For ITC" Value="2"></asp:ListItem>
                         <asp:ListItem Text="Rejected" Value="3"></asp:ListItem>
                         <asp:ListItem Text="Transfered/Waiting For IRR" Value="4"></asp:ListItem>
                         <asp:ListItem Text="Received(IRR)" Value="5"></asp:ListItem>
                    </asp:DropDownList>
                 </td>
                  <td style="" align="left">
                      </td>
