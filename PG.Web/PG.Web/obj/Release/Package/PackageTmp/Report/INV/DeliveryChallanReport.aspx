<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="DeliveryChallanReport.aspx.cs" Inherits="PG.Web.Report.INV.DeliveryChallanReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Delivery Challan Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Delivery Challan Report</span>
                                        </td>
                                    </tr>
                                </table>
                 ...
                 <td style="" align="left">
                     ...
                     <td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="lblDeliveryChallanNo" runat="server" Text="Delivery Challan No."></asp:Label>
                                        </td>
                                        <td style="" align="left">

                                            <asp:TextBox ID="txtDeliveryChallanNo" runat="server" CssClass="textBox  enableIsDirty"
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <%--<asp:Button ID="buttonGatePassPreview" runat="server"  CssClass="buttoncommon buttonPrint" style="padding-left:22px;" Width="140px"
                Text="Gate Pass Preview" onclick="btnGatePassPreview_Click" />--%>
                                        </td>
    ...
    <div id="dvGridContainer" style="width:100%; height: auto; text-align:left;">
        <div id="dvGridHeader" style="width:auto;height:25px; font-size: smaller;" class="subHeader">
            ...
            <tr>
                <td align="center" Width="50px">SL</td>
                <td align="center" Width="150px">Gate Pass No.</td>
                <td align="left" Width="70px">GP Date</td>
        ...
        <div id="dvGrid" style="width:auto; height: 300px; overflow:auto;">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            CellPadding="1" CellSpacing="1" ForeColor="#333333" GridLines="None" 
            Font-Names="Arial" Font-Size="9pt" 
            DataKeyNames="GP_NO" OnRowDataBound="GridView1_RowDataBound"
            ShowHeader="False" Width="760px" OnRowCommand="GridView1_RowCommand" >
            <PagerSettings Mode="NumericFirstLast" />
            <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
            <Columns>
                <asp:TemplateField HeaderText="SL" HeaderStyle-Width="50px" ItemStyle-Width="50px">
                <ItemTemplate>
                    <%# Container.DataItemIndex + 1 %>
                </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="GP_NO" HeaderText="Gate Pass No." >
                <HeaderStyle HorizontalAlign="center" />
                <ItemStyle Width="150px" HorizontalAlign="Left" />
                </asp:BoundField>  
                 <asp:BoundField DataField="GP_DATE" dataformatstring="{0:dd-MMM-yyyy}" HeaderText="GP Date" >
                <HeaderStyle HorizontalAlign="center" />
