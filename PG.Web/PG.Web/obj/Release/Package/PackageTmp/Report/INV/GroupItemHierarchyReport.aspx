<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="GroupItemHierarchyReport.aspx.cs" Inherits="PG.Web.Report.INV.GroupItemHierarchyReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div id="dvHeader" class="dvHeader" >
		<asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Group Item Hierarchy Report"></asp:Label>
	</div>
	<!--Message Div -->
