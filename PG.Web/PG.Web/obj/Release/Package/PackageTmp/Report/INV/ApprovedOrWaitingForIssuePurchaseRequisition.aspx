<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ApprovedOrWaitingForIssuePurchaseRequisition.aspx.cs" Inherits="PG.Web.Report.INV.ApprovedOrWaitingForIssuePurchaseRequisition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Approved Or Waiting For Issue Purchase Requisition Report"></asp:Label>
    </div>
    <!--Message Div -->
                      ...
                      <div style="width:100%;height:20px;">
                         <table>
                            <tr>
                             ...
                             <td>
                                <span>Approved Or Waiting For Issue Purchase Requisition View</span> 
                             </td>
                            </tr>
                         </table>
                      </div>
