<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="INVITCPrintReport.aspx.cs" Inherits="PG.Web.Report.INV.INVITCPrintReport" %>
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left"> <asp:HiddenField ID="hdnItemIdForFilter" runat="server" /></td>
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td style="" align="left"> 
                                            <asp:DropDownList ID="ddlItemSNS" runat="server" CssClass="dropDownList enableIsDirty"  Width="245">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtItemName" Width="235px" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox>&nbsp;</td>
                                        <td style="" align="left"><input id="btnItemLoad" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" /></td>
                                        <td style="" align="left"></td>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtITCNo" Width="235px" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox>&nbsp;</td>
                                        <td style="" align="left"><input id="Button1" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" /></td>
                                        <td style="" align="left"></td>
                                        <td></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="Label4" runat="server" Text="IGR No"></asp:Label>
                                        </td>
                                        <td style="" align="left">

                                            <asp:TextBox ID="txtIGRNo" Width="235px" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox>&nbsp;</td>
                                        <td style="" align="left"><input id="Button2" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" /></td>
                                        <td style="" align="left"></td>
                                        <td></td>
                                    </tr>
