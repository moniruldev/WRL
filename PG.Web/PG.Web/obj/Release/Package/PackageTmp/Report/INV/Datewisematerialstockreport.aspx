<%@ Page Title="" Language="C#" EnableViewState="false" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Datewisematerialstockreport.aspx.cs" Inherits="PG.Web.Report.INV.Datewisematerialstockreport" %>
       ...
       <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Date wise Material Stock Report"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblDateFrom" runat="server" Text="Trans Date From:" Font-Bold="true"></asp:Label>
                        </td>
                        <td colspan="2">
            ...
            <%--Select ITEM_GROUP_ID,ITEM_GROUP_NAME,ITEM_ID,ITEM_NAME,UOM_ID,UOM_NAME,ITEM_TYPE_ID,ITEM_TYPE_NAME,ITEM_CLASS_ID,ITEM_CLASS_NAME,OP_BAL+OP_MRR_QTY+OP_IRR_QTY-OP_ITC_QTY-OP_OUTSALES_QTY-OP_ROTARY_QTY-OP_LOANRP_QTY+OP_RTN_QTY+OP_ADJ OPPENING_BAL_QTY,MRR_QTY,IRR_QTY,ITC_QTY,OUTSALES_QTY,ROTARY_QTY,LOANRP_QTY,RTN_QTY, OP_BAL+OP_MRR_QTY+OP_IRR_QTY-OP_ITC_QTY-OP_OUTSALES_QTY-OP_ROTARY_QTY-OP_LOANRP_QTY+OP_RTN_QTY+OP_ADJ+MRR_QTY+IRR_QTY-ITC_QTY-OUTSALES_QTY-ROTARY_QTY-LOANRP_QTY+RTN_QTY+ADJUST_QTY COLISING_QTY, BAL_QTY,ADJUST_QTY FROM TEMP_STORE_ITEM_STOCK--%>
         ...
         <%-- <ClientSideEvents Init="grid_Init" BeginCallback="grid_BeginCallback" EndCallback="grid_EndCallback" />--%>
           ...
           <%-- <ClientSideEvents Init="grid_Init" BeginCallback="grid_BeginCallback" EndCallback="grid_EndCallback" />--%>
            ...
            <TotalSummary>
                ...
                <dx:ASPxSummaryItem FieldName="MRR_QTY" ShowInColumn="MRR Qty" ShowInGroupFooterColumn="MRR Qty" SummaryType="Sum" Tag="ITC Qty" />
                 <dx:ASPxSummaryItem FieldName="IRR_QTY" ShowInColumn="IRR Qty" ShowInGroupFooterColumn="IRR Qty" SummaryType="Sum" Tag="ITC Qty" />
            </TotalSummary>
            ...
            <dx:ASPxSummaryItem FieldName="IRR_QTY" ShowInGroupFooterColumn="IRR Qty" SummaryType="Sum" />
        </GroupSummary>
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Group Name" FieldName="ITEM_GROUP_NAME" VisibleIndex="1" Width="100px"  >
                  ...
                  <dx:GridViewDataTextColumn Caption="Item Code" FieldName="ITEM_CODE" VisibleIndex="2" Width="180px" >
                   <%-- <Settings AllowGroup="True" />--%>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Item Name" FieldName="ITEM_NAME" VisibleIndex="3" Width="180px" >
                   <%-- <Settings AllowGroup="True" />--%>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="Type" FieldName="ITEM_TYPE_NAME" VisibleIndex="4" Width="70px" >
               <%-- <Settings f--%>
                      <%-- <DataItemTemplate>
                            <%#Eval("REQ_ISSUE_DATE", "{0:dd-MMM-yyyy}")%>
                        </DataItemTemplate>--%>
                   </dx:GridViewDataTextColumn>
                 <dx:GridViewDataTextColumn Caption="Class" FieldName="ITEM_CLASS_NAME" VisibleIndex="5" Width="150px" />
                 <dx:GridViewDataTextColumn  Caption="Uom" FieldName="UOM_NAME" VisibleIndex="6" Width="80px" />
                 <dx:GridViewDataTextColumn Caption="OP_BAL" FieldName="OPPENING_BAL_QTY" VisibleIndex="7" Width="80px" />
                <dx:GridViewDataTextColumn Caption="MRR Qnty" FieldName="MRR_QTY" VisibleIndex="8" Width="80px" >
                  <%--<DataItemTemplate>
                            <%#Eval("REQ_DATE", "{0:dd-MMM-yyyy}")%>
                        </DataItemTemplate>--%>
                   </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn  Caption="IRR_QTY" FieldName="IRR_QTY" VisibleIndex="9" Width="80px" />
                 <dx:GridViewDataTextColumn  Caption="RTN Qty" FieldName="RTN_QTY" VisibleIndex="10" Width="80px" />
                <dx:GridViewDataTextColumn  Caption="Total RCV" FieldName="TOT_RECEIVE_QNTY" VisibleIndex="11" Width="80px" />
                 <dx:GridViewDataTextColumn  Caption="Total RCV with OP" FieldName="OPWITHTOTRCV_QTY" VisibleIndex="12" Width="80px" />
                 <dx:GridViewDataTextColumn  Caption="ITC_Qty" FieldName="ITC_QTY" VisibleIndex="13" Width="80px" />

                 <dx:GridViewDataTextColumn  Caption="Sales Qty" FieldName="OUTSALES_QTY" VisibleIndex="14" Width="80px" >
                    <%-- <PropertiesTextEdit DisplayFormatString="c" />--%>
            </dx:GridViewDataTextColumn>
                 <dx:GridViewDataTextColumn  Caption="Rotary Qty" FieldName="ROTARY_QTY" VisibleIndex="15" Width="80px" />

                <dx:GridViewDataTextColumn  Caption="Loan Qty" FieldName="LOANRP_QTY" VisibleIndex="16" Width="80px" />
                 <dx:GridViewDataTextColumn  Caption="Tot Issue Qty" FieldName="TOT_ISSUE_QNTY" VisibleIndex="17" Width="80px" />
                <dx:GridViewDataTextColumn  Caption="ADJ Qty" FieldName="ADJUST_QTY" VisibleIndex="18" Width="80px" />
                 <dx:GridViewDataTextColumn  Caption="Closing Qty" FieldName="COLISING_QTY" VisibleIndex="19" Width="80px" />
