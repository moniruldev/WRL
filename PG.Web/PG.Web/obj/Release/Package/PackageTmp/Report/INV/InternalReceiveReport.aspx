<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="InternalReceiveReport.aspx.cs" Inherits="PG.Web.Report.INV.InternalReceiveReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Internal Receive Report"></asp:Label>
    </div>
    <!--Message Div -->
             ...
             <div id="groupBox">
                      ...
                      <div style="width:100%;height:20px;">
                         <table>
                            <tr>
                             ...
                             <td>
                                <span>Internal Receive Report</span> 
                             </td>
                            </tr>
                         </table>
              ...
              <table style="text-align:left;" border="0" cellspacing="4" cellpadding="2">
                 ...
                 <td style="" align="right">
                   <asp:Label id="lblInternalReceiveNo" runat="server" Text="Internal Receive No." ></asp:Label>
                 </td>
                 <td style="" align="left">
