<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="PurchaseRequisitionStatusDetails.aspx.cs" Inherits="PG.Web.Report.INV.PurchaseRequisitionStatusDetails" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Purchase Requisition Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Purchase Requisition Report</span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="240" CssClass="dropDownList enableIsDirty" OnSelectedIndexChanged="ddlReportType_SelectedIndexChanged" AutoPostBack="true">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td align="right"><asp:Label runat="server" ID="lblPRNo" Text="Purchase No :"></asp:Label></td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtPRNo" CssClass="textBox" Width="200px"></asp:TextBox>
                                        </td>
                                    </tr>
                                      <tr>
                                          <td></td>
