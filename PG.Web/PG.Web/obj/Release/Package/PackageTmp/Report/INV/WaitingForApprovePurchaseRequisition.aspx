<%@ Page Language="C#"  MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="WaitingForApprovePurchaseRequisition.aspx.cs" Inherits="PG.Web.Report.INV.WaitingForApprovePurchaseRequisition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Waiting For Approved Purchase Requisition Report"></asp:Label>
    </div>
    <!--Message Div -->
                      ...
                      <div style="width:100%;height:20px;">
                         <table>
                            <tr>
                             ...
                             <td>
                                <span>Waiting For Approved Purchase Requisition View</span> 
                             </td>
                            </tr>
                         </table>
                      </div>
