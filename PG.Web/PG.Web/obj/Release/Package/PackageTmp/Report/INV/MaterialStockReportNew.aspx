<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="MaterialStockReportNew.aspx.cs" Inherits="PG.Web.Report.INV.MaterialStockReportNew" %>
                            ...
                            <td valign="top" style="height: 100%;">
                              ...
                              <%--               <tr class="rowParam">
                                        ...
                                        <tr class="rowParam">
                                            ...
                                            <td style="" align="right">&nbsp;</td>
                                            <td>
                                                <asp:CheckBox ID="chkWithPrice" runat="server" Text="With AVG Price" Visible="false"/>
                                                </td>
                                            <td> </td>
                                            <td style="" align="right"></td>
                                            <td></td>
