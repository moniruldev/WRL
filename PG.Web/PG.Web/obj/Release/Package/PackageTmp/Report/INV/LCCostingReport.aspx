<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="LCCostingReport.aspx.cs" Inherits="PG.Web.Report.INV.LCCostingReport" %>
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" style="height: auto; width: 100%;">
                                        <tr>
                                            <td style="border-bottom: 1px solid grey;">
                                                <asp:Label ID="lblReportName" runat="server" Text="LC Costing Reports" Font-Bold="True"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TreeView ID="tvwReport" runat="server" OnSelectedNodeChanged="tvwReport_SelectedNodeChanged"
                                                    ...
                                                    <Nodes>
                                                        <asp:TreeNode Text="Costing Report" Value="Stock_Reports" Expanded="True" SelectAction="Expand">
                                                            <asp:TreeNode Text="LC Costing Report" Value="1606" Selected="True"></asp:TreeNode>
                                ...
                                <div id="dvParam" class="dvParam">
                                    <table id="tblParam" cellspacing="4" cellpadding="2" border="0" class="tblParam">
                                        ...
                                        <tr class="rowParam">
                                            <td></td>
                                            <td style="" align="right">
                                                <asp:Label ID="lblCostingItemType" runat="server" Text="Type:" Visible="True"></asp:Label>
                                            </td>
                                            <td>
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <cc1:DropDownCheckBoxes ID="ddlCostingItemCategory" runat="server" AddJQueryReference="false" UseButtons="false"    UseSelectAllNode="True" style="top: 0px; left: 0px">
                    <Style2 SelectBoxWidth="150px" DropDownBoxBoxWidth="" DropDownBoxBoxHeight=""></Style2>
                    <Texts OkButton="OK" CancelButton="Cancel" SelectAllNode="All Type" SelectBoxCaption="Select" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnView" runat="server" Text="View Report" Width="100px" CssClass="buttoncommon buttonPrintPreview"
                                        OnClick="btnView_Click" OnClientClick="showOverlay();" Visible="false" />
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:Label ID="Label3" runat="server" Text="Get Report As:" Visible="false"></asp:Label>
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:Button ID="btnExport" runat="server" Text="Get Report" Width="100px" CssClass="buttoncommon buttonExport"
                                        OnClick="btnExport_Click" OnClientClick="showOverlay();" Visible="false" />
                                </td>
