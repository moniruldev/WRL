<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="LCInvoiceMRRGridview.aspx.cs" Inherits="PG.Web.Report.INV.LCInvoiceMRRGridview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="LC Purchase MRR View"></asp:Label>
    </div>
    <!--Message Div -->
    ...
    <div id = "dvControls" style="height:auto; width:100%">
        <div id="dvControlsInner" class="groupBoxContainer boxShadow">    
             <div id="groupBox">
                      ...
                      <div style="width:100%;height:20px;">
                         <table>
                            <tr>
                             ...
                             <td>
                                <span>LC Purchase MRR View</span> 
                             </td>
                            </tr>
                         </table>
              ...
              <table style="text-align:left;" border="0" cellspacing="4" cellpadding="2">
                 ...
                 <td style="" align="left">
                   <asp:Label id="lblInvoiceNo" runat="server" Text="LC No." ></asp:Label>
                 </td>
                 <td style="" align="left">
                      
                    <asp:TextBox id="txtLCNo" runat="server" CssClass="textBox  enableIsDirty" 
                 ...
                 <td style="" align="left">
                     <asp:DropDownList ID="ddlMRRCondition" runat="server" Width="240"  CssClass="dropDownList enableIsDirty">
                         <asp:ListItem Selected="True" Text="--All--" Value="0"></asp:ListItem>
                         <asp:ListItem Text="Waiting For Purchase" Value="1"></asp:ListItem>
                        <%-- <asp:ListItem Text="Rejected" Value="2"></asp:ListItem>--%>
                         <asp:ListItem Text="Waiting For MRR" Value="2"></asp:ListItem>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            ShowHeader="true" Width="98%"  style="margin-bottom: 0px">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="LC No" Visible="true">
                  <ItemTemplate>
                 <asp:Label ID="lblLCNO" runat="server" Text='<%# Bind("LC_NO") %>' Style="text-align: left;" Width="150px"></asp:Label>
                  </ItemTemplate>
                   <ItemStyle VerticalAlign="Top" />
                </asp:TemplateField>
                <asp:boundfield datafield="LC_DATE" DataFormatString="{0:dd/MM/yyyy}" htmlencode="false" HeaderText="LC Date" />
                 <%--<asp:TemplateField HeaderText="Req. Time" Visible="true" >
                  <ItemTemplate>
                 <asp:Label ID="lblReqtime" runat="server" Text='<%# Bind("LC_DATE") %>' Style="text-align: center;" Width="120px" ></asp:Label>
                  </ItemTemplate>
                   <ItemStyle VerticalAlign="Top" />
                </asp:TemplateField>--%>
                 ...
                 <asp:TemplateField HeaderText="LC Status" Visible="true">
                  <ItemTemplate>
                 <asp:Label ID="lblLCStatus" runat="server" Text='<%# Bind("MRR_STATUS") %>' Style="text-align: center;" Width="100px"></asp:Label>
                  </ItemTemplate>
                   <ItemStyle VerticalAlign="Top" />
                </asp:TemplateField>
                 <asp:TemplateField HeaderText="Invoice No" Visible="true">
                  <ItemTemplate>
                 <asp:Label ID="lblInvoiceNO" runat="server" Text='<%# Bind("IMP_PURCHASE_NO") %>' Style="text-align: center;" Width="120px"></asp:Label>
                                                                   
                  </ItemTemplate>
                   <ItemStyle VerticalAlign="Top" />
                </asp:TemplateField>
                 <asp:boundfield datafield="IMP_PURCHASE_DATE" DataFormatString="{0:dd/MM/yyyy}" htmlencode="false" HeaderText="Purchase Date" />
                 <%--<asp:TemplateField HeaderText="Purchase Date" Visible="true" >
                  <ItemTemplate>
                 <asp:Label ID="lblPurchaseDate" runat="server" Text='<%# Bind("IMP_PURCHASE_DATE") %>' Style="text-align: center;" Width="120px" ></asp:Label>
                                                                   
                  </ItemTemplate>
                   <ItemStyle VerticalAlign="Top" />
                </asp:TemplateField>--%>

                 <asp:TemplateField HeaderText="MRR No" Visible="true">
                  <ItemTemplate>
                 <asp:Label ID="lblIRRNo" runat="server" Text='<%# Bind("MRR_NO") %>' Style="text-align: center;" Width="120px"></asp:Label>
                                                                   
                  </ItemTemplate>
                   <ItemStyle VerticalAlign="Top" />
                </asp:TemplateField>
                  <asp:boundfield datafield="MRR_DATE" DataFormatString="{0:dd/MM/yyyy}" htmlencode="false" HeaderText="MRR Date" />
                 <%--<asp:TemplateField HeaderText="MRR Date" Visible="true" >
                  <ItemTemplate>
                 <asp:Label ID="lblMRRTime" runat="server" Text='<%# Bind("MRR_DATE") %>' Style="text-align: center;" Width="120px" ></asp:Label>
