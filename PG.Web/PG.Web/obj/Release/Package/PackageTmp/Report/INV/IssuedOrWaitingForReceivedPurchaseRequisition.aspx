<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="IssuedOrWaitingForReceivedPurchaseRequisition.aspx.cs" Inherits="PG.Web.Report.INV.IssuedOrWaitingForReceivedPurchaseRequisition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Issued or Waiting For Received Purchase Requisition Report"></asp:Label>
    </div>
    <!--Message Div -->
                      ...
                      <div style="width:100%;height:20px;">
                         <table>
                            <tr>
                             ...
                             <td>
                                <span>Issued or Waiting For Received Purchase Requisition View</span> 
                             </td>
                            </tr>
                         </table>
                      </div>
     ...
     AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" OnRowDataBound="GridView1_RowDataBound" >
        ...
        <Columns>
         ...
         <Columns>
            <asp:TemplateField HeaderText="Req Qty" HeaderStyle-Width="60px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%#Eval("REQ_QNTY")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
         <Columns>
        ...
        <Columns>
            <asp:TemplateField HeaderText="Aprv Qty" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%#Eval("REQ_APRV_QNTY")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <Columns>
         ...
         <Columns>
            <asp:TemplateField HeaderText="Iss No" HeaderStyle-Width="120px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="Label3" runat="server" Text='<%#Eval("ISSUE_NO")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
         <Columns>
         ...
         <Columns>
            <asp:TemplateField HeaderText="Iss Qty" HeaderStyle-Width="60px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Text='<%#Eval("ISSUE_QNTY")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
         <Columns>
            <asp:TemplateField HeaderText="Rcv No" HeaderStyle-Width="120px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="Label5" runat="server" Text='<%#Eval("RCV_NO")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
         <Columns>
         ...
         <Columns>
            <asp:TemplateField HeaderText="Rcv Qty" HeaderStyle-Width="60px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="Label6" runat="server" Text='<%#Eval("RCV_QNTY")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
         <%--<Columns>
                    ...
                    <div style="width: auto; min-width: 300px; height: auto; text-align: left;">
                        <table border="0">
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label7" runat="server" Text="Report View"></asp:Label>
                                </td>
                                <td>
