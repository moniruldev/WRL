<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="IRRByStorePrintReport.aspx.cs" Inherits="PG.Web.Report.INV.Inter_Dept_IRR_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="ITC/IRR By Store Report"></asp:Label>
            </div>
            <!--Message Div -->
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>ITC/IRR By Store Report</span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style=" align="left">
                                            <asp:DropDownList ID="ddlDeptName" runat="server" Width="245" CssClass="dropDownList enableIsDirty"></asp:DropDownList>
                                        </td>
                    ...
                    <td></td>
                                     ...
                                     <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox required" Enabled="true" Width="240"></asp:TextBox>&nbsp;</td>
                                        <td style="" align="left">
                                     ...
                                     <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtItemName" Width="240px" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox>&nbsp;</td>
                                        <td style="" align="left">
                                             <input id="btnItemLoad" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" /></td>
                                        <td style="" align="left"></td>
                                        <td></td>
                                    </tr>
