<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="StoreRequisitionInfoView.aspx.cs" Inherits="PG.Web.Report.INV.StoreRequisitionInfoView" %>
    ...
    <div id="dvContentMain" class="dvContentMain">
     <div id="dvControlsInner1" class="boxShadow">
                      ...
                      <div style="width:100%;height:20px;">
                         <table>
                            <tr>
                             ...
                             <td>
                                <span>Purchase Requisition View</span> 
                             </td>
                            </tr>
                         </table>
                      </div>
              ...
              <table style="text-align:left;" border="0" cellspacing="4" cellpadding="2">
                 ...
                 <td style="" align="left">
                     <asp:DropDownList ID="ddlRequisitionCondition" runat="server" Width="230"  CssClass="dropDownList enableIsDirty">
                         <asp:ListItem Text="Waiting For Approve" Value="1"></asp:ListItem>
                         <asp:ListItem Text="Approved/Waiting For Issed" Value="2"></asp:ListItem>
                         <asp:ListItem Text="Rejected" Value="3"></asp:ListItem>
                         <asp:ListItem Text="Issued/Waiting For Receive" Value="4"></asp:ListItem>
                         <asp:ListItem Text="Received" Value="5"></asp:ListItem>
                    </asp:DropDownList>
                 </td>
                  <td style="" align="right">
                      </td>
