<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="MaterialReceiveReport.aspx.cs" Inherits="PG.Web.Report.INV.MaterialReceiveReport" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="IGR:Material Receive Report"></asp:Label>
            </div>
            <!--Message Div -->
            ...
            <div id="dvControlsHead" style="height: auto; width: 100%;">
                <table>
                      <tr>
                        ...
                        <td>
                            <asp:Label ID="Label7" runat="server" Text=" MRR Type"></asp:Label><span style="color: red">*</span>
                        </td>
                        <td>
                        ...
                        <div id="dvGridHeader" style="width: 100%; height: 25px; font-size: smaller;" class="subHeader">
                            <table style="height: 100%; color: #FFFFFF; font-weight: bold; text-align: center;"
                                ...
                                <tr>
                                    ...
                                    <td width="200px" align="left">Purchase Info
                                    </td>
                                    <td width="50px" align="left">QC?</td>
                                     <td width="50px" align="left">Replace?</td>
                                    <td width="100px" align="left">MRR RePrint
                                    </td>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Purchase Info">
                                      ...
                                      <asp:TemplateField HeaderText="QC Status">
                                        <ItemTemplate>
                                            <asp:Label ID="lblQC_STATUS" runat="server" Text='<%# Eval("QC_STATUS").ToString()=="Y"?"Yes":"No" %>' Style="text-align: left;" Width="50px"></asp:Label>
                                    ...
                                    <asp:TemplateField HeaderText="MRR Reprint">
                                     ...
                                     <asp:BoundField DataField="CREATE_BY_NAME" HeaderText="MRR BY" ItemStyle-Width="150">
                                        <ItemStyle Width="150px"></ItemStyle>
                                    </asp:BoundField>
