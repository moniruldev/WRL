<%@ Page Language="C#"  MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="GatePassReport.aspx.cs" Inherits="PG.Web.Report.INV.GatePassReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Gate Pass Report"></asp:Label>
    </div>
    <!--Message Div -->
    ...
    <div id = "dvControls" style="height:auto; width:100%">
        <div id="dvControlsInner" class="groupBoxContainer boxShadow">    
            ...
            <%-- <tr class="rowParam">
                 ...
                 <td style="" align="right">
                   <asp:Label id="lblGatePassNo" runat="server" Text="Gate Pass No." ></asp:Label>
                 </td>
                 <td style="" align="left">
                      
                    <asp:TextBox id="txtGatePassNo" runat="server" CssClass="textBox  enableIsDirty" 
