<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="InvoiceDC_GPView.aspx.cs" Inherits="PG.Web.Report.INV.InvoiceDC_GPView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="dvHeader" class="dvHeader" >
        <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Invoice DC GP Report"></asp:Label>
    </div>
    <!--Message Div -->
    ...
    <div id="dvContentMain" class="dvContentMain">
     <div id="dvControlsInner1" class="boxShadow">
                      ...
                      <div style="width:100%;height:20px;">
                         <table>
                            <tr>
                             ...
                             <td>
                                <span>Invoice Delivery Challan Gate Pass Report</span> 
                             </td>
                            </tr>
                         </table>
                      </div>
             ...
             <tr>
                 ...
                 <td style="" align="right">
                   <asp:Label id="Label1" runat="server" Text="Delivery Challan No" ></asp:Label>
                     </td>
                 <td style="" align="left">
                 ...
                 <td style="" align="right">
                   <asp:Label id="Label3" runat="server" Text="Gate Pass No" ></asp:Label>
                     </td>
                 <td style="" align="left">
                      
                     <asp:TextBox id="txtGPNo" runat="server" Width="235px"  CssClass="textBox fldRequired enableIsDirty"></asp:TextBox>
                 ...
                 <td style="" align="left">
                  ...
                  <td align="right">
                  <asp:Label ID="lblFromDate" runat="server" Text="Invoice Date From:"></asp:Label>
                   </td>
                  <td>
                     ...
                     <td>
                      ...
                      <td>
                      <asp:Label ID="lblToDate" runat="server" Text="Invoice Date To:"></asp:Label>
                      </td>
                        <td style="width: 2px;">
                         </td>                               
                          <td>                                                              
...
<div id="dvGrid" style="height: 400px; overflow:auto;">
    <asp:GridView ID="GridView1" runat="server" HeaderStyle-BackColor="LightGray"
     AutoGenerateColumns="false" AlternatingRowStyle-BackColor="WhiteSmoke" OnRowDataBound="GridView1_RowDataBound" >
        ...
        <Columns>
            <asp:TemplateField HeaderText="Invoice No" HeaderStyle-Width="60px" ItemStyle-Width="60px">
                <ItemTemplate>
                    <asp:Label ID="lblDist" runat="server" Text='<%#Eval("INVOICE_NO")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <Columns>
             <asp:BoundField DataField="INVOICE_DATE" HeaderText="Invoice Date " HeaderStyle-Width="100px" ItemStyle-Width="100px" >
        ...
        <Columns>
            <asp:TemplateField HeaderText="Customer" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="lblDis" runat="server" Text='<%#Eval("CUST_NAME")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
         
         <Columns>
            <asp:TemplateField HeaderText="Item Name" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                <ItemTemplate>
        ...
        <Columns>
            <asp:TemplateField HeaderText="Unit" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                <ItemTemplate>
        ...
        <Columns>
            <asp:TemplateField HeaderText="Item Qty" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="lblDistID" runat="server" Text='<%#Eval("ITEM_QNTY")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <Columns>
            <asp:TemplateField HeaderText="DC No" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="lblDistID" runat="server" Text='<%#Eval("DC_NO")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
       
        <Columns>
             <asp:BoundField DataField="DC_DATE" HeaderText="DC Date" HeaderStyle-Width="100px" ItemStyle-Width="100px">
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle HorizontalAlign="Left" />
                </asp:BoundField>
        </Columns>
        <Columns>
            <asp:TemplateField HeaderText="GP No" HeaderStyle-Width="80px" ItemStyle-Width="80px">
                <ItemTemplate>
                    <asp:Label ID="lblDistID" runat="server" Text='<%#Eval("GP_NO")%>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <Columns>
             <asp:BoundField DataField="GP_DATE" HeaderText="GP Date " HeaderStyle-Width="100px" ItemStyle-Width="100px">
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle  HorizontalAlign="Left" />
                </asp:BoundField>
        </Columns>
