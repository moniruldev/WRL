<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="MaterialStockEvaluationReport.aspx.cs" Inherits="PG.Web.Report.INV.MaterialStockEvaluationReport" %>
                                ...
                                <div id="dvParam" class="dvParam">
                                    <table id="tblParam" cellspacing="4" cellpadding="2" border="0" class="tblParam">
                                        ...
                                        <tr class="rowParam">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlReportType" runat="server" CssClass="dropDownList enableIsDirty" Width="180px">
                                                    <asp:ListItem Value="0" Selected="True">All</asp:ListItem>
                                                     <asp:ListItem Value="1" >Stock Evaluation History</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                            <td></td>
