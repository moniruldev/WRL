<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="RequisitionITCIRRDetailsPrintReport.aspx.cs" Inherits="PG.Web.Report.INV.RequisitionITCIRRDetailsPrintReport" %>
                                ...
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="right">
                                            <asp:Label ID="Label5" runat="server" Text="ITC/IRR Status"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="240" CssClass="dropDownList enableIsDirty">
                                                <asp:ListItem  Value="ITCByStore">ITC(From store to floor)</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="IGRVSITCIRRACTUAL">Item Wise IGR Details Within Date</asp:ListItem>
                                                <asp:ListItem Value="ItemWiseSummary">Item Wise IGR History Report</asp:ListItem>
                                                <asp:ListItem Value="IGRITCIRRSUMMARY">IGR ITC IRR Summary Report</asp:ListItem> 
                                                <%-- <asp:ListItem  Value="QuantityWise">Department Wise Quantity</asp:ListItem>--%>
                                            </asp:DropDownList>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtRequisitionNo" runat="server" Width="235px" CssClass="textBox fldRequired enableIsDirty"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:DropDownList ID="ddlItemSNS" runat="server" CssClass="dropDownList enableIsDirty" Width="240px">
