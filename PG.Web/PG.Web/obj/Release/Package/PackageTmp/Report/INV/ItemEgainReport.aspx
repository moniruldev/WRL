<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="ItemEgainReport.aspx.cs" Inherits="PG.Web.Report.INV.ItemEgainReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                    ...
                                    <table cellspacing="0" cellpadding="0" border="0" style="height: auto; width: 100%;">
                                        <tr>
                                            <td style="border-bottom: 1px solid grey;">
                                                <asp:Label ID="lblReportName" runat="server" Text="Item Stock Ageing Reports" Font-Bold="True"
                                ...
                                <div id="dvParam" class="dvParam">
                                    <table id="tblParam" cellspacing="4" cellpadding="2" border="0" class="tblParam">
                                        ...
                                        <tr class="rowParam">
                                            <td></td>
                                            <td style="" align="right"> 
                                                <asp:Label ID="Label4" runat="server" Text="Ageing Date:"></asp:Label>
                                            </td>
                                            <td> <asp:TextBox ID="txtAGEINGDATE" runat="server" Width="85px" CssClass="textBox textDate dateParse"></asp:TextBox></td>
                                            <td></td>
                                            <td style="" align="right"></td>
                                            <td></td>
                                        </tr>
    ...
    <div id="overlay" class="overlay">
        <div style="margin: auto; width: 200px; height: 400px; background-color: black; border: solid 1px black; text-align: center; vertical-align: middle;">
           <%-- <span style="color: white; font-size: medium;">Please Wait...
                </span>--%>
