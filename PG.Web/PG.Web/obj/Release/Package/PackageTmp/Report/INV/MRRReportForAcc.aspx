<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="MRRReportForAcc.aspx.cs" Inherits="PG.Web.Report.INV.MRRReportForAcc" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function bindSupplierList() {
            ...
            $(supplierIDElem).blur(function () {
                ...
                var SupplierID = $(supplierIDElem).val();
                if (SupplierID == '') {
                    $('#' + hdnSupplierID).val('0');
                    $('#' + txtSupplierName).val('');
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="MRR Report"></asp:Label>
            </div>
            <!--Message Div -->
                                ...
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="right">
                                            <asp:Label ID="Label7" runat="server" Text="SNS Type:"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="Label6" runat="server" Text="Report Type:" Visible="false"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="dropDownList" Width="235px" Visible="false">
                                                <asp:ListItem Value="GW">Item Group Wise</asp:ListItem>
                                                <asp:ListItem Value="DW">Date Wise Details</asp:ListItem>
                                                <asp:ListItem Value="DS">Date Wise Summary</asp:ListItem>
                                            </asp:DropDownList>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" CssClass="dropDownList" Width="235px">
                                                <asp:ListItem Value="GW">Item Group Wise</asp:ListItem>
                                                <asp:ListItem Value="DW">Date Wise Details</asp:ListItem>
                                                <%--<asp:ListItem Value="DS">Date Wise Summary</asp:ListItem>--%>
                                            </asp:DropDownList>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="Label1" runat="server" Text="MRR Type:"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            ...
                                            <asp:DropDownList ID="ddlMMRType" runat="server" CssClass="dropDownList" Width="235px">
                                                ...
                                                <asp:ListItem Value="102">MRR Against IP</asp:ListItem>
                                            </asp:DropDownList>
                            ...
                            <asp:Label ID="Label9" runat="server"  Text="Department:"></asp:Label>
                               ...
                               <asp:DropDownList ID="ddlFromDepartment" runat="server" CssClass="dropDownList required">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="Label8" runat="server" Text="MRR No:"></asp:Label>
                                        </td>
                                        <td style="" align="left">

                                            <asp:TextBox ID="txtMRRNo" runat="server" Width="232px" CssClass="textBox fldRequired enableIsDirty"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="lblName" runat="server" Text="Supplier:"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:TextBox ID="txtSupplierName" runat="server" CssClass="textBox" Width="235px"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="Label5" runat="server" Text="Item Group:"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                        ...
                                        <td>
                                            <input id="btnGroupID" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" /></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:Button ID="buttonIRRPreview" runat="server" CssClass="buttoncommon buttonPrint" Style="padding-left: 22px;" Width="100px" Text="Preview" OnClick="btnIRRPreview_Click" /> &nbsp;&nbsp;&nbsp;
