<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="InvoiceDOdetailsPrintReport.aspx.cs" Inherits="PG.Web.Report.INV.InvoiceDOdetailsPrintReport" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="DO/Invoice Report"></asp:Label>
            </div>
            <!--Message Div -->
                                ...
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="right">
                                            <asp:Label ID="Label4" runat="server" Text="SNS Type:"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlItemSNS" runat="server" CssClass="dropDownList enableIsDirty" Width="238px">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="Label1" runat="server" Text="DO No"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:TextBox ID="txtInvoiceNO" runat="server" CssClass="textBox " Width="235px"></asp:TextBox>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtItemName" Width="220px" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox><input id="btnItemLoad" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
