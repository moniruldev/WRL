<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="INV_LC_Summary_Report.aspx.cs" Inherits="PG.Web.Report.INV.INV_LC_Summary_Report" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="LC Report"></asp:Label>
            </div>
            <!--Message Div -->
                                ...
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtLCNo" runat="server" Width="232px" CssClass="textBox fldRequired enableIsDirty"></asp:TextBox>
