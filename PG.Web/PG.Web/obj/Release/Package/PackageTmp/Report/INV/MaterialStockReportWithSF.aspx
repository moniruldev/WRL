<%@ Page Title="" Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="MaterialStockReportWithSF.aspx.cs" Inherits="PG.Web.Report.INV.MaterialStockReportWithSF" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: 100%;">
        ...
        <div id="dvContentMain" class="dvContentMain">
            ...
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Material Stock Monitor"></asp:Label>
            </div>
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow" style="min-height: 340px;">
                    <div id="groupBox">
                        <div id="groupHeader" class="groupHeader">
                            <span>Material Stock Monitor</span>
                        </div>
