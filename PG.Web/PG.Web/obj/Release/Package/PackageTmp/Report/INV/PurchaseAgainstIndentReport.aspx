<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="PurchaseAgainstIndentReport.aspx.cs" Inherits="PG.Web.Report.INV.PurchageAgainstIndentReport" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Purchase Against Indent Report"></asp:Label>
            </div>
            <!--Message Div -->
        ...
        <div id="dvContentMain" class="dvContentMain">
                            ...
                            <div style="width: 100%; height: 20px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <span>Purchase Against Indent Report</span>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div id="groupContenInner" style="width: 100%; height: auto; text-align: left;">
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="240" CssClass="dropDownList enableIsDirty">
                                                <asp:ListItem  Value="IndentActual">Indent Details Within Date</asp:ListItem>
                                                <asp:ListItem Selected="True" Value="IndentHistory">Indent Details History Report</asp:ListItem>
                                            </asp:DropDownList>   
                                        </td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="Label8" runat="server" Text="Indent No :"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:TextBox ID="txtIndentNo" runat="server" Width="235px" CssClass="textBox fldRequired enableIsDirty"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                             <table cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtGroupName" runat="server" Width="235px" CssClass="textBox"></asp:TextBox>
                                                    </td>
                                                    <td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                             <table cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtItemName" runat="server" Width="235px" CssClass="textBox"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <input id="btnItemLoad" type="button" value="" runat="server" class="buttonDropdown"
                                                            tabindex="-1" />
                                                    </td>
                                                    <td>
                                    ...
                                    <tr class="rowParam">
                                        ...
                                        <td>
                                            <table cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtFromDate" runat="server" Width="100px" CssClass="textBox textDate dateParse"></asp:TextBox>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtToDate" runat="server" Width="100px" CssClass="textBox textDate dateParse"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="right"></td>
                                        <td>
                                            <asp:Button ID="btnLoadReport" runat="server" CssClass="buttoncommon buttonPrint"
                                                Text=" Load Report" OnClick="btnLoadReport_Click" Width="100px"  />
                                            &nbsp;</td>
                                        <td style="" align="left">&nbsp;</td>
            ...
            <br />
            <br /><div style="padding-top:285px"></div>
        </div>
