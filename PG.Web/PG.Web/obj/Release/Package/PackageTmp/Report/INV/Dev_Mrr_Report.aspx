<%@ Page Title="" Language="C#" ViewStateMode="Disabled" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Dev_Mrr_Report.aspx.cs" Inherits="PG.Web.Report.INV.Dev_Mrr_Report" %>
                        ...
                        <div id="dvGrid" style="width: 100%; height: 500px; overflow: auto;">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Width="100%" AutoGenerateColumns="False" KeyFieldName="MRR_NO">
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Supplier" FieldName="SUP_NAME" VisibleIndex="3" Width="130px">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="MRR No" FieldName="MRR_NO" VisibleIndex="4" Width="150px" />
                                    <dx:GridViewDataTextColumn Caption="ITC Date" FieldName="MRR_DATE" VisibleIndex="3" Width="100px">
                                        <DataItemTemplate>
                                            <%#Eval("MRR_DATE", "{0:dd-MMM-yyyy}")%>
                                        </DataItemTemplate>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="PUR No" FieldName="PURCHASE_NO" VisibleIndex="6" Width="150px" />
                                    <dx:GridViewDataTextColumn Caption="Type" FieldName="INV_TRANS_TYPE_NAME" VisibleIndex="7" Width="80px">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="MRR Qty" FieldName="MRR_QTY" VisibleIndex="8" Width="100px" />
                                    <dx:GridViewDataTextColumn Caption="Uom" FieldName="UOM_CODE" VisibleIndex="9" Width="80px" />
