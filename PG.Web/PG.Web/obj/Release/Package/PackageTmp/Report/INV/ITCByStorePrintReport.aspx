<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ITCByStorePrintReport.aspx.cs" Inherits="PG.Web.Report.INV.ITCByStorePrintReport" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="ITC By Store Report"></asp:Label>
            </div>
            <!--Message Div -->
                ...
                <div id="dvControlsInner" class="groupBoxContainer boxShadow">
                                ...
                                <table style="text-align: left;" border="0" cellspacing="4" cellpadding="2">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="right">
                                            <asp:Label ID="Label4" runat="server" Text="IRR Status"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlItcIrrStatus" runat="server" Width="240" CssClass="dropDownList enableIsDirty">
                                                <asp:ListItem Selected="True" Value="0">--All-</asp:ListItem>
                                             <%--   <asp:ListItem Value="ITC-PENDING">ITC Pending</asp:ListItem>--%>
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlReportType" runat="server" Width="210px" CssClass="dropDownList enableIsDirty">
                                                <asp:ListItem Value="AgainstIGR">ITC Against IGR</asp:ListItem>
                                                <asp:ListItem Value="Direct">Direct ITC</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td style="" align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right">
                                            <asp:Label ID="Label6" runat="server" Text="ITC NO:"></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                              <asp:TextBox ID="txtITCNO" runat="server" CssClass="textBox required" Width="190px" Enabled="true"></asp:TextBox>
                                        </td>
                                        <td style="" align="left">
                                            <asp:CheckBox ID="chkIDCPRINT" Text="IDC Print" runat="server" />
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="" align="right">
                                            <asp:Label ID="lblDeptName" runat="server" Text="To Department : "></asp:Label>
                                        </td>
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlDeptName" runat="server" Width="210px" CssClass="dropDownList enableIsDirty"></asp:DropDownList>
                                        </td>
                                        <td style="" align="left"></td>
                                        <td style="" align="left"></td>
                 ...
                 <td style="" align="left">
                     <asp:DropDownList ID="ddlIRRCondition" runat="server" Width="240"  CssClass="dropDownList enableIsDirty">
                         ...
                         <asp:ListItem Text="ITC By Floor" Value="1"></asp:ListItem>
                         <asp:ListItem Text="IRR By Store" Value="2"></asp:ListItem> 
                    </asp:DropDownList>
                 </td>--%>
                                        <td style="" align="right">
                                        ...
                                        <td style="" align="left">
                                            <asp:DropDownList ID="ddlItemSNS" runat="server" CssClass="dropDownList enableIsDirty" Width="210px">
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            ...
                                            <asp:TextBox ID="txtGroupName" runat="server" CssClass="textBox required" Width="190px" Enabled="true"></asp:TextBox><input id="btnGroupID" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 280px" align="left">
                                            ...
                                            <asp:TextBox ID="txtItemName" Width="190px" runat="server" CssClass="textBox required" Enabled="true"></asp:TextBox><input id="btnItemLoad" type="button" value="" runat="server" class="buttonDropdown" tabindex="-1" />
