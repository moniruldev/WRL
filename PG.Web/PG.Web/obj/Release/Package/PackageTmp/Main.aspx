...
<head runat="server">
	...
	*/
	...
	.leftHeader { 
		background: #00B386;
        /*background: #80ade5 url('image/header03_s.png') 0 50% repeat-x;*/
		font-weight: bold;
		text-align: center;
		padding: 2px 0 4px;
		position: relative;
	...
	<div id="container">
		<div id="containerInner" class="pane ui-layout-center">
			<div id="dvTop" class="pane ui-layout-north fixPng"">
			   <div id="dvTopInner" 
					style="padding:0; width:100%;height:100%; Background-color: #00B386;  background-repeat:no-repeat;"> <%--background-image: linear-gradient(to right, green, red,#0094ff, green); --%>
						...
						<td style="width:10px;">
						 ...
						 <td>
						   <table>
							  <tr>
							   <td>
								   <asp:Image ID="imgTopBanner"  runat="server" BorderStyle="None" 
									   ImageUrl="~/image/topbannertext.png"  Visible="false" />
							   </td>
							   </tr>
							   <tr>
								 <td style="">
									 <asp:Label ID="lblVersion" runat="server" CssClass="version" Visible="false"></asp:Label>
							   ...
							   <tr>
								 <td style="">
									  ...
									  <asp:Label ID="lblUserLoc" runat="server" CssClass="version" Visible="false"></asp:Label>
					   ...
					   <table border="0" cellpadding="0" cellspacing="0">
						 <tr>
						  <td align="right" style="padding-right:4px;">
								<input id="btnFullScreen" type="button" value="full screen" onclick="btnFullScreenClick();" />
								<asp:Label ID="Label1" runat="server" CssClass="login" Text="Today:"></asp:Label>
								<asp:Label ID="lblDate" runat="server" CssClass="login" Text="date"></asp:Label>
						  </td>
						  </tr>
						  <tr>
							<td align="right" style="padding-right:4px;">
							   <asp:Label ID="Label3" runat="server" Text="User ID: " CssClass="login"></asp:Label>
								<asp:LoginName ID="LoginName1" runat="server" CssClass="login loginbold"/> 

							</td>
						  </tr>
						  <tr>
                            <td align="left" style="padding-right:4px; float:left;"  >
                               <asp:LinkButton ID="lnkHome" runat="server" CssClass="login loginbold" Font-Names="Verdana" OnClick="lnkHome_Click"  > Back to Home </asp:LinkButton>
                            </td>
							<td align="left" style="padding-right:4px; float:right;" >
							  <asp:LinkButton ID="btnLogout" runat="server" CssClass="login loginbold" onclick="btnLogOut_Click" 
										Font-Names="Verdana">Logout</asp:LinkButton>
			...
			<div id="dvLeft" class="pane ui-layout-west">
				...
				<div id="dvLeftContent"  class="leftContent">
				  <div id="dvLeftContentInner" 
						style="width:100%;height:100%; overflow:auto; background-color: #DDFFEE;"> 
					<div id="dvTreeMenu" style="padding: 2px 2px 2px 4px;" >
						<asp:TreeView ID="TreeView1" runat="server" BackColor="#DDFFEE" Font-Size="8pt" 
							ForeColor="Black" NodeIndent="8"
							EnableViewState="False" Font-Names="Verdana" ImageSet="Simple2" 
							NodeWrap="True" RootNodeStyle-Width="100%" RootNodeStyle-NodeSpacing="2px" 
							ontreenodedatabound="TreeView1_TreeNodeDataBound">
							<HoverNodeStyle Font-Underline="True"  ForeColor="#333399" BackColor="#BCCEF3" />
							<SelectedNodeStyle Font-Bold="True" Font-Italic="False" Font-Underline="True" />
							<RootNodeStyle NodeSpacing="1px" Width="100%" CssClass="menuRootNode"></RootNodeStyle>
