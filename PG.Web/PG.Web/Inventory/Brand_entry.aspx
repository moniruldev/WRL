<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Brand_entry.aspx.cs" Inherits="PG.Web.Inventory.Brand_entry" %>
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Brand"></asp:Label>
            </div>
            <!--Message Div -->
                                ...
                                <table cellpadding="2" cellspacing="4">
                                    <tr>
                                     ...
                                     <tr>
                                        <td></td>
                                        <td align="right">
                                            <asp:Label ID="lblBrandCode" runat="server" Text="Brand Code:"></asp:Label>
                                        </td>
                                        <td align="left">
                                            <asp:TextBox ID="txtBrandCode" runat="server" CssClass="textBoxReadOnly"
                                    ...
                                    <tr>
                                        ...
                                        <td style="" align="left">
                                            <asp:TextBox ID="txtBrandName" runat="server" CssClass="textBox fldRequired enableIsDirty"
