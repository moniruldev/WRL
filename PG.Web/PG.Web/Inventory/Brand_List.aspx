<%@ Page Language="C#" MasterPageFile="~/AppMaster.Master" AutoEventWireup="true" CodeBehind="Brand_List.aspx.cs" Inherits="PG.Web.Inventory.Brand_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function tbopen(key, userid) {
            ...
            var url = IForm.RootPath + "Inventory/Brand_entry.aspx?id=" + key;
    ...
    <div id="dvPageContent" style="width: 100%; height: auto;">
        <div id="dvContentHeader" class="dvContentHeader">
            <div id="dvHeader" class="dvHeader">
                <asp:Label ID="lblHeader" CssClass="lblHeader" runat="server" Text="Brand List"></asp:Label>
            </div>
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <input id="btnAddNew" type="button" runat="server" value="New Brand" class="buttonNew" style="padding-left: 22px; width: 120px;" />
                    ...
                    <div id="dvGridContainer" style="width: 100%; height: auto; text-align: left;">
                        ...
                        <div id="dvGrid" style="width: auto; height: 250px; overflow: auto;">
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                ...
                                DataKeyNames="BRAND_ID" OnRowDataBound="GridView1_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="BRAND_CODE" HeaderText="Code" ItemStyle-Width="80px" />

                                    <asp:BoundField DataField="BRAND_NAME" HeaderText="Name">
