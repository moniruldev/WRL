...
namespace PG.BLLibrary.WRElBL
{
    public class CLIENT_MSTBL
    {
        ...
        public static string GetCLIENTMstListString()
        {
            ...
            sb.Append(" SELECT CLIENT_ID,CLIENT_NAME,CLIENT_TYPE_ID,CLIENT_ADDRESS,MOBILE_NO,REMARKS ");
            sb.Append(" FROM CLIENT_MST  ");
        ...
        public static dcCLIENT_MST GetCLIENT_TYPEInfoById(int pCLIENT_ID)
        {
            return GetCLIENT_TYPEInfoListById(pCLIENT_ID, null).FirstOrDefault();
        }
        public static List<dcCLIENT_MST> GetCLIENT_TYPEInfoListById(int pCLIENT_ID, DBContext dc)
        {
            List<dcCLIENT_MST> cObjList = new List<dcCLIENT_MST>();
            bool isDCInit = false;
            try
            {
                ...
                if (pCLIENT_ID > 0)
                {
                    sb.Append(" AND CLIENT_ID= @pCLIENT_ID ");
        ...
        public static List<dcCLIENT_MST> GetCLIENT_TYPEList(dcCLIENT_MST prmHms, DBContext dc)
        {
            List<dcCLIENT_MST> cObjList = new List<dcCLIENT_MST>();
            bool isDCInit = false;
            try
