...
namespace PG.BLLibrary.WRElBL
{
    public class REFUND_CAUSE_MSTBL
    {
        ...
        public static string GetReturnCauseListString()
        {
            StringBuilder sb = new StringBuilder();

            sb.Append(" SELECT REFUND_CAUSE_ID,REFUND_CAUSE_NAME ");
            sb.Append(" FROM REFUND_CAUSE_MST  ");
        ...
        //public static dcREFUND_CAUSE_MST GetReturnCauseListInfoByName()
        //{
        //    return GetReturnCauseListInfoByName(null);
        //}
        public static List<dcREFUND_CAUSE_MST> GetReturnCauseListInfoByName( DBContext dc)
        {
            ...
            try
            {
                ...
                StringBuilder sb = new StringBuilder(GetReturnCauseListString());
