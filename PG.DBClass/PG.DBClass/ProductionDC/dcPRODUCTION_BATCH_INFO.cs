...
{
    [DBTable(Name = "PRODUCTION_BATCH_INFO")]
    public partial class dcPRODUCTION_BATCH_INFO : DBBaseClass, INotifyPropertyChanged
    {
    ...
    public partial class dcPRODUCTION_BATCH_INFO
    {
