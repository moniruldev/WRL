...
{
    [DBTable(Name = "BOM_MST_T_log")]
    public partial class dcBOM_MST_T_LOG : DBBaseClass, INotifyPropertyChanged
    {
        ...
        private DateTime? m_INSERT_DATE = null;
        ...
        [DBColumn(Name = "SI", Storage = "m_SI", DbType = "Int NOT NULL IDENTITY", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int SI
        {
        ...
        [DBColumn(Name = "BOM_ID", Storage = "m_BOM_ID", DbType = "126")]
        public int BOM_ID
        {
        ...
        [DBColumn(Name = "INSERT_DATE", Storage = "m_INSERT_DATE", DbType = "106")]
        public DateTime? INSERT_DATE
        {
            get { return this.m_INSERT_DATE; }
            set
            {
                this.m_INSERT_DATE = value;
                this.NotifyPropertyChanged("INSERT_DATE");
            }
        }
        #endregion //properties
    }

    public partial class dcBOM_MST_T_LOG
    {
        public string m_ITEM_NAME = "";
        private List<dcBOM_DTL_T_LOG> m_BOMDetListLog = null;

        public string m_FULL_NAME = "";
        public List<dcBOM_DTL_T_LOG>  BOMDetListLog
        {
            get { return m_BOMDetListLog; }
            set { m_BOMDetListLog = value; }
        }
