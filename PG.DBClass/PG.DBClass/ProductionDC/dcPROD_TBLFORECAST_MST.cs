...
{
    [DBTable(Name = "PROD_TBLFORECAST_MST")]
    public partial class dcPROD_TBLFORECAST_MST : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_FC_ID = 0;
        private string m_FC_DESC = string.Empty;
        ...
        [DBColumn(Name = "FC_ID", Storage = "m_FC_ID", DbType = "Int NOT NULL IDENTITY", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int FC_ID
        {
        ...
        [DBColumn(Name = "FC_DESC", Storage = "m_FC_DESC", DbType = "126")]
        public string FC_DESC
        {
            get { return this.m_FC_DESC; }
            set
            {
                this.m_FC_DESC = value;
                this.NotifyPropertyChanged("FC_DESC");
            }
        }
        //  DbType = "Int NOT NULL IDENTITY", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true
        [DBColumn(Name = "FOR_MONTH", Storage = "m_FOR_MONTH", DbType = "126")]
        ...
        [DBColumn(Name = "FOR_YEAR", Storage = "m_FOR_YEAR", DbType = "126")]
        public int FOR_YEAR
        {
    ...
    public partial class dcPROD_TBLFORECAST_MST
    {
        private List<dcPROD_TBLFORECAST_DTL> m_ForecastDetList = null;
        public List<dcPROD_TBLFORECAST_DTL> ForecastDetList
        {
            get { return m_ForecastDetList; }
            set { m_ForecastDetList = value; }
        }


        private string m_FGFC_TYPENAME = "";
        public string FGFC_TYPENAME
        {
            get { return this.m_FGFC_TYPENAME; }
            set
            {
                m_FGFC_TYPENAME = value;
        ...
        private string m_FORCAST_BY_NAME = "";
        public string FORCAST_BY_NAME
        {
            get { return this.m_FORCAST_BY_NAME; }
            set
            {
                m_FORCAST_BY_NAME = value;
            }
        }
