...
{
    [DBTable(Name = "MACHINE_MST_ASM")]
    public partial class dcMACHINE_MST_ASM : DBBaseClass, INotifyPropertyChanged
    {
        ...
        [DBColumn(Name = "ORDER_SI", Storage = "m_ORDER_SI", DbType = "107")]
        public decimal ORDER_SI
        {
            get { return this.m_ORDER_SI; }
            set
            {
                this.m_ORDER_SI = value;
                this.NotifyPropertyChanged("ORDER_SI");
            }
        }
