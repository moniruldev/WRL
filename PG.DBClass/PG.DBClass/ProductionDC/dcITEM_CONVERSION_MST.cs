...
{
    [DBTable(Name = "ITEM_CONVERSION_MST")]
    public partial class dcITEM_CONVERSION_MST : DBBaseClass, INotifyPropertyChanged
    {
        ...
        private string m_CONVERSION_TYPE = string.Empty;
        ...
        [DBColumn(Name = "CONVERSION_MST_ID", Storage = "m_CONVERSION_MST_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        ...
        [DBColumn(Name = "CONVERSION_TYPE", Storage = "m_CONVERSION_TYPE", DbType = "126")]
        public string CONVERSION_TYPE
        {
            get { return this.m_CONVERSION_TYPE; }
            set
            {
                this.m_CONVERSION_TYPE = value;
                this.NotifyPropertyChanged("CONVERSION_TYPE");
            }
        }
    ...
    public partial class dcITEM_CONVERSION_MST
     {
        public List<dcITEM_CONVERSION_DTL> CONVERSION_DTL_LIST = new List<dcITEM_CONVERSION_DTL>();
