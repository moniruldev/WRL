...
{
    [DBTable(Name = "PROD_BATT_BREAKING_DTL")]
    public partial class dcPROD_BATT_BREAKING_DTL : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_BREAKING_DTL_ID = 0;
        private int m_BREAKING_MST_ID = 0;
        ...
        private string m_OPERATOR_ID = string.Empty;
        private decimal m_USED_BAR_PC = 0;
        private decimal m_BAR_TYPE = 0;
        private decimal m_USED_QTY_KG = 0;
        private decimal m_BAR_WEIGHT = 0;
        private string m_GRID_BATCH = string.Empty;
        private decimal m_AMPERE = 0;
        private decimal m_CYCLETIME = 0;
        private decimal m_SULFURIC_GRAVITY = 0;
        private decimal m_TEMPARATURE = 0;
        private decimal m_UNFORMED_QTY = 0;
        private decimal m_FORMED_QTY = 0;
        private string m_PASTING_BATCH = string.Empty;
        private string m_FORMATION_STARTTIME = string.Empty;
        private DateTime? m_FORMATION_OFFDATE = null;
        private string m_FORMATION_OFFTIME = string.Empty;
        private decimal m_REJECT_QTY = 0;
        private string m_IS_PACKING = string.Empty;
        private string m_PACK_FINISHED_BATCH = string.Empty;
        private string m_FILLING_BATCH = string.Empty;
        private string m_SULPHATION_STARTTIME = string.Empty;
        private DateTime? m_SULPHATION_OFFDATE = null;
        private string m_SULPHATION_OFFTIME = string.Empty;
        private int m_USED_ITEM_ID = 0;
        private string m_IS_UNFORMED = string.Empty;
        private string m_PROCESSTYPE = string.Empty;
        private decimal m_ITEM_STANDARD_WEIGHT_KG = 0;
        private decimal m_SML_ITEM_PC = 0;
        private int m_PROD_BAT_TYPE_ID = 0;
        ...
        [DBColumn(Name = "BREAKING_DTL_ID", Storage = "m_BREAKING_DTL_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int BREAKING_DTL_ID
        {
            get { return this.m_BREAKING_DTL_ID; }
            set
            {
                this.m_BREAKING_DTL_ID = value;
                this.NotifyPropertyChanged("BREAKING_DTL_ID");
            }
        }

        [DBColumn(Name = "BREAKING_MST_ID", Storage = "m_BREAKING_MST_ID", DbType = "107")]
        public int BREAKING_MST_ID
        {
            get { return this.m_BREAKING_MST_ID; }
            set
            {
                this.m_BREAKING_MST_ID = value;
                this.NotifyPropertyChanged("BREAKING_MST_ID");
            }
        }
        ...
        [DBColumn(Name = "OPERATOR_ID", Storage = "m_OPERATOR_ID", DbType = "126")]
        ...
        [DBColumn(Name = "GRID_BATCH", Storage = "m_GRID_BATCH", DbType = "126")]
        ...
        [DBColumn(Name = "PASTING_BATCH", Storage = "m_PASTING_BATCH", DbType = "126")]
        ...
        [DBColumn(Name = "FORMATION_STARTTIME", Storage = "m_FORMATION_STARTTIME", DbType = "126")]
        ...
        [DBColumn(Name = "FORMATION_OFFDATE", Storage = "m_FORMATION_OFFDATE", DbType = "106")]
        ...
        [DBColumn(Name = "FORMATION_OFFTIME", Storage = "m_FORMATION_OFFTIME", DbType = "126")]
        ...
        [DBColumn(Name = "PACK_FINISHED_BATCH", Storage = "m_PACK_FINISHED_BATCH", DbType = "126")]
        ...
        [DBColumn(Name = "FILLING_BATCH", Storage = "m_FILLING_BATCH", DbType = "126")]
        ...
        [DBColumn(Name = "SULPHATION_STARTTIME", Storage = "m_SULPHATION_STARTTIME", DbType = "126")]
        ...
        [DBColumn(Name = "SULPHATION_OFFDATE", Storage = "m_SULPHATION_OFFDATE", DbType = "106")]
        ...
        [DBColumn(Name = "SULPHATION_OFFTIME", Storage = "m_SULPHATION_OFFTIME", DbType = "126")]
        ...
        [DBColumn(Name = "IS_UNFORMED", Storage = "m_IS_UNFORMED", DbType = "126")]
        ...
        [DBColumn(Name = "PROCESSTYPE", Storage = "m_PROCESSTYPE", DbType = "126")]
        ...
        [DBColumn(Name = "PROD_BAT_TYPE_ID", Storage = "m_PROD_BAT_TYPE_ID", DbType = "107")]
        public int PROD_BAT_TYPE_ID
        {
            get { return this.m_PROD_BAT_TYPE_ID; }
            set
            {
                this.m_PROD_BAT_TYPE_ID = value;
                this.NotifyPropertyChanged("PROD_BAT_TYPE_ID");
            }
        }
        ...
        [DBColumn(Name = "BATCH_NO_DTL", Storage = "m_BATCH_NO_DTL", DbType = "126")]
        public string BATCH_NO_DTL
        {
            get { return this.m_BATCH_NO_DTL; }
            set
            {
                this.m_BATCH_NO_DTL = value;
                this.NotifyPropertyChanged("BATCH_NO_DTL");
            }
        }

        [DBColumn(Name = "QA_PASS_STATUS_ID", Storage = "m_QA_PASS_STATUS_ID", DbType = "107")]
        public decimal QA_PASS_STATUS_ID
        {
        ...
        public decimal FALSE_LUG_ITEM_ID
        {
        ...
        [DBColumn(Name = "MANUAL_SLNO", Storage = "m_MANUAL_SLNO", DbType = "126")]
    ...
    public partial class dcPROD_BATT_BREAKING_DTL
    {
