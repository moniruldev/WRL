...
{
    [DBTable(Name = "PROD_SCRAP_DTL")]
    public partial class dcPROD_SCRAP_DTL : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_SCRAP_DTL_ID = 0;
        private int m_SCRAP_ID = 0;
        private int m_ITEM_ID = 0;
        private int m_UOM_ID = 0;
        private decimal m_ITEM_QTY = 0;
        private string m_REMARKS = string.Empty;
        private decimal m_SI = 0;
        ...
        [DBColumn(Name = "SCRAP_DTL_ID", Storage = "m_SCRAP_DTL_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int SCRAP_DTL_ID
        {
            get { return this.m_SCRAP_DTL_ID; }
            set
            {
                this.m_SCRAP_DTL_ID = value;
                this.NotifyPropertyChanged("SCRAP_DTL_ID");
            }
        }

        [DBColumn(Name = "SCRAP_ID", Storage = "m_SCRAP_ID", DbType = "107")]
        public int SCRAP_ID
        {
     ...
     public partial class dcPROD_SCRAP_DTL
     {
