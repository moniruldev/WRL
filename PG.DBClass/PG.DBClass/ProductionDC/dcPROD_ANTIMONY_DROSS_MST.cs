...
{
    [DBTable(Name = "PROD_ANTIMONY_DROSS_MST")]
    public partial class dcPROD_ANTIMONY_DROSS_MST : DBBaseClass, INotifyPropertyChanged
    {
        ...
        [DBColumn(Name = "DROSS_AN_MST_ID", Storage = "m_DROSS_AN_MST_ID", DbType = "Int NOT NULL IDENTITY", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true )]
        ...
        [DBColumn(Name = "DROSS_AN_NO", Storage = "m_DROSS_AN_NO", DbType = "126")]
        public string DROSS_AN_NO
        {
            get { return this.m_DROSS_AN_NO; }
            set
            {
                this.m_DROSS_AN_NO = value;
                this.NotifyPropertyChanged("DROSS_AN_NO");
            }
        }
    ...
    public partial class dcPROD_ANTIMONY_DROSS_MST
    {
        ...
        private List<dcPROD_ANTIMONY_ALOY_DROSS_DTL> m_PROD_ANTIMONY_ALOY_DROSS_DTL_List = null;
        public List<dcPROD_ANTIMONY_ALOY_DROSS_DTL> PROD_ANTIMONY_ALOY_DROSS_DTL_List
        {
            get { return m_PROD_ANTIMONY_ALOY_DROSS_DTL_List; }
            set { m_PROD_ANTIMONY_ALOY_DROSS_DTL_List = value; }
        }
