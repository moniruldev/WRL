...
{
    [DBTable(Name = "IB_CUTTING_MST")]
    public partial class dcIB_CUTTING_MST : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private Int64 m_CUTTING_MST_ID = 0;
        private string m_CUTTING_MAS_NO = string.Empty;
        ...
        [DBColumn(Name = "CUTTING_MST_ID", Storage = "m_CUTTING_MST_ID", DbType = "Int NOT NULL IDENTITY", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        ...
        [DBColumn(Name = "CUTTING_MAS_NO", Storage = "m_CUTTING_MAS_NO", DbType = "126")]
        public string CUTTING_MAS_NO
        {
            get { return this.m_CUTTING_MAS_NO; }
            set
            {
                this.m_CUTTING_MAS_NO = value;
                this.NotifyPropertyChanged("CUTTING_MAS_NO");
            }
        }
    ...
    public partial class dcIB_CUTTING_MST
    {
        ...
        private List<dcIB_CUTTING_DTL> m_Ib_Cutting_Dtl_List = null;
        public List<dcIB_CUTTING_DTL> Ib_Cutting_Dtl_List
        {
            get { return m_Ib_Cutting_Dtl_List; }
            set { m_Ib_Cutting_Dtl_List = value; }
        }
