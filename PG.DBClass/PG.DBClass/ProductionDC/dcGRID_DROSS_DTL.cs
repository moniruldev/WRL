...
{
    [DBTable(Name = "GRID_DROSS_DTL")]
    public partial class dcGRID_DROSS_DTL : DBBaseClass, INotifyPropertyChanged
    {
        #region private members
        

        private Int64 m_DROSS_DTL_ID = 0;
        private Int64 m_DROSS_MST_ID = 0;
        private Int64 m_ITEM_ID = 0;
        private Int64 m_USED_ITEM_ID = 0;
        private decimal m_ITEM_QTY = 0;
        private int m_UOM_ID = 0;
        private string m_REMARKS = string.Empty;
        private int m_SLNO = 0;
        private Int64 m_PROD_MST_ID = 0;
        ...
        [DBColumn(Name = "DROSS_DTL_ID", Storage = "m_CUTTING_DTL_ID", DbType = "Int NOT NULL IDENTITY", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public Int64 DROSS_DTL_ID
        {
        ...
        [DBColumn(Name = "DROSS_MST_ID", Storage = "m_DROSS_MST_ID", DbType = "107")]
    ...
    public partial class dcGRID_DROSS_DTL
    {
        ...
        {
            get { return m_DROSS_NO; }
            set { m_DROSS_NO = value; }
        }
