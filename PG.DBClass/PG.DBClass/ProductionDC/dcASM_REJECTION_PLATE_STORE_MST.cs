...
{
    [DBTable(Name = "ASM_REJECTION_PLATE_STORE_MST")]
    public partial class dcASM_REJECTION_PLATE_STORE_MST : DBBaseClass, INotifyPropertyChanged
    {
    ...
    public partial class dcASM_REJECTION_PLATE_STORE_MST
    {

        private List<dcASM_REJECTION_PLATE_STORE_DTL> m_RejectionDetList = null;
        public List<dcASM_REJECTION_PLATE_STORE_DTL> RejectionDetList
        {
