...
{
    [DBTable(Name = "PROD_CMP_CRUSHING_PP_DTL")]
    public partial class dcPROD_CMP_CRUSHING_PP_DTL : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_PROD_CMP_CRUS_DTL_ID = 0;
        private int m_PROD_CMP_CRUS_ID = 0;
        private int m_ITEM_ID = 0;
        private decimal m_ITEM_QTY = 0;
        private int m_UOM_ID = 0;
        private string m_CMP_CRUS_DET_REMARKS = string.Empty;
        private int m_CMP_CRUS_DET_SLNO = 0;
        private int m_MACHINE_ID = 0;
        private string m_OPERATOR_ID = string.Empty;
        private int m_MIXED_CRUSHING_TYPE_ID = 0;
        private int m_REJECT_ITEM_ID = 0;
        private decimal m_REJECT_ITEM_QTY = 0;
        private int m_REJECT_UOM_ID = 0;
        ...
        [DBColumn(Name = "PROD_CMP_CRUS_DTL_ID", Storage = "m_PROD_CMP_CRUS_DTL_ID", DbType = "Int NOT NULL IDENTITY", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int PROD_CMP_CRUS_DTL_ID
        {
            get { return this.m_PROD_CMP_CRUS_DTL_ID; }
            set
            {
                this.m_PROD_CMP_CRUS_DTL_ID = value;
                this.NotifyPropertyChanged("PROD_CMP_CRUS_DTL_ID");
            }
        }

        [DBColumn(Name = "PROD_CMP_CRUS_ID", Storage = "m_PROD_CMP_CRUS_ID", DbType = "107")]
        ...
        [DBColumn(Name = "CMP_CRUS_DET_REMARKS", Storage = "m_CMP_CRUS_DET_REMARKS", DbType = "126")]
        public string CMP_CRUS_DET_REMARKS
        {
            get { return this.m_CMP_CRUS_DET_REMARKS; }
            set
            {
                this.m_CMP_CRUS_DET_REMARKS = value;
                this.NotifyPropertyChanged("CMP_CRUS_DET_REMARKS");
            }
        }

        [DBColumn(Name = "CMP_CRUS_DET_SLNO", Storage = "m_CMP_CRUS_DET_SLNO", DbType = "107")]
        public int CMP_CRUS_DET_SLNO
        {
            get { return this.m_CMP_CRUS_DET_SLNO; }
            set
            {
                this.m_CMP_CRUS_DET_SLNO = value;
                this.NotifyPropertyChanged("CMP_CRUS_DET_SLNO");
            }
        }
        ...
        public int MIXED_CRUSHING_TYPE_ID
        {
        ...
        [DBColumn(Name = "REJECT_ITEM_QTY", Storage = "m_REJECT_ITEM_QTY", DbType = "107")]
        public decimal REJECT_ITEM_QTY
        {
            get { return this.m_REJECT_ITEM_QTY; }
            set
            {
                this.m_REJECT_ITEM_QTY = value;
                this.NotifyPropertyChanged("REJECT_ITEM_QTY");
            }
        }

        [DBColumn(Name = "REJECT_UOM_ID", Storage = "m_REJECT_UOM_ID", DbType = "107")]
        public int REJECT_UOM_ID
        {
            get { return this.m_REJECT_UOM_ID; }
            set
            {
                this.m_REJECT_UOM_ID = value;
                this.NotifyPropertyChanged("REJECT_UOM_ID");
            }
        }
    ...
    public partial class dcPROD_CMP_CRUSHING_PP_DTL
    {
        ...
        public string REJECT_UOM_NAME { get; set; }
