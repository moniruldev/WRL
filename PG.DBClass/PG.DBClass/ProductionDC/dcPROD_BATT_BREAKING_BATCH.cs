...
{
    [DBTable(Name = "PROD_BATT_BREAKING_BATCH")]
    public partial class dcPROD_BATT_BREAKING_BATCH : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_BREAKING_BATCH_ID = 0;
        ...
        [DBColumn(Name = "BREAKING_BATCH_ID", Storage = "m_BREAKING_BATCH_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int BREAKING_BATCH_ID
        {
            get { return this.m_BREAKING_BATCH_ID; }
            set
            {
                this.m_BREAKING_BATCH_ID = value;
                this.NotifyPropertyChanged("BREAKING_BATCH_ID");
            }
        }
