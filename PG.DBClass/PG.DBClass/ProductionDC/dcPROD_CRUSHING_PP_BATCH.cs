...
{
     [DBTable(Name = "PROD_CRUSHING_PP_BATCH")]
   public partial class dcPROD_CRUSHING_PP_BATCH : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_PROD_BATCH_ID = 0;
        ...
        [DBColumn(Name = "PROD_BATCH_ID", Storage = "m_PROD_BATCH_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int PROD_BATCH_ID
        {
            get { return this.m_PROD_BATCH_ID; }
            set
            {
                this.m_PROD_BATCH_ID = value;
                this.NotifyPropertyChanged("PROD_BATCH_ID");
            }
        }
     ...
     public partial class dcPROD_CRUSHING_PP_BATCH
        {
