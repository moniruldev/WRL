...
{
    [DBTable(Name = "ASM_REJECTION_PLATE_STORE_DTL")]
    public partial class dcASM_REJECTION_PLATE_STORE_DTL : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_PROD_REJECTION_DTL_ID = 0;
        private decimal m_PROD_REJECTION_ID = 0;
        ...
        private decimal m_TO_REJ_ITEM_ID = 0;
        ...
        public decimal PROD_REJECTION_ID
        {
        ...
        [DBColumn(Name = "TO_REJ_ITEM_ID", Storage = "m_TO_REJ_ITEM_ID", DbType = "107")]
        public decimal TO_REJ_ITEM_ID
        {
    ...
    public partial class dcASM_REJECTION_PLATE_STORE_DTL
    {
