...
{
    [DBTable(Name = "PROD_DMW_REGEN_CONSUM_MST")]
    public partial class dcPROD_DMW_REGEN_CONSUM_MST : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_PROD_DMW_REGEN_ID = 0;
        private string m_PROD_DMW_REGEN_NO = string.Empty;
        private DateTime? m_PROD_DMW_REGEN_DATE = null;
        private decimal m_DEPT_ID = 0;
        private string m_DMW_REGEN_REMARKS = string.Empty;
        ...
        [DBColumn(Name = "PROD_DMW_REGEN_ID", Storage = "m_PROD_DMW_REGEN_ID", DbType = "Int NOT NULL IDENTITY", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        ...
        [DBColumn(Name = "PROD_DMW_REGEN_NO", Storage = "m_PROD_DMW_REGEN_NO", DbType = "126")]
        public string PROD_DMW_REGEN_NO
        {
            get { return this.m_PROD_DMW_REGEN_NO; }
            set
            {
                this.m_PROD_DMW_REGEN_NO = value;
                this.NotifyPropertyChanged("PROD_DMW_REGEN_NO");
            }
        }

        [DBColumn(Name = "PROD_DMW_REGEN_DATE", Storage = "m_PROD_DMW_REGEN_DATE", DbType = "106")]
        public DateTime? PROD_DMW_REGEN_DATE
        {
            get { return this.m_PROD_DMW_REGEN_DATE; }
            set
            {
                this.m_PROD_DMW_REGEN_DATE = value;
                this.NotifyPropertyChanged("PROD_DMW_REGEN_DATE");
            }
        }
        ...
        [DBColumn(Name = "DMW_REGEN_REMARKS", Storage = "m_DMW_REGEN_REMARKS", DbType = "126")]
        public string DMW_REGEN_REMARKS
        {
            get { return this.m_DMW_REGEN_REMARKS; }
            set
            {
                this.m_DMW_REGEN_REMARKS = value;
                this.NotifyPropertyChanged("DMW_REGEN_REMARKS");
            }
        }
    ...
    public partial class dcPROD_DMW_REGEN_CONSUM_MST
    {

        private List<dcPROD_DMW_REGEN_CONSUM_DTL> m_PROD_DMW_REGEN_CONSUMDetList = null;


        public List<dcPROD_DMW_REGEN_CONSUM_DTL> PROD_DMW_REGEN_CONSUMDetList
        {
            get { return m_PROD_DMW_REGEN_CONSUMDetList; }
            set { m_PROD_DMW_REGEN_CONSUMDetList = value; }
        }
