...
{
    [DBTable(Name = "PROD_REJECTION_BATCH")]
    public partial class dcPROD_REJECTION_BATCH : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_REJ_BATCH_ID = 0;
        private int m_REJECTION_ID = 0;
        ...
        [DBColumn(Name = "REJ_BATCH_ID", Storage = "m_REJ_BATCH_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int REJ_BATCH_ID
        {
            get { return this.m_REJ_BATCH_ID; }
            set
            {
                this.m_REJ_BATCH_ID = value;
                this.NotifyPropertyChanged("REJ_BATCH_ID");
            }
        }

        [DBColumn(Name = "REJECTION_ID", Storage = "m_REJECTION_ID", DbType = "107")]
        public int REJECTION_ID
        {
            get { return this.m_REJECTION_ID; }
            set
            {
                this.m_REJECTION_ID = value;
                this.NotifyPropertyChanged("REJECTION_ID");
            }
        }
     ...
     public partial class dcPROD_REJECTION_BATCH
     {
