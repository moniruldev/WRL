...
{
    [DBTable(Name = "ITC_BATCH_INFO")]
    public partial class dcITC_BATCH_INFO : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_ITC_BATCH_ID = 0;
        ...
        [DBColumn(Name = "ITC_BATCH_ID", Storage = "m_ITC_BATCH_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int ITC_BATCH_ID
        {
            get { return this.m_ITC_BATCH_ID; }
            set
            {
                this.m_ITC_BATCH_ID = value;
                this.NotifyPropertyChanged("ITC_BATCH_ID");
            }
        }
    ...
    public partial class dcITC_BATCH_INFO
    {
