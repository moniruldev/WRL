...
{
    [DBTable(Name = "REQ_COMMENT_DTL")]
    public partial class dcREQ_COMMENT_DTL : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_REQ_COMMENT_DTL_ID = 0;
        ...
        [DBColumn(Name = "REQ_COMMENT_DTL_ID", Storage = "m_REQ_COMMENT_DTL_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int REQ_COMMENT_DTL_ID
        {
            get { return this.m_REQ_COMMENT_DTL_ID; }
            set
            {
                this.m_REQ_COMMENT_DTL_ID = value;
                this.NotifyPropertyChanged("REQ_COMMENT_DTL_ID");
            }
        }
