...
{
    [DBTable(Name = "RTN_RECEIVE_MST")]
    public partial class dcRTN_RECEIVE_MST : DBBaseClass, INotifyPropertyChanged
    {
        ...
        [DBColumn(Name = "RECEIVE_ID", Storage = "m_RECEIVE_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
     ...
     public partial class dcRTN_RECEIVE_MST
     {
