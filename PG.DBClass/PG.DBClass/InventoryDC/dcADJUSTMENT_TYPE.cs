...
{
    [DBTable(Name = "ADJUSTMENT_TYPE")]
    public partial class dcADJUSTMENT_TYPE : DBBaseClass, INotifyPropertyChanged
    {
        ...
        [DBColumn(Name = "ADJUST_TYPE_ID", Storage = "m_ADJUST_TYPE_ID", DbType = "126", IsPrimaryKey = true)]
