...
namespace PG.DBClass.InventoryDC
{
    ...
    public partial class dcDEPARTMENT_INFO : DBBaseClass, INotifyPropertyChanged
    {
        ...
        private decimal m_DEP_HEAD_EMP_KEY = 0;
        private string m_IS_ITC = string.Empty;
        ...
        public decimal DEP_HEAD_EMP_KEY
        {
         ...
         [DBColumn(Name = "IS_ITC", Storage = "m_IS_ITC", DbType = "107")]
        public string IS_ITC
        {
            get { return this.m_IS_ITC; }
            set
            {
                this.m_IS_ITC = value;
                this.NotifyPropertyChanged("IS_ITC");
            }
        }

         [DBColumn(Name = "IS_ACTIVE", Storage = "m_IS_ACTIVE", DbType = "107")]
    ...
    public partial class dcDEPARTMENT_INFO
    {
        ...
        public string IS_BATCH_USABLE { get; set; }
    }
}
