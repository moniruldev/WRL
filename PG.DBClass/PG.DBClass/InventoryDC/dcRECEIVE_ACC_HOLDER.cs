...
{
    [DBTable(Name = "RECEIVE_ACC_HOLDER")]
    public partial class dcRECEIVE_ACC_HOLDER : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_RCV_ACC_HOLD_ID = 0;
        private decimal m_RECEIVE_ID = 0;
        private decimal m_BANK_ID = 0;
        private decimal m_BRANCH_ID = 0;
        private decimal m_ACC_HOLDER_ID = 0;
        private decimal m_ACC_HOLDER_DTL_ID = 0;
        private string m_ACC_NO = string.Empty;
        private decimal m_ONLINE_AMT = 0;
        private string m_TT_NO = string.Empty;
        ...
        private decimal m_ONLINE_AMT_VAT = 0;
        private decimal m_ALTU = 0;
        ...
        [DBColumn(Name = "RCV_ACC_HOLD_ID", Storage = "m_RCV_ACC_HOLD_ID", DbType = "Int NOT NULL IDENTITY", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int RCV_ACC_HOLD_ID
        {
            get { return this.m_RCV_ACC_HOLD_ID; }
            set
            {
                this.m_RCV_ACC_HOLD_ID = value;
                this.NotifyPropertyChanged("RCV_ACC_HOLD_ID");
            }
        }
        ...
        [DBColumn(Name = "ACC_HOLDER_ID", Storage = "m_ACC_HOLDER_ID", DbType = "107")]
        public decimal ACC_HOLDER_ID
        {
        ...
        [DBColumn(Name = "ONLINE_AMT", Storage = "m_ONLINE_AMT", DbType = "107")]
        public decimal ONLINE_AMT
        {
            get { return this.m_ONLINE_AMT; }
            set
            {
                this.m_ONLINE_AMT = value;
                this.NotifyPropertyChanged("ONLINE_AMT");
            }
        }

        [DBColumn(Name = "TT_NO", Storage = "m_TT_NO", DbType = "126")]
        public string TT_NO
        {
            get { return this.m_TT_NO; }
            set
            {
                this.m_TT_NO = value;
                this.NotifyPropertyChanged("TT_NO");
            }
        }
        ...
        [DBColumn(Name = "ONLINE_AMT_VAT", Storage = "m_ONLINE_AMT_VAT", DbType = "107")]
        public decimal ONLINE_AMT_VAT
        {
            get { return this.m_ONLINE_AMT_VAT; }
            set
            {
                this.m_ONLINE_AMT_VAT = value;
                this.NotifyPropertyChanged("ONLINE_AMT_VAT");
            }
        }

        [DBColumn(Name = "ALTU", Storage = "m_ALTU", DbType = "107")]
        public decimal ALTU
        {
            get { return this.m_ALTU; }
            set
            {
                this.m_ALTU = value;
                this.NotifyPropertyChanged("ALTU");
            }
        }
