...
{
     [Serializable]
    [DBTable(Name = "SALES_RETURN_DETAILS")]
    public partial class dcSALES_RETURN_DETAILS : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private decimal m_RTN_DET_ID = 0;
        private decimal m_RTN_ID = 0;
        private decimal m_RTN_DET_SLNO = 0;
        ...
        [DBColumn(Name = "RTN_DET_ID", Storage = "m_RTN_DET_ID", DbType = "Int NOT NULL IDENTITY", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public decimal RTN_DET_ID
        {
    ...
    public partial class dcSALES_RETURN_DETAILS
    {
