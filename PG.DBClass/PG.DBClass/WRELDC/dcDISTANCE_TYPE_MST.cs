...
{
    [DBTable(Name = "DISTANCE_TYPE_MST")]
    public partial class dcDISTANCE_TYPE_MST : DBBaseClass, INotifyPropertyChanged
    {
        ...
        [DBColumn(Name = "DISTANCE_TYPE_ID", Storage = "m_DISTANCE_TYPE_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        ...
        [DBColumn(Name = "TYPE_NAME", Storage = "m_TYPE_NAME", DbType = "126")]
        public string TYPE_NAME
        {
            ...
            set
            {
                ...
                this.NotifyPropertyChanged("TYPE_NAME");
            }
        }
