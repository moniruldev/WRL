...
{
    [DBTable(Name = "BRANCH_THANA_ASSIGNING")]
    public partial class dcBRANCH_THANA_ASSIGNING : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_BRANCH_THANA_ID = 0;
        ...
        [DBColumn(Name = "BRANCH_THANA_ID", Storage = "m_BRANCH_THANA_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int BRANCH_THANA_ID
        {
            get { return this.m_BRANCH_THANA_ID; }
            set
            {
                this.m_BRANCH_THANA_ID = value;
                this.NotifyPropertyChanged("BRANCH_THANA_ID");
            }
        }
    ...
    public partial class dcBRANCH_THANA_ASSIGNING
    {
