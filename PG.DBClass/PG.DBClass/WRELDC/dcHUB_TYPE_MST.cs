...
{
    [DBTable(Name = "HUB_TYPE_MST")]
    public partial class dcHUB_TYPE_MST : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_HUB_TYPE_ID = 0;
        private string m_HUB_TYPE_NAME = string.Empty;
        ...
        [DBColumn(Name = "HUB_TYPE_ID", Storage = "m_HUB_TYPE_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int HUB_TYPE_ID
        {
        ...
        [DBColumn(Name = "HUB_TYPE_NAME", Storage = "m_HUB_TYPE_NAME", DbType = "126")]
        public string HUB_TYPE_NAME
        {
            get { return this.m_HUB_TYPE_NAME; }
            set
            {
                this.m_HUB_TYPE_NAME = value;
                this.NotifyPropertyChanged("HUB_TYPE_NAME");
            }
        }
