...
{
    [DBTable(Name = "CLIENT_TYPE_MST")]
    public partial class dcCLIENT_TYPE_MST : DBBaseClass, INotifyPropertyChanged
    {
        ...
        [DBColumn(Name = "CLIENT_TYPE_ID", Storage = "m_CLIENT_TYPE_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
