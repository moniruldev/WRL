...
{
    [DBTable(Name = "ITEM_MST")]
    public partial class dcITEM_MST : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_ITEM_ID = 0;
        private string m_ITEM_NAME = string.Empty;
        private decimal m_ITEM_TYPE_ID = 0;
        private decimal m_UOM_ID = 0;
        private decimal m_SERVICE_CHARGE_AMT_DEFAULT = 0;
        ...
        [DBColumn(Name = "ITEM_ID", Storage = "m_ITEM_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
        public int ITEM_ID
        {
        ...
        [DBColumn(Name = "SERVICE_CHARGE_AMT_DEFAULT", Storage = "m_SERVICE_CHARGE_AMT_DEFAULT", DbType = "107")]
        public decimal SERVICE_CHARGE_AMT_DEFAULT
        {
            get { return this.m_SERVICE_CHARGE_AMT_DEFAULT; }
            set
            {
                this.m_SERVICE_CHARGE_AMT_DEFAULT = value;
                this.NotifyPropertyChanged("SERVICE_CHARGE_AMT_DEFAULT");
            }
        }
