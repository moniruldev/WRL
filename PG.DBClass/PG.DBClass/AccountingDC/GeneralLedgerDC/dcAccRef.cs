...
{
    [DBTable(Name = "tblAccRef")]
    public partial class dcAccRef : DBBaseClass, INotifyPropertyChanged
    {
        ...
        private string m_AccRefDesc = string.Empty;
        private int m_AccRefIDParent = 0;
        private int m_AccRefSLNo = 0;
        ...
        [DBColumn(Name = "AccRefID", Storage = "m_AccRefID", DbType = "Int NOT NULL IDENTITY", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true,IsIdentity=true)]
        public int AccRefID
        {
        ...
        [DBColumn(Name = "AccRefCode", Storage = "m_AccRefCode", DbType = "NVarChar(50) NULL")]
        public string AccRefCode
        {
            get { return this.m_AccRefCode; }
            set
            {
                this.m_AccRefCode = value;
                this.NotifyPropertyChanged("AccRefCode");
            }
        }

        [DBColumn(Name = "AccRefNameShort", Storage = "m_AccRefNameShort", DbType = "NVarChar(50) NULL")]
        public string AccRefNameShort
        {
            get { return this.m_AccRefNameShort; }
            set
            {
                this.m_AccRefNameShort = value;
                this.NotifyPropertyChanged("AccRefNameShort");
            }
        }

        [DBColumn(Name = "AccRefName", Storage = "m_AccRefName", DbType = "NVarChar(100) NULL")]
        public string AccRefName
        {
            get { return this.m_AccRefName; }
            set
            {
                this.m_AccRefName = value;
                this.NotifyPropertyChanged("AccRefName");
            }
        }

        [DBColumn(Name = "AccRefDesc", Storage = "m_AccRefDesc", DbType = "NVarChar(MAX) NULL")]
        public string AccRefDesc
        {
            get { return this.m_AccRefDesc; }
            set
            {
                this.m_AccRefDesc = value;
                this.NotifyPropertyChanged("AccRefDesc");
            }
        }

        [DBColumn(Name = "AccRefIDParent", Storage = "m_AccRefIDParent", DbType = "Int NULL")]
        public int AccRefIDParent
        {
            get { return this.m_AccRefIDParent; }
            set
            {
                this.m_AccRefIDParent = value;
                this.NotifyPropertyChanged("AccRefIDParent");
            }
        }

        [DBColumn(Name = "AccRefSLNo", Storage = "m_AccRefSLNo", DbType = "Int NULL")]
        public int AccRefSLNo
        {
            get { return this.m_AccRefSLNo; }
            set
            {
                this.m_AccRefSLNo = value;
                this.NotifyPropertyChanged("AccRefSLNo");
            }
        }
    ...
    public partial class dcAccRef
    {
        public string AccRefCodeName
        {
            get {
                string cn = m_AccRefCode + "-" + m_AccRefName;
                return cn; 
        ...
        private string m_AccRefNameParent = string.Empty;
        public string AccRefNameParent
        {
            get { return m_AccRefNameParent; }
            set { m_AccRefNameParent = value; }
        }
