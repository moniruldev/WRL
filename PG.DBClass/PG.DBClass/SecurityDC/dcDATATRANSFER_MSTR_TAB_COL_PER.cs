...
{
     [Serializable]
     [DBTable(Name = "DATATRANSFER_MSTR_TAB_COL_PER")]
    public partial class dcDATATRANSFER_MSTR_TAB_COL_PER : DBBaseClass, INotifyPropertyChanged
    {
        #region private members

        private int m_MASTER_ID = 0;
        ...
        [DBColumn(Name = "MASTER_ID", Storage = "m_MASTER_ID", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true, DbType = "Int NOT NULL IDENTITY")]
        public int MASTER_ID
        {
            get { return this.m_MASTER_ID; }
            set
            {
                this.m_MASTER_ID = value;
                this.NotifyPropertyChanged("MASTER_ID");
            }
        }
