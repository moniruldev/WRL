...
{
    [DBTable(Name = "HMCOUNTRY_MST")]
    public partial class dcHMCOUNTRY_MST : DBBaseClass, INotifyPropertyChanged
    {
        ...
        [DBColumn(Name = "COUNTRY_ID", Storage = "m_COUNTRY_ID", DbType = "107", IsDbGenerated = true, SyncOnInsert = true, IsPrimaryKey = true, IsIdentity = true)]
